...
class SearchdataController(BaseController):
	def __init__(self, config,):
		super(SearchdataController, self).__init__(config,)
	def searchData(self, body: SearchdataRequest):
		end_point = '/api/rest/2.0/searchdata'
