...
class TspublicRestV2UserCreateRequest(object):
    ...
    Attributes:
        ...
        org (OrgInput): This is applicable only if organization feature is
            enabled in the cluster.   A JSON object of organization name, id
            or both, in which the object should be created. When both are
            given then id is considered. If no value is provided then object
    ...
    def from_dictionary(cls,
        ...
        org = OrgInput.from_dictionary(dictionary.get('org')) if 'org' in dictionary.keys() else APIHelper.SKIP 
        groups = None
