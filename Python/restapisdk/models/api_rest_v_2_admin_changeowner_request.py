...
class ApiRestV2AdminChangeownerRequest(object):

    """Implementation of the 'Api Rest V2 Admin Changeowner Request' model.

    TODO: type model description here.

    Attributes:
        meta_object_id (list of string): A JSON array of GUIDs of the metadata
        ...
        from_user (FromUserNameAndIDInput): A JSON object of name or GUIDs of
            ...
            metaObjectId, then only for those ids that have owner as the value
    ...
    def __init__(self,
                 ...
                 from_user=None,
                 to_user=None):
        """Constructor for the ApiRestV2AdminChangeownerRequest class"""

        # Initialize members of the class
        self.meta_object_id = meta_object_id
    ...
    def from_dictionary(cls,
        ...
        meta_object_id = dictionary.get('metaObjectId')
