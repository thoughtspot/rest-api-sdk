...
class TspublicRestV2AdminSyncprincipalRequest(object):
    ...
    Attributes:
        ...
        update_modified (UpdateModifiedEnum): Specifies whether to apply the
            changes to users and groups already in the cluster based on the
            principal object list input.
        delete_removed (DeleteRemovedEnum): Specifies whether to delete the
            users and groups already in the cluster if not present in the
            principal object list input.
