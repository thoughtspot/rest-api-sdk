...
class TspublicRestV2GroupCreateRequest(object):
    ...
    Attributes:
        ...
        org_id (int): This is applicable only if organization feature is
            enabled in the cluster.    Unique identifier of the organization.
            If no value is provided, the organization associated with the
            login session is considered.
