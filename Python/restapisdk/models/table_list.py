...
class TableList(object):
    ...
    Attributes:
        ...
        is_external (TableListIsExternalEnum): TODO: type description here.
        is_deprecated (TableListIsDeprecatedEnum): Indicates if the table is
            deprecated
        is_deleted (TableListIsDeletedEnum): Indicates if the table is
            deleted
        is_hidden (TableListIsHiddenEnum): Indicates if the table is hideen
    ...
    def from_dictionary(cls,
        ...
        is_external = dictionary.get("isExternal") if dictionary.get("isExternal") else APIHelper.SKIP
        is_deprecated = dictionary.get("isDeprecated") if dictionary.get("isDeprecated") else APIHelper.SKIP
        is_deleted = dictionary.get("isDeleted") if dictionary.get("isDeleted") else APIHelper.SKIP
        is_hidden = dictionary.get("isHidden") if dictionary.get("isHidden") else APIHelper.SKIP
