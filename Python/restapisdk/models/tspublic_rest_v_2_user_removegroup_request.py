...
class TspublicRestV2UserRemovegroupRequest(object):

    """Implementation of the 'Tspublic Rest V2 User Removegroup Request' model.
    ...
    def __init__(self,
                 ...
                 name=None,
                 id=None):
        """Constructor for the TspublicRestV2UserRemovegroupRequest class"""
