class AuthTokenFullRequest():
	_names = {'username':'username','password':'password','secret_key':'secret_key','validity_time_in_sec':'validity_time_in_sec','org_id':'org_id','email':'email','display_name':'display_name','auto_create':'auto_create','group_identifiers':'group_identifiers',}
	def __init__(self,username,password=None,secret_key=None,validity_time_in_sec=None,org_id=None,email=None,display_name=None,auto_create=None,group_identifiers=None,):
		'''
		Args:
		...
		group_identifiers (array<string>): ID or name of the groups to which the newly created user belongs. Use this parameter to provision a user just-in-time (JIT).
		'''
