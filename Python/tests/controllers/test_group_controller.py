...
class GroupControllerTests(ControllerTestBase):
    ...
    def test_restapi_v_2__get_group(self):
        # Parameters for the API call
        name = None
        id = None

        # Perform the API call through the SDK function
        result = self.controller.restapi_v_2__get_group(name, id)
    ...
    def test_restapi_v_2__delete_group(self):
        # Parameters for the API call
        name = None
        id = None

        # Perform the API call through the SDK function
        result = self.controller.restapi_v_2__delete_group(name, id)
