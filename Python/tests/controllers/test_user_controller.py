...
class UserControllerTests(ControllerTestBase):
    ...
    def test_restapi_v_2__get_user(self):
        # Parameters for the API call
        name = None
        id = None

        # Perform the API call through the SDK function
        result = self.controller.restapi_v_2__get_user(name, id)
    ...
    def test_restapi_v_2__delete_user(self):
        # Parameters for the API call
        name = None
        id = None
        org_id = None
        ...
        # Perform the API call through the SDK function
        result = self.controller.restapi_v_2__delete_user(name, id, org_id)
