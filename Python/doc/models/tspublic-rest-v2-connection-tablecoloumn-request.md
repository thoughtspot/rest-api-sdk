...
| `table` | [`List of ConnectionTableColumnsInput`](../../doc/models/connection-table-columns-input.md) | Required | A JSON object of database, schema and table combination |
