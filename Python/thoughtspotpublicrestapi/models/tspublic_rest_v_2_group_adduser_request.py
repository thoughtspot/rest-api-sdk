...
class TspublicRestV2GroupAdduserRequest(object):

    """Implementation of the 'Tspublic Rest V2 Group Adduser Request' model.
    ...
    def __init__(self,
                 ...
                 name=APIHelper.SKIP,
                 id=APIHelper.SKIP):
        """Constructor for the TspublicRestV2GroupAdduserRequest class"""
