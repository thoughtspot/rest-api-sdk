...
class TspublicRestV2AdminSyncprincipalRequest(object):
    ...
    Attributes:
        principal_object (list of object): A JSON array of principal objects
            ...
            1568926267025,   "modified": 1568926982242,   "principalTypeEnum":
            "LOCAL_GROUP",   "groupNames": [],   "visibility": "DEFAULT"   }, 
            {   "name": "test",   "displayName": "test one",   "created":
            1587573621279,   "modified": 1587573621674,   "mail":
            "test2@test.com",   "principalTypeEnum": "LOCAL_USER",  
            "groupNames": [ "Administrator", "All" ],   "visibility":
            "DEFAULT"   }   You can leave the created and modified dates blank
            for new users.   You can specify if the principal is a user
            (LOCAL_USER) or user group (LOCAL_GROUP) in the principalTypeEnum
            keyword.   Set visibility to NON_SHARABLE, if you do not want the
            user to be able to share ThoughtSpot objects with other users in
            this group.
    ...
    def __init__(self,
                 ...
                 new_user_password=APIHelper.SKIP):
        ...
        if new_user_password is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        principal_object = dictionary.get("principalObject") if dictionary.get("principalObject") else None
        ...
        new_user_password = dictionary.get("newUserPassword") if dictionary.get("newUserPassword") else APIHelper.SKIP
