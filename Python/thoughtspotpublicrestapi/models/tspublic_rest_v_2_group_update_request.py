...
class TspublicRestV2GroupUpdateRequest(object):
    ...
    Attributes:
        name (string): Name of the user group. The group name string must be
            unique.
        id (string): he GUID of the user account to query.
        ...
        groups (list of GroupNameAndIDInput): Array of objects of groups that
            the user belong to.
        users (list of UserNameAndIDInput): Array of object, A JSON array of
            name of users of users.
        assigned_liveboards (list of string): Array of string. An array of
            liveboard ids to be assigned to the group.
