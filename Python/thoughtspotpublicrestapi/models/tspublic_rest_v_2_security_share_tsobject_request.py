...
class TspublicRestV2SecurityShareTsobjectRequest(object):
    ...
    Attributes:
        mtype (Type18Enum): Type of metadata object. Valid values:
        ...
        permission (string): A JSON object with GUIDs of user and user group,
            ...
            enables users to modify the object.   To remove access to a shared
            object, you can set the shareMode in the permission string to
            NO_ACCESS. Example:   {"permissions":
