...
"""
from tspublicrestapi.models.e_format import EFormat
from tspublicrestapi.models.user_properties import UserProperties


class RestAPISessionInfo(object):

    """Implementation of the 'RestAPISessionInfo' model.
    ...
    Attributes:
        ...
        date_format (EFormat): TODO: type description here.
        time_format (EFormat): TODO: type description here.
        date_time_format (EFormat): TODO: type description here.
        ...
        first_login_date (float): Date on which the user account logged in for
            the first time
        user_properties (UserProperties): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 state=None):
        """Constructor for the RestAPISessionInfo class"""
    ...
    def from_dictionary(cls,
        ...
        date_format = EFormat.from_dictionary(dictionary.get('dateFormat')) if dictionary.get('dateFormat') else None
        time_format = EFormat.from_dictionary(dictionary.get('timeFormat')) if dictionary.get('timeFormat') else None
        date_time_format = EFormat.from_dictionary(dictionary.get('dateTimeFormat')) if dictionary.get('dateTimeFormat') else None
        ...
        user_properties = UserProperties.from_dictionary(dictionary.get('userProperties')) if dictionary.get('userProperties') else None
