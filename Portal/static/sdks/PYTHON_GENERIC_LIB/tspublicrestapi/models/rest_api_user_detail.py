...
from tspublicrestapi.models.group_properties import GroupProperties
...
class RestAPIUserDetail(object):

    """Implementation of the 'RestAPIUserDetail' model.
    ...
    Attributes:
        ...
        groups (list of GroupProperties): Name of the group to which user
            account is added
    ...
    def __init__(self,
                 ...
                 modified_by=None,
                 owner=None):
        """Constructor for the RestAPIUserDetail class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('groups') is not None:
            groups = [GroupProperties.from_dictionary(x) for x in dictionary.get('groups')]
