...
from tspublicrestapi.http.requests_client import RequestsClient
...
class Configuration(object):
    ...
    def __init__(
        ...
        content_type='application/json', accept_language='application/json', access_token='TODO: Replace'
    ):
    ...
    def clone_with(self, timeout=None, max_retries=None, backoff_factor=None,
                   ...
                   base_url=None, content_type=None, accept_language=None,
                   access_token=None):
