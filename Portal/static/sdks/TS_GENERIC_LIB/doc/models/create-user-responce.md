...
| `groups` | `string[] \| undefined` | Optional | Username of the owner of the user account |
| `privileges` | `string[] \| undefined` | Optional | Privileges assigned to user account |
| `tags` | `string[] \| undefined` | Optional | - |
| `state` | [`StateEnum \| undefined`](/doc/models/state-enum.md) | Optional | Indicates if the user account is active or inactive |
