...
import { EFormat, eFormatSchema } from './eFormat';
import { UserProperties, userPropertiesSchema } from './userProperties';

/** Session Info */
export interface RestAPISessionInfo {
...
export const restAPISessionInfoSchema: Schema<RestAPISessionInfo> = object({
  ...
  dateFormat: ['dateFormat', optional(lazy(() => eFormatSchema))],
  timeFormat: ['timeFormat', optional(lazy(() => eFormatSchema))],
  dateTimeFormat: ['dateTimeFormat', optional(lazy(() => eFormatSchema))],
  ...
  userProperties: [
    'userProperties',
    optional(lazy(() => userPropertiesSchema)),
  ],
