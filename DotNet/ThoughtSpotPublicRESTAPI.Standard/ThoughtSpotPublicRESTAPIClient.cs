// <copyright file="ThoughtSpotPublicRESTAPIClient.cs" company="APIMatic">
...
namespace ThoughtSpotPublicRESTAPI.Standard
{
    ...
    /// </summary>
    public sealed class ThoughtSpotPublicRESTAPIClient : IConfiguration
    {
        ...
        private readonly Lazy<CustomActionsController> customActions;
        ...
        private ThoughtSpotPublicRESTAPIClient(
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.customActions = new Lazy<CustomActionsController>(
                () => new CustomActionsController(this, this.httpClient, this.authManagers, this.httpCallBack));
            this.security = new Lazy<SecurityController>(
                () => new SecurityController(this, this.httpClient, this.authManagers, this.httpCallBack));
        ...
        /// <summary>
        /// Gets CustomActionsController controller.
        /// </summary>
        public CustomActionsController CustomActionsController => this.customActions.Value;
        ...
        /// <summary>
        /// Creates an object of the ThoughtSpotPublicRESTAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> ThoughtSpotPublicRESTAPIClient.</returns>
        internal static ThoughtSpotPublicRESTAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("THOUGHT_SPOT_PUBLIC_RESTAPI_STANDARD_ENVIRONMENT");
            string baseUrl = System.Environment.GetEnvironmentVariable("THOUGHT_SPOT_PUBLIC_RESTAPI_STANDARD_BASE_URL");
            string accessToken = System.Environment.GetEnvironmentVariable("THOUGHT_SPOT_PUBLIC_RESTAPI_STANDARD_ACCESS_TOKEN");
        ...
        {
            private Environment environment = ThoughtSpotPublicRESTAPI.Standard.Environment.Production;
            ...
            public ThoughtSpotPublicRESTAPIClient Build()
            {
                ...
                return new ThoughtSpotPublicRESTAPIClient(
                    this.environment,
                    this.baseUrl,
                    this.accessToken,
                    this.authManagers,
