...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `body` | [`Models.TspublicRestV2SessionOrgRequest`](../../doc/models/tspublic-rest-v2-session-org-request.md) | Body, Required | - |
...
```csharp
var body = new TspublicRestV2SessionOrgRequest();

try
{
    bool? result = await sessionController.SwitchOrgAsync(body);
}
catch (ApiException e){};
```
