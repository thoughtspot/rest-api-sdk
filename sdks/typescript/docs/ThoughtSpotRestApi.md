...
[**updateLinkCustomizations**](ThoughtSpotRestApi.md#updateLinkCustomizations) | **POST** /api/rest/2.0/customization/links/update | 
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ConfigureAuthSettingsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ConfigureCommunicationChannelPreferencesRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ConfigureSecuritySettingsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, CreateAgentConversationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, CreateCollectionRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, CreateSemanticIntegrationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, CreateWebhookConfigurationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteCollectionRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteConversationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteManualTranslationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteSemanticIntegrationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteStyleFontsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteVariablesRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, DeleteWebhookConfigurationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ExportManualTranslationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ExportMemoryRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ExportStyleLogosRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, FetchObjectPrivilegesRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetAgentInstructionsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetConversationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetConversationListRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetManualTranslationBundleRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetRelevantQuestionsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetShareInfoRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetSharedContentRequest } from '@thoughtspot/rest-api-sdk';
...
> Array<WebhookStorageConfigInfo> getWebhookStorageConfig()
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, GetWebhookStorageConfigRequest } from '@thoughtspot/rest-api-sdk';
...
apiInstance.getWebhookStorageConfig().then((data:any) => {
  console.log('API called successfully. Returned data: ' + JSON.stringify(data));
}).catch((error:any) => console.error(error));
...
**Array<WebhookStorageConfigInfo>**
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ImportManualTranslationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ImportMemoryRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ImportSemanticIntegrationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, LoadAnswerRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ManageObjectPrivilegeRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ParameterizeMetadataFieldsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, PutVariableValuesRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, RevokeRefreshTokensRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchAuthSettingsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchChannelHistoryRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchCollectionsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchCommunicationChannelPreferencesRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchSecuritySettingsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchSemanticIntegrationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchStyleCustomizationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchStyleFontsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SearchWebhookConfigurationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SendAgentConversationMessageRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SendAgentConversationMessageStreamingRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SendAgentMessageStreamingRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SetAgentInstructionsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ShareConversationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, StopConversationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, SyncMetadataRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateCollectionRequest } from '@thoughtspot/rest-api-sdk';
...
> void updateConnectionStatus(updateConnectionStatusRequest)
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateConnectionStatusRequest } from '@thoughtspot/rest-api-sdk';
...
apiInstance.updateConnectionStatus(
  // string | Unique ID or name of the connection.
  "connection_identifier_example" , 
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateConversationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateLinkCustomizationsRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateStyleCustomizationRequest } from '@thoughtspot/rest-api-sdk';
...
apiInstance.updateStyleCustomization(
  ...
  "REPLACE" , 
  // StyleResetOptionsInput | Fields to reset when operation is RESET. Specify style fields and visualization areas to revert to defaults. (optional)
  null , 
  // NavigationPanelInput | Navigation panel color. Provide theme and, when theme is CUSTOM, also provide base_color. Must not be provided together with app_color_theme -- both update the same underlying color. (optional)
  null , 
  // AppColorThemeInput | App color theme -- the same underlying color navigation_panel sets, expressed as a brand color plus how it is applied. brand_color and apply_as_top_nav_color may be set independently; each is left unchanged if omitted. To clear the brand color, use operation RESET with reset_options.style: [\\\"APP_COLOR_THEME\\\"]. Supported only when the app color theme is enabled on the cluster. Must not be provided together with navigation_panel.    Version: 26.10.0.cl or later  (optional)
  null , 
  // StyleColorPaletteInput | Chart color palette. When provided with operation REPLACE, exactly 8 color entries must be specified in colors. (optional)
  null , 
  ...
  // VisualizationFontsInput | Font assignments per visualization area. Provide only the areas to update; omitted areas remain unchanged. (optional)
  null , 
 ...
 **resetOptions** | **StyleResetOptionsInput** | Fields to reset when operation is RESET. Specify style fields and visualization areas to revert to defaults. | (optional) defaults to undefined
 **navigationPanel** | **NavigationPanelInput** | Navigation panel color. Provide theme and, when theme is CUSTOM, also provide base_color. Must not be provided together with app_color_theme -- both update the same underlying color. | (optional) defaults to undefined
 **appColorTheme** | **AppColorThemeInput** | App color theme -- the same underlying color navigation_panel sets, expressed as a brand color plus how it is applied. brand_color and apply_as_top_nav_color may be set independently; each is left unchanged if omitted. To clear the brand color, use operation RESET with reset_options.style: [\\\&quot;APP_COLOR_THEME\\\&quot;]. Supported only when the app color theme is enabled on the cluster. Must not be provided together with navigation_panel.    Version: 26.10.0.cl or later  | (optional) defaults to undefined
 **chartColorPalette** | **StyleColorPaletteInput** | Chart color palette. When provided with operation REPLACE, exactly 8 color entries must be specified in colors. | (optional) defaults to undefined
 ...
 **visualizationFonts** | **VisualizationFontsInput** | Font assignments per visualization area. Provide only the areas to update; omitted areas remain unchanged. | (optional) defaults to undefined
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateStyleFontRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UpdateWebhookConfigurationRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, UploadStyleFontRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, ThoughtSpotRestApi, ValidateCommunicationChannelRequest } from '@thoughtspot/rest-api-sdk';
