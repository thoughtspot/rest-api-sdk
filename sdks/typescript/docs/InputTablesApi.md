...
```typescript
import { createBearerAuthenticationConfig, InputTablesApi, CreateInputTableColumnRequest } from '@thoughtspot/rest-api-sdk';
...
```typescript
import { createBearerAuthenticationConfig, InputTablesApi, DeleteInputTableColumnRequest } from '@thoughtspot/rest-api-sdk';
