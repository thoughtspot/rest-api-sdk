...
const apiInstance = new ThoughtSpotRestApiSdk.MetadataApi(configuration);

let body:ThoughtSpotRestApiSdk.MetadataApiDeleteMetadataRequest = {
...
let body:ThoughtSpotRestApiSdk.MetadataApiExportMetadataTMLRequest = {
...
let body:ThoughtSpotRestApiSdk.MetadataApiFetchAnswerSqlQueryRequest = {
...
let body:ThoughtSpotRestApiSdk.MetadataApiFetchLiveboardSqlQueryRequest = {
...
let body:ThoughtSpotRestApiSdk.MetadataApiImportMetadataTMLRequest = {
...
let body:ThoughtSpotRestApiSdk.MetadataApiSearchMetadataRequest = {
