...
const apiInstance = new ThoughtSpotRestApiSdk.SecurityApi(configuration);

let body:ThoughtSpotRestApiSdk.SecurityApiAssignChangeAuthorRequest = {
...
let body:ThoughtSpotRestApiSdk.SecurityApiFetchPermissionsOfPrincipalsRequest = {
...
let body:ThoughtSpotRestApiSdk.SecurityApiFetchPermissionsOnMetadataRequest = {
...
let body:ThoughtSpotRestApiSdk.SecurityApiShareMetadataRequest = {
