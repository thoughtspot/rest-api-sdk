...
export class ObservableClass900ClApi {
    private requestFactory: Class900ClApiRequestFactory;
    private responseProcessor: Class900ClApiResponseProcessor;
    private configuration: Configuration;

    public constructor(
        configuration: Configuration,
        requestFactory?: Class900ClApiRequestFactory,
        responseProcessor?: Class900ClApiResponseProcessor
    ) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new Class900ClApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new Class900ClApiResponseProcessor();
    }
     ...
     */
    public exportAnswerReport(exportAnswerReportRequest: ExportAnswerReportRequest, _options?: Configuration): Observable<any> {
     ...
     */
    public exportLiveboardReport(exportLiveboardReportRequest: ExportLiveboardReportRequest, _options?: Configuration): Observable<any> {
...
export class ObservableClass920ClApi {
    private requestFactory: Class920ClApiRequestFactory;
    private responseProcessor: Class920ClApiResponseProcessor;
    private configuration: Configuration;

    public constructor(
        configuration: Configuration,
        requestFactory?: Class920ClApiRequestFactory,
        responseProcessor?: Class920ClApiResponseProcessor
    ) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new Class920ClApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new Class920ClApiResponseProcessor();
    }
...
export class ObservableClass940ClApi {
    private requestFactory: Class940ClApiRequestFactory;
    private responseProcessor: Class940ClApiResponseProcessor;
    private configuration: Configuration;

    public constructor(
        configuration: Configuration,
        requestFactory?: Class940ClApiRequestFactory,
        responseProcessor?: Class940ClApiResponseProcessor
    ) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new Class940ClApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new Class940ClApiResponseProcessor();
    }
...
export class ObservableClass950ClApi {
    private requestFactory: Class950ClApiRequestFactory;
    private responseProcessor: Class950ClApiResponseProcessor;
    private configuration: Configuration;

    public constructor(
        configuration: Configuration,
        requestFactory?: Class950ClApiRequestFactory,
        responseProcessor?: Class950ClApiResponseProcessor
    ) {
        this.configuration = configuration;
        this.requestFactory = requestFactory || new Class950ClApiRequestFactory(configuration);
        this.responseProcessor = responseProcessor || new Class950ClApiResponseProcessor();
    }
