...
export class PromiseDBTApi {
     ...
     */
    public dbtSearch(_options?: Configuration): Promise<any> {
     ...
     */
    public generateSyncTml(generateSyncTmlRequest: GenerateSyncTmlRequest, _options?: Configuration): Promise<any> {
        const result = this.api.generateSyncTml(generateSyncTmlRequest, _options);
        return result.toPromise();
    }
     ...
     */
    public generateTml(generateTmlRequest: GenerateTmlRequest, _options?: Configuration): Promise<any> {
        const result = this.api.generateTml(generateTmlRequest, _options);
        return result.toPromise();
    }
     ...
     */
    public updateDbtConnection(dbtConnectionIdentifier: string, updateDbtConnectionRequest?: UpdateDbtConnectionRequest, _options?: Configuration): Promise<void> {
        const result = this.api.updateDbtConnection(dbtConnectionIdentifier, updateDbtConnectionRequest, _options);
        return result.toPromise();
    }
