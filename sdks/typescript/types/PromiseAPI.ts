...
export class PromiseThoughtSpotRestApi {
     ...
     */
    public getWebhookStorageConfig(webhookIdentifier: string, _options?: Configuration): Promise<StorageSetupInfo> {
        const result = this.api.getWebhookStorageConfig(webhookIdentifier, _options);
        return result.toPromise();
    }
