...
export class PromiseClass900ClApi {
     ...
     */
    public exportAnswerReport(exportAnswerReportRequest: ExportAnswerReportRequest, _options?: Configuration): Promise<any> {
     ...
     */
    public exportLiveboardReport(exportLiveboardReportRequest: ExportLiveboardReportRequest, _options?: Configuration): Promise<any> {
...
export class PromiseClass920ClApi {
...
export class PromiseClass940ClApi {
...
export class PromiseClass950ClApi {
