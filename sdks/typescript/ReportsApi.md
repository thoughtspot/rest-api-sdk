...
const apiInstance = new ThoughtSpotRestApiSdk.ReportsApi(configuration);

let body:ThoughtSpotRestApiSdk.ReportsApiExportAnswerReportRequest = {
...
let body:ThoughtSpotRestApiSdk.ReportsApiExportLiveboardReportRequest = {
