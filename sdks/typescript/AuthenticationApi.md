...
const apiInstance = new ThoughtSpotRestApiSdk.AuthenticationApi(configuration);
...
let body:ThoughtSpotRestApiSdk.AuthenticationApiGetFullAccessTokenRequest = {
...
let body:ThoughtSpotRestApiSdk.AuthenticationApiGetObjectAccessTokenRequest = {
...
let body:ThoughtSpotRestApiSdk.AuthenticationApiLoginRequest = {
...
let body:ThoughtSpotRestApiSdk.AuthenticationApiRevokeTokenRequest = {
