...
/**
  ...
  * );
 */
declare const createBearerAuthenticationConfig: (thoughtSpotHost: string, paramOrTokenProvider: GetFullAccessTokenRequest | (() => Promise<string>), options?: ConfigurationOptions) => Configuration;
/**
 ...
 */
declare const createBasicConfig: (thoughtSpotHost: string, options?: ConfigurationOptions) => Configuration;
