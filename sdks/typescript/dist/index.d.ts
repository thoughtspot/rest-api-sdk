 ...
 */
declare const createBearerAuthenticationConfig: (thoughtSpotHost: string, paramOrTokenProvider: GetFullAccessTokenRequest | (() => Promise<string>), options?: {
 ...
 */
declare const createBasicConfig: (thoughtSpotHost: string, options?: {
    additionalHeaders: Record<string, string>;
}) => Configuration;
