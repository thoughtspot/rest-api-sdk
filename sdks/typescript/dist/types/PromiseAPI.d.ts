...
export declare class PromiseClass900ClApi {
    private api;
    ...
    exportAnswerReport(exportAnswerReportRequest: ExportAnswerReportRequest, _options?: Configuration): Promise<any>;
    exportLiveboardReport(exportLiveboardReportRequest: ExportLiveboardReportRequest, _options?: Configuration): Promise<any>;
...
export declare class PromiseClass920ClApi {
    private api;
...
export declare class PromiseClass940ClApi {
    private api;
...
export declare class PromiseClass950ClApi {
    private api;
