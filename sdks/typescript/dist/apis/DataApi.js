...
exports.DataApiResponseProcessor = exports.DataApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var DataApiRequestFactory = (function (_super) {
    __extends(DataApiRequestFactory, _super);
    function DataApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataApiRequestFactory.prototype.fetchAnswerData = function (fetchAnswerDataRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (fetchAnswerDataRequest === null || fetchAnswerDataRequest === undefined) {
                            throw new baseapi_1.RequiredError("DataApi", "fetchAnswerData", "fetchAnswerDataRequest");
                        }
    ...
    DataApiRequestFactory.prototype.fetchLiveboardData = function (fetchLiveboardDataRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (fetchLiveboardDataRequest === null || fetchLiveboardDataRequest === undefined) {
                            throw new baseapi_1.RequiredError("DataApi", "fetchLiveboardData", "fetchLiveboardDataRequest");
                        }
    ...
    DataApiRequestFactory.prototype.searchData = function (searchDataRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (searchDataRequest === null || searchDataRequest === undefined) {
                            throw new baseapi_1.RequiredError("DataApi", "searchData", "searchDataRequest");
                        }
...
exports.DataApiRequestFactory = DataApiRequestFactory;
var DataApiResponseProcessor = (function () {
    function DataApiResponseProcessor() {
    }
    DataApiResponseProcessor.prototype.fetchAnswerData = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    DataApiResponseProcessor.prototype.fetchLiveboardData = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    DataApiResponseProcessor.prototype.searchData = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
...
exports.DataApiResponseProcessor = DataApiResponseProcessor;
