...
export class ThoughtSpotRestApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async generateSyncTml(generateSyncTmlRequest: GenerateSyncTmlRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'generateSyncTmlRequest' is not null or undefined
        if (generateSyncTmlRequest === null || generateSyncTmlRequest === undefined) {
            throw new RequiredError("ThoughtSpotRestApi", "generateSyncTml", "generateSyncTmlRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(generateSyncTmlRequest, "GenerateSyncTmlRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
    ...
    public async generateTml(generateTmlRequest: GenerateTmlRequest, _options?: Configuration): Promise<RequestContext> {
        ...
        // verify required parameter 'generateTmlRequest' is not null or undefined
        if (generateTmlRequest === null || generateTmlRequest === undefined) {
            throw new RequiredError("ThoughtSpotRestApi", "generateTml", "generateTmlRequest");
        }
        ...
        requestContext.setHeaderParam("Content-Type", contentType);
        const serializedBody = ObjectSerializer.stringify(
            ObjectSerializer.serialize(generateTmlRequest, "GenerateTmlRequest", ""),
            contentType
        );
        requestContext.setBody(serializedBody);
     ...
     */
    public async updateDbtConnection(dbtConnectionIdentifier: string, updateDbtConnectionRequest?: UpdateDbtConnectionRequest, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        // Path Params
        const localVarPath = '/api/rest/2.0/dbt/{dbt_connection_identifier}'
...
export class ThoughtSpotRestApiResponseProcessor {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async dbtSearch(response: ResponseContext): Promise<any > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to generateSyncTml
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async generateSyncTml(response: ResponseContext): Promise<any > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * to the expected objects
     *
     * @params response Response returned by the server for a request to generateTml
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async generateTml(response: ResponseContext): Promise<any > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
            const body: any = ObjectSerializer.deserialize(
                ObjectSerializer.parse(await response.body.text(), contentType),
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateDbtConnection(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return;
        }
