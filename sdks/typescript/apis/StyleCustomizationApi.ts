...
export class StyleCustomizationApiRequestFactory extends BaseAPIRequestFactory {
    ...
    public async updateStyleCustomization(scope: string, operation?: string, resetOptions?: UpdateStyleCustomizationRequestResetOptions, navigationPanel?: UpdateStyleCustomizationRequestNavigationPanel, chartColorPalette?: UpdateStyleCustomizationRequestChartColorPalette, embeddedFooterText?: string, visualizationFonts?: UpdateStyleCustomizationRequestVisualizationFonts, defaultLogo?: HttpFile, wideLogo?: HttpFile, _options?: Configuration): Promise<RequestContext> {
        ...
        if (resetOptions !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('reset_options', resetOptions as any);
        }
        if (navigationPanel !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('navigation_panel', navigationPanel as any);
        }
        if (chartColorPalette !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('chart_color_palette', chartColorPalette as any);
        }
        ...
        if (visualizationFonts !== undefined) {
             // TODO: replace .append with .set
             localVarFormParams.append('visualization_fonts', visualizationFonts as any);
        }
...
export class StyleCustomizationApiResponseProcessor {
     ...
     */
     public async deleteStyleFonts(response: ResponseContext): Promise<StyleFontDeleteData > {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchStyleCustomizations(response: ResponseContext): Promise<Array<StylePreference> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async searchStyleFonts(response: ResponseContext): Promise<Array<StyleFontRecord> > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateStyleCustomization(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async updateStyleFont(response: ResponseContext): Promise<void > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("204", response.httpStatusCode)) {
            return;
        }
     ...
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async uploadStyleFont(response: ResponseContext): Promise<StyleFontUploadData > {
        const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
        if (isCodeInRange("200", response.httpStatusCode)) {
