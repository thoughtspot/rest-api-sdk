...
const apiInstance = new ThoughtSpotRestApiSdk.ConnectionsApi(configuration);

let body:ThoughtSpotRestApiSdk.ConnectionsApiCreateConnectionRequest = {
...
let body:ThoughtSpotRestApiSdk.ConnectionsApiDeleteConnectionRequest = {
...
let body:ThoughtSpotRestApiSdk.ConnectionsApiSearchConnectionRequest = {
...
let body:ThoughtSpotRestApiSdk.ConnectionsApiUpdateConnectionRequest = {
