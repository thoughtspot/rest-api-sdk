...
const apiInstance = new ThoughtSpotRestApiSdk.VersionControlApi(configuration);

let body:ThoughtSpotRestApiSdk.VersionControlApiCommitBranchRequest = {
  // CommitBranchRequest
  commitBranchRequest: {
    metadata: [
      {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiCreateConfigRequest = {
  // CreateConfigRequest
  createConfigRequest: {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiDeleteConfigRequest = {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiDeployCommitRequest = {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiRevertCommitRequest = {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiSearchCommitsRequest = {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiSearchConfigRequest = {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiUpdateConfigRequest = {
...
let body:ThoughtSpotRestApiSdk.VersionControlApiValidateMergeRequest = {
