...
const apiInstance = new ThoughtSpotRestApiSdk.DataApi(configuration);

let body:ThoughtSpotRestApiSdk.DataApiFetchAnswerDataRequest = {
...
let body:ThoughtSpotRestApiSdk.DataApiFetchLiveboardDataRequest = {
...
let body:ThoughtSpotRestApiSdk.DataApiSearchDataRequest = {
  // SearchDataRequest
  searchDataRequest: {
