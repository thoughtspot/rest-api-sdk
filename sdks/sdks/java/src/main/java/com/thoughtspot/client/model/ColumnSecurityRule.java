...
import com.thoughtspot.client.model.ColumnSecurityRuleColumn;
import com.thoughtspot.client.model.ColumnSecurityRuleGroup;
import com.thoughtspot.client.model.ColumnSecurityRuleSourceTable;
...
public class ColumnSecurityRule implements Serializable {
  ...
  public ColumnSecurityRule groups(@javax.annotation.Nullable List<ColumnSecurityRuleGroup> groups) {
    this.groups = groups;
    return this;
  }
  ...
  public ColumnSecurityRule sourceTableDetails(@javax.annotation.Nullable ColumnSecurityRuleSourceTable sourceTableDetails) {
  ...
  public void setSourceTableDetails(@javax.annotation.Nullable ColumnSecurityRuleSourceTable sourceTableDetails) {
    this.sourceTableDetails = sourceTableDetails;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColumnSecurityRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColumnSecurityRule is not found in the empty JSON string", ColumnSecurityRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColumnSecurityRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColumnSecurityRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("source_table_details") != null && !jsonObj.get("source_table_details").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ColumnSecurityRule>() {
           @Override
           public void write(JsonWriter out, ColumnSecurityRule value) throws IOException {
