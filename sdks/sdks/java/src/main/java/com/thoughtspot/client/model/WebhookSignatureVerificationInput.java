...
public class WebhookSignatureVerificationInput implements Serializable {
  ...
  public WebhookSignatureVerificationInput algorithm(@javax.annotation.Nonnull AlgorithmEnum algorithm) {
  ...
  public boolean equals(Object o) {
    ...
    WebhookSignatureVerificationInput webhookSignatureVerificationInput = (WebhookSignatureVerificationInput) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to WebhookSignatureVerificationInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSignatureVerificationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSignatureVerificationInput is not found in the empty JSON string", WebhookSignatureVerificationInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSignatureVerificationInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSignatureVerificationInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookSignatureVerificationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookSignatureVerificationInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WebhookSignatureVerificationInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WebhookSignatureVerificationInput.class));

       return (TypeAdapter<T>) new TypeAdapter<WebhookSignatureVerificationInput>() {
           @Override
           public void write(JsonWriter out, WebhookSignatureVerificationInput value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WebhookSignatureVerificationInput read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to WebhookSignatureVerificationInput
   */
