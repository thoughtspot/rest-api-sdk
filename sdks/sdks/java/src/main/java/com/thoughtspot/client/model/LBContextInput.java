...
public class LBContextInput implements Serializable {
  ...
  public static final String SERIALIZED_NAME_VISUALIZATION_IDENTIFIER = "visualization_identifier";
  ...
  public LBContextInput liveboardIdentifier(@javax.annotation.Nonnull String liveboardIdentifier) {
  ...
  public LBContextInput visualizationIdentifier(@javax.annotation.Nonnull String visualizationIdentifier) {
  ...
  public void setVisualizationIdentifier(@javax.annotation.Nonnull String visualizationIdentifier) {
    this.visualizationIdentifier = visualizationIdentifier;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.liveboardIdentifier, lbContextInput.liveboardIdentifier) &&
        Objects.equals(this.visualizationIdentifier, lbContextInput.visualizationIdentifier);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LBContextInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LBContextInput is not found in the empty JSON string", LBContextInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LBContextInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LBContextInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (!jsonObj.get("liveboard_identifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `liveboard_identifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("liveboard_identifier").toString()));
      }
      if (!jsonObj.get("visualization_identifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `visualization_identifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("visualization_identifier").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LBContextInput>() {
           @Override
