...
public class ColumnSecurityRuleTableInput implements Serializable {
  ...
  public ColumnSecurityRuleTableInput objIdentifier(@javax.annotation.Nullable String objIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    ColumnSecurityRuleTableInput columnSecurityRuleTableInput = (ColumnSecurityRuleTableInput) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to ColumnSecurityRuleTableInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColumnSecurityRuleTableInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColumnSecurityRuleTableInput is not found in the empty JSON string", ColumnSecurityRuleTableInput.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ColumnSecurityRuleTableInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ColumnSecurityRuleTableInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColumnSecurityRuleTableInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColumnSecurityRuleTableInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ColumnSecurityRuleTableInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ColumnSecurityRuleTableInput.class));

       return (TypeAdapter<T>) new TypeAdapter<ColumnSecurityRuleTableInput>() {
           @Override
           public void write(JsonWriter out, ColumnSecurityRuleTableInput value) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to ColumnSecurityRuleTableInput
   */
