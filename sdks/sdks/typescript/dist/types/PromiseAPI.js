...
exports.PromiseVersionControlApi = exports.PromiseUsersApi = exports.PromiseThoughtSpotRestApi = exports.PromiseTagsApi = exports.PromiseSystemApi = exports.PromiseSecurityApi = exports.PromiseSchedulesApi = exports.PromiseRolesApi = exports.PromiseReportsApi = exports.PromiseOrgsApi = exports.PromiseMetadataApi = exports.PromiseLogApi = exports.PromiseGroupsApi = exports.PromiseDataApi = exports.PromiseDBTApi = exports.PromiseCustomActionApi = exports.PromiseConnectionsApi = exports.PromiseAuthenticationApi = void 0;
...
var PromiseDBTApi = (function () {
    function PromiseDBTApi(configuration, requestFactory, responseProcessor) {
        this.api = new ObservableAPI_4.ObservableDBTApi(configuration, requestFactory, responseProcessor);
    }
    PromiseDBTApi.prototype.dbtConnection = function (dbtConnectionRequest, _options) {
        var result = this.api.dbtConnection(dbtConnectionRequest, _options);
        return result.toPromise();
    };
    PromiseDBTApi.prototype.dbtSearch = function (_options) {
        var result = this.api.dbtSearch(_options);
        return result.toPromise();
    };
    PromiseDBTApi.prototype.generateSyncTml = function (generateSyncTmlRequest, _options) {
        var result = this.api.generateSyncTml(generateSyncTmlRequest, _options);
        return result.toPromise();
    };
    PromiseDBTApi.prototype.generateTml = function (generateTmlRequest, _options) {
        var result = this.api.generateTml(generateTmlRequest, _options);
        return result.toPromise();
    };
    PromiseDBTApi.prototype.updateDbtConnection = function (dbtConnectionIdentifier, updateDbtConnectionRequest, _options) {
        var result = this.api.updateDbtConnection(dbtConnectionIdentifier, updateDbtConnectionRequest, _options);
        return result.toPromise();
    };
    return PromiseDBTApi;
}());
exports.PromiseDBTApi = PromiseDBTApi;
...
var PromiseThoughtSpotRestApi = (function () {
    ...
    PromiseThoughtSpotRestApi.prototype.activateUser = function (activateUserRequest, _options) {
        var result = this.api.activateUser(activateUserRequest, _options);
        return result.toPromise();
    };
    ...
    PromiseThoughtSpotRestApi.prototype.dbtConnection = function (dbtConnectionRequest, _options) {
        var result = this.api.dbtConnection(dbtConnectionRequest, _options);
        return result.toPromise();
    };
    PromiseThoughtSpotRestApi.prototype.dbtSearch = function (_options) {
        var result = this.api.dbtSearch(_options);
        return result.toPromise();
    };
    PromiseThoughtSpotRestApi.prototype.deactivateUser = function (deactivateUserRequest, _options) {
        var result = this.api.deactivateUser(deactivateUserRequest, _options);
        return result.toPromise();
    };
    ...
    PromiseThoughtSpotRestApi.prototype.generateSyncTml = function (generateSyncTmlRequest, _options) {
        var result = this.api.generateSyncTml(generateSyncTmlRequest, _options);
        return result.toPromise();
    };
    PromiseThoughtSpotRestApi.prototype.generateTml = function (generateTmlRequest, _options) {
        var result = this.api.generateTml(generateTmlRequest, _options);
        return result.toPromise();
    };
    ...
    PromiseThoughtSpotRestApi.prototype.updateDbtConnection = function (dbtConnectionIdentifier, updateDbtConnectionRequest, _options) {
        var result = this.api.updateDbtConnection(dbtConnectionIdentifier, updateDbtConnectionRequest, _options);
        return result.toPromise();
    };
...
var PromiseUsersApi = (function () {
    ...
    PromiseUsersApi.prototype.activateUser = function (activateUserRequest, _options) {
        var result = this.api.activateUser(activateUserRequest, _options);
        return result.toPromise();
    };
    ...
    PromiseUsersApi.prototype.deactivateUser = function (deactivateUserRequest, _options) {
        var result = this.api.deactivateUser(deactivateUserRequest, _options);
        return result.toPromise();
    };
