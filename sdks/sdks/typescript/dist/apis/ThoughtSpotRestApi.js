...
var ThoughtSpotRestApiRequestFactory = (function (_super) {
    ...
    ThoughtSpotRestApiRequestFactory.prototype.activateUser = function (activateUserRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (activateUserRequest === null || activateUserRequest === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "activateUser", "activateUserRequest");
                        }
    ...
    ThoughtSpotRestApiRequestFactory.prototype.dbtConnection = function (dbtConnectionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (dbtConnectionRequest === null || dbtConnectionRequest === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "dbtConnection", "dbtConnectionRequest");
                        }
                        localVarPath = '/api/rest/2.0/dbt/dbt-connection';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("User-Agent", "ThoughtSpot-ts-client");
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(dbtConnectionRequest, "DbtConnectionRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        authMethod = _config.authMethods["bearerAuth"];
                        if (!(authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication)) return [3, 2];
                        return [4, (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication(requestContext))];
    ...
    ThoughtSpotRestApiRequestFactory.prototype.dbtSearch = function (_options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        localVarPath = '/api/rest/2.0/dbt/search';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("User-Agent", "ThoughtSpot-ts-client");
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        authMethod = _config.authMethods["bearerAuth"];
    ...
    ThoughtSpotRestApiRequestFactory.prototype.deactivateUser = function (deactivateUserRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (deactivateUserRequest === null || deactivateUserRequest === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "deactivateUser", "deactivateUserRequest");
                        }
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (deployCommitRequest === null || deployCommitRequest === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "deployCommit", "deployCommitRequest");
                        }
    ...
    ThoughtSpotRestApiRequestFactory.prototype.generateSyncTml = function (generateSyncTmlRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (generateSyncTmlRequest === null || generateSyncTmlRequest === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "generateSyncTml", "generateSyncTmlRequest");
                        }
                        localVarPath = '/api/rest/2.0/dbt/generate-sync-tml';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("User-Agent", "ThoughtSpot-ts-client");
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(generateSyncTmlRequest, "GenerateSyncTmlRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        authMethod = _config.authMethods["bearerAuth"];
                        if (!(authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication)) return [3, 2];
                        return [4, (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication(requestContext))];
    ...
    ThoughtSpotRestApiRequestFactory.prototype.generateTml = function (generateTmlRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (generateTmlRequest === null || generateTmlRequest === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "generateTml", "generateTmlRequest");
                        }
                        localVarPath = '/api/rest/2.0/dbt/generate-tml';
                        requestContext = _config.baseServer.makeRequestContext(localVarPath, http_1.HttpMethod.POST);
                        requestContext.setHeaderParam("User-Agent", "ThoughtSpot-ts-client");
                        requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8");
                        contentType = ObjectSerializer_1.ObjectSerializer.getPreferredMediaType([
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(generateTmlRequest, "GenerateTmlRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        authMethod = _config.authMethods["bearerAuth"];
                        if (!(authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication)) return [3, 2];
                        return [4, (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication(requestContext))];
    ...
    ThoughtSpotRestApiRequestFactory.prototype.updateDbtConnection = function (dbtConnectionIdentifier, updateDbtConnectionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (dbtConnectionIdentifier === null || dbtConnectionIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("ThoughtSpotRestApi", "updateDbtConnection", "dbtConnectionIdentifier");
                        }
                        localVarPath = '/api/rest/2.0/dbt/{dbt_connection_identifier}'
                        ...
                        requestContext.setHeaderParam("Content-Type", contentType);
                        serializedBody = ObjectSerializer_1.ObjectSerializer.stringify(ObjectSerializer_1.ObjectSerializer.serialize(updateDbtConnectionRequest, "UpdateDbtConnectionRequest", ""), contentType);
                        requestContext.setBody(serializedBody);
                        authMethod = _config.authMethods["bearerAuth"];
                        if (!(authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication)) return [3, 2];
                        return [4, (authMethod === null || authMethod === void 0 ? void 0 : authMethod.applySecurityAuthentication(requestContext))];
...
var ThoughtSpotRestApiResponseProcessor = (function () {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.activateUser = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.dbtConnection = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.dbtSearch = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.deactivateUser = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.generateSyncTml = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.generateTml = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    ThoughtSpotRestApiResponseProcessor.prototype.updateDbtConnection = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
