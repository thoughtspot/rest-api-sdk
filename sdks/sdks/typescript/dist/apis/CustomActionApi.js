...
exports.CustomActionApiResponseProcessor = exports.CustomActionApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var CustomActionApiRequestFactory = (function (_super) {
    __extends(CustomActionApiRequestFactory, _super);
    function CustomActionApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CustomActionApiRequestFactory.prototype.createCustomAction = function (createCustomActionRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createCustomActionRequest === null || createCustomActionRequest === undefined) {
                            throw new baseapi_1.RequiredError("CustomActionApi", "createCustomAction", "createCustomActionRequest");
                        }
    ...
    CustomActionApiRequestFactory.prototype.deleteCustomAction = function (customActionIdentifier, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (customActionIdentifier === null || customActionIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("CustomActionApi", "deleteCustomAction", "customActionIdentifier");
                        }
    ...
    CustomActionApiRequestFactory.prototype.searchCustomActions = function (searchCustomActionsRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
    ...
    CustomActionApiRequestFactory.prototype.updateCustomAction = function (customActionIdentifier, updateCustomActionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (customActionIdentifier === null || customActionIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("CustomActionApi", "updateCustomAction", "customActionIdentifier");
                        }
...
exports.CustomActionApiRequestFactory = CustomActionApiRequestFactory;
var CustomActionApiResponseProcessor = (function () {
    function CustomActionApiResponseProcessor() {
    }
    CustomActionApiResponseProcessor.prototype.createCustomAction = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CustomActionApiResponseProcessor.prototype.deleteCustomAction = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CustomActionApiResponseProcessor.prototype.searchCustomActions = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    CustomActionApiResponseProcessor.prototype.updateCustomAction = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
...
exports.CustomActionApiResponseProcessor = CustomActionApiResponseProcessor;
//# sourceMappingURL=CustomActionApi.js.map