...
exports.SchedulesApiResponseProcessor = exports.SchedulesApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var SchedulesApiRequestFactory = (function (_super) {
    __extends(SchedulesApiRequestFactory, _super);
    function SchedulesApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SchedulesApiRequestFactory.prototype.createSchedule = function (createScheduleRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createScheduleRequest === null || createScheduleRequest === undefined) {
                            throw new baseapi_1.RequiredError("SchedulesApi", "createSchedule", "createScheduleRequest");
                        }
    ...
    SchedulesApiRequestFactory.prototype.deleteSchedule = function (scheduleIdentifier, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (scheduleIdentifier === null || scheduleIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("SchedulesApi", "deleteSchedule", "scheduleIdentifier");
                        }
    ...
    SchedulesApiRequestFactory.prototype.searchSchedules = function (searchSchedulesRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
    ...
    SchedulesApiRequestFactory.prototype.updateSchedule = function (scheduleIdentifier, updateScheduleRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (scheduleIdentifier === null || scheduleIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("SchedulesApi", "updateSchedule", "scheduleIdentifier");
                        }
...
exports.SchedulesApiRequestFactory = SchedulesApiRequestFactory;
var SchedulesApiResponseProcessor = (function () {
    function SchedulesApiResponseProcessor() {
    }
    SchedulesApiResponseProcessor.prototype.createSchedule = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SchedulesApiResponseProcessor.prototype.deleteSchedule = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SchedulesApiResponseProcessor.prototype.searchSchedules = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    SchedulesApiResponseProcessor.prototype.updateSchedule = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
...
exports.SchedulesApiResponseProcessor = SchedulesApiResponseProcessor;
