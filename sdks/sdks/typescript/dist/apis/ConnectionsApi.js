...
exports.ConnectionsApiResponseProcessor = exports.ConnectionsApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var ConnectionsApiRequestFactory = (function (_super) {
    __extends(ConnectionsApiRequestFactory, _super);
    function ConnectionsApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    ConnectionsApiRequestFactory.prototype.createConnection = function (createConnectionRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createConnectionRequest === null || createConnectionRequest === undefined) {
                            throw new baseapi_1.RequiredError("ConnectionsApi", "createConnection", "createConnectionRequest");
                        }
    ...
    ConnectionsApiRequestFactory.prototype.deleteConnection = function (deleteConnectionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (deleteConnectionRequest === null || deleteConnectionRequest === undefined) {
                            throw new baseapi_1.RequiredError("ConnectionsApi", "deleteConnection", "deleteConnectionRequest");
                        }
    ...
    ConnectionsApiRequestFactory.prototype.searchConnection = function (searchConnectionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
    ...
    ConnectionsApiRequestFactory.prototype.updateConnection = function (updateConnectionRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (updateConnectionRequest === null || updateConnectionRequest === undefined) {
                            throw new baseapi_1.RequiredError("ConnectionsApi", "updateConnection", "updateConnectionRequest");
                        }
...
exports.ConnectionsApiRequestFactory = ConnectionsApiRequestFactory;
var ConnectionsApiResponseProcessor = (function () {
    function ConnectionsApiResponseProcessor() {
    }
    ConnectionsApiResponseProcessor.prototype.createConnection = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ConnectionsApiResponseProcessor.prototype.deleteConnection = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ConnectionsApiResponseProcessor.prototype.searchConnection = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    ConnectionsApiResponseProcessor.prototype.updateConnection = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
...
exports.ConnectionsApiResponseProcessor = ConnectionsApiResponseProcessor;
