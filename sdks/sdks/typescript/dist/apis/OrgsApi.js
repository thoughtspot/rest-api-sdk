...
exports.OrgsApiResponseProcessor = exports.OrgsApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var OrgsApiRequestFactory = (function (_super) {
    __extends(OrgsApiRequestFactory, _super);
    function OrgsApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    OrgsApiRequestFactory.prototype.createOrg = function (createOrgRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createOrgRequest === null || createOrgRequest === undefined) {
                            throw new baseapi_1.RequiredError("OrgsApi", "createOrg", "createOrgRequest");
                        }
    ...
    OrgsApiRequestFactory.prototype.deleteOrg = function (orgIdentifier, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (orgIdentifier === null || orgIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("OrgsApi", "deleteOrg", "orgIdentifier");
                        }
    ...
    OrgsApiRequestFactory.prototype.searchOrgs = function (searchOrgsRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
    ...
    OrgsApiRequestFactory.prototype.updateOrg = function (orgIdentifier, updateOrgRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (orgIdentifier === null || orgIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("OrgsApi", "updateOrg", "orgIdentifier");
                        }
...
exports.OrgsApiRequestFactory = OrgsApiRequestFactory;
var OrgsApiResponseProcessor = (function () {
    function OrgsApiResponseProcessor() {
    }
    OrgsApiResponseProcessor.prototype.createOrg = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrgsApiResponseProcessor.prototype.deleteOrg = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    OrgsApiResponseProcessor.prototype.searchOrgs = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    OrgsApiResponseProcessor.prototype.updateOrg = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
...
exports.OrgsApiResponseProcessor = OrgsApiResponseProcessor;
//# sourceMappingURL=OrgsApi.js.map