...
exports.LogApiResponseProcessor = exports.LogApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var LogApiRequestFactory = (function (_super) {
    __extends(LogApiRequestFactory, _super);
    function LogApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    LogApiRequestFactory.prototype.fetchLogs = function (fetchLogsRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (fetchLogsRequest === null || fetchLogsRequest === undefined) {
                            throw new baseapi_1.RequiredError("LogApi", "fetchLogs", "fetchLogsRequest");
                        }
...
exports.LogApiRequestFactory = LogApiRequestFactory;
var LogApiResponseProcessor = (function () {
    function LogApiResponseProcessor() {
    }
    LogApiResponseProcessor.prototype.fetchLogs = function (response) {
        return __awaiter(this, void 0, void 0, function () {
...
exports.LogApiResponseProcessor = LogApiResponseProcessor;
