...
exports.SecurityApiResponseProcessor = exports.SecurityApiRequestFactory = void 0;
var baseapi_1 = require("./baseapi");
var http_1 = require("../http/http");
var ObjectSerializer_1 = require("../models/ObjectSerializer");
var exception_1 = require("./exception");
var util_1 = require("../util");
var SecurityApiRequestFactory = (function (_super) {
    __extends(SecurityApiRequestFactory, _super);
    function SecurityApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    SecurityApiRequestFactory.prototype.assignChangeAuthor = function (assignChangeAuthorRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (assignChangeAuthorRequest === null || assignChangeAuthorRequest === undefined) {
                            throw new baseapi_1.RequiredError("SecurityApi", "assignChangeAuthor", "assignChangeAuthorRequest");
                        }
    ...
    SecurityApiRequestFactory.prototype.fetchPermissionsOfPrincipals = function (fetchPermissionsOfPrincipalsRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (fetchPermissionsOfPrincipalsRequest === null || fetchPermissionsOfPrincipalsRequest === undefined) {
                            throw new baseapi_1.RequiredError("SecurityApi", "fetchPermissionsOfPrincipals", "fetchPermissionsOfPrincipalsRequest");
                        }
    ...
    SecurityApiRequestFactory.prototype.fetchPermissionsOnMetadata = function (fetchPermissionsOnMetadataRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (fetchPermissionsOnMetadataRequest === null || fetchPermissionsOnMetadataRequest === undefined) {
                            throw new baseapi_1.RequiredError("SecurityApi", "fetchPermissionsOnMetadata", "fetchPermissionsOnMetadataRequest");
                        }
    ...
    SecurityApiRequestFactory.prototype.shareMetadata = function (shareMetadataRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (shareMetadataRequest === null || shareMetadataRequest === undefined) {
                            throw new baseapi_1.RequiredError("SecurityApi", "shareMetadata", "shareMetadataRequest");
                        }
...
exports.SecurityApiRequestFactory = SecurityApiRequestFactory;
var SecurityApiResponseProcessor = (function () {
    function SecurityApiResponseProcessor() {
    }
    SecurityApiResponseProcessor.prototype.assignChangeAuthor = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SecurityApiResponseProcessor.prototype.fetchPermissionsOfPrincipals = function (response) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SecurityApiResponseProcessor.prototype.fetchPermissionsOnMetadata = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
    ...
    SecurityApiResponseProcessor.prototype.shareMetadata = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, _w, _x;
            return __generator(this, function (_y) {
                switch (_y.label) {
...
exports.SecurityApiResponseProcessor = SecurityApiResponseProcessor;
