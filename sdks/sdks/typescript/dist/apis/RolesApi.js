...
var RolesApiRequestFactory = (function (_super) {
    __extends(RolesApiRequestFactory, _super);
    function RolesApiRequestFactory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    RolesApiRequestFactory.prototype.createRole = function (createRoleRequest, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (createRoleRequest === null || createRoleRequest === undefined) {
                            throw new baseapi_1.RequiredError("RolesApi", "createRole", "createRoleRequest");
                        }
    ...
    RolesApiRequestFactory.prototype.deleteRole = function (roleIdentifier, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (roleIdentifier === null || roleIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("RolesApi", "deleteRole", "roleIdentifier");
                        }
    ...
    RolesApiRequestFactory.prototype.searchRoles = function (searchRolesRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
    ...
    RolesApiRequestFactory.prototype.updateRole = function (roleIdentifier, updateRoleRequest, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, contentType, serializedBody, authMethod, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (roleIdentifier === null || roleIdentifier === undefined) {
                            throw new baseapi_1.RequiredError("RolesApi", "updateRole", "roleIdentifier");
                        }
                        if (updateRoleRequest === null || updateRoleRequest === undefined) {
                            throw new baseapi_1.RequiredError("RolesApi", "updateRole", "updateRoleRequest");
                        }
...
var RolesApiResponseProcessor = (function () {
    ...
    RolesApiResponseProcessor.prototype.searchRoles = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, body, _e, _f, _g, _h, body, _j, _k, _l, _m, body, _o, _p, _q, _r, body, _s, _t, _u, _v, body, _w, _x, _y, _z, _0, _1;
            return __generator(this, function (_2) {
                switch (_2.label) {
