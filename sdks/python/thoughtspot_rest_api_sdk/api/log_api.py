...
class LogApi:
    ...
    def __init__(self, api_client=None, configuration=None) -> None:
        ...
        # internally (Java-style `LogApi(config)`), while still accepting
        # an explicit, shareable ApiClient. `configuration` is ignored when an
        # `api_client` is supplied.
        if isinstance(api_client, Configuration):   # allow LogApi(config) positionally
    ...
    async def __aenter__(self):
        # CUSTOM: `async with LogApi(configuration=cfg) as client:` opens
    ...
    async def fetch_logs(
        self,
        fetch_logs_request: FetchLogsRequest,
        ...
        _param = self._fetch_logs_serialize(
    ...
    @validate_call
    async def fetch_logs_with_http_info(
        self,
        fetch_logs_request: FetchLogsRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def fetch_logs_without_preload_content(
        self,
        fetch_logs_request: FetchLogsRequest,
        _request_timeout: Union[
            None,
    ...
    def fetch_logs_sync(
        ...
        """fetch_logs (synchronous)

        Synchronous variant of :meth:`fetch_logs`. It calls the asynchronous
    ...
    @validate_call
    def fetch_logs_sync_with_http_info(
        self,
        fetch_logs_request: FetchLogsRequest,
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`fetch_logs_with_http_info`. It calls the
        asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.fetch_logs_with_http_info(
                fetch_logs_request=fetch_logs_request,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    @validate_call
    def fetch_logs_sync_without_preload_content(
        self,
        fetch_logs_request: FetchLogsRequest,
        _request_timeout: Union[
            None,
        ...
        Synchronous variant of :meth:`fetch_logs_without_preload_content`. It calls
        the asynchronous method and blocks until it completes.
        """ # noqa: E501
        return run_sync(
            self.fetch_logs_without_preload_content(
                fetch_logs_request=fetch_logs_request,
                _request_timeout=_request_timeout,
                _request_auth=_request_auth,
                _content_type=_content_type,
    ...
    def _fetch_logs_serialize(
        ...
        if fetch_logs_request is not None:
            _body_params = fetch_logs_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/rest/2.0/logs/fetch',
