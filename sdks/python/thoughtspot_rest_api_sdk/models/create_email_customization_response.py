...
class CreateEmailCustomizationResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateEmailCustomizationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateEmailCustomizationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "org": OrgType.from_dict(obj["org"]) if obj.get("org") is not None else None,
            "name": obj.get("name"),
            "template_properties": obj.get("template_properties")
        })
