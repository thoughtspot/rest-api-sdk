...
class TokenValidationResponse(BaseModel):
    ...
    token_type: StrictStr = Field(description="Type of token.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["creation_time_in_millis", "expiration_time_in_millis", "scope", "valid_for_user_id", "token_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TokenValidationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TokenValidationResponse from a dict"""
        if obj is None:
            return None
