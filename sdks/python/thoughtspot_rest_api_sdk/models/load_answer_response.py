...
class LoadAnswerResponse(BaseModel):
    """
    LoadAnswerResponse
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LoadAnswerResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LoadAnswerResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "answer": AnswerDetails.from_dict(obj["answer"]) if obj.get("answer") is not None else None
        })
