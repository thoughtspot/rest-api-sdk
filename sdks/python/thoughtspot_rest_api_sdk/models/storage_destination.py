...
class StorageDestination(BaseModel):
    ...
    """ # noqa: E501
    storage_type: StrictStr = Field(description="Type of storage destination (e.g., AWS_S3).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StorageDestination from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StorageDestination from a dict"""
        if obj is None:
            return None
