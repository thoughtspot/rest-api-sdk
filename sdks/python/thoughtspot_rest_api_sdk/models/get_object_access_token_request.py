...
class GetObjectAccessTokenRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["username", "object_id", "password", "secret_key", "validity_time_in_sec", "org_id", "email", "display_name", "auto_create", "group_identifiers", "user_parameters"]
