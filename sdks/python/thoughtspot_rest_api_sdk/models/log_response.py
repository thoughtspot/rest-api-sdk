...
class LogResponse(BaseModel):
    ...
    LogResponse
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date timestamp of the log entry", alias="date")
    log: StrictStr = Field(description="Log data")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["date", "log"]
