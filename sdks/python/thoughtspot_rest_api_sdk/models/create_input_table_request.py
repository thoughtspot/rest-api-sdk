...
class CreateInputTableRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["table_name", "model_identifier", "table_definition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateInputTableRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.table_definition:
            _dict['table_definition'] = self.table_definition.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateInputTableRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "table_definition": InputTableDefinitionInput.from_dict(obj["table_definition"]) if obj.get("table_definition") is not None else None
        })
