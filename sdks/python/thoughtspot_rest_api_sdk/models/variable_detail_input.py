...
class VariableDetailInput(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["identifier", "type", "name_pattern"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VariableDetailInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VariableDetailInput from a dict"""
        if obj is None:
            return None
