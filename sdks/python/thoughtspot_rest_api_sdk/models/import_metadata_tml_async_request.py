...
class ImportMetadataTMLAsyncRequest(BaseModel):
    """
    ImportMetadataTMLAsyncRequest
    """ # noqa: E501
    metadata_tmls: List[StrictStr] = Field(description="Details of TML objects.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportMetadataTMLAsyncRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportMetadataTMLAsyncRequest from a dict"""
        if obj is None:
            return None
