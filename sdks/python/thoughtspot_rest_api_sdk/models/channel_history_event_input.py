...
class ChannelHistoryEventInput(BaseModel):
    """
    Event specification for channel history search.
    """ # noqa: E501
    type: StrictStr = Field(description="Type of the event.")
    identifier: Optional[StrictStr] = Field(default=None, description="Unique ID or name of the event.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChannelHistoryEventInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChannelHistoryEventInput from a dict"""
        if obj is None:
            return None
