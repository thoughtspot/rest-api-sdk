...
class UserMessage(BaseModel):
    ...
    """ # noqa: E501
    message_id: StrictStr = Field(description="Unique identifier of the user message.")
    content: StrictStr = Field(description="Text body of the user query.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message_id", "content"]
