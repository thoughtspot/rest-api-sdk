...
class DeployResponse(BaseModel):
    ...
    DeployResponse
    """ # noqa: E501
    file_name: Optional[StrictStr] = Field(default=None, description="Name of the file deployed")
    metadata_name: Optional[StrictStr] = Field(default=None, description="Name of the metadata object")
    metadata_type: Optional[StrictStr] = Field(default=None, description="Type of the metadata object")
    status_code: Optional[StrictStr] = Field(default=None, description="Indicates the status of deployment for the file")
    status_message: Optional[StrictStr] = Field(default=None, description="Any error or warning with the deployment")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["file_name", "metadata_name", "metadata_type", "status_code", "status_message"]
