...
class DefaultActionConfigSearchInput(BaseModel):
    """
    ...
    """ # noqa: E501
    visibility: Optional[StrictBool] = Field(default=None, description="Custom action is available on all visualizations. Earlier naming convention: LOCAL/GLOBAL. TRUE signifies GLOBAL for backward compatibility.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DefaultActionConfigSearchInput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DefaultActionConfigSearchInput from a dict"""
        if obj is None:
            return None
