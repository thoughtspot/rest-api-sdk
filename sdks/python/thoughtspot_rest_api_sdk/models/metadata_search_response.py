...
class MetadataSearchResponse(BaseModel):
    ...
    def metadata_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LIVEBOARD', 'ANSWER', 'LOGICAL_TABLE', 'LOGICAL_COLUMN', 'CONNECTION', 'TAG', 'USER', 'USER_GROUP', 'LOGICAL_RELATIONSHIP', 'INSIGHT_SPEC', 'COLLECTION', 'TEMPLATE_VARIABLE']):
            raise ValueError("must be one of enum values ('LIVEBOARD', 'ANSWER', 'LOGICAL_TABLE', 'LOGICAL_COLUMN', 'CONNECTION', 'TAG', 'USER', 'USER_GROUP', 'LOGICAL_RELATIONSHIP', 'INSIGHT_SPEC', 'COLLECTION', 'TEMPLATE_VARIABLE')")
        return value
