...
class EurekaDataSourceSuggestionResponse(BaseModel):
    """
    EurekaDataSourceSuggestionResponse
    """ # noqa: E501
    data_sources: Optional[List[DataSource]] = Field(default=None, description="List of data sources suggested.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EurekaDataSourceSuggestionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EurekaDataSourceSuggestionResponse from a dict"""
        if obj is None:
            return None
