...
class ChangeUserPasswordRequest(BaseModel):
    ...
    """ # noqa: E501
    current_password: StrictStr = Field(description="Current password of the user.")
    new_password: StrictStr = Field(description="New password for the user.")
    user_identifier: StrictStr = Field(description="GUID or name of the user.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["current_password", "new_password", "user_identifier"]
