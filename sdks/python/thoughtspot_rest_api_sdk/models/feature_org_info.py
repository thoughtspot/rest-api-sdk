...
class FeatureOrgInfo(BaseModel):
    """
    ...
    """ # noqa: E501
    org_id: StrictInt = Field(description="Numeric ID of the Org.")
    org_name: StrictStr = Field(description="Display name of the Org.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["org_id", "org_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeatureOrgInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeatureOrgInfo from a dict"""
        if obj is None:
            return None
