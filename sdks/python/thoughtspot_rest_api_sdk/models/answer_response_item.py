...
class AnswerResponseItem(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Variant discriminator. Always `\"answer\"`.")
    ...
    answer_id: StrictStr = Field(description="Identifier used to fetch the full answer payload separately.")
    tool_call_id: Optional[StrictStr] = Field(default=None, description="Links to the originating tool_call, when applicable.")
    tool_name: Optional[StrictStr] = Field(default=None, description="Tool that produced the answer, when applicable.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "timestamp_in_millis", "is_thinking", "step_title", "answer_id", "tool_call_id", "tool_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnswerResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnswerResponseItem from a dict"""
        if obj is None:
            return None
