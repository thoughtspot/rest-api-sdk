...
class CreateWebhookConfigurationRequest(BaseModel):
    """
    ...
    status: Optional[StrictStr] = Field(default=None, description="Status of the webhook (ENABLED or DISABLED). Optional — when omitted, status is not stored and will be absent from the response.    Version: 26.7.0.cl or later ")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["name", "description", "url", "url_params", "events", "authentication", "signature_verification", "storage_destination", "additional_headers", "status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateWebhookConfigurationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateWebhookConfigurationRequest from a dict"""
        if obj is None:
            return None
