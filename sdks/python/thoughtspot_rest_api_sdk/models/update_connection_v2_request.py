...
class UpdateConnectionV2Request(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "data_warehouse_config", "validate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateConnectionV2Request from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateConnectionV2Request from a dict"""
        if obj is None:
            return None
