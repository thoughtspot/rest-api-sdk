...
class FileResponseItem(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Variant discriminator. Always `\"file\"`.")
    ...
    files: Optional[List[PublicFileInfo]] = Field(default=None, description="Sanitized file metadata.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["type", "timestamp_in_millis", "is_thinking", "step_title", "files"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileResponseItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileResponseItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "files": [PublicFileInfo.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
