...
class DataWarehouseObjects(BaseModel):
    """
    DataWarehouseObjects
    """ # noqa: E501
    databases: List[Database] = Field(description="Databases of the connection.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataWarehouseObjects from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataWarehouseObjects from a dict"""
        if obj is None:
            return None
