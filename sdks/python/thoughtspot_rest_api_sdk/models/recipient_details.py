...
class RecipientDetails(BaseModel):
    ...
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = Field(default=None, description="Emails of the recipients. Specify email address if the recipient is not a ThoughtSpot user.")
    principals: Optional[List[PrincipalsListItem]] = Field(default=None, description="List of user or groups to subscribe for the scheduled job notifications.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "principals": [PrincipalsListItem.from_dict(_item) for _item in obj["principals"]] if obj.get("principals") is not None else None
        })
