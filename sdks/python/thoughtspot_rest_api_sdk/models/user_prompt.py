...
class UserPrompt(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserPrompt from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserPrompt from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "message": UserMessage.from_dict(obj["message"]) if obj.get("message") is not None else None,
