...
class CollectionEntityIdentifier(BaseModel):
    """
    Entity identifier with name.
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="Unique identifier of the entity.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CollectionEntityIdentifier from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CollectionEntityIdentifier from a dict"""
        if obj is None:
            return None
