...
class FetchAnswerDataRequest(BaseModel):
    """
    FetchAnswerDataRequest
    """ # noqa: E501
    metadata_identifier: StrictStr = Field(description="GUID or name of the Answer.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FetchAnswerDataRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FetchAnswerDataRequest from a dict"""
        if obj is None:
            return None
