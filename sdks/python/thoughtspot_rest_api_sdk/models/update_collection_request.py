...
class UpdateCollectionRequest(BaseModel):
    ...
    metadata: Optional[List[CollectionMetadataInput]] = Field(default=None, description="Metadata objects to add, remove, or replace in the collection.")
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "metadata", "operation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": [CollectionMetadataInput.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None,
