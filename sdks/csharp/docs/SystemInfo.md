# ThoughtSpot.RestApi.Sdk.Model.SystemInfo
...
**VarTimeZone** | **string** | The timezone of the cluster. | [optional] 
...
**VarEnvironment** | **string** | The deployed environment of the cluster. | [optional] 
...
**AllUserGroupMemberUserCount** | **int?** | The count of users of ALL group. | [optional] 
**LogicalModelVersion** | **int?** | The version number of logical model of the cluster. | [optional] 
