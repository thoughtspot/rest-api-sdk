# ThoughtSpot.RestApi.Sdk.Model.FavoriteObjectOptionsInput
...
------------ | ------------- | ------------- | -------------
**Include** | **bool?** | Includes objects marked as favorite for the specified users. | [optional] [default to false]
