...
namespace Example
{
    public class UpdateLinkCustomizationExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling ThoughtSpotRestApi.UpdateLinkCustomization: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling ThoughtSpotRestApi.UpdateLinkCustomizationWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
