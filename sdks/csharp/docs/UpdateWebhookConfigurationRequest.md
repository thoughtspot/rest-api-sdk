...
**Operation** | **string** | Operation to perform. REPLACE (default) updates the provided fields. RESET clears the sections in reset_options and accepts no other field.    Version: 26.11.0.cl or later  | [optional] [default to OperationEnum.REPLACE]
**ResetOptions** | **List&lt;UpdateWebhookConfigurationRequest.ResetOptionsEnum&gt;** | Sections to clear when operation is RESET. Each value removes that configuration from the webhook entirely.    Version: 26.11.0.cl or later  | [optional] 
