# ThoughtSpot.RestApi.Sdk.Model.ParameterizeMetadataFieldsRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**MetadataType** | **string** | Type of metadata object to parameterize. | [optional] 
**MetadataIdentifier** | **string** | Unique ID or name of the metadata object to parameterize. | 
**FieldType** | **string** | Type of field in the metadata to parameterize. | 
