# ThoughtSpot.RestApi.Sdk.Model.CreateWebhookConfigurationRequest
...
**Events** | **List&lt;CreateWebhookConfigurationRequest.EventsEnum&gt;** | List of events to subscribe to. | 
...
**Status** | **string** | Status of the webhook (ENABLED or DISABLED). Optional — when omitted, status is not stored and will be absent from the response.    Version: 26.7.0.cl or later  | [optional] 
