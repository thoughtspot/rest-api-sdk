# ThoughtSpot.RestApi.Sdk.Model.AnswerDetails
...
**GenerationNumber** | **int?** | Generation number of the answer. | [optional] 
**Tokens** | **List&lt;string&gt;** | Ordered list of TML token strings that make up the answer query. | [optional] 
**VisualizationType** | **string** | Visualization type for the answer. | [optional] 
