# ThoughtSpot.RestApi.Sdk.Model.FetchLiveboardDataRequest
...
**DataFormat** | **string** | JSON output in compact or full format. The FULL option is available in 9.12.5.cl or later. | [optional] [default to DataFormatEnum.COMPACT]
**RecordOffset** | **int** | The starting record number from where the records should be included. | [optional] [default to 0]
**RecordSize** | **int** | The number of records to include in a batch. | [optional] [default to 10]
