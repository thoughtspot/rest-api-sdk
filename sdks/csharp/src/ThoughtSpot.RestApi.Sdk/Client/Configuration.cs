...
namespace ThoughtSpot.RestApi.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("ThoughtSpot-Client/csharp/2.27.0");
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "No description provided"},
                        {
                            "variables", new Dictionary<string, object> {
                                {
                                    "base-url", new Dictionary<string, object> {
                                        {"description", "No description provided"},
        ...
        public Configuration(
            ...
            string basePath = "https://localhost:443") : this()
        {
        ...
        {
            string report = "C# SDK (ThoughtSpot.RestApi.Sdk) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.0\n";
            report += "    SDK Package Version: 2.27.0\n";
