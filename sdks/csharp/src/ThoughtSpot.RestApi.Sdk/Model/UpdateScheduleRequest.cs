...
namespace ThoughtSpot.RestApi.Sdk.Model
{
    ...
    public partial class UpdateScheduleRequest : IValidatableObject
    {
        ...
        public UpdateScheduleRequest(string name = default, string description = default, MetadataTypeEnum? metadataType = default, string metadataIdentifier = default, FileFormatEnum? fileFormat = default, LiveboardOptionsInput liveboardOptions = default, SchedulesPdfOptionsInput pdfOptions = default, VarTimeZoneEnum? varTimeZone = default, FrequencyInput frequency = default, RecipientDetailsInput recipientDetails = default, StatusEnum? status = default, string personalisedViewId = default)
        {
            this.Name = name;
