...
public class UpdateSystemConfigRequest implements Serializable {
  ...
  public UpdateSystemConfigRequest _configuration(@javax.annotation.Nullable Object _configuration) {
   ...
   * @return the UpdateSystemConfigRequest instance itself
   */
  public UpdateSystemConfigRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this._configuration, updateSystemConfigRequest._configuration)&&
        Objects.equals(this.additionalProperties, updateSystemConfigRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSystemConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateSystemConfigRequest is not found in the empty JSON string", UpdateSystemConfigRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSystemConfigRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSystemConfigRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateSystemConfigRequest>() {
           @Override
           public void write(JsonWriter out, UpdateSystemConfigRequest value) throws IOException {
           ...
           public UpdateSystemConfigRequest read(JsonReader in) throws IOException {
             ...
             UpdateSystemConfigRequest instance = thisAdapter.fromJsonTree(jsonObj);
