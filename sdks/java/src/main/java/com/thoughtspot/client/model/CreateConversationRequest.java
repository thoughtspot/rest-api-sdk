...
public class CreateConversationRequest implements Serializable {
   ...
   * @return the CreateConversationRequest instance itself
   */
  public CreateConversationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataIdentifier, createConversationRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, createConversationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, tokens, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateConversationRequest>() {
           ...
           public CreateConversationRequest read(JsonReader in) throws IOException {
             ...
             CreateConversationRequest instance = thisAdapter.fromJsonTree(jsonObj);
