...
public class UpdateOrgRequest implements Serializable {
    ...
    public UpdateOrgRequest userIdentifiers(
    ...
    public UpdateOrgRequest groupIdentifiers(
     ...
     * @return the UpdateOrgRequest instance itself
     */
    public UpdateOrgRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, updateOrgRequest.name)
                ...
                && Objects.equals(this.additionalProperties, updateOrgRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateOrgRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateOrgRequest is not found in the"
                                        + " empty JSON string",
                                UpdateOrgRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateOrgRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateOrgRequest value)
                                throws IOException {
                        ...
                        public UpdateOrgRequest read(JsonReader in) throws IOException {
                            ...
                            UpdateOrgRequest instance = thisAdapter.fromJsonTree(jsonObj);
