...
public class EurekaRelevantQuestion implements Serializable {
  ...
  public EurekaRelevantQuestion dataSourceIdentifier(@javax.annotation.Nullable String dataSourceIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, eurekaRelevantQuestion.query) &&
        Objects.equals(this.dataSourceIdentifier, eurekaRelevantQuestion.dataSourceIdentifier) &&
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EurekaRelevantQuestion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EurekaRelevantQuestion is not found in the empty JSON string", EurekaRelevantQuestion.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!EurekaRelevantQuestion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `EurekaRelevantQuestion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EurekaRelevantQuestion>() {
           @Override
           public void write(JsonWriter out, EurekaRelevantQuestion value) throws IOException {
