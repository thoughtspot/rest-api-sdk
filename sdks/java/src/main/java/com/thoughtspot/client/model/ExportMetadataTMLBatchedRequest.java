...
public class ExportMetadataTMLBatchedRequest implements Serializable {
   ...
   * @return the ExportMetadataTMLBatchedRequest instance itself
   */
  public ExportMetadataTMLBatchedRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataType, exportMetadataTMLBatchedRequest.metadataType) &&
        ...
        Objects.equals(this.additionalProperties, exportMetadataTMLBatchedRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataType, batchOffset, batchSize, edocFormat, exportDependent, allOrgsOverride, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExportMetadataTMLBatchedRequest>() {
           ...
           public ExportMetadataTMLBatchedRequest read(JsonReader in) throws IOException {
             ...
             ExportMetadataTMLBatchedRequest instance = thisAdapter.fromJsonTree(jsonObj);
