...
public class ExportOptions implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(includeObjIdRef, includeGuid, includeObjId, exportWithAssociatedFeedbacks, exportColumnSecurityRules, exportWithColumnAliases, additionalProperties);
  }
