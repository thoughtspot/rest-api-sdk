...
public class RevokeRefreshTokensRequest implements Serializable {
  ...
  public static final String SERIALIZED_NAME_CONFIGURATION_IDENTIFIERS = "configuration_identifiers";
  ...
  public RevokeRefreshTokensRequest configurationIdentifiers(@javax.annotation.Nullable List<String> configurationIdentifiers) {
    this.configurationIdentifiers = configurationIdentifiers;
    return this;
  }

  public RevokeRefreshTokensRequest addConfigurationIdentifiersItem(String configurationIdentifiersItem) {
  ...
  public void setConfigurationIdentifiers(@javax.annotation.Nullable List<String> configurationIdentifiers) {
    this.configurationIdentifiers = configurationIdentifiers;
  }


  public RevokeRefreshTokensRequest userIdentifiers(@javax.annotation.Nullable List<String> userIdentifiers) {
  ...
  public RevokeRefreshTokensRequest orgIdentifiers(@javax.annotation.Nullable List<String> orgIdentifiers) {
   ...
   * @return the RevokeRefreshTokensRequest instance itself
   */
  public RevokeRefreshTokensRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configurationIdentifiers, revokeRefreshTokensRequest.configurationIdentifiers) &&
        ...
        Objects.equals(this.additionalProperties, revokeRefreshTokensRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configurationIdentifiers, userIdentifiers, orgIdentifiers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RevokeRefreshTokensRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RevokeRefreshTokensRequest is not found in the empty JSON string", RevokeRefreshTokensRequest.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("configuration_identifiers") != null && !jsonObj.get("configuration_identifiers").isJsonNull() && !jsonObj.get("configuration_identifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `configuration_identifiers` to be an array in the JSON string but got `%s`", jsonObj.get("configuration_identifiers").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RevokeRefreshTokensRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RevokeRefreshTokensRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevokeRefreshTokensRequest>() {
           @Override
           public void write(JsonWriter out, RevokeRefreshTokensRequest value) throws IOException {
           ...
           public RevokeRefreshTokensRequest read(JsonReader in) throws IOException {
             ...
             RevokeRefreshTokensRequest instance = thisAdapter.fromJsonTree(jsonObj);
