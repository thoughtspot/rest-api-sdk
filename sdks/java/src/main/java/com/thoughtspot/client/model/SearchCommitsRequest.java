...
public class SearchCommitsRequest implements Serializable {
   ...
   * @return the SearchCommitsRequest instance itself
   */
  public SearchCommitsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataIdentifier, searchCommitsRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, searchCommitsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, metadataType, branchName, recordOffset, recordSize, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchCommitsRequest>() {
           ...
           public SearchCommitsRequest read(JsonReader in) throws IOException {
             ...
             SearchCommitsRequest instance = thisAdapter.fromJsonTree(jsonObj);
