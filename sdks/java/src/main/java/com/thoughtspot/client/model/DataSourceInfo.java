...
import com.thoughtspot.client.model.DataSourceHeader;
import com.thoughtspot.client.model.DataSourcePopularity;
import com.thoughtspot.client.model.DataSourceUserUsage;
...
public class DataSourceInfo implements Serializable {
  ...
  public static final String SERIALIZED_NAME_RELATED_LIVEBOARD_VISUALIZATIONS = "related_liveboard_visualizations";
  ...
  public DataSourceInfo dataSourceIdentifier(@javax.annotation.Nullable String dataSourceIdentifier) {
  ...
  public DataSourceInfo relatedLiveboardVisualizations(@javax.annotation.Nullable List<Object> relatedLiveboardVisualizations) {
    this.relatedLiveboardVisualizations = relatedLiveboardVisualizations;
    return this;
  }

  public DataSourceInfo addRelatedLiveboardVisualizationsItem(Object relatedLiveboardVisualizationsItem) {
  ...
  public void setRelatedLiveboardVisualizations(@javax.annotation.Nullable List<Object> relatedLiveboardVisualizations) {
    this.relatedLiveboardVisualizations = relatedLiveboardVisualizations;
  }
  ...
  public DataSourceInfo relatedSpotterQueries(@javax.annotation.Nullable List<String> relatedSpotterQueries) {
  ...
  public void setRelatedSpotterQueries(@javax.annotation.Nullable List<String> relatedSpotterQueries) {
    this.relatedSpotterQueries = relatedSpotterQueries;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSourceIdentifier, dataSourceInfo.dataSourceIdentifier) &&
        ...
        Objects.equals(this.relatedLiveboardVisualizations, dataSourceInfo.relatedLiveboardVisualizations) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataSourceIdentifier, dataSourceName, description, confidence, reasoning, header, relatedLiveboardVisualizations, relatedAnswers, relatedSpotterQueries, popularity, userUsage, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    relatedLiveboardVisualizations: ").append(toIndentedString(relatedLiveboardVisualizations)).append("\n");
    sb.append("    relatedAnswers: ").append(toIndentedString(relatedAnswers)).append("\n");
    sb.append("    relatedSpotterQueries: ").append(toIndentedString(relatedSpotterQueries)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataSourceInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataSourceInfo is not found in the empty JSON string", DataSourceInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("reasoning") != null && !jsonObj.get("reasoning").isJsonNull()) && !jsonObj.get("reasoning").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `reasoning` to be a primitive type in the JSON string but got `%s`", jsonObj.get("reasoning").toString()));
      }
      ...
      if (jsonObj.get("related_liveboard_visualizations") != null && !jsonObj.get("related_liveboard_visualizations").isJsonNull() && !jsonObj.get("related_liveboard_visualizations").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `related_liveboard_visualizations` to be an array in the JSON string but got `%s`", jsonObj.get("related_liveboard_visualizations").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("related_answers") != null && !jsonObj.get("related_answers").isJsonNull() && !jsonObj.get("related_answers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `related_answers` to be an array in the JSON string but got `%s`", jsonObj.get("related_answers").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("related_spotter_queries") != null && !jsonObj.get("related_spotter_queries").isJsonNull() && !jsonObj.get("related_spotter_queries").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `related_spotter_queries` to be an array in the JSON string but got `%s`", jsonObj.get("related_spotter_queries").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataSourceInfo>() {
           @Override
