...
public class OrgType implements Serializable {
   ...
   * @return the OrgType instance itself
   */
  public OrgType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, orgType.name) &&
        Objects.equals(this.id, orgType.id)&&
        Objects.equals(this.additionalProperties, orgType.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgType is not found in the empty JSON string", OrgType.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrgType>() {
           @Override
           ...
           public OrgType read(JsonReader in) throws IOException {
             ...
             OrgType instance = thisAdapter.fromJsonTree(jsonObj);
