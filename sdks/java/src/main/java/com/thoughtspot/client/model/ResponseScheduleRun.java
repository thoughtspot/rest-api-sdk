...
public class ResponseScheduleRun implements Serializable {
   ...
   * @return the ResponseScheduleRun instance itself
   */
  public ResponseScheduleRun putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, responseScheduleRun.id) &&
        ...
        Objects.equals(this.additionalProperties, responseScheduleRun.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, startTimeInMillis, endTimeInMillis, status, detail, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseScheduleRun>() {
           ...
           public ResponseScheduleRun read(JsonReader in) throws IOException {
             ...
             ResponseScheduleRun instance = thisAdapter.fromJsonTree(jsonObj);
