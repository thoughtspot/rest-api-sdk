...
public class UnparameterizeMetadataRequest implements Serializable {
  ...
  public UnparameterizeMetadataRequest metadataType(@javax.annotation.Nullable MetadataTypeEnum metadataType) {
  ...
  public UnparameterizeMetadataRequest metadataIdentifier(@javax.annotation.Nonnull String metadataIdentifier) {
  ...
  public UnparameterizeMetadataRequest fieldType(@javax.annotation.Nonnull FieldTypeEnum fieldType) {
   ...
   * @return the UnparameterizeMetadataRequest instance itself
   */
  public UnparameterizeMetadataRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UnparameterizeMetadataRequest unparameterizeMetadataRequest = (UnparameterizeMetadataRequest) o;
    return Objects.equals(this.metadataType, unparameterizeMetadataRequest.metadataType) &&
        Objects.equals(this.metadataIdentifier, unparameterizeMetadataRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, unparameterizeMetadataRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataType, metadataIdentifier, fieldType, fieldName, value, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UnparameterizeMetadataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnparameterizeMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnparameterizeMetadataRequest is not found in the empty JSON string", UnparameterizeMetadataRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnparameterizeMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnparameterizeMetadataRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnparameterizeMetadataRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnparameterizeMetadataRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UnparameterizeMetadataRequest>() {
           @Override
           public void write(JsonWriter out, UnparameterizeMetadataRequest value) throws IOException {
           ...
           @Override
           public UnparameterizeMetadataRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UnparameterizeMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to UnparameterizeMetadataRequest
   */
