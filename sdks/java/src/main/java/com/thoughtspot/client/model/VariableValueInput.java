...
public class VariableValueInput implements Serializable {
    ...
    public VariableValueInput variableIdentifier(
    ...
    public VariableValueInput variableValues(
            @javax.annotation.Nonnull List<InputVariableValue> variableValues) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VariableValueInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in VariableValueInput is not found in"
                                        + " the empty JSON string",
                                VariableValueInput.openapiRequiredFields.toString()));
            }
        }
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `VariableValueInput` properties. JSON: %s",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<VariableValueInput>() {
                        @Override
                        public void write(JsonWriter out, VariableValueInput value)
                                throws IOException {
