...
public class MetadataApi {
     ...
     */
    public okhttp3.Call parameterizeMetadataFieldsCall(ParameterizeMetadataFieldsRequest parameterizeMetadataFieldsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call parameterizeMetadataFieldsValidateBeforeCall(ParameterizeMetadataFieldsRequest parameterizeMetadataFieldsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'parameterizeMetadataFieldsRequest' is set
        if (parameterizeMetadataFieldsRequest == null) {
            throw new ApiException("Missing the required parameter 'parameterizeMetadataFieldsRequest' when calling parameterizeMetadataFields(Async)");
        }
     ...
     */
    public void parameterizeMetadataFields(ParameterizeMetadataFieldsRequest parameterizeMetadataFieldsRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> parameterizeMetadataFieldsWithHttpInfo(ParameterizeMetadataFieldsRequest parameterizeMetadataFieldsRequest) throws ApiException {
        okhttp3.Call localVarCall = parameterizeMetadataFieldsValidateBeforeCall(parameterizeMetadataFieldsRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call parameterizeMetadataFieldsAsync(ParameterizeMetadataFieldsRequest parameterizeMetadataFieldsRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = parameterizeMetadataFieldsValidateBeforeCall(parameterizeMetadataFieldsRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
