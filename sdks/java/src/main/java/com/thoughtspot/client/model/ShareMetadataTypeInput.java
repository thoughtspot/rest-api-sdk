...
public class ShareMetadataTypeInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, shareMetadataTypeInput.type) &&
        ...
        Objects.equals(this.additionalProperties, shareMetadataTypeInput.additionalProperties);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ShareMetadataTypeInput>() {
           @Override
           public void write(JsonWriter out, ShareMetadataTypeInput value) throws IOException {
