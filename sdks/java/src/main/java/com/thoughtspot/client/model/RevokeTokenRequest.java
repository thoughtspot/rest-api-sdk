...
public class RevokeTokenRequest implements Serializable {
   ...
   * @return the RevokeTokenRequest instance itself
   */
  public RevokeTokenRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userIdentifier, revokeTokenRequest.userIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, revokeTokenRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userIdentifier, token, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevokeTokenRequest>() {
           ...
           public RevokeTokenRequest read(JsonReader in) throws IOException {
             ...
             RevokeTokenRequest instance = thisAdapter.fromJsonTree(jsonObj);
