...
import com.thoughtspot.client.model.Role;
import com.thoughtspot.client.model.UserGroup;
...
public class UserGroupResponse implements Serializable {
   ...
   * @return the UserGroupResponse instance itself
   */
  public UserGroupResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objId, userGroupResponse.objId) &&
        ...
        Objects.equals(this.additionalProperties, userGroupResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objId, authorId, completeDetail, content, creationTimeInMillis, defaultLiveboards, deleted, deprecated, description, displayName, external, generationNumber, hidden, id, index, indexVersion, metadataVersion, modificationTimeInMillis, modifierId, name, orgs, ownerId, parentType, privileges, subGroups, systemGroup, tags, type, users, visibility, roles, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserGroupResponse>() {
           ...
           public UserGroupResponse read(JsonReader in) throws IOException {
             ...
             UserGroupResponse instance = thisAdapter.fromJsonTree(jsonObj);
