...
public class DeleteConfigRequest implements Serializable {
   ...
   * @return the DeleteConfigRequest instance itself
   */
  public DeleteConfigRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.clusterLevel, deleteConfigRequest.clusterLevel)&&
        Objects.equals(this.additionalProperties, deleteConfigRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(clusterLevel, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeleteConfigRequest>() {
           ...
           public DeleteConfigRequest read(JsonReader in) throws IOException {
             ...
             DeleteConfigRequest instance = thisAdapter.fromJsonTree(jsonObj);
