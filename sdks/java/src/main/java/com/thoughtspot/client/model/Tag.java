...
public class Tag implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, id, color, deleted, hidden, external, deprecated, creationTimeInMillis, modificationTimeInMillis, authorId, modifierId, ownerId, additionalProperties);
  }
