...
public class SharePermissionsInput implements Serializable {
  ...
  public enum ContentShareModeEnum {
    ...
    public static class Adapter extends TypeAdapter<ContentShareModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ContentShareModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  public SharePermissionsInput contentShareMode(@javax.annotation.Nullable ContentShareModeEnum contentShareMode) {
  ...
  public void setContentShareMode(@javax.annotation.Nullable ContentShareModeEnum contentShareMode) {
    this.contentShareMode = contentShareMode;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.principal, sharePermissionsInput.principal) &&
        ...
        Objects.equals(this.additionalProperties, sharePermissionsInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("content_share_mode") != null && !jsonObj.get("content_share_mode").isJsonNull()) && !jsonObj.get("content_share_mode").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `content_share_mode` to be a primitive type in the JSON string but got `%s`", jsonObj.get("content_share_mode").toString()));
      }
      // validate the optional field `content_share_mode`
      if (jsonObj.get("content_share_mode") != null && !jsonObj.get("content_share_mode").isJsonNull()) {
