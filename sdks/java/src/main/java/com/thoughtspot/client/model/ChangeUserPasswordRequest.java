...
public class ChangeUserPasswordRequest implements Serializable {
   ...
   * @return the ChangeUserPasswordRequest instance itself
   */
  public ChangeUserPasswordRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.currentPassword, changeUserPasswordRequest.currentPassword) &&
        ...
        Objects.equals(this.additionalProperties, changeUserPasswordRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currentPassword, newPassword, userIdentifier, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChangeUserPasswordRequest>() {
           ...
           public ChangeUserPasswordRequest read(JsonReader in) throws IOException {
             ...
             ChangeUserPasswordRequest instance = thisAdapter.fromJsonTree(jsonObj);
