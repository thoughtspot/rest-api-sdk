...
public class NLInstructionsInfo implements Serializable {
   ...
   * @return the NLInstructionsInfo instance itself
   */
  public NLInstructionsInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instructions, nlInstructionsInfo.instructions) &&
        ...
        Objects.equals(this.additionalProperties, nlInstructionsInfo.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NLInstructionsInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NLInstructionsInfo is not found in the empty JSON string", NLInstructionsInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NLInstructionsInfo>() {
           @Override
           public void write(JsonWriter out, NLInstructionsInfo value) throws IOException {
           ...
           public NLInstructionsInfo read(JsonReader in) throws IOException {
             ...
             NLInstructionsInfo instance = thisAdapter.fromJsonTree(jsonObj);
