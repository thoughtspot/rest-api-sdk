...
public class SchedulesPdfOptionsInput implements Serializable {
  ...
  public SchedulesPdfOptionsInput completeLiveboard(@javax.annotation.Nullable Boolean completeLiveboard) {
  ...
  public SchedulesPdfOptionsInput includeCoverPage(@javax.annotation.Nullable Boolean includeCoverPage) {
  ...
  public SchedulesPdfOptionsInput includeCustomLogo(@javax.annotation.Nullable Boolean includeCustomLogo) {
  ...
  public SchedulesPdfOptionsInput includeFilterPage(@javax.annotation.Nullable Boolean includeFilterPage) {
  ...
  public SchedulesPdfOptionsInput includePageNumber(@javax.annotation.Nullable Boolean includePageNumber) {
  ...
  public SchedulesPdfOptionsInput pageFooterText(@javax.annotation.Nullable String pageFooterText) {
  ...
  public SchedulesPdfOptionsInput pageOrientation(@javax.annotation.Nullable String pageOrientation) {
  ...
  public SchedulesPdfOptionsInput truncateTable(@javax.annotation.Nullable Boolean truncateTable) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.completeLiveboard, schedulesPdfOptionsInput.completeLiveboard) &&
        ...
        Objects.equals(this.additionalProperties, schedulesPdfOptionsInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(completeLiveboard, includeCoverPage, includeCustomLogo, includeFilterPage, includePageNumber, pageFooterText, pageOrientation, pageSize, truncateTable, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SchedulesPdfOptionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
