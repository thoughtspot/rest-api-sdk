...
public class TableVisualizationFontRecord implements Serializable {
  ...
  public TableVisualizationFontRecord visualizationArea(@javax.annotation.Nullable VisualizationAreaEnum visualizationArea) {
  ...
  public TableVisualizationFontRecord isOverridden(@javax.annotation.Nullable Boolean isOverridden) {
  ...
  public boolean equals(Object o) {
    ...
    TableVisualizationFontRecord tableVisualizationFontRecord = (TableVisualizationFontRecord) o;
    return Objects.equals(this.visualizationArea, tableVisualizationFontRecord.visualizationArea) &&
        ...
        Objects.equals(this.additionalProperties, tableVisualizationFontRecord.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to TableVisualizationFontRecord
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TableVisualizationFontRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TableVisualizationFontRecord is not found in the empty JSON string", TableVisualizationFontRecord.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TableVisualizationFontRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TableVisualizationFontRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TableVisualizationFontRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TableVisualizationFontRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<TableVisualizationFontRecord>() {
           @Override
           public void write(JsonWriter out, TableVisualizationFontRecord value) throws IOException {
           ...
           public TableVisualizationFontRecord read(JsonReader in) throws IOException {
             ...
             TableVisualizationFontRecord instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to TableVisualizationFontRecord
   */
