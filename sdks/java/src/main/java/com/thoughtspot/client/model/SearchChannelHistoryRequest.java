...
import com.thoughtspot.client.model.ChannelHistoryEventInput;
...
public class SearchChannelHistoryRequest implements Serializable {
  ...
  public enum ChannelStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<ChannelStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ChannelStatusEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }
  ...
  public SearchChannelHistoryRequest channelType(@javax.annotation.Nonnull ChannelTypeEnum channelType) {
  ...
  public SearchChannelHistoryRequest channelIdentifiers(@javax.annotation.Nullable List<String> channelIdentifiers) {
  ...
  public SearchChannelHistoryRequest channelStatus(@javax.annotation.Nullable ChannelStatusEnum channelStatus) {
  ...
  public SearchChannelHistoryRequest events(@javax.annotation.Nullable List<ChannelHistoryEventInput> events) {
    this.events = events;
    return this;
  }
  ...
  public SearchChannelHistoryRequest startEpochTimeInMillis(@javax.annotation.Nullable Float startEpochTimeInMillis) {
  ...
  public SearchChannelHistoryRequest endEpochTimeInMillis(@javax.annotation.Nullable Float endEpochTimeInMillis) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.channelType, searchChannelHistoryRequest.channelType) &&
        ...
        Objects.equals(this.channelIdentifiers, searchChannelHistoryRequest.channelIdentifiers) &&
        ...
        Objects.equals(this.startEpochTimeInMillis, searchChannelHistoryRequest.startEpochTimeInMillis) &&
        Objects.equals(this.endEpochTimeInMillis, searchChannelHistoryRequest.endEpochTimeInMillis)&&
        Objects.equals(this.additionalProperties, searchChannelHistoryRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelType, jobIds, channelIdentifiers, channelStatus, events, startEpochTimeInMillis, endEpochTimeInMillis, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchChannelHistoryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchChannelHistoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchChannelHistoryRequest is not found in the empty JSON string", SearchChannelHistoryRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("job_ids") != null && !jsonObj.get("job_ids").isJsonNull() && !jsonObj.get("job_ids").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("channel_identifiers") != null && !jsonObj.get("channel_identifiers").isJsonNull() && !jsonObj.get("channel_identifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `channel_identifiers` to be an array in the JSON string but got `%s`", jsonObj.get("channel_identifiers").toString()));
      }
      if ((jsonObj.get("channel_status") != null && !jsonObj.get("channel_status").isJsonNull()) && !jsonObj.get("channel_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `channel_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("channel_status").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchChannelHistoryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchChannelHistoryRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchChannelHistoryRequest>() {
           @Override
           public void write(JsonWriter out, SearchChannelHistoryRequest value) throws IOException {
           ...
           public SearchChannelHistoryRequest read(JsonReader in) throws IOException {
             ...
             SearchChannelHistoryRequest instance = thisAdapter.fromJsonTree(jsonObj);
