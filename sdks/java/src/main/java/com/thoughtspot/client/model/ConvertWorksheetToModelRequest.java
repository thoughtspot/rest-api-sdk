...
public class ConvertWorksheetToModelRequest implements Serializable {
  ...
  public ConvertWorksheetToModelRequest worksheetIds(@javax.annotation.Nullable List<String> worksheetIds) {
  ...
  public ConvertWorksheetToModelRequest excludeWorksheetIds(@javax.annotation.Nullable List<String> excludeWorksheetIds) {
    this.excludeWorksheetIds = excludeWorksheetIds;
    return this;
  }

  public ConvertWorksheetToModelRequest addExcludeWorksheetIdsItem(String excludeWorksheetIdsItem) {
  ...
  public void setExcludeWorksheetIds(@javax.annotation.Nullable List<String> excludeWorksheetIds) {
    this.excludeWorksheetIds = excludeWorksheetIds;
  }


  public ConvertWorksheetToModelRequest convertAll(@javax.annotation.Nullable Boolean convertAll) {
  ...
  public ConvertWorksheetToModelRequest applyChanges(@javax.annotation.Nullable Boolean applyChanges) {
   ...
   * @return the ConvertWorksheetToModelRequest instance itself
   */
  public ConvertWorksheetToModelRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConvertWorksheetToModelRequest convertWorksheetToModelRequest = (ConvertWorksheetToModelRequest) o;
    return Objects.equals(this.worksheetIds, convertWorksheetToModelRequest.worksheetIds) &&
        Objects.equals(this.excludeWorksheetIds, convertWorksheetToModelRequest.excludeWorksheetIds) &&
        ...
        Objects.equals(this.additionalProperties, convertWorksheetToModelRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(worksheetIds, excludeWorksheetIds, convertAll, applyChanges, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConvertWorksheetToModelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConvertWorksheetToModelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConvertWorksheetToModelRequest is not found in the empty JSON string", ConvertWorksheetToModelRequest.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("worksheet_ids") != null && !jsonObj.get("worksheet_ids").isJsonNull() && !jsonObj.get("worksheet_ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `worksheet_ids` to be an array in the JSON string but got `%s`", jsonObj.get("worksheet_ids").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("exclude_worksheet_ids") != null && !jsonObj.get("exclude_worksheet_ids").isJsonNull() && !jsonObj.get("exclude_worksheet_ids").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `exclude_worksheet_ids` to be an array in the JSON string but got `%s`", jsonObj.get("exclude_worksheet_ids").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConvertWorksheetToModelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConvertWorksheetToModelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConvertWorksheetToModelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConvertWorksheetToModelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConvertWorksheetToModelRequest>() {
           @Override
           public void write(JsonWriter out, ConvertWorksheetToModelRequest value) throws IOException {
           ...
           @Override
           public ConvertWorksheetToModelRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ConvertWorksheetToModelRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to ConvertWorksheetToModelRequest
   */
