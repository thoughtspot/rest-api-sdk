...
public class PermissionOfMetadataResponse implements Serializable {
    ...
    public static final String SERIALIZED_NAME_METADATA_PERMISSION_DETAILS =
    ...
    public PermissionOfMetadataResponse metadataPermissionDetails(
            @javax.annotation.Nullable Object metadataPermissionDetails) {
    ...
    public void setMetadataPermissionDetails(
            @javax.annotation.Nullable Object metadataPermissionDetails) {
        this.metadataPermissionDetails = metadataPermissionDetails;
    }
     ...
     * @return the PermissionOfMetadataResponse instance itself
     */
    public PermissionOfMetadataResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        PermissionOfMetadataResponse permissionOfMetadataResponse =
                (PermissionOfMetadataResponse) o;
        return Objects.equals(
                        this.metadataPermissionDetails,
                        permissionOfMetadataResponse.metadataPermissionDetails)
                && Objects.equals(
                        this.additionalProperties,
                        permissionOfMetadataResponse.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(metadataPermissionDetails, additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    metadataPermissionDetails: ")
                .append(toIndentedString(metadataPermissionDetails))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PermissionOfMetadataResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PermissionOfMetadataResponse is not"
                                        + " found in the empty JSON string",
                                PermissionOfMetadataResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PermissionOfMetadataResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PermissionOfMetadataResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PermissionOfMetadataResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(PermissionOfMetadataResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<PermissionOfMetadataResponse>() {
                        @Override
                        public void write(JsonWriter out, PermissionOfMetadataResponse value)
                                throws IOException {
                        ...
                        public PermissionOfMetadataResponse read(JsonReader in) throws IOException {
                            ...
                            PermissionOfMetadataResponse instance =
