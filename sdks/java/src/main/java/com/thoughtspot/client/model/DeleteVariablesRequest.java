...
public class DeleteVariablesRequest implements Serializable {
   ...
   * @return the DeleteVariablesRequest instance itself
   */
  public DeleteVariablesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifiers, deleteVariablesRequest.identifiers)&&
        Objects.equals(this.additionalProperties, deleteVariablesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifiers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteVariablesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteVariablesRequest is not found in the empty JSON string", DeleteVariablesRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeleteVariablesRequest>() {
           @Override
           public void write(JsonWriter out, DeleteVariablesRequest value) throws IOException {
           ...
           public DeleteVariablesRequest read(JsonReader in) throws IOException {
             ...
             DeleteVariablesRequest instance = thisAdapter.fromJsonTree(jsonObj);
