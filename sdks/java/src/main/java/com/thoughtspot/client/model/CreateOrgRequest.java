...
public class CreateOrgRequest implements Serializable {
    ...
    public CreateOrgRequest name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public CreateOrgRequest description(@javax.annotation.Nullable String description) {
     ...
     * @return the CreateOrgRequest instance itself
     */
    public CreateOrgRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, createOrgRequest.name)
                ...
                && Objects.equals(this.additionalProperties, createOrgRequest.additionalProperties);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to CreateOrgRequest
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateOrgRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateOrgRequest is not found in the"
                                        + " empty JSON string",
                                CreateOrgRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CreateOrgRequest>() {
                        @Override
                        public void write(JsonWriter out, CreateOrgRequest value)
                                throws IOException {
                        ...
                        public CreateOrgRequest read(JsonReader in) throws IOException {
                            ...
                            CreateOrgRequest instance = thisAdapter.fromJsonTree(jsonObj);
