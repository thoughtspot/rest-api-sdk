...
import com.thoughtspot.client.model.ColumnSecurityRuleUpdate;
...
public class UpdateColumnSecurityRulesRequest implements Serializable {
  ...
  public UpdateColumnSecurityRulesRequest identifier(@javax.annotation.Nullable String identifier) {
  ...
  public UpdateColumnSecurityRulesRequest objIdentifier(@javax.annotation.Nullable String objIdentifier) {
  ...
  public UpdateColumnSecurityRulesRequest columnSecurityRules(@javax.annotation.Nonnull List<ColumnSecurityRuleUpdate> columnSecurityRules) {
    this.columnSecurityRules = columnSecurityRules;
    return this;
  }

  public UpdateColumnSecurityRulesRequest addColumnSecurityRulesItem(ColumnSecurityRuleUpdate columnSecurityRulesItem) {
  ...
  public void setColumnSecurityRules(@javax.annotation.Nonnull List<ColumnSecurityRuleUpdate> columnSecurityRules) {
    this.columnSecurityRules = columnSecurityRules;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateColumnSecurityRulesRequest updateColumnSecurityRulesRequest = (UpdateColumnSecurityRulesRequest) o;
    return Objects.equals(this.identifier, updateColumnSecurityRulesRequest.identifier) &&
        Objects.equals(this.objIdentifier, updateColumnSecurityRulesRequest.objIdentifier) &&
        Objects.equals(this.clearCsr, updateColumnSecurityRulesRequest.clearCsr) &&
        Objects.equals(this.columnSecurityRules, updateColumnSecurityRulesRequest.columnSecurityRules)&&
        Objects.equals(this.additionalProperties, updateColumnSecurityRulesRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identifier, objIdentifier, clearCsr, columnSecurityRules, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateColumnSecurityRulesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateColumnSecurityRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateColumnSecurityRulesRequest is not found in the empty JSON string", UpdateColumnSecurityRulesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("column_security_rules").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `column_security_rules` to be an array in the JSON string but got `%s`", jsonObj.get("column_security_rules").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateColumnSecurityRulesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateColumnSecurityRulesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateColumnSecurityRulesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateColumnSecurityRulesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateColumnSecurityRulesRequest>() {
           @Override
           public void write(JsonWriter out, UpdateColumnSecurityRulesRequest value) throws IOException {
           ...
           @Override
           public UpdateColumnSecurityRulesRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateColumnSecurityRulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to UpdateColumnSecurityRulesRequest
   */
