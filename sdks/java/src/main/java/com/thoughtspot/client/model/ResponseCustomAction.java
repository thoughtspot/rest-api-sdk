...
import com.thoughtspot.client.model.ActionDetails;
import com.thoughtspot.client.model.DefaultActionConfig;
import com.thoughtspot.client.model.MetadataAssociationItem;
...
public class ResponseCustomAction implements Serializable {
   ...
   * @return the ResponseCustomAction instance itself
   */
  public ResponseCustomAction putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionDetails, responseCustomAction.actionDetails) &&
        ...
        Objects.equals(this.additionalProperties, responseCustomAction.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionDetails, defaultActionConfig, id, objId, metadataAssociation, name, userGroups, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseCustomAction>() {
           ...
           public ResponseCustomAction read(JsonReader in) throws IOException {
             ...
             ResponseCustomAction instance = thisAdapter.fromJsonTree(jsonObj);
