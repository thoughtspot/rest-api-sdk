...
public class LiveboardOptionsInput implements Serializable {
     ...
     * @return the LiveboardOptionsInput instance itself
     */
    public LiveboardOptionsInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(
                        ...
                        liveboardOptionsInput.visualizationIdentifiers)
                && Objects.equals(
                        this.additionalProperties, liveboardOptionsInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LiveboardOptionsInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LiveboardOptionsInput is not found in"
                                        + " the empty JSON string",
                                LiveboardOptionsInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<LiveboardOptionsInput>() {
                        @Override
                        public void write(JsonWriter out, LiveboardOptionsInput value)
                                throws IOException {
                        ...
                        public LiveboardOptionsInput read(JsonReader in) throws IOException {
                            ...
                            LiveboardOptionsInput instance = thisAdapter.fromJsonTree(jsonObj);
