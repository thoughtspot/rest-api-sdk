...
public class HeaderAttributeInput implements Serializable {
   ...
   * @return the HeaderAttributeInput instance itself
   */
  public HeaderAttributeInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, headerAttributeInput.name) &&
        ...
        Objects.equals(this.additionalProperties, headerAttributeInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HeaderAttributeInput>() {
           ...
           public HeaderAttributeInput read(JsonReader in) throws IOException {
             ...
             HeaderAttributeInput instance = thisAdapter.fromJsonTree(jsonObj);
