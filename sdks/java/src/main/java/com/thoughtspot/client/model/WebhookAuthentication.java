...
public class WebhookAuthentication implements Serializable {
    ...
    public WebhookAuthentication BASIC_AUTH(
            @javax.annotation.Nullable WebhookAuthBasicAuth BASIC_AUTH) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.API_KEY, webhookAuthentication.API_KEY)
                ...
                && Objects.equals(
                        this.additionalProperties, webhookAuthentication.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookAuthentication.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookAuthentication is not found in"
                                        + " the empty JSON string",
                                WebhookAuthentication.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookAuthentication>() {
                        @Override
                        public void write(JsonWriter out, WebhookAuthentication value)
                                throws IOException {
