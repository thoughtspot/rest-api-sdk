...
public class GroupInfo implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, groupInfo.id) && Objects.equals(this.name, groupInfo.name);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GroupInfo.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GroupInfo is not found in the empty"
                                        + " JSON string",
                                GroupInfo.openapiRequiredFields.toString()));
            }
        }
