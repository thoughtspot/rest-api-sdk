...
import com.thoughtspot.client.model.TagMetadataTypeInput;
...
public class UnassignTagRequest implements Serializable {
  ...
  public UnassignTagRequest metadata(@javax.annotation.Nonnull List<TagMetadataTypeInput> metadata) {
  ...
  public UnassignTagRequest tagIdentifiers(@javax.annotation.Nonnull List<String> tagIdentifiers) {
   ...
   * @return the UnassignTagRequest instance itself
   */
  public UnassignTagRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, unassignTagRequest.metadata) &&
        ...
        Objects.equals(this.additionalProperties, unassignTagRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadata, tagIdentifiers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UnassignTagRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnassignTagRequest is not found in the empty JSON string", UnassignTagRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UnassignTagRequest>() {
           @Override
           public void write(JsonWriter out, UnassignTagRequest value) throws IOException {
           ...
           public UnassignTagRequest read(JsonReader in) throws IOException {
             ...
             UnassignTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
