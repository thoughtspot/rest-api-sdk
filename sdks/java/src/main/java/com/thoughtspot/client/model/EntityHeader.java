...
public class EntityHeader implements Serializable {
    ...
    public EntityHeader dataSourceIdentifier(
     ...
     * @return the EntityHeader instance itself
     */
    public EntityHeader putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.description, entityHeader.description)
                ...
                && Objects.equals(this.additionalProperties, entityHeader.additionalProperties);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                description, dataSourceName, dataSourceIdentifier, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!EntityHeader.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in EntityHeader is not found in the"
                                        + " empty JSON string",
                                EntityHeader.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<EntityHeader>() {
                        ...
                        public EntityHeader read(JsonReader in) throws IOException {
                            ...
                            EntityHeader instance = thisAdapter.fromJsonTree(jsonObj);
