...
public class ColumnSecurityRuleUpdate implements Serializable {
    ...
    public ColumnSecurityRuleUpdate columnIdentifier(
            @javax.annotation.Nonnull String columnIdentifier) {
    ...
    /**
     * If true, the column will be marked as unprotected and all groups associated with it will be
     * removed
     *
     * @return isUnsecured
     */
    ...
    public ColumnSecurityRuleUpdate groupAccess(
            @javax.annotation.Nullable List<ColumnSecurityRuleGroupOperation> groupAccess) {
        this.groupAccess = groupAccess;
        return this;
    }

    public ColumnSecurityRuleUpdate addGroupAccessItem(
            ColumnSecurityRuleGroupOperation groupAccessItem) {
    ...
    /**
     * Array of group operation objects that specifies the actions for groups to be associated with
     * a column
     *
     * @return groupAccess
     */
     ...
     * @return the ColumnSecurityRuleUpdate instance itself
     */
    public ColumnSecurityRuleUpdate putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.columnIdentifier, columnSecurityRuleUpdate.columnIdentifier)
                ...
                && Objects.equals(
                        this.additionalProperties, columnSecurityRuleUpdate.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(columnIdentifier, isUnsecured, groupAccess, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ColumnSecurityRuleUpdate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ColumnSecurityRuleUpdate is not found"
                                        + " in the empty JSON string",
                                ColumnSecurityRuleUpdate.openapiRequiredFields.toString()));
            }
        }
        ...
        if (!jsonObj.get("column_identifier").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `column_identifier` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("column_identifier").toString()));
        }
        if (jsonObj.get("group_access") != null && !jsonObj.get("group_access").isJsonNull()) {
            ...
            if (jsonArraygroupAccess != null) {
                ...
                if (!jsonObj.get("group_access").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `group_access` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("group_access").toString()));
                }

                // validate the optional field `group_access` (array)
                for (int i = 0; i < jsonArraygroupAccess.size(); i++) {
                    ColumnSecurityRuleGroupOperation.validateJsonElement(
                            jsonArraygroupAccess.get(i));
                }
                ;
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ColumnSecurityRuleUpdate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ColumnSecurityRuleUpdate' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ColumnSecurityRuleUpdate>() {
                        @Override
                        public void write(JsonWriter out, ColumnSecurityRuleUpdate value)
                                throws IOException {
                        ...
                        public ColumnSecurityRuleUpdate read(JsonReader in) throws IOException {
                            ...
                            ColumnSecurityRuleUpdate instance = thisAdapter.fromJsonTree(jsonObj);
