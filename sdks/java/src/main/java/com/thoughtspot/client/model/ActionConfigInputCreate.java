...
public class ActionConfigInputCreate implements Serializable {
     ...
     * @return the ActionConfigInputCreate instance itself
     */
    public ActionConfigInputCreate putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.position, actionConfigInputCreate.position)
                ...
                && Objects.equals(
                        this.additionalProperties, actionConfigInputCreate.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ActionConfigInputCreate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ActionConfigInputCreate is not found"
                                        + " in the empty JSON string",
                                ActionConfigInputCreate.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ActionConfigInputCreate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ActionConfigInputCreate' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ActionConfigInputCreate>() {
                        @Override
                        public void write(JsonWriter out, ActionConfigInputCreate value)
                                throws IOException {
                        ...
                        public ActionConfigInputCreate read(JsonReader in) throws IOException {
                            ...
                            ActionConfigInputCreate instance = thisAdapter.fromJsonTree(jsonObj);
