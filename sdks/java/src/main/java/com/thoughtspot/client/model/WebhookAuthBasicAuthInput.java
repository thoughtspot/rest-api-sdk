...
public class WebhookAuthBasicAuthInput implements Serializable {
     ...
     * @return the WebhookAuthBasicAuthInput instance itself
     */
    public WebhookAuthBasicAuthInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.username, webhookAuthBasicAuthInput.username)
                ...
                && Objects.equals(
                        this.additionalProperties, webhookAuthBasicAuthInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookAuthBasicAuthInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookAuthBasicAuthInput is not"
                                        + " found in the empty JSON string",
                                WebhookAuthBasicAuthInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WebhookAuthBasicAuthInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WebhookAuthBasicAuthInput' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookAuthBasicAuthInput>() {
                        @Override
                        public void write(JsonWriter out, WebhookAuthBasicAuthInput value)
                                throws IOException {
                        ...
                        public WebhookAuthBasicAuthInput read(JsonReader in) throws IOException {
                            ...
                            WebhookAuthBasicAuthInput instance = thisAdapter.fromJsonTree(jsonObj);
