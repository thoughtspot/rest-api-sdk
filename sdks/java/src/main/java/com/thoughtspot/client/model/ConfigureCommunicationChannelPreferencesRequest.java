...
public class ConfigureCommunicationChannelPreferencesRequest implements Serializable {
    ...
    public ConfigureCommunicationChannelPreferencesRequest clusterPreferences(
            @javax.annotation.Nullable List<EventChannelConfigInput> clusterPreferences) {
        this.clusterPreferences = clusterPreferences;
        return this;
    }

    public ConfigureCommunicationChannelPreferencesRequest addClusterPreferencesItem(
            EventChannelConfigInput clusterPreferencesItem) {
    ...
    public ConfigureCommunicationChannelPreferencesRequest orgPreferences(
            @javax.annotation.Nullable List<OrgChannelConfigInput> orgPreferences) {
        this.orgPreferences = orgPreferences;
        return this;
    }

    public ConfigureCommunicationChannelPreferencesRequest addOrgPreferencesItem(
            OrgChannelConfigInput orgPreferencesItem) {
     ...
     * @return the ConfigureCommunicationChannelPreferencesRequest instance itself
     */
    public ConfigureCommunicationChannelPreferencesRequest putAdditionalProperty(
    ...
    public boolean equals(Object o) {
        ...
        ConfigureCommunicationChannelPreferencesRequest
                configureCommunicationChannelPreferencesRequest =
                        (ConfigureCommunicationChannelPreferencesRequest) o;
        return Objects.equals(
                        this.clusterPreferences,
                        configureCommunicationChannelPreferencesRequest.clusterPreferences)
                && Objects.equals(
                        this.orgPreferences,
                        configureCommunicationChannelPreferencesRequest.orgPreferences)
                && Objects.equals(
                        this.additionalProperties,
                        configureCommunicationChannelPreferencesRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ConfigureCommunicationChannelPreferencesRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in"
                                        + " ConfigureCommunicationChannelPreferencesRequest is not"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ConfigureCommunicationChannelPreferencesRequest.class.isAssignableFrom(
                    type.getRawType())) {
                return null; // this class only serializes
                // 'ConfigureCommunicationChannelPreferencesRequest' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ConfigureCommunicationChannelPreferencesRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this,
                            TypeToken.get(ConfigureCommunicationChannelPreferencesRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ConfigureCommunicationChannelPreferencesRequest>() {
                        @Override
                        public void write(
                                JsonWriter out,
                                ConfigureCommunicationChannelPreferencesRequest value)
                                throws IOException {
                        ...
                        @Override
                        public ConfigureCommunicationChannelPreferencesRequest read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            ConfigureCommunicationChannelPreferencesRequest instance =
     ...
     *     ConfigureCommunicationChannelPreferencesRequest
     */
    public static ConfigureCommunicationChannelPreferencesRequest fromJson(String jsonString)
            throws IOException {
        return JSON.getGson()
                .fromJson(jsonString, ConfigureCommunicationChannelPreferencesRequest.class);
    }
