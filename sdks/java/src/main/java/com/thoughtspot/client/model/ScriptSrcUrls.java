...
public class ScriptSrcUrls implements Serializable {
   ...
   * @return the ScriptSrcUrls instance itself
   */
  public ScriptSrcUrls putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, scriptSrcUrls.enabled) &&
        ...
        Objects.equals(this.additionalProperties, scriptSrcUrls.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ScriptSrcUrls.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScriptSrcUrls is not found in the empty JSON string", ScriptSrcUrls.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScriptSrcUrls>() {
           @Override
           ...
           public ScriptSrcUrls read(JsonReader in) throws IOException {
             ...
             ScriptSrcUrls instance = thisAdapter.fromJsonTree(jsonObj);
