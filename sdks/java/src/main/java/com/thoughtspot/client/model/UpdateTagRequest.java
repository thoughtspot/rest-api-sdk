...
public class UpdateTagRequest implements Serializable {
     ...
     * @return the UpdateTagRequest instance itself
     */
    public UpdateTagRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, updateTagRequest.name)
                ...
                && Objects.equals(this.additionalProperties, updateTagRequest.additionalProperties);
    }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateTagRequest>() {
                        ...
                        public UpdateTagRequest read(JsonReader in) throws IOException {
                            ...
                            UpdateTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
