...
public class FavoriteObjectOptionsInput implements Serializable {
  ...
  public FavoriteObjectOptionsInput userIdentifiers(@javax.annotation.Nullable List<String> userIdentifiers) {
   ...
   * @return the FavoriteObjectOptionsInput instance itself
   */
  public FavoriteObjectOptionsInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.include, favoriteObjectOptionsInput.include) &&
        ...
        Objects.equals(this.additionalProperties, favoriteObjectOptionsInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(include, userIdentifiers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FavoriteObjectOptionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FavoriteObjectOptionsInput>() {
           ...
           public FavoriteObjectOptionsInput read(JsonReader in) throws IOException {
             ...
             FavoriteObjectOptionsInput instance = thisAdapter.fromJsonTree(jsonObj);
