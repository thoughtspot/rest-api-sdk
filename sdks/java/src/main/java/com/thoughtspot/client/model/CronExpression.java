...
public class CronExpression implements Serializable {
   ...
   * @return the CronExpression instance itself
   */
  public CronExpression putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dayOfMonth, cronExpression.dayOfMonth) &&
        ...
        Objects.equals(this.additionalProperties, cronExpression.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CronExpression.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CronExpression>() {
           ...
           public CronExpression read(JsonReader in) throws IOException {
             ...
             CronExpression instance = thisAdapter.fromJsonTree(jsonObj);
