...
public class TokenAccessScopeObject implements Serializable {
     ...
     * @return the TokenAccessScopeObject instance itself
     */
    public TokenAccessScopeObject putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.type, tokenAccessScopeObject.type)
                ...
                && Objects.equals(
                        this.additionalProperties, tokenAccessScopeObject.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TokenAccessScopeObject.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TokenAccessScopeObject is not found"
                                        + " in the empty JSON string",
                                TokenAccessScopeObject.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<TokenAccessScopeObject>() {
                        @Override
                        public void write(JsonWriter out, TokenAccessScopeObject value)
                                throws IOException {
                        ...
                        public TokenAccessScopeObject read(JsonReader in) throws IOException {
                            ...
                            TokenAccessScopeObject instance = thisAdapter.fromJsonTree(jsonObj);
