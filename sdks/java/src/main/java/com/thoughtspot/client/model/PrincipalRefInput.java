...
public class PrincipalRefInput implements Serializable {
  ...
  public PrincipalRefInput principalIdentifier(@javax.annotation.Nonnull String principalIdentifier) {
  ...
  public PrincipalRefInput principalType(@javax.annotation.Nonnull PrincipalTypeEnum principalType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.principalIdentifier, principalRefInput.principalIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, principalRefInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PrincipalRefInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrincipalRefInput is not found in the empty JSON string", PrincipalRefInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PrincipalRefInput>() {
           @Override
           public void write(JsonWriter out, PrincipalRefInput value) throws IOException {
