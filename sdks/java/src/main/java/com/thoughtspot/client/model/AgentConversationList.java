...
public class AgentConversationList implements Serializable {
  ...
  public AgentConversationList conversationIdentifier(@javax.annotation.Nonnull String conversationIdentifier) {
  ...
  public AgentConversationList conversationTitle(@javax.annotation.Nullable String conversationTitle) {
  ...
  public AgentConversationList dataSourceIdentifiers(@javax.annotation.Nullable List<String> dataSourceIdentifiers) {
  ...
  public AgentConversationList dataSourceNames(@javax.annotation.Nullable List<DataSourceEntry> dataSourceNames) {
  ...
  public void setDataSourceNames(@javax.annotation.Nullable List<DataSourceEntry> dataSourceNames) {
    this.dataSourceNames = dataSourceNames;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conversationIdentifier, agentConversationList.conversationIdentifier) &&
        ...
        Objects.equals(this.dataSourceIdentifiers, agentConversationList.dataSourceIdentifiers) &&
        ...
        Objects.equals(this.additionalProperties, agentConversationList.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conversationIdentifier, conversationTitle, createdAt, updatedAt, dataSourceIdentifiers, dataSourceNames, isPinned, analystId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentConversationList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentConversationList is not found in the empty JSON string", AgentConversationList.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("data_source_names") != null && !jsonObj.get("data_source_names").isJsonNull()) {
        ...
        if (jsonArraydataSourceNames != null) {
          ...
          if (!jsonObj.get("data_source_names").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `data_source_names` to be an array in the JSON string but got `%s`", jsonObj.get("data_source_names").toString()));
          }
      ...
      if ((jsonObj.get("analyst_id") != null && !jsonObj.get("analyst_id").isJsonNull()) && !jsonObj.get("analyst_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `analyst_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("analyst_id").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AgentConversationList>() {
           @Override
           public void write(JsonWriter out, AgentConversationList value) throws IOException {
