...
public class InputTableResponse implements Serializable {
    ...
    public InputTableResponse inputTableIdentifier(
            @javax.annotation.Nullable String inputTableIdentifier) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.inputTableIdentifier, inputTableResponse.inputTableIdentifier)
                && Objects.equals(
                        this.additionalProperties, inputTableResponse.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    inputTableIdentifier: ")
                .append(toIndentedString(inputTableIdentifier))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!InputTableResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in InputTableResponse is not found in"
                                        + " the empty JSON string",
                                InputTableResponse.openapiRequiredFields.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("input_table_identifier") != null
                        && !jsonObj.get("input_table_identifier").isJsonNull())
                && !jsonObj.get("input_table_identifier").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `input_table_identifier` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("input_table_identifier").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<InputTableResponse>() {
                        @Override
                        public void write(JsonWriter out, InputTableResponse value)
                                throws IOException {
