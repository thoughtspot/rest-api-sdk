...
import com.thoughtspot.client.model.ImportTargetSource;
...
public class ImportSummary implements Serializable {
  ...
  public enum MemoryTypeEnum {
    ...
    public static class Adapter extends TypeAdapter<MemoryTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MemoryTypeEnum enumeration) throws IOException {
  ...
  public ImportSummary existingRecordCount(@javax.annotation.Nullable Integer existingRecordCount) {
  ...
  public ImportSummary insertedRecordCount(@javax.annotation.Nullable Integer insertedRecordCount) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(memoryType, source, existingRecordCount, deletedRecordCount, insertedRecordCount, failedRecordCount, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    existingRecordCount: ").append(toIndentedString(existingRecordCount)).append("\n");
    sb.append("    deletedRecordCount: ").append(toIndentedString(deletedRecordCount)).append("\n");
    sb.append("    insertedRecordCount: ").append(toIndentedString(insertedRecordCount)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("memory_type") != null && !jsonObj.get("memory_type").isJsonNull()) && !jsonObj.get("memory_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `memory_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("memory_type").toString()));
      }
