...
import com.thoughtspot.client.model.ActionConfigInputCreate;
...
public class AssociateMetadataInputCreate implements Serializable {
  ...
  public AssociateMetadataInputCreate actionConfig(@javax.annotation.Nullable ActionConfigInputCreate actionConfig) {
   ...
   * @return the AssociateMetadataInputCreate instance itself
   */
  public AssociateMetadataInputCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionConfig, associateMetadataInputCreate.actionConfig) &&
        ...
        Objects.equals(this.additionalProperties, associateMetadataInputCreate.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AssociateMetadataInputCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateMetadataInputCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AssociateMetadataInputCreate>() {
           ...
           public AssociateMetadataInputCreate read(JsonReader in) throws IOException {
             ...
             AssociateMetadataInputCreate instance = thisAdapter.fromJsonTree(jsonObj);
