...
public class VariableValues implements Serializable {
   ...
   * @return the VariableValues instance itself
   */
  public VariableValues putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, variableValues.name) &&
        ...
        Objects.equals(this.additionalProperties, variableValues.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariableValues is not found in the empty JSON string", VariableValues.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VariableValues>() {
           @Override
           ...
           public VariableValues read(JsonReader in) throws IOException {
             ...
             VariableValues instance = thisAdapter.fromJsonTree(jsonObj);
