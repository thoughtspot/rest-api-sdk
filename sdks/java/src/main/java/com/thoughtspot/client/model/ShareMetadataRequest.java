...
import com.thoughtspot.client.model.ShareMetadataTypeInput;
...
public class ShareMetadataRequest implements Serializable {
   ...
   * @return the ShareMetadataRequest instance itself
   */
  public ShareMetadataRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataType, shareMetadataRequest.metadataType) &&
        ...
        Objects.equals(this.additionalProperties, shareMetadataRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataType, metadataIdentifiers, metadata, permissions, visualizationIdentifiers, emails, message, enableCustomUrl, notifyOnShare, hasLenientDiscoverability, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ShareMetadataRequest>() {
           ...
           public ShareMetadataRequest read(JsonReader in) throws IOException {
             ...
             ShareMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
