...
import com.thoughtspot.client.model.InputEurekaNLSRequest;
...
public class QueryGetDecomposedQueryRequest implements Serializable {
   ...
   * @return the QueryGetDecomposedQueryRequest instance itself
   */
  public QueryGetDecomposedQueryRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.answerIds, queryGetDecomposedQueryRequest.answerIds) &&
        ...
        Objects.equals(this.additionalProperties, queryGetDecomposedQueryRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(answerIds, content, conversationId, liveboardIds, maxDecomposedQueries, nlsRequest, worksheetIds, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<QueryGetDecomposedQueryRequest>() {
           ...
           public QueryGetDecomposedQueryRequest read(JsonReader in) throws IOException {
             ...
             QueryGetDecomposedQueryRequest instance = thisAdapter.fromJsonTree(jsonObj);
