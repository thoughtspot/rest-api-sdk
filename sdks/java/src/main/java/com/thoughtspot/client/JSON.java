...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(
                new com.thoughtspot.client.model.AWSAssumeRoleSetup.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(
        ...
        gsonBuilder.registerTypeAdapterFactory(
                new com.thoughtspot.client.model.GCPWebIdentitySetup.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(
