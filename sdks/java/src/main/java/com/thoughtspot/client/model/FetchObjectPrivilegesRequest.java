...
import com.thoughtspot.client.model.ObjectPrivilegesMetadataInput;
...
public class FetchObjectPrivilegesRequest implements Serializable {
  ...
  public FetchObjectPrivilegesRequest metadata(@javax.annotation.Nonnull List<ObjectPrivilegesMetadataInput> metadata) {
    this.metadata = metadata;
    return this;
  }

  public FetchObjectPrivilegesRequest addMetadataItem(ObjectPrivilegesMetadataInput metadataItem) {
  ...
  public void setMetadata(@javax.annotation.Nonnull List<ObjectPrivilegesMetadataInput> metadata) {
    this.metadata = metadata;
  }


  public FetchObjectPrivilegesRequest principals(@javax.annotation.Nullable List<PrincipalsInput> principals) {
  ...
  public FetchObjectPrivilegesRequest recordOffset(@javax.annotation.Nullable Integer recordOffset) {
   ...
   * @return the FetchObjectPrivilegesRequest instance itself
   */
  public FetchObjectPrivilegesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FetchObjectPrivilegesRequest fetchObjectPrivilegesRequest = (FetchObjectPrivilegesRequest) o;
    return Objects.equals(this.metadata, fetchObjectPrivilegesRequest.metadata) &&
        ...
        Objects.equals(this.additionalProperties, fetchObjectPrivilegesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadata, principals, recordOffset, recordSize, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FetchObjectPrivilegesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FetchObjectPrivilegesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FetchObjectPrivilegesRequest is not found in the empty JSON string", FetchObjectPrivilegesRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FetchObjectPrivilegesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FetchObjectPrivilegesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FetchObjectPrivilegesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FetchObjectPrivilegesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FetchObjectPrivilegesRequest>() {
           @Override
           public void write(JsonWriter out, FetchObjectPrivilegesRequest value) throws IOException {
           ...
           public FetchObjectPrivilegesRequest read(JsonReader in) throws IOException {
             ...
             FetchObjectPrivilegesRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to FetchObjectPrivilegesRequest
   */
