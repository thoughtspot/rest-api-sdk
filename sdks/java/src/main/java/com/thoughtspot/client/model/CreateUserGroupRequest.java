...
public class CreateUserGroupRequest implements Serializable {
  ...
  public CreateUserGroupRequest defaultLiveboardIdentifiers(@javax.annotation.Nullable List<String> defaultLiveboardIdentifiers) {
  ...
  public CreateUserGroupRequest privileges(@javax.annotation.Nullable List<PrivilegesEnum> privileges) {
  ...
  public CreateUserGroupRequest subGroupIdentifiers(@javax.annotation.Nullable List<String> subGroupIdentifiers) {
  ...
  public CreateUserGroupRequest userIdentifiers(@javax.annotation.Nullable List<String> userIdentifiers) {
  ...
  public CreateUserGroupRequest roleIdentifiers(@javax.annotation.Nullable List<String> roleIdentifiers) {
   ...
   * @return the CreateUserGroupRequest instance itself
   */
  public CreateUserGroupRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createUserGroupRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, createUserGroupRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, defaultLiveboardIdentifiers, description, privileges, subGroupIdentifiers, type, userIdentifiers, visibility, roleIdentifiers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateUserGroupRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateUserGroupRequest>() {
           ...
           public CreateUserGroupRequest read(JsonReader in) throws IOException {
             ...
             CreateUserGroupRequest instance = thisAdapter.fromJsonTree(jsonObj);
