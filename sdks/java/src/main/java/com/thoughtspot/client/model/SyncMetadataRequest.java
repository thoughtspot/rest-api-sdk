...
public class SyncMetadataRequest implements Serializable {
  ...
  public enum SyncAttributesEnum {
    ...
    public static class Adapter extends TypeAdapter<SyncAttributesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final SyncAttributesEnum enumeration) throws IOException {
  ...
  @javax.annotation.Nullable
  private List<SyncAttributesEnum> syncAttributes = new ArrayList<>(Arrays.asList(SyncAttributesEnum.DESCRIPTION));
  ...
  public SyncMetadataRequest syncAttributes(@javax.annotation.Nullable List<SyncAttributesEnum> syncAttributes) {
  ...
  public void setSyncAttributes(@javax.annotation.Nullable List<SyncAttributesEnum> syncAttributes) {
    this.syncAttributes = syncAttributes;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tables, syncMetadataRequest.tables) &&
        ...
        Objects.equals(this.additionalProperties, syncMetadataRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SyncMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncMetadataRequest is not found in the empty JSON string", SyncMetadataRequest.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("sync_attributes") != null && !jsonObj.get("sync_attributes").isJsonNull() && !jsonObj.get("sync_attributes").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `sync_attributes` to be an array in the JSON string but got `%s`", jsonObj.get("sync_attributes").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SyncMetadataRequest>() {
           @Override
           public void write(JsonWriter out, SyncMetadataRequest value) throws IOException {
