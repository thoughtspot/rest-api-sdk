...
public class WebhookPagination implements Serializable {
   ...
   * @return the WebhookPagination instance itself
   */
  public WebhookPagination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.recordOffset, webhookPagination.recordOffset) &&
        ...
        Objects.equals(this.additionalProperties, webhookPagination.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recordOffset, recordSize, totalCount, hasMore, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookPagination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookPagination is not found in the empty JSON string", WebhookPagination.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookPagination>() {
           @Override
           public void write(JsonWriter out, WebhookPagination value) throws IOException {
           ...
           public WebhookPagination read(JsonReader in) throws IOException {
             ...
             WebhookPagination instance = thisAdapter.fromJsonTree(jsonObj);
