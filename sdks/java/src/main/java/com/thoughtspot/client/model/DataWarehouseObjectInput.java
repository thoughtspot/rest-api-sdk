...
public class DataWarehouseObjectInput implements Serializable {
   ...
   * @return the DataWarehouseObjectInput instance itself
   */
  public DataWarehouseObjectInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.database, dataWarehouseObjectInput.database) &&
        ...
        Objects.equals(this.additionalProperties, dataWarehouseObjectInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(database, schema, table, column, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataWarehouseObjectInput>() {
           ...
           public DataWarehouseObjectInput read(JsonReader in) throws IOException {
             ...
             DataWarehouseObjectInput instance = thisAdapter.fromJsonTree(jsonObj);
