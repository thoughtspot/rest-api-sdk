...
public class EurekaImportSummary implements Serializable {
    ...
    @javax.annotation.Nullable
    private EurekaImportTargetSource source;
    ...
    public EurekaImportSummary() {}

    public EurekaImportSummary memoryType(@javax.annotation.Nullable MemoryTypeEnum memoryType) {
    ...
    public EurekaImportSummary source(@javax.annotation.Nullable EurekaImportTargetSource source) {
        this.source = source;
        return this;
    }
     ...
     */
    @javax.annotation.Nullable
    public EurekaImportTargetSource getSource() {
        return source;
    }

    public void setSource(@javax.annotation.Nullable EurekaImportTargetSource source) {
        this.source = source;
    }

    public EurekaImportSummary existingRecordCount(
    ...
    public EurekaImportSummary deletedRecordCount(
            @javax.annotation.Nullable Integer deletedRecordCount) {
    ...
    public EurekaImportSummary insertedRecordCount(
    ...
    public EurekaImportSummary failedRecordCount(
            @javax.annotation.Nullable Integer failedRecordCount) {
     ...
     * @return the EurekaImportSummary instance itself
     */
    public EurekaImportSummary putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        EurekaImportSummary eurekaImportSummary = (EurekaImportSummary) o;
        return Objects.equals(this.memoryType, eurekaImportSummary.memoryType)
                && Objects.equals(this.source, eurekaImportSummary.source)
                && Objects.equals(this.existingRecordCount, eurekaImportSummary.existingRecordCount)
                && Objects.equals(this.deletedRecordCount, eurekaImportSummary.deletedRecordCount)
                && Objects.equals(this.insertedRecordCount, eurekaImportSummary.insertedRecordCount)
                && Objects.equals(this.failedRecordCount, eurekaImportSummary.failedRecordCount)
                && Objects.equals(
                        this.additionalProperties, eurekaImportSummary.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("class EurekaImportSummary {\n");
     ...
     * @throws IOException if the JSON Element is invalid with respect to EurekaImportSummary
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!EurekaImportSummary.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in EurekaImportSummary is not found in"
                                        + " the empty JSON string",
                                EurekaImportSummary.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("source") != null && !jsonObj.get("source").isJsonNull()) {
            EurekaImportTargetSource.validateJsonElement(jsonObj.get("source"));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EurekaImportSummary.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EurekaImportSummary' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<EurekaImportSummary> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(EurekaImportSummary.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<EurekaImportSummary>() {
                        @Override
                        public void write(JsonWriter out, EurekaImportSummary value)
                                throws IOException {
                        ...
                        @Override
                        public EurekaImportSummary read(JsonReader in) throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            EurekaImportSummary instance = thisAdapter.fromJsonTree(jsonObj);
    ...
    /**
     * Create an instance of EurekaImportSummary given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of EurekaImportSummary
     * @throws IOException if the JSON string is invalid with respect to EurekaImportSummary
     */
    public static EurekaImportSummary fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, EurekaImportSummary.class);
    }

    /**
     * Convert an instance of EurekaImportSummary to an JSON string
     *
     * @return JSON string
     */
