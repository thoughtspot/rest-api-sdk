...
import com.thoughtspot.client.model.SemanticIntegrationSortOptions;
...
public class SearchSemanticIntegrationsRequest implements Serializable {
  ...
  public SearchSemanticIntegrationsRequest sortOptions(@javax.annotation.Nullable SemanticIntegrationSortOptions sortOptions) {
  ...
  public void setSortOptions(@javax.annotation.Nullable SemanticIntegrationSortOptions sortOptions) {
    this.sortOptions = sortOptions;
  }


  public SearchSemanticIntegrationsRequest recordOffset(@javax.annotation.Nullable Integer recordOffset) {
  ...
  public SearchSemanticIntegrationsRequest recordSize(@javax.annotation.Nullable Integer recordSize) {
  ...
  public SearchSemanticIntegrationsRequest authorIdentifiers(@javax.annotation.Nullable List<String> authorIdentifiers) {
    this.authorIdentifiers = authorIdentifiers;
    return this;
  }

  public SearchSemanticIntegrationsRequest addAuthorIdentifiersItem(String authorIdentifiersItem) {
  ...
  public SearchSemanticIntegrationsRequest connectionIdentifiers(@javax.annotation.Nullable List<String> connectionIdentifiers) {
    this.connectionIdentifiers = connectionIdentifiers;
    return this;
  }

  public SearchSemanticIntegrationsRequest addConnectionIdentifiersItem(String connectionIdentifiersItem) {
  ...
  public void setConnectionIdentifiers(@javax.annotation.Nullable List<String> connectionIdentifiers) {
    this.connectionIdentifiers = connectionIdentifiers;
  }
  ...
  public boolean equals(Object o) {
    ...
    SearchSemanticIntegrationsRequest searchSemanticIntegrationsRequest = (SearchSemanticIntegrationsRequest) o;
    return Objects.equals(this.sortOptions, searchSemanticIntegrationsRequest.sortOptions) &&
        ...
        Objects.equals(this.authorIdentifiers, searchSemanticIntegrationsRequest.authorIdentifiers) &&
        Objects.equals(this.connectionIdentifiers, searchSemanticIntegrationsRequest.connectionIdentifiers)&&
        Objects.equals(this.additionalProperties, searchSemanticIntegrationsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sortOptions, recordOffset, recordSize, pattern, authorIdentifiers, connectionIdentifiers, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    authorIdentifiers: ").append(toIndentedString(authorIdentifiers)).append("\n");
    sb.append("    connectionIdentifiers: ").append(toIndentedString(connectionIdentifiers)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchSemanticIntegrationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchSemanticIntegrationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchSemanticIntegrationsRequest is not found in the empty JSON string", SearchSemanticIntegrationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("author_identifiers") != null && !jsonObj.get("author_identifiers").isJsonNull() && !jsonObj.get("author_identifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `author_identifiers` to be an array in the JSON string but got `%s`", jsonObj.get("author_identifiers").toString()));
      }
      // ensure the optional json data is an array if present
      if (jsonObj.get("connection_identifiers") != null && !jsonObj.get("connection_identifiers").isJsonNull() && !jsonObj.get("connection_identifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `connection_identifiers` to be an array in the JSON string but got `%s`", jsonObj.get("connection_identifiers").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchSemanticIntegrationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchSemanticIntegrationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchSemanticIntegrationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchSemanticIntegrationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchSemanticIntegrationsRequest>() {
           @Override
           public void write(JsonWriter out, SearchSemanticIntegrationsRequest value) throws IOException {
           ...
           @Override
           public SearchSemanticIntegrationsRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SearchSemanticIntegrationsRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to SearchSemanticIntegrationsRequest
   */
