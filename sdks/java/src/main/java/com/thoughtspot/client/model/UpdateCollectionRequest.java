...
import com.thoughtspot.client.model.CollectionMetadataInput;
...
public class UpdateCollectionRequest implements Serializable {
  ...
  public UpdateCollectionRequest metadata(@javax.annotation.Nullable List<CollectionMetadataInput> metadata) {
   ...
   * @return the UpdateCollectionRequest instance itself
   */
  public UpdateCollectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateCollectionRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, updateCollectionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, metadata, operation, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateCollectionRequest>() {
           ...
           public UpdateCollectionRequest read(JsonReader in) throws IOException {
             ...
             UpdateCollectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
