...
public class FeatureDetail implements Serializable {
  ...
  public FeatureDetail assignedOrgs(@javax.annotation.Nullable List<FeatureOrgInfo> assignedOrgs) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(featureId, featureName, assignedOrgs, isOrgAware, featureValue, elementType, elementConfig, elementValue, docsUrl, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FeatureDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FeatureDetail is not found in the empty JSON string", FeatureDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("feature_value") != null && !jsonObj.get("feature_value").isJsonNull()) && !jsonObj.get("feature_value").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("element_type") != null && !jsonObj.get("element_type").isJsonNull()) && !jsonObj.get("element_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `element_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("element_type").toString()));
      }
      if ((jsonObj.get("element_value") != null && !jsonObj.get("element_value").isJsonNull()) && !jsonObj.get("element_value").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `element_value` to be a primitive type in the JSON string but got `%s`", jsonObj.get("element_value").toString()));
      }
      if ((jsonObj.get("docs_url") != null && !jsonObj.get("docs_url").isJsonNull()) && !jsonObj.get("docs_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `docs_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("docs_url").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FeatureDetail>() {
           @Override
