...
public class SearchDataRequest implements Serializable {
  ...
  public static final String SERIALIZED_NAME_LOGICAL_TABLE_IDENTIFIER = "logical_table_identifier";
  ...
  public SearchDataRequest logicalTableIdentifier(@javax.annotation.Nonnull String logicalTableIdentifier) {
  ...
  public SearchDataRequest runtimeParamOverride(@javax.annotation.Nullable Object runtimeParamOverride) {
   ...
   * @return the SearchDataRequest instance itself
   */
  public SearchDataRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.queryString, searchDataRequest.queryString) &&
        Objects.equals(this.logicalTableIdentifier, searchDataRequest.logicalTableIdentifier) &&
        ...
        Objects.equals(this.runtimeParamOverride, searchDataRequest.runtimeParamOverride)&&
        Objects.equals(this.additionalProperties, searchDataRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(queryString, logicalTableIdentifier, dataFormat, recordOffset, recordSize, runtimeFilter, runtimeSort, runtimeParamOverride, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchDataRequest is not found in the empty JSON string", SearchDataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("query_string").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `query_string` to be a primitive type in the JSON string but got `%s`", jsonObj.get("query_string").toString()));
      }
      if (!jsonObj.get("logical_table_identifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `logical_table_identifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("logical_table_identifier").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchDataRequest>() {
           @Override
           public void write(JsonWriter out, SearchDataRequest value) throws IOException {
           ...
           public SearchDataRequest read(JsonReader in) throws IOException {
             ...
             SearchDataRequest instance = thisAdapter.fromJsonTree(jsonObj);
