...
public class CreateConnectionRequest implements Serializable {
  ...
  public CreateConnectionRequest dataWarehouseConfig(@javax.annotation.Nullable Object dataWarehouseConfig) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, dataWarehouseType, dataWarehouseConfig, validate, additionalProperties);
  }
