...
import com.thoughtspot.client.model.ConnectionInput;
import com.thoughtspot.client.model.SortOptionInput;
...
public class SearchConnectionRequest implements Serializable {
   ...
   * @return the SearchConnectionRequest instance itself
   */
  public SearchConnectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connections, searchConnectionRequest.connections) &&
        ...
        Objects.equals(this.additionalProperties, searchConnectionRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connections, dataWarehouseTypes, recordOffset, recordSize, tagIdentifiers, dataWarehouseObjectType, sortOptions, includeDetails, _configuration, authenticationType, showResolvedParameters, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchConnectionRequest>() {
           ...
           public SearchConnectionRequest read(JsonReader in) throws IOException {
             ...
             SearchConnectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
