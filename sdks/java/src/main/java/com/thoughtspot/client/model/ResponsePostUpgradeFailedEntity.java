...
public class ResponsePostUpgradeFailedEntity implements Serializable {
   ...
   * @return the ResponsePostUpgradeFailedEntity instance itself
   */
  public ResponsePostUpgradeFailedEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ResponsePostUpgradeFailedEntity responsePostUpgradeFailedEntity = (ResponsePostUpgradeFailedEntity) o;
    return Objects.equals(this.id, responsePostUpgradeFailedEntity.id) &&
        ...
        Objects.equals(this.additionalProperties, responsePostUpgradeFailedEntity.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ResponsePostUpgradeFailedEntity
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponsePostUpgradeFailedEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponsePostUpgradeFailedEntity is not found in the empty JSON string", ResponsePostUpgradeFailedEntity.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ResponsePostUpgradeFailedEntity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ResponsePostUpgradeFailedEntity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ResponsePostUpgradeFailedEntity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ResponsePostUpgradeFailedEntity.class));

       return (TypeAdapter<T>) new TypeAdapter<ResponsePostUpgradeFailedEntity>() {
           @Override
           public void write(JsonWriter out, ResponsePostUpgradeFailedEntity value) throws IOException {
           ...
           @Override
           public ResponsePostUpgradeFailedEntity read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ResponsePostUpgradeFailedEntity instance = thisAdapter.fromJsonTree(jsonObj);
