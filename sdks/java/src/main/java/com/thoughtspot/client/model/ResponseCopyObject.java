...
public class ResponseCopyObject implements Serializable {
   ...
   * @return the ResponseCopyObject instance itself
   */
  public ResponseCopyObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataId, responseCopyObject.metadataId)&&
        Objects.equals(this.additionalProperties, responseCopyObject.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseCopyObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseCopyObject is not found in the empty JSON string", ResponseCopyObject.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseCopyObject>() {
           @Override
           public void write(JsonWriter out, ResponseCopyObject value) throws IOException {
           ...
           public ResponseCopyObject read(JsonReader in) throws IOException {
             ...
             ResponseCopyObject instance = thisAdapter.fromJsonTree(jsonObj);
