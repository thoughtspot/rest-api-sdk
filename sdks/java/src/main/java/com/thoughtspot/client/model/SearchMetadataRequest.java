...
public class SearchMetadataRequest implements Serializable {
    ...
    public enum DependentObjectVersionEnum {
        ...
        public static class Adapter extends TypeAdapter<DependentObjectVersionEnum> {
            @Override
            public void write(
                    final JsonWriter jsonWriter, final DependentObjectVersionEnum enumeration)
                    throws IOException {
    ...
    public static final String SERIALIZED_NAME_DEPENDENT_OBJECT_VERSION =
    ...
    public static final String SERIALIZED_NAME_INCLUDE_AUTO_CREATED_OBJECTS =
    ...
    public static final String SERIALIZED_NAME_INCLUDE_DEPENDENT_OBJECTS =
    ...
    public static final String SERIALIZED_NAME_DEPENDENT_OBJECTS_RECORD_SIZE =
    ...
    public static final String SERIALIZED_NAME_INCLUDE_INCOMPLETE_OBJECTS =
    ...
    public static final String SERIALIZED_NAME_INCLUDE_VISUALIZATION_HEADERS =
    ...
    public static final String SERIALIZED_NAME_INCLUDE_WORKSHEET_SEARCH_ASSIST_DATA =
    ...
    public static final String SERIALIZED_NAME_MODIFIED_BY_USER_IDENTIFIERS =
    ...
    public static final String SERIALIZED_NAME_INCLUDE_DISCOVERABLE_OBJECTS =
    ...
    public SearchMetadataRequest metadata(
            @javax.annotation.Nullable List<MetadataListItemInput> metadata) {
    ...
    public SearchMetadataRequest permissions(
            @javax.annotation.Nullable List<PermissionInput> permissions) {
    ...
    public SearchMetadataRequest dependentObjectVersion(
            @javax.annotation.Nullable DependentObjectVersionEnum dependentObjectVersion) {
    ...
    public void setDependentObjectVersion(
            @javax.annotation.Nullable DependentObjectVersionEnum dependentObjectVersion) {
        this.dependentObjectVersion = dependentObjectVersion;
    }

    public SearchMetadataRequest excludeObjects(
            @javax.annotation.Nullable List<ExcludeMetadataListItemInput> excludeObjects) {
        this.excludeObjects = excludeObjects;
        return this;
    }

    public SearchMetadataRequest addExcludeObjectsItem(
            ExcludeMetadataListItemInput excludeObjectsItem) {
    ...
    public void setExcludeObjects(
            @javax.annotation.Nullable List<ExcludeMetadataListItemInput> excludeObjects) {
        this.excludeObjects = excludeObjects;
    }

    public SearchMetadataRequest favoriteObjectOptions(
            @javax.annotation.Nullable FavoriteObjectOptionsInput favoriteObjectOptions) {
        this.favoriteObjectOptions = favoriteObjectOptions;
        return this;
    }

    /**
     * Options to sort the API response by objects set as favorites for the logged-in user or the
     * users specified in the API request.
     *
    ...
    public void setFavoriteObjectOptions(
            @javax.annotation.Nullable FavoriteObjectOptionsInput favoriteObjectOptions) {
        this.favoriteObjectOptions = favoriteObjectOptions;
    }

    public SearchMetadataRequest includeAutoCreatedObjects(
            @javax.annotation.Nullable Boolean includeAutoCreatedObjects) {
    ...
    public void setIncludeAutoCreatedObjects(
            @javax.annotation.Nullable Boolean includeAutoCreatedObjects) {
        this.includeAutoCreatedObjects = includeAutoCreatedObjects;
    }

    public SearchMetadataRequest includeDependentObjects(
            @javax.annotation.Nullable Boolean includeDependentObjects) {
        this.includeDependentObjects = includeDependentObjects;
        return this;
    }

    /**
     * Includes dependents of the metadata object specified in the API request. For example, a
     * worksheet can consist of dependent objects such as Liveboards or Answers.
     *
    ...
    public void setIncludeDependentObjects(
            @javax.annotation.Nullable Boolean includeDependentObjects) {
        this.includeDependentObjects = includeDependentObjects;
    }

    public SearchMetadataRequest dependentObjectsRecordSize(
            @javax.annotation.Nullable Integer dependentObjectsRecordSize) {
    ...
    public void setDependentObjectsRecordSize(
            @javax.annotation.Nullable Integer dependentObjectsRecordSize) {
        this.dependentObjectsRecordSize = dependentObjectsRecordSize;
    }
    ...
    public SearchMetadataRequest includeHiddenObjects(
            @javax.annotation.Nullable Boolean includeHiddenObjects) {
    ...
    public SearchMetadataRequest includeIncompleteObjects(
            @javax.annotation.Nullable Boolean includeIncompleteObjects) {
    ...
    public void setIncludeIncompleteObjects(
            @javax.annotation.Nullable Boolean includeIncompleteObjects) {
        this.includeIncompleteObjects = includeIncompleteObjects;
    }

    public SearchMetadataRequest includeVisualizationHeaders(
            @javax.annotation.Nullable Boolean includeVisualizationHeaders) {
    ...
    public void setIncludeVisualizationHeaders(
            @javax.annotation.Nullable Boolean includeVisualizationHeaders) {
        this.includeVisualizationHeaders = includeVisualizationHeaders;
    }

    public SearchMetadataRequest includeWorksheetSearchAssistData(
            @javax.annotation.Nullable Boolean includeWorksheetSearchAssistData) {
        this.includeWorksheetSearchAssistData = includeWorksheetSearchAssistData;
        return this;
    }

    /**
     * If search assistance lessons are configured on a worksheet, the API returns the search assist
     * data for Worksheet objects.
     *
    ...
    public void setIncludeWorksheetSearchAssistData(
            @javax.annotation.Nullable Boolean includeWorksheetSearchAssistData) {
        this.includeWorksheetSearchAssistData = includeWorksheetSearchAssistData;
    }

    public SearchMetadataRequest modifiedByUserIdentifiers(
            @javax.annotation.Nullable List<String> modifiedByUserIdentifiers) {
        this.modifiedByUserIdentifiers = modifiedByUserIdentifiers;
        return this;
    }

    public SearchMetadataRequest addModifiedByUserIdentifiersItem(
            String modifiedByUserIdentifiersItem) {
    ...
    public void setModifiedByUserIdentifiers(
            @javax.annotation.Nullable List<String> modifiedByUserIdentifiers) {
        this.modifiedByUserIdentifiers = modifiedByUserIdentifiers;
    }
    ...
    /**
     * The number of records that should be included. It is recommended to use a smaller
     * &#x60;record_size&#x60; when fetching dependent objects or any of the additional metadata
     * detail options.
     *
     * @return recordSize
     */
    ...
    public SearchMetadataRequest sortOptions(
            @javax.annotation.Nullable MetadataSearchSortOptions sortOptions) {
    ...
    public SearchMetadataRequest tagIdentifiers(
    ...
    public SearchMetadataRequest includeDiscoverableObjects(
            @javax.annotation.Nullable Boolean includeDiscoverableObjects) {
        this.includeDiscoverableObjects = includeDiscoverableObjects;
        return this;
    }

    /**
     * &lt;div&gt;Version: 10.7.0.cl or later &lt;/div&gt; Boolean to indicate whether to include
     * discoverable metadata objects.
     *
    ...
    public void setIncludeDiscoverableObjects(
            @javax.annotation.Nullable Boolean includeDiscoverableObjects) {
        this.includeDiscoverableObjects = includeDiscoverableObjects;
    }

    public SearchMetadataRequest showResolvedParameters(
     ...
     * @return the SearchMetadataRequest instance itself
     */
    public SearchMetadataRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadata, searchMetadataRequest.metadata)
                ...
                && Objects.equals(
                        ...
                        searchMetadataRequest.createdByUserIdentifiers)
                && Objects.equals(
                        this.dependentObjectVersion, searchMetadataRequest.dependentObjectVersion)
                && Objects.equals(this.excludeObjects, searchMetadataRequest.excludeObjects)
                && Objects.equals(
                        this.favoriteObjectOptions, searchMetadataRequest.favoriteObjectOptions)
                && Objects.equals(
                        this.includeAutoCreatedObjects,
                        searchMetadataRequest.includeAutoCreatedObjects)
                && Objects.equals(
                        this.includeDependentObjects, searchMetadataRequest.includeDependentObjects)
                && Objects.equals(
                ...
                && Objects.equals(
                        this.includeIncompleteObjects,
                        searchMetadataRequest.includeIncompleteObjects)
                && Objects.equals(
                        this.includeVisualizationHeaders,
                        searchMetadataRequest.includeVisualizationHeaders)
                && Objects.equals(
                        this.includeWorksheetSearchAssistData,
                        searchMetadataRequest.includeWorksheetSearchAssistData)
                && Objects.equals(
                        this.modifiedByUserIdentifiers,
                ...
                && Objects.equals(
                        this.additionalProperties, searchMetadataRequest.additionalProperties);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                dependentObjectVersion,
                excludeObjects,
                favoriteObjectOptions,
                includeAutoCreatedObjects,
    ...
    public String toString() {
        ...
        sb.append("    createdByUserIdentifiers: ")
                ...
                .append("\n");
        sb.append("    dependentObjectVersion: ")
                .append(toIndentedString(dependentObjectVersion))
                .append("\n");
        sb.append("    excludeObjects: ").append(toIndentedString(excludeObjects)).append("\n");
        sb.append("    favoriteObjectOptions: ")
                .append(toIndentedString(favoriteObjectOptions))
                .append("\n");
        sb.append("    includeAutoCreatedObjects: ")
                .append(toIndentedString(includeAutoCreatedObjects))
                .append("\n");
        sb.append("    includeDependentObjects: ")
                .append(toIndentedString(includeDependentObjects))
                .append("\n");
        sb.append("    dependentObjectsRecordSize: ")
        ...
        sb.append("    includeHiddenObjects: ")
                ...
                .append("\n");
        sb.append("    includeIncompleteObjects: ")
                .append(toIndentedString(includeIncompleteObjects))
                .append("\n");
        sb.append("    includeVisualizationHeaders: ")
                .append(toIndentedString(includeVisualizationHeaders))
                .append("\n");
        sb.append("    includeWorksheetSearchAssistData: ")
                .append(toIndentedString(includeWorksheetSearchAssistData))
                .append("\n");
        sb.append("    modifiedByUserIdentifiers: ")
                .append(toIndentedString(modifiedByUserIdentifiers))
                .append("\n");
        ...
        sb.append("    includeDiscoverableObjects: ")
                .append(toIndentedString(includeDiscoverableObjects))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SearchMetadataRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SearchMetadataRequest is not found in"
                                        + " the empty JSON string",
                                SearchMetadataRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        if ((jsonObj.get("dependent_object_version") != null
                        && !jsonObj.get("dependent_object_version").isJsonNull())
                && !jsonObj.get("dependent_object_version").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `dependent_object_version` to be a primitive type"
                                    + " in the JSON string but got `%s`",
                            jsonObj.get("dependent_object_version").toString()));
        }
        ...
        if (jsonObj.get("exclude_objects") != null
                && !jsonObj.get("exclude_objects").isJsonNull()) {
            ...
            if (jsonArrayexcludeObjects != null) {
                ...
                if (!jsonObj.get("exclude_objects").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `exclude_objects` to be an array in the"
                                            + " JSON string but got `%s`",
                                    jsonObj.get("exclude_objects").toString()));
                }

                // validate the optional field `exclude_objects` (array)
                for (int i = 0; i < jsonArrayexcludeObjects.size(); i++) {
                    ExcludeMetadataListItemInput.validateJsonElement(
                            jsonArrayexcludeObjects.get(i));
                }
                ;
            }
        }
        // validate the optional field `favorite_object_options`
        if (jsonObj.get("favorite_object_options") != null
                && !jsonObj.get("favorite_object_options").isJsonNull()) {
            FavoriteObjectOptionsInput.validateJsonElement(jsonObj.get("favorite_object_options"));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("modified_by_user_identifiers") != null
                && !jsonObj.get("modified_by_user_identifiers").isJsonNull()
                && !jsonObj.get("modified_by_user_identifiers").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `modified_by_user_identifiers` to be an array in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("modified_by_user_identifiers").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SearchMetadataRequest>() {
                        @Override
                        public void write(JsonWriter out, SearchMetadataRequest value)
                                throws IOException {
                        ...
                        public SearchMetadataRequest read(JsonReader in) throws IOException {
                            ...
                            SearchMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
