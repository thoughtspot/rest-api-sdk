...
public class SearchMetadataRequest implements Serializable {
  ...
  public static final String SERIALIZED_NAME_INCLUDE_PERSONALISED_VIEWS = "include_personalised_views";
  ...
  public enum LiveboardResponseVersionEnum {
    ...
    public static class Adapter extends TypeAdapter<LiveboardResponseVersionEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final LiveboardResponseVersionEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public LiveboardResponseVersionEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
  ...
  public static final String SERIALIZED_NAME_LIVEBOARD_RESPONSE_VERSION = "liveboard_response_version";
  ...
  public static final String SERIALIZED_NAME_INCLUDE_ONLY_PUBLISHED_OBJECTS = "include_only_published_objects";
  ...
  public SearchMetadataRequest includePersonalisedViews(@javax.annotation.Nullable Boolean includePersonalisedViews) {
  ...
  public void setIncludePersonalisedViews(@javax.annotation.Nullable Boolean includePersonalisedViews) {
    this.includePersonalisedViews = includePersonalisedViews;
  }
  ...
  public SearchMetadataRequest liveboardResponseVersion(@javax.annotation.Nullable LiveboardResponseVersionEnum liveboardResponseVersion) {
  ...
  public void setLiveboardResponseVersion(@javax.annotation.Nullable LiveboardResponseVersionEnum liveboardResponseVersion) {
    this.liveboardResponseVersion = liveboardResponseVersion;
  }


  public SearchMetadataRequest includeOnlyPublishedObjects(@javax.annotation.Nullable Boolean includeOnlyPublishedObjects) {
  ...
  public void setIncludeOnlyPublishedObjects(@javax.annotation.Nullable Boolean includeOnlyPublishedObjects) {
    this.includeOnlyPublishedObjects = includeOnlyPublishedObjects;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, searchMetadataRequest.metadata) &&
        ...
        Objects.equals(this.liveboardResponseVersion, searchMetadataRequest.liveboardResponseVersion) &&
        Objects.equals(this.includeOnlyPublishedObjects, searchMetadataRequest.includeOnlyPublishedObjects)&&
        Objects.equals(this.additionalProperties, searchMetadataRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("liveboard_response_version") != null && !jsonObj.get("liveboard_response_version").isJsonNull()) && !jsonObj.get("liveboard_response_version").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `liveboard_response_version` to be a primitive type in the JSON string but got `%s`", jsonObj.get("liveboard_response_version").toString()));
      }
      // validate the optional field `liveboard_response_version`
      if (jsonObj.get("liveboard_response_version") != null && !jsonObj.get("liveboard_response_version").isJsonNull()) {
        LiveboardResponseVersionEnum.validateJsonElement(jsonObj.get("liveboard_response_version"));
      }
  }
