...
public class WebhookAuthApiKeyInput implements Serializable {
     ...
     * @return the WebhookAuthApiKeyInput instance itself
     */
    public WebhookAuthApiKeyInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.key, webhookAuthApiKeyInput.key)
                ...
                && Objects.equals(
                        this.additionalProperties, webhookAuthApiKeyInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookAuthApiKeyInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookAuthApiKeyInput is not found"
                                        + " in the empty JSON string",
                                WebhookAuthApiKeyInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookAuthApiKeyInput>() {
                        @Override
                        public void write(JsonWriter out, WebhookAuthApiKeyInput value)
                                throws IOException {
                        ...
                        public WebhookAuthApiKeyInput read(JsonReader in) throws IOException {
                            ...
                            WebhookAuthApiKeyInput instance = thisAdapter.fromJsonTree(jsonObj);
