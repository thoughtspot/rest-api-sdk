...
public class PngOptionsInput implements Serializable {
  ...
  public PngOptionsInput personalisedViewId(@javax.annotation.Nullable String personalisedViewId) {
   ...
   * @return the PngOptionsInput instance itself
   */
  public PngOptionsInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeCoverPage, pngOptionsInput.includeCoverPage) &&
        ...
        Objects.equals(this.additionalProperties, pngOptionsInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(includeCoverPage, includeFilterPage, personalisedViewId, imageResolution, imageScale, includeHeader, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PngOptionsInput>() {
           ...
           public PngOptionsInput read(JsonReader in) throws IOException {
             ...
             PngOptionsInput instance = thisAdapter.fromJsonTree(jsonObj);
