...
import com.thoughtspot.client.model.LiveboardContent;
...
public class LiveboardDataResponse implements Serializable {
   ...
   * @return the LiveboardDataResponse instance itself
   */
  public LiveboardDataResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataId, liveboardDataResponse.metadataId) &&
        ...
        Objects.equals(this.additionalProperties, liveboardDataResponse.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LiveboardDataResponse>() {
           ...
           public LiveboardDataResponse read(JsonReader in) throws IOException {
             ...
             LiveboardDataResponse instance = thisAdapter.fromJsonTree(jsonObj);
