...
public class ConfigureAuthSettingsRequest implements Serializable {
  ...
  public ConfigureAuthSettingsRequest clusterPreferences(@javax.annotation.Nullable AuthClusterPreferencesInput clusterPreferences) {
  ...
  public void setClusterPreferences(@javax.annotation.Nullable AuthClusterPreferencesInput clusterPreferences) {
    this.clusterPreferences = clusterPreferences;
  }


  public ConfigureAuthSettingsRequest orgPreferences(@javax.annotation.Nullable List<AuthOrgPreferenceInput> orgPreferences) {
    this.orgPreferences = orgPreferences;
    return this;
  }

  public ConfigureAuthSettingsRequest addOrgPreferencesItem(AuthOrgPreferenceInput orgPreferencesItem) {
  ...
  public void setOrgPreferences(@javax.annotation.Nullable List<AuthOrgPreferenceInput> orgPreferences) {
    this.orgPreferences = orgPreferences;
  }
  ...
  public boolean equals(Object o) {
    ...
    ConfigureAuthSettingsRequest configureAuthSettingsRequest = (ConfigureAuthSettingsRequest) o;
    return Objects.equals(this.authType, configureAuthSettingsRequest.authType) &&
        Objects.equals(this.clusterPreferences, configureAuthSettingsRequest.clusterPreferences) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to ConfigureAuthSettingsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConfigureAuthSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigureAuthSettingsRequest is not found in the empty JSON string", ConfigureAuthSettingsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigureAuthSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigureAuthSettingsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigureAuthSettingsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigureAuthSettingsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigureAuthSettingsRequest>() {
           @Override
           public void write(JsonWriter out, ConfigureAuthSettingsRequest value) throws IOException {
           ...
           public ConfigureAuthSettingsRequest read(JsonReader in) throws IOException {
             ...
             ConfigureAuthSettingsRequest instance = thisAdapter.fromJsonTree(jsonObj);
