...
public class SortOption implements Serializable {
     ...
     * @return the SortOption instance itself
     */
    public SortOption putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.fieldName, sortOption.fieldName)
                ...
                && Objects.equals(this.additionalProperties, sortOption.additionalProperties);
    }
        ...
        if (jsonElement == null) {
            if (!SortOption.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SortOption is not found in the empty"
                                        + " JSON string",
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SortOption>() {
                        ...
                        public SortOption read(JsonReader in) throws IOException {
                            ...
                            SortOption instance = thisAdapter.fromJsonTree(jsonObj);
