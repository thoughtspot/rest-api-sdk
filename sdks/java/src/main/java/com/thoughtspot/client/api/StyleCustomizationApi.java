...
import com.thoughtspot.client.model.AppColorThemeInput;
...
public class StyleCustomizationApi {
     ...
     */
    public okhttp3.Call deleteStyleFontsCall(DeleteStyleFontsRequest deleteStyleFontsRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteStyleFontsValidateBeforeCall(DeleteStyleFontsRequest deleteStyleFontsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'deleteStyleFontsRequest' is set
        if (deleteStyleFontsRequest == null) {
            throw new ApiException("Missing the required parameter 'deleteStyleFontsRequest' when calling deleteStyleFonts(Async)");
        }
     ...
     */
    public StyleFontDeleteData deleteStyleFonts(DeleteStyleFontsRequest deleteStyleFontsRequest) throws ApiException {
        ApiResponse<StyleFontDeleteData> localVarResp = deleteStyleFontsWithHttpInfo(deleteStyleFontsRequest);
     ...
     */
    public ApiResponse<StyleFontDeleteData> deleteStyleFontsWithHttpInfo(DeleteStyleFontsRequest deleteStyleFontsRequest) throws ApiException {
        okhttp3.Call localVarCall = deleteStyleFontsValidateBeforeCall(deleteStyleFontsRequest, null);
     ...
     */
    public okhttp3.Call deleteStyleFontsAsync(DeleteStyleFontsRequest deleteStyleFontsRequest, final ApiCallback<StyleFontDeleteData> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteStyleFontsValidateBeforeCall(deleteStyleFontsRequest, _callback);
        Type localVarReturnType = new TypeToken<StyleFontDeleteData>(){}.getType();
     ...
     */
    public okhttp3.Call exportStyleLogosCall(ExportStyleLogosRequest exportStyleLogosRequest, String accept, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call exportStyleLogosValidateBeforeCall(ExportStyleLogosRequest exportStyleLogosRequest, String accept, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'exportStyleLogosRequest' is set
        if (exportStyleLogosRequest == null) {
            throw new ApiException("Missing the required parameter 'exportStyleLogosRequest' when calling exportStyleLogos(Async)");
        }
     ...
     */
    public File exportStyleLogos(ExportStyleLogosRequest exportStyleLogosRequest, String accept) throws ApiException {
        ApiResponse<File> localVarResp = exportStyleLogosWithHttpInfo(exportStyleLogosRequest, accept);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<File> exportStyleLogosWithHttpInfo(ExportStyleLogosRequest exportStyleLogosRequest, String accept) throws ApiException {
        okhttp3.Call localVarCall = exportStyleLogosValidateBeforeCall(exportStyleLogosRequest, accept, null);
     ...
     */
    public okhttp3.Call exportStyleLogosAsync(ExportStyleLogosRequest exportStyleLogosRequest, String accept, final ApiCallback<File> _callback) throws ApiException {

        okhttp3.Call localVarCall = exportStyleLogosValidateBeforeCall(exportStyleLogosRequest, accept, _callback);
        Type localVarReturnType = new TypeToken<File>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call searchStyleCustomizationsCall(SearchStyleCustomizationsRequest searchStyleCustomizationsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchStyleCustomizationsValidateBeforeCall(SearchStyleCustomizationsRequest searchStyleCustomizationsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'searchStyleCustomizationsRequest' is set
        if (searchStyleCustomizationsRequest == null) {
            throw new ApiException("Missing the required parameter 'searchStyleCustomizationsRequest' when calling searchStyleCustomizations(Async)");
        }
     ...
     */
    public List<StylePreference> searchStyleCustomizations(SearchStyleCustomizationsRequest searchStyleCustomizationsRequest) throws ApiException {
        ApiResponse<List<StylePreference>> localVarResp = searchStyleCustomizationsWithHttpInfo(searchStyleCustomizationsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<StylePreference>> searchStyleCustomizationsWithHttpInfo(SearchStyleCustomizationsRequest searchStyleCustomizationsRequest) throws ApiException {
        okhttp3.Call localVarCall = searchStyleCustomizationsValidateBeforeCall(searchStyleCustomizationsRequest, null);
     ...
     */
    public okhttp3.Call searchStyleCustomizationsAsync(SearchStyleCustomizationsRequest searchStyleCustomizationsRequest, final ApiCallback<List<StylePreference>> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchStyleCustomizationsValidateBeforeCall(searchStyleCustomizationsRequest, _callback);
        Type localVarReturnType = new TypeToken<List<StylePreference>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call searchStyleFontsCall(SearchStyleFontsRequest searchStyleFontsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchStyleFontsValidateBeforeCall(SearchStyleFontsRequest searchStyleFontsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'searchStyleFontsRequest' is set
        if (searchStyleFontsRequest == null) {
            throw new ApiException("Missing the required parameter 'searchStyleFontsRequest' when calling searchStyleFonts(Async)");
        }
     ...
     */
    public List<StyleFontRecord> searchStyleFonts(SearchStyleFontsRequest searchStyleFontsRequest) throws ApiException {
        ApiResponse<List<StyleFontRecord>> localVarResp = searchStyleFontsWithHttpInfo(searchStyleFontsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<StyleFontRecord>> searchStyleFontsWithHttpInfo(SearchStyleFontsRequest searchStyleFontsRequest) throws ApiException {
        okhttp3.Call localVarCall = searchStyleFontsValidateBeforeCall(searchStyleFontsRequest, null);
     ...
     */
    public okhttp3.Call searchStyleFontsAsync(SearchStyleFontsRequest searchStyleFontsRequest, final ApiCallback<List<StyleFontRecord>> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchStyleFontsValidateBeforeCall(searchStyleFontsRequest, _callback);
        Type localVarReturnType = new TypeToken<List<StyleFontRecord>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param operation Operation to perform. REPLACE (default) applies the provided fields and leaves omitted fields unchanged. RESET reverts fields listed in reset_options to defaults. (optional, default to REPLACE)
     * @param resetOptions Fields to reset when operation is RESET. Specify style fields and visualization areas to revert to defaults. (optional)
     * @param navigationPanel Navigation panel color. Provide theme and, when theme is CUSTOM, also provide base_color. Must not be provided together with app_color_theme -- both update the same underlying color. (optional)
     * @param appColorTheme App color theme -- the same underlying color navigation_panel sets, expressed as a brand color plus how it is applied. brand_color and apply_as_top_nav_color may be set independently; each is left unchanged if omitted. To clear the brand color, use operation RESET with reset_options.style: [\\\&quot;APP_COLOR_THEME\\\&quot;]. Supported only when the app color theme is enabled on the cluster. Must not be provided together with navigation_panel.    Version: 26.10.0.cl or later  (optional)
     * @param chartColorPalette Chart color palette. When provided with operation REPLACE, exactly 8 color entries must be specified in colors. (optional)
     * @param embeddedFooterText Custom footer text for the embedded application. An empty string clears the footer. (optional)
     * @param visualizationFonts Font assignments per visualization area. Provide only the areas to update; omitted areas remain unchanged. (optional)
     * @param defaultLogo Binary image for the DEFAULT logo slot (square app icon and favicon; recommended 140x140 px). Accepted formats: PNG, JPG. (optional)
     * @param wideLogo Binary image for the WIDE logo slot (horizontal top nav bar logo; recommended 230x45 px). Accepted formats: PNG, JPG. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updateStyleCustomizationCall(String scope, String operation, StyleResetOptionsInput resetOptions, NavigationPanelInput navigationPanel, AppColorThemeInput appColorTheme, StyleColorPaletteInput chartColorPalette, String embeddedFooterText, VisualizationFontsInput visualizationFonts, File defaultLogo, File wideLogo, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        if (appColorTheme != null) {
            localVarFormParams.put("app_color_theme", appColorTheme);
        }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateStyleCustomizationValidateBeforeCall(String scope, String operation, StyleResetOptionsInput resetOptions, NavigationPanelInput navigationPanel, AppColorThemeInput appColorTheme, StyleColorPaletteInput chartColorPalette, String embeddedFooterText, VisualizationFontsInput visualizationFonts, File defaultLogo, File wideLogo, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling updateStyleCustomization(Async)");
        }

        return updateStyleCustomizationCall(scope, operation, resetOptions, navigationPanel, appColorTheme, chartColorPalette, embeddedFooterText, visualizationFonts, defaultLogo, wideLogo, _callback);
     ...
     */
    public void updateStyleCustomization(String scope, String operation, StyleResetOptionsInput resetOptions, NavigationPanelInput navigationPanel, AppColorThemeInput appColorTheme, StyleColorPaletteInput chartColorPalette, String embeddedFooterText, VisualizationFontsInput visualizationFonts, File defaultLogo, File wideLogo) throws ApiException {
        updateStyleCustomizationWithHttpInfo(scope, operation, resetOptions, navigationPanel, appColorTheme, chartColorPalette, embeddedFooterText, visualizationFonts, defaultLogo, wideLogo);
    }
     ...
     */
    public ApiResponse<Void> updateStyleCustomizationWithHttpInfo(String scope, String operation, StyleResetOptionsInput resetOptions, NavigationPanelInput navigationPanel, AppColorThemeInput appColorTheme, StyleColorPaletteInput chartColorPalette, String embeddedFooterText, VisualizationFontsInput visualizationFonts, File defaultLogo, File wideLogo) throws ApiException {
        okhttp3.Call localVarCall = updateStyleCustomizationValidateBeforeCall(scope, operation, resetOptions, navigationPanel, appColorTheme, chartColorPalette, embeddedFooterText, visualizationFonts, defaultLogo, wideLogo, null);
     ...
     */
    public okhttp3.Call updateStyleCustomizationAsync(String scope, String operation, StyleResetOptionsInput resetOptions, NavigationPanelInput navigationPanel, AppColorThemeInput appColorTheme, StyleColorPaletteInput chartColorPalette, String embeddedFooterText, VisualizationFontsInput visualizationFonts, File defaultLogo, File wideLogo, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateStyleCustomizationValidateBeforeCall(scope, operation, resetOptions, navigationPanel, appColorTheme, chartColorPalette, embeddedFooterText, visualizationFonts, defaultLogo, wideLogo, _callback);
     ...
     */
    public okhttp3.Call updateStyleFontCall(String fontIdentifier, UpdateStyleFontRequest updateStyleFontRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/customization/styles/fonts/{font_identifier}/update"
            .replace("{" + "font_identifier" + "}", localVarApiClient.escapeString(fontIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateStyleFontValidateBeforeCall(String fontIdentifier, UpdateStyleFontRequest updateStyleFontRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'fontIdentifier' is set
        if (fontIdentifier == null) {
            throw new ApiException("Missing the required parameter 'fontIdentifier' when calling updateStyleFont(Async)");
        }

        // verify the required parameter 'updateStyleFontRequest' is set
        if (updateStyleFontRequest == null) {
            throw new ApiException("Missing the required parameter 'updateStyleFontRequest' when calling updateStyleFont(Async)");
        }
     ...
     */
    public void updateStyleFont(String fontIdentifier, UpdateStyleFontRequest updateStyleFontRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateStyleFontWithHttpInfo(String fontIdentifier, UpdateStyleFontRequest updateStyleFontRequest) throws ApiException {
        okhttp3.Call localVarCall = updateStyleFontValidateBeforeCall(fontIdentifier, updateStyleFontRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateStyleFontAsync(String fontIdentifier, UpdateStyleFontRequest updateStyleFontRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateStyleFontValidateBeforeCall(fontIdentifier, updateStyleFontRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     ...
     * @param fileContent Binary WOFF or WOFF2 font file to upload. Only WOFF and WOFF2 formats are accepted; TTF and OTF are rejected. The file is validated on upload. (required)
     * @param scope Scope of the font library to upload to. CLUSTER uploads to the cluster-level library, making the font available as a default for all orgs. ORG uploads to the authenticated user&#39;s org library. Defaults to ORG if omitted. (optional, default to ORG)
     * @param weight Weight of the font. Supported values: NORMAL, LIGHT, BOLD. Defaults to NORMAL if omitted. (optional, default to NORMAL)
     * @param style Style of the font. Supported values: NORMAL, ITALIC, OBLIQUE. Defaults to NORMAL if omitted. (optional, default to NORMAL)
     * @param color Color of the font as a 6-digit hex string (e.g. \\\&quot;#333333\\\&quot;). Defaults to #000000 (black) if omitted. Returns an error if the value is malformed. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call uploadStyleFontCall(String name, File fileContent, String scope, String weight, String style, String color, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call uploadStyleFontValidateBeforeCall(String name, File fileContent, String scope, String weight, String style, String color, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling uploadStyleFont(Async)");
        }

        // verify the required parameter 'fileContent' is set
        if (fileContent == null) {
            throw new ApiException("Missing the required parameter 'fileContent' when calling uploadStyleFont(Async)");
        }
     ...
     */
    public StyleFontUploadData uploadStyleFont(String name, File fileContent, String scope, String weight, String style, String color) throws ApiException {
        ApiResponse<StyleFontUploadData> localVarResp = uploadStyleFontWithHttpInfo(name, fileContent, scope, weight, style, color);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<StyleFontUploadData> uploadStyleFontWithHttpInfo(String name, File fileContent, String scope, String weight, String style, String color) throws ApiException {
        okhttp3.Call localVarCall = uploadStyleFontValidateBeforeCall(name, fileContent, scope, weight, style, color, null);
     ...
     */
    public okhttp3.Call uploadStyleFontAsync(String name, File fileContent, String scope, String weight, String style, String color, final ApiCallback<StyleFontUploadData> _callback) throws ApiException {

        okhttp3.Call localVarCall = uploadStyleFontValidateBeforeCall(name, fileContent, scope, weight, style, color, _callback);
        Type localVarReturnType = new TypeToken<StyleFontUploadData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
