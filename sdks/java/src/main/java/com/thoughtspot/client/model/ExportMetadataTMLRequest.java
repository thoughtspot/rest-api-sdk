...
public class ExportMetadataTMLRequest implements Serializable {
    ...
    /**
     * TML EDOC content format. **Note: exporting in YAML format currently requires manual
     * formatting of the output. For more details on the workaround, please click
    ...
    public enum ExportSchemaVersionEnum {
        ...
        public static class Adapter extends TypeAdapter<ExportSchemaVersionEnum> {
            @Override
            public void write(
                    final JsonWriter jsonWriter, final ExportSchemaVersionEnum enumeration)
                    throws IOException {
                jsonWriter.value(enumeration.getValue());
            }
    ...
    public static final String SERIALIZED_NAME_EXPORT_CONNECTION_AS_DEPENDENT =
    ...
    public ExportMetadataTMLRequest metadata(
            @javax.annotation.Nonnull List<ExportMetadataTypeInput> metadata) {
    ...
    public ExportMetadataTMLRequest exportAssociated(
            @javax.annotation.Nullable Boolean exportAssociated) {
    ...
    /**
     * Adds FQNs of the referenced objects. For example, if you are exporting a Liveboard and its
     * associated objects, the API returns the Liveboard TML data with the FQNs of the referenced
     * worksheet. If the exported TML data includes FQNs, you don&#39;t need to manually add FQNs of
     * the referenced objects during TML import.
     *
     * @return exportFqn
     */
    @javax.annotation.Nullable
    ...
    public ExportMetadataTMLRequest edocFormat(
    ...
    public ExportMetadataTMLRequest exportSchemaVersion(
            @javax.annotation.Nullable ExportSchemaVersionEnum exportSchemaVersion) {
    ...
    public void setExportSchemaVersion(
            @javax.annotation.Nullable ExportSchemaVersionEnum exportSchemaVersion) {
        this.exportSchemaVersion = exportSchemaVersion;
    }

    public ExportMetadataTMLRequest exportDependent(
    ...
    public ExportMetadataTMLRequest exportConnectionAsDependent(
            @javax.annotation.Nullable Boolean exportConnectionAsDependent) {
        this.exportConnectionAsDependent = exportConnectionAsDependent;
        return this;
    }

    /**
     * Indicates whether to export connection as dependent while exporting
     * table/worksheet/answer/liveboard. This will only be active when export_associated is true.
     *
    ...
    public void setExportConnectionAsDependent(
            @javax.annotation.Nullable Boolean exportConnectionAsDependent) {
        this.exportConnectionAsDependent = exportConnectionAsDependent;
    }

    public ExportMetadataTMLRequest allOrgsOverride(
    ...
    public ExportMetadataTMLRequest exportOptions(
            @javax.annotation.Nullable ExportOptions exportOptions) {
     ...
     * @return the ExportMetadataTMLRequest instance itself
     */
    public ExportMetadataTMLRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadata, exportMetadataTMLRequest.metadata)
                ...
                && Objects.equals(
                        this.exportSchemaVersion, exportMetadataTMLRequest.exportSchemaVersion)
                && Objects.equals(this.exportDependent, exportMetadataTMLRequest.exportDependent)
                && Objects.equals(
                        this.exportConnectionAsDependent,
                        exportMetadataTMLRequest.exportConnectionAsDependent)
                ...
                && Objects.equals(
                        this.additionalProperties, exportMetadataTMLRequest.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    exportSchemaVersion: ")
                .append(toIndentedString(exportSchemaVersion))
                .append("\n");
        sb.append("    exportDependent: ").append(toIndentedString(exportDependent)).append("\n");
        sb.append("    exportConnectionAsDependent: ")
                .append(toIndentedString(exportConnectionAsDependent))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExportMetadataTMLRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ExportMetadataTMLRequest is not found"
                                        + " in the empty JSON string",
                                ExportMetadataTMLRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        if ((jsonObj.get("export_schema_version") != null
                        && !jsonObj.get("export_schema_version").isJsonNull())
                && !jsonObj.get("export_schema_version").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `export_schema_version` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("export_schema_version").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExportMetadataTMLRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExportMetadataTMLRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ExportMetadataTMLRequest>() {
                        @Override
                        public void write(JsonWriter out, ExportMetadataTMLRequest value)
                                throws IOException {
                        ...
                        public ExportMetadataTMLRequest read(JsonReader in) throws IOException {
                            ...
                            ExportMetadataTMLRequest instance = thisAdapter.fromJsonTree(jsonObj);
