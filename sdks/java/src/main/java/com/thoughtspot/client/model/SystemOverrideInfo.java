...
public class SystemOverrideInfo implements Serializable {
  ...
  public SystemOverrideInfo configOverrideInfo(@javax.annotation.Nullable Object configOverrideInfo) {
   ...
   * @return the SystemOverrideInfo instance itself
   */
  public SystemOverrideInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configOverrideInfo, systemOverrideInfo.configOverrideInfo)&&
        Objects.equals(this.additionalProperties, systemOverrideInfo.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configOverrideInfo, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SystemOverrideInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SystemOverrideInfo is not found in the empty JSON string", SystemOverrideInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SystemOverrideInfo>() {
           @Override
           public void write(JsonWriter out, SystemOverrideInfo value) throws IOException {
           ...
           public SystemOverrideInfo read(JsonReader in) throws IOException {
             ...
             SystemOverrideInfo instance = thisAdapter.fromJsonTree(jsonObj);
