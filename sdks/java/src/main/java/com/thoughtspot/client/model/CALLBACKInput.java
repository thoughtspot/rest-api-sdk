...
public class CALLBACKInput implements Serializable {
     ...
     * @return the CALLBACKInput instance itself
     */
    public CALLBACKInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.reference, caLLBACKInput.reference)
                && Objects.equals(this.additionalProperties, caLLBACKInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CALLBACKInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CALLBACKInput is not found in the"
                                        + " empty JSON string",
                                CALLBACKInput.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CALLBACKInput>() {
                        ...
                        public CALLBACKInput read(JsonReader in) throws IOException {
                            ...
                            CALLBACKInput instance = thisAdapter.fromJsonTree(jsonObj);
