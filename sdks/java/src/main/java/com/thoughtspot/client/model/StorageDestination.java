...
import com.thoughtspot.client.model.StorageConfig;
...
public class StorageDestination implements Serializable {
   ...
   * @return the StorageDestination instance itself
   */
  public StorageDestination putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.storageType, storageDestination.storageType) &&
        ...
        Objects.equals(this.additionalProperties, storageDestination.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageDestination.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StorageDestination is not found in the empty JSON string", StorageDestination.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StorageDestination>() {
           @Override
           public void write(JsonWriter out, StorageDestination value) throws IOException {
           ...
           public StorageDestination read(JsonReader in) throws IOException {
             ...
             StorageDestination instance = thisAdapter.fromJsonTree(jsonObj);
