...
public class RecipientDetailsInput implements Serializable {
    ...
    public RecipientDetailsInput principals(
            @javax.annotation.Nullable List<PrincipalsListItemInput> principals) {
     ...
     * @return the RecipientDetailsInput instance itself
     */
    public RecipientDetailsInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.emails, recipientDetailsInput.emails)
                ...
                && Objects.equals(
                        this.additionalProperties, recipientDetailsInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RecipientDetailsInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in RecipientDetailsInput is not found in"
                                        + " the empty JSON string",
                                RecipientDetailsInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<RecipientDetailsInput>() {
                        @Override
                        public void write(JsonWriter out, RecipientDetailsInput value)
                                throws IOException {
                        ...
                        public RecipientDetailsInput read(JsonReader in) throws IOException {
                            ...
                            RecipientDetailsInput instance = thisAdapter.fromJsonTree(jsonObj);
