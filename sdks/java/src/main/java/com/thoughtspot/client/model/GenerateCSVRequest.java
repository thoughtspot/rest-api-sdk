...
public class GenerateCSVRequest implements Serializable {
  ...
  public GenerateCSVRequest calendarType(@javax.annotation.Nullable CalendarTypeEnum calendarType) {
  ...
  public GenerateCSVRequest startDayOfWeek(@javax.annotation.Nullable StartDayOfWeekEnum startDayOfWeek) {
  ...
  public GenerateCSVRequest quarterNamePrefix(@javax.annotation.Nullable String quarterNamePrefix) {
   ...
   * @return the GenerateCSVRequest instance itself
   */
  public GenerateCSVRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.startDate, generateCSVRequest.startDate) &&
        ...
        Objects.equals(this.additionalProperties, generateCSVRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startDate, endDate, calendarType, monthOffset, startDayOfWeek, quarterNamePrefix, yearNamePrefix, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateCSVRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateCSVRequest is not found in the empty JSON string", GenerateCSVRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GenerateCSVRequest>() {
           @Override
           public void write(JsonWriter out, GenerateCSVRequest value) throws IOException {
           ...
           public GenerateCSVRequest read(JsonReader in) throws IOException {
             ...
             GenerateCSVRequest instance = thisAdapter.fromJsonTree(jsonObj);
