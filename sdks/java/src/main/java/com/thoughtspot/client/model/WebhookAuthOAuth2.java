...
public class WebhookAuthOAuth2 implements Serializable {
   ...
   * @return the WebhookAuthOAuth2 instance itself
   */
  public WebhookAuthOAuth2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationUrl, webhookAuthOAuth2.authorizationUrl) &&
        ...
        Objects.equals(this.additionalProperties, webhookAuthOAuth2.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookAuthOAuth2.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookAuthOAuth2 is not found in the empty JSON string", WebhookAuthOAuth2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookAuthOAuth2>() {
           @Override
           public void write(JsonWriter out, WebhookAuthOAuth2 value) throws IOException {
           ...
           public WebhookAuthOAuth2 read(JsonReader in) throws IOException {
             ...
             WebhookAuthOAuth2 instance = thisAdapter.fromJsonTree(jsonObj);
