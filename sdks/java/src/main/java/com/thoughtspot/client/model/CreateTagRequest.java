...
public class CreateTagRequest implements Serializable {
     ...
     * @return the CreateTagRequest instance itself
     */
    public CreateTagRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, createTagRequest.name)
                ...
                && Objects.equals(this.additionalProperties, createTagRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateTagRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateTagRequest is not found in the"
                                        + " empty JSON string",
                                CreateTagRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CreateTagRequest>() {
                        @Override
                        public void write(JsonWriter out, CreateTagRequest value)
                                throws IOException {
                        ...
                        public CreateTagRequest read(JsonReader in) throws IOException {
                            ...
                            CreateTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
