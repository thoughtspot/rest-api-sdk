...
public class DefaultActionConfigInputCreate implements Serializable {
  ...
  public DefaultActionConfigInputCreate visibility(@javax.annotation.Nullable Boolean visibility) {
   ...
   * @return the DefaultActionConfigInputCreate instance itself
   */
  public DefaultActionConfigInputCreate putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visibility, defaultActionConfigInputCreate.visibility)&&
        Objects.equals(this.additionalProperties, defaultActionConfigInputCreate.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DefaultActionConfigInputCreate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefaultActionConfigInputCreate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DefaultActionConfigInputCreate>() {
           ...
           public DefaultActionConfigInputCreate read(JsonReader in) throws IOException {
             ...
             DefaultActionConfigInputCreate instance = thisAdapter.fromJsonTree(jsonObj);
