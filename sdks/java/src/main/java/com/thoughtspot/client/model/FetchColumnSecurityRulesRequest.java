...
import com.thoughtspot.client.model.ColumnSecurityRuleTableInput;
...
public class FetchColumnSecurityRulesRequest implements Serializable {
  ...
  public FetchColumnSecurityRulesRequest tables(@javax.annotation.Nonnull List<ColumnSecurityRuleTableInput> tables) {
    this.tables = tables;
    return this;
  }
   ...
   * @return the FetchColumnSecurityRulesRequest instance itself
   */
  public FetchColumnSecurityRulesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FetchColumnSecurityRulesRequest fetchColumnSecurityRulesRequest = (FetchColumnSecurityRulesRequest) o;
    return Objects.equals(this.tables, fetchColumnSecurityRulesRequest.tables)&&
        Objects.equals(this.additionalProperties, fetchColumnSecurityRulesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tables, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to FetchColumnSecurityRulesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FetchColumnSecurityRulesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FetchColumnSecurityRulesRequest is not found in the empty JSON string", FetchColumnSecurityRulesRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FetchColumnSecurityRulesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FetchColumnSecurityRulesRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FetchColumnSecurityRulesRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FetchColumnSecurityRulesRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<FetchColumnSecurityRulesRequest>() {
           @Override
           public void write(JsonWriter out, FetchColumnSecurityRulesRequest value) throws IOException {
           ...
           @Override
           public FetchColumnSecurityRulesRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             FetchColumnSecurityRulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to FetchColumnSecurityRulesRequest
   */
