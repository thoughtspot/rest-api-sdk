...
import com.thoughtspot.client.model.OrgChannelConfigResponse;
...
public class CommunicationChannelPreferencesResponse implements Serializable {
  ...
  public CommunicationChannelPreferencesResponse clusterPreferences(@javax.annotation.Nullable List<EventChannelConfig> clusterPreferences) {
    this.clusterPreferences = clusterPreferences;
    return this;
  }

  public CommunicationChannelPreferencesResponse addClusterPreferencesItem(EventChannelConfig clusterPreferencesItem) {
  ...
  public void setClusterPreferences(@javax.annotation.Nullable List<EventChannelConfig> clusterPreferences) {
    this.clusterPreferences = clusterPreferences;
  }


  public CommunicationChannelPreferencesResponse orgPreferences(@javax.annotation.Nullable List<OrgChannelConfigResponse> orgPreferences) {
    this.orgPreferences = orgPreferences;
    return this;
  }

  public CommunicationChannelPreferencesResponse addOrgPreferencesItem(OrgChannelConfigResponse orgPreferencesItem) {
  ...
  public void setOrgPreferences(@javax.annotation.Nullable List<OrgChannelConfigResponse> orgPreferences) {
    this.orgPreferences = orgPreferences;
  }
   ...
   * @return the CommunicationChannelPreferencesResponse instance itself
   */
  public CommunicationChannelPreferencesResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommunicationChannelPreferencesResponse communicationChannelPreferencesResponse = (CommunicationChannelPreferencesResponse) o;
    return Objects.equals(this.clusterPreferences, communicationChannelPreferencesResponse.clusterPreferences) &&
        Objects.equals(this.orgPreferences, communicationChannelPreferencesResponse.orgPreferences)&&
        Objects.equals(this.additionalProperties, communicationChannelPreferencesResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommunicationChannelPreferencesResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationChannelPreferencesResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommunicationChannelPreferencesResponse is not found in the empty JSON string", CommunicationChannelPreferencesResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommunicationChannelPreferencesResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommunicationChannelPreferencesResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommunicationChannelPreferencesResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommunicationChannelPreferencesResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CommunicationChannelPreferencesResponse>() {
           @Override
           public void write(JsonWriter out, CommunicationChannelPreferencesResponse value) throws IOException {
           ...
           @Override
           public CommunicationChannelPreferencesResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CommunicationChannelPreferencesResponse instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to CommunicationChannelPreferencesResponse
   */
  public static CommunicationChannelPreferencesResponse fromJson(String jsonString) throws IOException {
