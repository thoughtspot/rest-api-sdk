...
public class ResponseIncompleteEntity implements Serializable {
   ...
   * @return the ResponseIncompleteEntity instance itself
   */
  public ResponseIncompleteEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, responseIncompleteEntity.id) &&
        ...
        Objects.equals(this.additionalProperties, responseIncompleteEntity.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseIncompleteEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseIncompleteEntity>() {
           ...
           public ResponseIncompleteEntity read(JsonReader in) throws IOException {
             ...
             ResponseIncompleteEntity instance = thisAdapter.fromJsonTree(jsonObj);
