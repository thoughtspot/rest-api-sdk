...
public class VariableUpdateScopeInput implements Serializable {
  ...
  public VariableUpdateScopeInput principalType(@javax.annotation.Nullable PrincipalTypeEnum principalType) {
  ...
  public VariableUpdateScopeInput principalIdentifier(@javax.annotation.Nullable String principalIdentifier) {
  ...
  public VariableUpdateScopeInput modelIdentifier(@javax.annotation.Nullable String modelIdentifier) {
   ...
   * @return the VariableUpdateScopeInput instance itself
   */
  public VariableUpdateScopeInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orgIdentifier, variableUpdateScopeInput.orgIdentifier) &&
        ...
        Objects.equals(this.principalIdentifier, variableUpdateScopeInput.principalIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, variableUpdateScopeInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(orgIdentifier, principalType, principalIdentifier, modelIdentifier, priority, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VariableUpdateScopeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VariableUpdateScopeInput is not found in the empty JSON string", VariableUpdateScopeInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VariableUpdateScopeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VariableUpdateScopeInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<VariableUpdateScopeInput>() {
           @Override
           public void write(JsonWriter out, VariableUpdateScopeInput value) throws IOException {
           ...
           public VariableUpdateScopeInput read(JsonReader in) throws IOException {
             ...
             VariableUpdateScopeInput instance = thisAdapter.fromJsonTree(jsonObj);
