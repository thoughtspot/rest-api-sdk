...
public class WebhookAuthApiKey implements Serializable {
     ...
     * @return the WebhookAuthApiKey instance itself
     */
    public WebhookAuthApiKey putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.key, webhookAuthApiKey.key)
                ...
                && Objects.equals(
                        this.additionalProperties, webhookAuthApiKey.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookAuthApiKey.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookAuthApiKey is not found in the"
                                        + " empty JSON string",
                                WebhookAuthApiKey.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookAuthApiKey>() {
                        @Override
                        public void write(JsonWriter out, WebhookAuthApiKey value)
                                throws IOException {
                        ...
                        public WebhookAuthApiKey read(JsonReader in) throws IOException {
                            ...
                            WebhookAuthApiKey instance = thisAdapter.fromJsonTree(jsonObj);
