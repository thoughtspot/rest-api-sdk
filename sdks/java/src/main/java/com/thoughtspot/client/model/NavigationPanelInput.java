...
public class NavigationPanelInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.theme, navigationPanelInput.theme) &&
        ...
        Objects.equals(this.additionalProperties, navigationPanelInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!NavigationPanelInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NavigationPanelInput is not found in the empty JSON string", NavigationPanelInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("base_color") != null && !jsonObj.get("base_color").isJsonNull()) && !jsonObj.get("base_color").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `base_color` to be a primitive type in the JSON string but got `%s`", jsonObj.get("base_color").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<NavigationPanelInput>() {
           @Override
           public void write(JsonWriter out, NavigationPanelInput value) throws IOException {
