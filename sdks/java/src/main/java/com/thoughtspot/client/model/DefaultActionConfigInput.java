...
public class DefaultActionConfigInput implements Serializable {
     ...
     * @return the DefaultActionConfigInput instance itself
     */
    public DefaultActionConfigInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.visibility, defaultActionConfigInput.visibility)
                && Objects.equals(
                        this.additionalProperties, defaultActionConfigInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DefaultActionConfigInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DefaultActionConfigInput is not found"
                                        + " in the empty JSON string",
                                DefaultActionConfigInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DefaultActionConfigInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DefaultActionConfigInput' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DefaultActionConfigInput>() {
                        @Override
                        public void write(JsonWriter out, DefaultActionConfigInput value)
                                throws IOException {
                        ...
                        public DefaultActionConfigInput read(JsonReader in) throws IOException {
                            ...
                            DefaultActionConfigInput instance = thisAdapter.fromJsonTree(jsonObj);
