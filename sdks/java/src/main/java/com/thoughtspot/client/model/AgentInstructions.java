...
public class AgentInstructions implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, agentInstructions.id) &&
        ...
        Objects.equals(this.additionalProperties, agentInstructions.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, instructions, createdAt, updatedAt, lastUpdatedBy, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentInstructions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentInstructions is not found in the empty JSON string", AgentInstructions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AgentInstructions>() {
           @Override
           public void write(JsonWriter out, AgentInstructions value) throws IOException {
