...
public class PolicyProcessOptions implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.impersonateUser, policyProcessOptions.impersonateUser)&&
        Objects.equals(this.additionalProperties, policyProcessOptions.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PolicyProcessOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PolicyProcessOptions is not found in the empty JSON string", PolicyProcessOptions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PolicyProcessOptions>() {
           @Override
           public void write(JsonWriter out, PolicyProcessOptions value) throws IOException {
