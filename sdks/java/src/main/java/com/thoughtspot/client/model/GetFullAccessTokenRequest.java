...
public class GetFullAccessTokenRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.username, getFullAccessTokenRequest.username) &&
        ...
        Objects.equals(this.additionalProperties, getFullAccessTokenRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(username, password, secretKey, validityTimeInSec, orgId, email, displayName, autoCreate, groupIdentifiers, userParameters, additionalProperties);
  }
