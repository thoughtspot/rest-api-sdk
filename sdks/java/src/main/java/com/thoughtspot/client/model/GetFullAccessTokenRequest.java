...
public class GetFullAccessTokenRequest implements Serializable {
    ...
    public GetFullAccessTokenRequest validityTimeInSec(
    ...
    /**
     * Indicates display name of the user. Use this parameter to provision a user just-in-time
     * (JIT).
     *
     * @return displayName
     */
    ...
    /**
     * Creates a new user if the specified username does not already exist in ThoughtSpot. To
     * provision a user just-in-time (JIT), set this attribute to true. Note: For JIT provisioning
     * of a user, the secret_key is required.
     *
     * @return autoCreate
     */
    @javax.annotation.Nullable
    ...
    public GetFullAccessTokenRequest groupIdentifiers(
    ...
    /**
     * ID or name of the groups to which the newly created user belongs. Use this parameter to
     * provision a user just-in-time (JIT).
     *
     ...
     * @return the GetFullAccessTokenRequest instance itself
     */
    public GetFullAccessTokenRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.username, getFullAccessTokenRequest.username)
                ...
                && Objects.equals(
                        this.additionalProperties, getFullAccessTokenRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetFullAccessTokenRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetFullAccessTokenRequest is not"
                                        + " found in the empty JSON string",
                                GetFullAccessTokenRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetFullAccessTokenRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetFullAccessTokenRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<GetFullAccessTokenRequest>() {
                        @Override
                        public void write(JsonWriter out, GetFullAccessTokenRequest value)
                                throws IOException {
                        ...
                        public GetFullAccessTokenRequest read(JsonReader in) throws IOException {
                            ...
                            GetFullAccessTokenRequest instance = thisAdapter.fromJsonTree(jsonObj);
