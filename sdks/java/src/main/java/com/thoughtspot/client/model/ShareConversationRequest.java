...
import com.thoughtspot.client.model.PrincipalRefInput;
...
public class ShareConversationRequest implements Serializable {
  ...
  public ShareConversationRequest refreshSharedContent(@javax.annotation.Nullable Boolean refreshSharedContent) {
  ...
  public ShareConversationRequest revoke(@javax.annotation.Nonnull List<PrincipalRefInput> revoke) {
    this.revoke = revoke;
    return this;
  }
  ...
  public ShareConversationRequest notifyOnShare(@javax.annotation.Nullable Boolean notifyOnShare) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.refreshSharedContent, shareConversationRequest.refreshSharedContent) &&
        ...
        Objects.equals(this.additionalProperties, shareConversationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(refreshSharedContent, grant, revoke, notifyOnShare, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    refreshSharedContent: ").append(toIndentedString(refreshSharedContent)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ShareConversationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShareConversationRequest is not found in the empty JSON string", ShareConversationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("grant").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `grant` to be an array in the JSON string but got `%s`", jsonObj.get("grant").toString()));
      }
      ...
      if (!jsonObj.get("revoke").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `revoke` to be an array in the JSON string but got `%s`", jsonObj.get("revoke").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShareConversationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShareConversationRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ShareConversationRequest>() {
           @Override
           public void write(JsonWriter out, ShareConversationRequest value) throws IOException {
