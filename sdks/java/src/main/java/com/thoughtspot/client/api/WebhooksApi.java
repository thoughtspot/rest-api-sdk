...
public class WebhooksApi {
     ...
     */
    public okhttp3.Call getWebhookStorageConfigCall(final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getWebhookStorageConfigValidateBeforeCall(final ApiCallback _callback) throws ApiException {
    ...
    public List<WebhookStorageConfigInfo> getWebhookStorageConfig() throws ApiException {
        ApiResponse<List<WebhookStorageConfigInfo>> localVarResp = getWebhookStorageConfigWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<WebhookStorageConfigInfo>> getWebhookStorageConfigWithHttpInfo() throws ApiException {
     ...
     */
    public okhttp3.Call getWebhookStorageConfigAsync(final ApiCallback<List<WebhookStorageConfigInfo>> _callback) throws ApiException {
