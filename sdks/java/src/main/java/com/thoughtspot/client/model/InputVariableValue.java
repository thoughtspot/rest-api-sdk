...
public class InputVariableValue implements Serializable {
  ...
  public InputVariableValue principalType(@javax.annotation.Nullable PrincipalTypeEnum principalType) {
  ...
  public InputVariableValue principalIdentifier(@javax.annotation.Nullable String principalIdentifier) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!InputVariableValue.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InputVariableValue is not found in the empty JSON string", InputVariableValue.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!InputVariableValue.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InputVariableValue` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<InputVariableValue>() {
           @Override
           public void write(JsonWriter out, InputVariableValue value) throws IOException {
