...
public class DeployResponse implements Serializable {
   ...
   * @return the DeployResponse instance itself
   */
  public DeployResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileName, deployResponse.fileName) &&
        ...
        Objects.equals(this.additionalProperties, deployResponse.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeployResponse>() {
           ...
           public DeployResponse read(JsonReader in) throws IOException {
             ...
             DeployResponse instance = thisAdapter.fromJsonTree(jsonObj);
