...
public class ValidateTokenRequest implements Serializable {
   ...
   * @return the ValidateTokenRequest instance itself
   */
  public ValidateTokenRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, validateTokenRequest.token)&&
        Objects.equals(this.additionalProperties, validateTokenRequest.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidateTokenRequest>() {
           ...
           public ValidateTokenRequest read(JsonReader in) throws IOException {
             ...
             ValidateTokenRequest instance = thisAdapter.fromJsonTree(jsonObj);
