...
public class PdfOptions implements Serializable {
     ...
     * @return the PdfOptions instance itself
     */
    public PdfOptions putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.completeLiveboard, pdfOptions.completeLiveboard)
                ...
                && Objects.equals(this.additionalProperties, pdfOptions.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PdfOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PdfOptions is not found in the empty"
                                        + " JSON string",
                                PdfOptions.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<PdfOptions>() {
                        ...
                        public PdfOptions read(JsonReader in) throws IOException {
                            ...
                            PdfOptions instance = thisAdapter.fromJsonTree(jsonObj);
