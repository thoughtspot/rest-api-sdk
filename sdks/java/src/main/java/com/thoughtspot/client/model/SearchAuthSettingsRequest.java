...
public class SearchAuthSettingsRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authType, searchAuthSettingsRequest.authType) &&
        ...
        Objects.equals(this.additionalProperties, searchAuthSettingsRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchAuthSettingsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchAuthSettingsRequest is not found in the empty JSON string", SearchAuthSettingsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchAuthSettingsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchAuthSettingsRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchAuthSettingsRequest>() {
           @Override
           public void write(JsonWriter out, SearchAuthSettingsRequest value) throws IOException {
