...
import com.thoughtspot.client.model.ACState;
...
public class AnswerDetails implements Serializable {
  ...
  public AnswerDetails visualizationType(@javax.annotation.Nullable VisualizationTypeEnum visualizationType) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(title, description, sessionIdentifier, generationNumber, tokens, visualizationType, formulas, parameters, subQueries, acState, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnswerDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnswerDetails is not found in the empty JSON string", AnswerDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("formulas") != null && !jsonObj.get("formulas").isJsonNull() && !jsonObj.get("formulas").isJsonArray()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("sub_queries") != null && !jsonObj.get("sub_queries").isJsonNull() && !jsonObj.get("sub_queries").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `sub_queries` to be an array in the JSON string but got `%s`", jsonObj.get("sub_queries").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnswerDetails>() {
           @Override
