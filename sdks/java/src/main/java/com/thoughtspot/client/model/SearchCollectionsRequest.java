...
import com.thoughtspot.client.model.SortOptions;
...
public class SearchCollectionsRequest implements Serializable {
  ...
  public SearchCollectionsRequest collectionIdentifiers(@javax.annotation.Nullable List<String> collectionIdentifiers) {
  ...
  public void setCollectionIdentifiers(@javax.annotation.Nullable List<String> collectionIdentifiers) {
    this.collectionIdentifiers = collectionIdentifiers;
  }


  public SearchCollectionsRequest createdByUserIdentifiers(@javax.annotation.Nullable List<String> createdByUserIdentifiers) {
    this.createdByUserIdentifiers = createdByUserIdentifiers;
    return this;
  }

  public SearchCollectionsRequest addCreatedByUserIdentifiersItem(String createdByUserIdentifiersItem) {
  ...
  public SearchCollectionsRequest includeMetadata(@javax.annotation.Nullable Boolean includeMetadata) {
  ...
  public SearchCollectionsRequest sortOptions(@javax.annotation.Nullable SortOptions sortOptions) {
   ...
   * @return the SearchCollectionsRequest instance itself
   */
  public SearchCollectionsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.namePattern, searchCollectionsRequest.namePattern) &&
        ...
        Objects.equals(this.collectionIdentifiers, searchCollectionsRequest.collectionIdentifiers) &&
        Objects.equals(this.createdByUserIdentifiers, searchCollectionsRequest.createdByUserIdentifiers) &&
        ...
        Objects.equals(this.additionalProperties, searchCollectionsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(namePattern, recordOffset, recordSize, collectionIdentifiers, createdByUserIdentifiers, includeMetadata, sortOptions, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchCollectionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchCollectionsRequest is not found in the empty JSON string", SearchCollectionsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("collection_identifiers") != null && !jsonObj.get("collection_identifiers").isJsonNull() && !jsonObj.get("collection_identifiers").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `collection_identifiers` to be an array in the JSON string but got `%s`", jsonObj.get("collection_identifiers").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchCollectionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchCollectionsRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchCollectionsRequest>() {
           @Override
           public void write(JsonWriter out, SearchCollectionsRequest value) throws IOException {
           ...
           public SearchCollectionsRequest read(JsonReader in) throws IOException {
             ...
             SearchCollectionsRequest instance = thisAdapter.fromJsonTree(jsonObj);
