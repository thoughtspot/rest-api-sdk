...
public class ModelTableList implements Serializable {
    ...
    /**
     * Model directory path, this is optional param and required if there are duplicate models with
     * the same name.
     *
     * @return modelPath
     */
     ...
     * @return the ModelTableList instance itself
     */
    public ModelTableList putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.modelName, modelTableList.modelName)
                ...
                && Objects.equals(this.additionalProperties, modelTableList.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(modelName, modelPath, tables, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ModelTableList.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ModelTableList is not found in the"
                                        + " empty JSON string",
                                ModelTableList.openapiRequiredFields.toString()));
            }
        }
        ...
        if ((jsonObj.get("model_path") != null && !jsonObj.get("model_path").isJsonNull())
                && !jsonObj.get("model_path").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `model_path` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("model_path").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ModelTableList>() {
                        @Override
                        ...
                        public ModelTableList read(JsonReader in) throws IOException {
                            ...
                            ModelTableList instance = thisAdapter.fromJsonTree(jsonObj);
