...
public class SearchConnectionResponse implements Serializable {
    ...
    public SearchConnectionResponse dataWarehouseType(
    ...
    public SearchConnectionResponse dataWarehouseObjects(
            @javax.annotation.Nullable DataWarehouseObjects dataWarehouseObjects) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, searchConnectionResponse.id)
                ...
                && Objects.equals(
                        this.dataWarehouseObjects, searchConnectionResponse.dataWarehouseObjects)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SearchConnectionResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SearchConnectionResponse is not found"
                                        + " in the empty JSON string",
                                SearchConnectionResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SearchConnectionResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SearchConnectionResponse' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SearchConnectionResponse>() {
                        @Override
                        public void write(JsonWriter out, SearchConnectionResponse value)
                                throws IOException {
