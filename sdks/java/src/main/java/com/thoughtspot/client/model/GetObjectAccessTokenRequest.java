...
public class GetObjectAccessTokenRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(username, objectId, password, secretKey, validityTimeInSec, orgId, email, displayName, autoCreate, groupIdentifiers, userParameters, additionalProperties);
  }
