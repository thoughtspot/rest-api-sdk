...
public class GetObjectAccessTokenRequest implements Serializable {
   ...
   * @return the GetObjectAccessTokenRequest instance itself
   */
  public GetObjectAccessTokenRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.username, getObjectAccessTokenRequest.username) &&
        ...
        Objects.equals(this.additionalProperties, getObjectAccessTokenRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(username, objectId, password, secretKey, validityTimeInSec, orgId, scope, email, displayName, autoCreate, groupIdentifiers, userParameters, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetObjectAccessTokenRequest>() {
           ...
           public GetObjectAccessTokenRequest read(JsonReader in) throws IOException {
             ...
             GetObjectAccessTokenRequest instance = thisAdapter.fromJsonTree(jsonObj);
