...
public class ColumnSecurityRuleResponse implements Serializable {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("columnSecurityRules") != null && !jsonObj.get("columnSecurityRules").isJsonNull()) {
        ...
        if (jsonArraycolumnSecurityRules != null) {
          ...
          if (!jsonObj.get("columnSecurityRules").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `columnSecurityRules` to be an array in the JSON string but got `%s`", jsonObj.get("columnSecurityRules").toString()));
          }
