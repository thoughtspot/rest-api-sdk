...
import com.thoughtspot.client.model.ColumnSecurityRule;
...
public class ColumnSecurityRuleResponse implements Serializable {
  ...
  public ColumnSecurityRuleResponse columnSecurityRules(@javax.annotation.Nullable List<ColumnSecurityRule> columnSecurityRules) {
    this.columnSecurityRules = columnSecurityRules;
    return this;
  }

  public ColumnSecurityRuleResponse addColumnSecurityRulesItem(ColumnSecurityRule columnSecurityRulesItem) {
  ...
  public void setColumnSecurityRules(@javax.annotation.Nullable List<ColumnSecurityRule> columnSecurityRules) {
    this.columnSecurityRules = columnSecurityRules;
  }
   ...
   * @return the ColumnSecurityRuleResponse instance itself
   */
  public ColumnSecurityRuleResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tableGuid, columnSecurityRuleResponse.tableGuid) &&
        ...
        Objects.equals(this.columnSecurityRules, columnSecurityRuleResponse.columnSecurityRules)&&
        Objects.equals(this.additionalProperties, columnSecurityRuleResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tableGuid, objId, columnSecurityRules, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ColumnSecurityRuleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ColumnSecurityRuleResponse is not found in the empty JSON string", ColumnSecurityRuleResponse.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("table_guid") != null && !jsonObj.get("table_guid").isJsonNull()) && !jsonObj.get("table_guid").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `table_guid` to be a primitive type in the JSON string but got `%s`", jsonObj.get("table_guid").toString()));
      }
      ...
      if (jsonObj.get("column_security_rules") != null && !jsonObj.get("column_security_rules").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ColumnSecurityRuleResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ColumnSecurityRuleResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ColumnSecurityRuleResponse>() {
           @Override
           public void write(JsonWriter out, ColumnSecurityRuleResponse value) throws IOException {
           ...
           public ColumnSecurityRuleResponse read(JsonReader in) throws IOException {
             ...
             ColumnSecurityRuleResponse instance = thisAdapter.fromJsonTree(jsonObj);
