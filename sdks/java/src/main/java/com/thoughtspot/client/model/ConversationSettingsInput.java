...
public class ConversationSettingsInput implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(enableContextualChangeAnalysis, enableNaturalLanguageAnswerGeneration, enableReasoning);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ConversationSettingsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ConversationSettingsInput` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
