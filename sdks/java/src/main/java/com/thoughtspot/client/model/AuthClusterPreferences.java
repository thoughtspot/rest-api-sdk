...
public class AuthClusterPreferences implements Serializable {
  ...
  public AuthClusterPreferences accessTokens(@javax.annotation.Nullable List<AuthSettingsAccessToken> accessTokens) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authStatus, authClusterPreferences.authStatus) &&
        ...
        Objects.equals(this.additionalProperties, authClusterPreferences.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthClusterPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthClusterPreferences is not found in the empty JSON string", AuthClusterPreferences.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AuthClusterPreferences>() {
           @Override
           public void write(JsonWriter out, AuthClusterPreferences value) throws IOException {
