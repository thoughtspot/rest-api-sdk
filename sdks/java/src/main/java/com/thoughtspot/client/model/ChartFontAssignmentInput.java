...
public class ChartFontAssignmentInput implements Serializable {
  ...
  public ChartFontAssignmentInput visualizationArea(@javax.annotation.Nonnull VisualizationAreaEnum visualizationArea) {
  ...
  public ChartFontAssignmentInput fontIdentifier(@javax.annotation.Nonnull String fontIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visualizationArea, chartFontAssignmentInput.visualizationArea) &&
        ...
        Objects.equals(this.additionalProperties, chartFontAssignmentInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChartFontAssignmentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChartFontAssignmentInput is not found in the empty JSON string", ChartFontAssignmentInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChartFontAssignmentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChartFontAssignmentInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChartFontAssignmentInput>() {
           @Override
           public void write(JsonWriter out, ChartFontAssignmentInput value) throws IOException {
