...
public class FetchAsyncImportTaskStatusRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(taskIds, taskStatus, authorIdentifier, recordOffset, recordSize, includeImportResponse, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FetchAsyncImportTaskStatusRequest>() {
           ...
           public FetchAsyncImportTaskStatusRequest read(JsonReader in) throws IOException {
             ...
             FetchAsyncImportTaskStatusRequest instance = thisAdapter.fromJsonTree(jsonObj);
