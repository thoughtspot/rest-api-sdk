...
public class FetchAsyncImportTaskStatusRequest implements Serializable {
    ...
    public enum TaskStatusEnum {
        ...
        public static class Adapter extends TypeAdapter<TaskStatusEnum> {
            @Override
            public void write(final JsonWriter jsonWriter, final TaskStatusEnum enumeration)
                    throws IOException {
    ...
    public FetchAsyncImportTaskStatusRequest taskIds(
            @javax.annotation.Nullable List<String> taskIds) {
    ...
    public FetchAsyncImportTaskStatusRequest taskStatus(
            @javax.annotation.Nullable List<TaskStatusEnum> taskStatus) {
    ...
    public FetchAsyncImportTaskStatusRequest authorIdentifier(
            @javax.annotation.Nullable String authorIdentifier) {
    ...
    public FetchAsyncImportTaskStatusRequest recordOffset(
    ...
    public FetchAsyncImportTaskStatusRequest recordSize(
    ...
    /**
     * The number of task statuses that should be included in the response starting from offset
     * position.
     *
     * @return recordSize
     */
    ...
    public FetchAsyncImportTaskStatusRequest includeImportResponse(
     ...
     * @return the FetchAsyncImportTaskStatusRequest instance itself
     */
    public FetchAsyncImportTaskStatusRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        FetchAsyncImportTaskStatusRequest fetchAsyncImportTaskStatusRequest =
                (FetchAsyncImportTaskStatusRequest) o;
        return Objects.equals(this.taskIds, fetchAsyncImportTaskStatusRequest.taskIds)
                ...
                && Objects.equals(
                        this.authorIdentifier, fetchAsyncImportTaskStatusRequest.authorIdentifier)
                ...
                && Objects.equals(
                        ...
                        fetchAsyncImportTaskStatusRequest.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    includeImportResponse: ")
                .append(toIndentedString(includeImportResponse))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FetchAsyncImportTaskStatusRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FetchAsyncImportTaskStatusRequest is"
                                        + " not found in the empty JSON string",
                                FetchAsyncImportTaskStatusRequest.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        if (jsonObj.get("task_ids") != null
                && !jsonObj.get("task_ids").isJsonNull()
                && !jsonObj.get("task_ids").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `task_ids` to be an array in the JSON string but"
                                    + " got `%s`",
                            jsonObj.get("task_ids").toString()));
        }
        // ensure the optional json data is an array if present
        if (jsonObj.get("task_status") != null
                && !jsonObj.get("task_status").isJsonNull()
                && !jsonObj.get("task_status").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `task_status` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("task_status").toString()));
        }
        if ((jsonObj.get("author_identifier") != null
                        && !jsonObj.get("author_identifier").isJsonNull())
                && !jsonObj.get("author_identifier").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `author_identifier` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("author_identifier").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FetchAsyncImportTaskStatusRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FetchAsyncImportTaskStatusRequest' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FetchAsyncImportTaskStatusRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(FetchAsyncImportTaskStatusRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FetchAsyncImportTaskStatusRequest>() {
                        @Override
                        public void write(JsonWriter out, FetchAsyncImportTaskStatusRequest value)
                                throws IOException {
                        ...
                        @Override
                        public FetchAsyncImportTaskStatusRequest read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            FetchAsyncImportTaskStatusRequest instance =
