...
public class CreateEmailCustomizationRequest implements Serializable {
    ...
    public CreateEmailCustomizationRequest templateProperties(
    ...
    public CreateEmailCustomizationRequest orgIdentifier(
     ...
     * @return the CreateEmailCustomizationRequest instance itself
     */
    public CreateEmailCustomizationRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        CreateEmailCustomizationRequest createEmailCustomizationRequest =
                (CreateEmailCustomizationRequest) o;
        return Objects.equals(
                        this.templateProperties, createEmailCustomizationRequest.templateProperties)
                && Objects.equals(this.orgIdentifier, createEmailCustomizationRequest.orgIdentifier)
                && Objects.equals(
                        this.additionalProperties,
                        createEmailCustomizationRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateEmailCustomizationRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateEmailCustomizationRequest is"
                                        + " not found in the empty JSON string",
                                CreateEmailCustomizationRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateEmailCustomizationRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateEmailCustomizationRequest' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateEmailCustomizationRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateEmailCustomizationRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateEmailCustomizationRequest>() {
                        @Override
                        public void write(JsonWriter out, CreateEmailCustomizationRequest value)
                                throws IOException {
                        ...
                        @Override
                        public CreateEmailCustomizationRequest read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            CreateEmailCustomizationRequest instance =
