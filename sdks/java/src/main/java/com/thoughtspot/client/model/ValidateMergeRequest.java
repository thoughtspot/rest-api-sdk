...
public class ValidateMergeRequest implements Serializable {
  ...
  public ValidateMergeRequest sourceBranchName(@javax.annotation.Nonnull String sourceBranchName) {
  ...
  public ValidateMergeRequest targetBranchName(@javax.annotation.Nonnull String targetBranchName) {
   ...
   * @return the ValidateMergeRequest instance itself
   */
  public ValidateMergeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sourceBranchName, validateMergeRequest.sourceBranchName) &&
        ...
        Objects.equals(this.additionalProperties, validateMergeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceBranchName, targetBranchName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidateMergeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ValidateMergeRequest>() {
           ...
           public ValidateMergeRequest read(JsonReader in) throws IOException {
             ...
             ValidateMergeRequest instance = thisAdapter.fromJsonTree(jsonObj);
