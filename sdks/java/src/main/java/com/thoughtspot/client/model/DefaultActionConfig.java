...
public class DefaultActionConfig implements Serializable {
   ...
   * @return the DefaultActionConfig instance itself
   */
  public DefaultActionConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visibility, defaultActionConfig.visibility)&&
        Objects.equals(this.additionalProperties, defaultActionConfig.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DefaultActionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DefaultActionConfig is not found in the empty JSON string", DefaultActionConfig.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DefaultActionConfig>() {
           @Override
           public void write(JsonWriter out, DefaultActionConfig value) throws IOException {
           ...
           public DefaultActionConfig read(JsonReader in) throws IOException {
             ...
             DefaultActionConfig instance = thisAdapter.fromJsonTree(jsonObj);
