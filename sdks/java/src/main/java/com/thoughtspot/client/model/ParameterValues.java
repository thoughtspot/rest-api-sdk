...
public class ParameterValues implements Serializable {
     ...
     * @return the ParameterValues instance itself
     */
    public ParameterValues putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, parameterValues.name)
                ...
                && Objects.equals(this.additionalProperties, parameterValues.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ParameterValues.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ParameterValues is not found in the"
                                        + " empty JSON string",
                                ParameterValues.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ParameterValues>() {
                        @Override
                        public void write(JsonWriter out, ParameterValues value)
                                throws IOException {
                        ...
                        public ParameterValues read(JsonReader in) throws IOException {
                            ...
                            ParameterValues instance = thisAdapter.fromJsonTree(jsonObj);
