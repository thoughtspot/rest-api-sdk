...
public class DeactivateUserRequest implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.userIdentifier, deactivateUserRequest.userIdentifier)
                ...
                && Objects.equals(
                        this.additionalProperties, deactivateUserRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DeactivateUserRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeactivateUserRequest is not found in"
                                        + " the empty JSON string",
                                DeactivateUserRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        if (!jsonObj.get("base_url").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `base_url` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("base_url").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DeactivateUserRequest>() {
                        @Override
                        public void write(JsonWriter out, DeactivateUserRequest value)
                                throws IOException {
