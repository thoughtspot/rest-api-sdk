...
import com.thoughtspot.client.model.TokenScopeInput;
...
public class GetCustomAccessTokenRequest implements Serializable {
  ...
  public GetCustomAccessTokenRequest validityTimeInSec(@javax.annotation.Nullable Integer validityTimeInSec) {
  ...
  public GetCustomAccessTokenRequest orgIdentifier(@javax.annotation.Nullable String orgIdentifier) {
  ...
  public GetCustomAccessTokenRequest persistOption(@javax.annotation.Nonnull PersistOptionEnum persistOption) {
  ...
  public GetCustomAccessTokenRequest filterRules(@javax.annotation.Nullable List<FilterRules> filterRules) {
  ...
  public GetCustomAccessTokenRequest parameterValues(@javax.annotation.Nullable List<ParameterValues> parameterValues) {
  ...
  public void setParameterValues(@javax.annotation.Nullable List<ParameterValues> parameterValues) {
    this.parameterValues = parameterValues;
  }


  public GetCustomAccessTokenRequest variableValues(@javax.annotation.Nullable List<VariableValues> variableValues) {
  ...
  public GetCustomAccessTokenRequest objects(@javax.annotation.Nullable List<TokenAccessScopeObject> objects) {
   ...
   * @return the GetCustomAccessTokenRequest instance itself
   */
  public GetCustomAccessTokenRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.username, getCustomAccessTokenRequest.username) &&
        ...
        Objects.equals(this.additionalProperties, getCustomAccessTokenRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(username, password, secretKey, validityTimeInSec, orgIdentifier, scope, persistOption, filterRules, parameterValues, variableValues, objects, email, displayName, groups, autoCreate, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetCustomAccessTokenRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetCustomAccessTokenRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      if (jsonObj.get("variable_values") != null && !jsonObj.get("variable_values").isJsonNull()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetCustomAccessTokenRequest>() {
           ...
           public GetCustomAccessTokenRequest read(JsonReader in) throws IOException {
             ...
             GetCustomAccessTokenRequest instance = thisAdapter.fromJsonTree(jsonObj);
