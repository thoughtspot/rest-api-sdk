...
import com.thoughtspot.client.model.UserPrompt;
...
public class ConversationMessage implements Serializable {
  ...
  public ConversationMessage timestampInMillis(@javax.annotation.Nullable Object timestampInMillis) {
  ...
  public ConversationMessage responseItems(@javax.annotation.Nullable List<Object> responseItems) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(messageId, timestampInMillis, userPrompt, responseItems, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("response_items") != null && !jsonObj.get("response_items").isJsonNull() && !jsonObj.get("response_items").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `response_items` to be an array in the JSON string but got `%s`", jsonObj.get("response_items").toString()));
      }
  }
