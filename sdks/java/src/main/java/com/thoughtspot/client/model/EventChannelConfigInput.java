...
public class EventChannelConfigInput implements Serializable {
   ...
   * @return the EventChannelConfigInput instance itself
   */
  public EventChannelConfigInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventType, eventChannelConfigInput.eventType) &&
        ...
        Objects.equals(this.additionalProperties, eventChannelConfigInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!EventChannelConfigInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventChannelConfigInput is not found in the empty JSON string", EventChannelConfigInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventChannelConfigInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventChannelConfigInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<EventChannelConfigInput>() {
           @Override
           public void write(JsonWriter out, EventChannelConfigInput value) throws IOException {
           ...
           public EventChannelConfigInput read(JsonReader in) throws IOException {
             ...
             EventChannelConfigInput instance = thisAdapter.fromJsonTree(jsonObj);
