...
public class FetchPermissionsOfPrincipalsRequest implements Serializable {
   ...
   * @return the FetchPermissionsOfPrincipalsRequest instance itself
   */
  public FetchPermissionsOfPrincipalsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.principals, fetchPermissionsOfPrincipalsRequest.principals) &&
        ...
        Objects.equals(this.additionalProperties, fetchPermissionsOfPrincipalsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(principals, metadata, recordOffset, recordSize, defaultMetadataType, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FetchPermissionsOfPrincipalsRequest>() {
           ...
           public FetchPermissionsOfPrincipalsRequest read(JsonReader in) throws IOException {
             ...
             FetchPermissionsOfPrincipalsRequest instance = thisAdapter.fromJsonTree(jsonObj);
