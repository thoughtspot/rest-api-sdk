...
public class UpdateConnectionConfigurationRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionIdentifier, name, description, authenticationType, _configuration, policyType, policyPrincipals, policyProcesses, disable);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateConnectionConfigurationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateConnectionConfigurationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
