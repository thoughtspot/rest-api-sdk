...
public class UpdateConnectionConfigurationRequest implements Serializable {
  ...
  public UpdateConnectionConfigurationRequest connectionIdentifier(@javax.annotation.Nonnull String connectionIdentifier) {
  ...
  public UpdateConnectionConfigurationRequest description(@javax.annotation.Nullable String description) {
  ...
  public UpdateConnectionConfigurationRequest sameAsParent(@javax.annotation.Nullable Boolean sameAsParent) {
  ...
  public UpdateConnectionConfigurationRequest policyProcessOptions(@javax.annotation.Nullable PolicyProcessOptionsInput policyProcessOptions) {
  ...
  public UpdateConnectionConfigurationRequest authenticationType(@javax.annotation.Nullable AuthenticationTypeEnum authenticationType) {
  ...
  public UpdateConnectionConfigurationRequest _configuration(@javax.annotation.Nullable Object _configuration) {
  ...
  public UpdateConnectionConfigurationRequest policyType(@javax.annotation.Nullable PolicyTypeEnum policyType) {
  ...
  public UpdateConnectionConfigurationRequest policyPrincipals(@javax.annotation.Nullable List<String> policyPrincipals) {
    this.policyPrincipals = policyPrincipals;
    return this;
  }

  public UpdateConnectionConfigurationRequest addPolicyPrincipalsItem(String policyPrincipalsItem) {
  ...
  public UpdateConnectionConfigurationRequest policyProcesses(@javax.annotation.Nullable List<PolicyProcessesEnum> policyProcesses) {
    this.policyProcesses = policyProcesses;
    return this;
  }

  public UpdateConnectionConfigurationRequest addPolicyProcessesItem(PolicyProcessesEnum policyProcessesItem) {
  ...
  public UpdateConnectionConfigurationRequest disable(@javax.annotation.Nullable Boolean disable) {
   ...
   * @return the UpdateConnectionConfigurationRequest instance itself
   */
  public UpdateConnectionConfigurationRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateConnectionConfigurationRequest updateConnectionConfigurationRequest = (UpdateConnectionConfigurationRequest) o;
    return Objects.equals(this.connectionIdentifier, updateConnectionConfigurationRequest.connectionIdentifier) &&
        Objects.equals(this.name, updateConnectionConfigurationRequest.name) &&
        Objects.equals(this.description, updateConnectionConfigurationRequest.description) &&
        Objects.equals(this.sameAsParent, updateConnectionConfigurationRequest.sameAsParent) &&
        Objects.equals(this.policyProcessOptions, updateConnectionConfigurationRequest.policyProcessOptions) &&
        Objects.equals(this.authenticationType, updateConnectionConfigurationRequest.authenticationType) &&
        Objects.equals(this._configuration, updateConnectionConfigurationRequest._configuration) &&
        Objects.equals(this.policyType, updateConnectionConfigurationRequest.policyType) &&
        Objects.equals(this.policyPrincipals, updateConnectionConfigurationRequest.policyPrincipals) &&
        Objects.equals(this.policyProcesses, updateConnectionConfigurationRequest.policyProcesses) &&
        Objects.equals(this.disable, updateConnectionConfigurationRequest.disable)&&
        Objects.equals(this.additionalProperties, updateConnectionConfigurationRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionIdentifier, name, description, sameAsParent, policyProcessOptions, authenticationType, _configuration, policyType, policyPrincipals, policyProcesses, disable, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateConnectionConfigurationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateConnectionConfigurationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateConnectionConfigurationRequest is not found in the empty JSON string", UpdateConnectionConfigurationRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateConnectionConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateConnectionConfigurationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateConnectionConfigurationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateConnectionConfigurationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateConnectionConfigurationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateConnectionConfigurationRequest value) throws IOException {
           ...
           @Override
           public UpdateConnectionConfigurationRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateConnectionConfigurationRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to UpdateConnectionConfigurationRequest
   */
  public static UpdateConnectionConfigurationRequest fromJson(String jsonString) throws IOException {
