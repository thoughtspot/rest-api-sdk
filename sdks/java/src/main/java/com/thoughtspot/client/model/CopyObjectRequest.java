...
public class CopyObjectRequest implements Serializable {
   ...
   * @return the CopyObjectRequest instance itself
   */
  public CopyObjectRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.description, copyObjectRequest.description) &&
        ...
        Objects.equals(this.additionalProperties, copyObjectRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, identifier, type, title, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyObjectRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CopyObjectRequest>() {
           ...
           public CopyObjectRequest read(JsonReader in) throws IOException {
             ...
             CopyObjectRequest instance = thisAdapter.fromJsonTree(jsonObj);
