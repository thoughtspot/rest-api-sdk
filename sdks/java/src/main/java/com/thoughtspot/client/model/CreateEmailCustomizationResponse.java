...
public class CreateEmailCustomizationResponse implements Serializable {
     ...
     * @return the CreateEmailCustomizationResponse instance itself
     */
    public CreateEmailCustomizationResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        CreateEmailCustomizationResponse createEmailCustomizationResponse =
                (CreateEmailCustomizationResponse) o;
        return Objects.equals(this.tenantId, createEmailCustomizationResponse.tenantId)
                ...
                && Objects.equals(
                        ...
                        createEmailCustomizationResponse.templateProperties)
                && Objects.equals(
                        this.additionalProperties,
                        createEmailCustomizationResponse.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(tenantId, org, name, templateProperties, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateEmailCustomizationResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateEmailCustomizationResponse is"
                                        + " not found in the empty JSON string",
                                CreateEmailCustomizationResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!CreateEmailCustomizationResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'CreateEmailCustomizationResponse' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<CreateEmailCustomizationResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(CreateEmailCustomizationResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<CreateEmailCustomizationResponse>() {
                        @Override
                        public void write(JsonWriter out, CreateEmailCustomizationResponse value)
                                throws IOException {
                        ...
                        @Override
                        public CreateEmailCustomizationResponse read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            CreateEmailCustomizationResponse instance =
