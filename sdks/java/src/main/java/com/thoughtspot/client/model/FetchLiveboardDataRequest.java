...
public class FetchLiveboardDataRequest implements Serializable {
  ...
  public FetchLiveboardDataRequest metadataIdentifier(@javax.annotation.Nonnull String metadataIdentifier) {
  ...
  public FetchLiveboardDataRequest visualizationIdentifiers(@javax.annotation.Nullable List<String> visualizationIdentifiers) {
    this.visualizationIdentifiers = visualizationIdentifiers;
    return this;
  }

  public FetchLiveboardDataRequest addVisualizationIdentifiersItem(String visualizationIdentifiersItem) {
  ...
  public FetchLiveboardDataRequest transientContent(@javax.annotation.Nullable String transientContent) {
  ...
  public FetchLiveboardDataRequest dataFormat(@javax.annotation.Nullable DataFormatEnum dataFormat) {
  ...
  public FetchLiveboardDataRequest runtimeFilter(@javax.annotation.Nullable Object runtimeFilter) {
  ...
  public FetchLiveboardDataRequest runtimeParamOverride(@javax.annotation.Nullable Object runtimeParamOverride) {
   ...
   * @return the FetchLiveboardDataRequest instance itself
   */
  public FetchLiveboardDataRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataIdentifier, fetchLiveboardDataRequest.metadataIdentifier) &&
        Objects.equals(this.visualizationIdentifiers, fetchLiveboardDataRequest.visualizationIdentifiers) &&
        ...
        Objects.equals(this.runtimeParamOverride, fetchLiveboardDataRequest.runtimeParamOverride)&&
        Objects.equals(this.additionalProperties, fetchLiveboardDataRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, visualizationIdentifiers, transientContent, dataFormat, recordOffset, recordSize, runtimeFilter, runtimeSort, runtimeParamOverride, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FetchLiveboardDataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FetchLiveboardDataRequest is not found in the empty JSON string", FetchLiveboardDataRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FetchLiveboardDataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FetchLiveboardDataRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<FetchLiveboardDataRequest>() {
           @Override
           public void write(JsonWriter out, FetchLiveboardDataRequest value) throws IOException {
           ...
           public FetchLiveboardDataRequest read(JsonReader in) throws IOException {
             ...
             FetchLiveboardDataRequest instance = thisAdapter.fromJsonTree(jsonObj);
