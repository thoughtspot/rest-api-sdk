...
import com.thoughtspot.client.model.StyleColorEntry;
...
public class StyleChartColorPalette implements Serializable {
  ...
  public StyleChartColorPalette disableColorRotation(@javax.annotation.Nullable Boolean disableColorRotation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.colors, styleChartColorPalette.colors) &&
        Objects.equals(this.disableColorRotation, styleChartColorPalette.disableColorRotation) &&
        Objects.equals(this.isOverridden, styleChartColorPalette.isOverridden)&&
        Objects.equals(this.additionalProperties, styleChartColorPalette.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StyleChartColorPalette.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StyleChartColorPalette is not found in the empty JSON string", StyleChartColorPalette.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StyleChartColorPalette>() {
           @Override
           public void write(JsonWriter out, StyleChartColorPalette value) throws IOException {
