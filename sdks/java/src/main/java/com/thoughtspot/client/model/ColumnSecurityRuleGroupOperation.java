...
public class ColumnSecurityRuleGroupOperation implements Serializable {
    ...
    public ColumnSecurityRuleGroupOperation operation(
    ...
    public ColumnSecurityRuleGroupOperation groupIdentifiers(
            @javax.annotation.Nonnull List<String> groupIdentifiers) {
     ...
     * @return the ColumnSecurityRuleGroupOperation instance itself
     */
    public ColumnSecurityRuleGroupOperation putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        ColumnSecurityRuleGroupOperation columnSecurityRuleGroupOperation =
                (ColumnSecurityRuleGroupOperation) o;
        return Objects.equals(this.operation, columnSecurityRuleGroupOperation.operation)
                && Objects.equals(
                        this.groupIdentifiers, columnSecurityRuleGroupOperation.groupIdentifiers)
                && Objects.equals(
                        this.additionalProperties,
                        columnSecurityRuleGroupOperation.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(operation, groupIdentifiers, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ColumnSecurityRuleGroupOperation.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ColumnSecurityRuleGroupOperation is"
                                        + " not found in the empty JSON string",
                                ColumnSecurityRuleGroupOperation.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ColumnSecurityRuleGroupOperation.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ColumnSecurityRuleGroupOperation' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ColumnSecurityRuleGroupOperation> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ColumnSecurityRuleGroupOperation.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ColumnSecurityRuleGroupOperation>() {
                        @Override
                        public void write(JsonWriter out, ColumnSecurityRuleGroupOperation value)
                                throws IOException {
                        ...
                        @Override
                        public ColumnSecurityRuleGroupOperation read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            ColumnSecurityRuleGroupOperation instance =
