...
public class UnpublishMetadataRequest implements Serializable {
    ...
    /**
     * Force unpublishes the object. This will break all the dependent objects in the unpublished
     * orgs.
     *
     * @return force
     */
    ...
    public UnpublishMetadataRequest includeDependencies(
            @javax.annotation.Nonnull Boolean includeDependencies) {
        this.includeDependencies = includeDependencies;
        return this;
    }

    /**
     * Should we unpublish all the dependencies for the objects specified. The dependencies will be
     * unpublished if no other published object is using it.
     *
    ...
    public UnpublishMetadataRequest metadata(
    ...
    public UnpublishMetadataRequest orgIdentifiers(
     ...
     * @return the UnpublishMetadataRequest instance itself
     */
    public UnpublishMetadataRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.force, unpublishMetadataRequest.force)
                && Objects.equals(
                        this.includeDependencies, unpublishMetadataRequest.includeDependencies)
                ...
                && Objects.equals(
                        this.additionalProperties, unpublishMetadataRequest.additionalProperties);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                force, includeDependencies, metadata, orgIdentifiers, additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    includeDependencies: ")
                .append(toIndentedString(includeDependencies))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UnpublishMetadataRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UnpublishMetadataRequest is not found"
                                        + " in the empty JSON string",
                                UnpublishMetadataRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UnpublishMetadataRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UnpublishMetadataRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UnpublishMetadataRequest>() {
                        @Override
                        public void write(JsonWriter out, UnpublishMetadataRequest value)
                                throws IOException {
                        ...
                        public UnpublishMetadataRequest read(JsonReader in) throws IOException {
                            ...
                            UnpublishMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
