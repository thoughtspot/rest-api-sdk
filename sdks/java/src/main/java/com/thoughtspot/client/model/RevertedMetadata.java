...
public class RevertedMetadata implements Serializable {
   ...
   * @return the RevertedMetadata instance itself
   */
  public RevertedMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileName, revertedMetadata.fileName) &&
        ...
        Objects.equals(this.additionalProperties, revertedMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileName, metadataName, metadataType, statusCode, statusMessage, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevertedMetadata>() {
           ...
           public RevertedMetadata read(JsonReader in) throws IOException {
             ...
             RevertedMetadata instance = thisAdapter.fromJsonTree(jsonObj);
