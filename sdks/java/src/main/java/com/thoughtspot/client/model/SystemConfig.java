...
public class SystemConfig implements Serializable {
  ...
  public SystemConfig onboardingContentUrl(@javax.annotation.Nullable String onboardingContentUrl) {
   ...
   * @return the SystemConfig instance itself
   */
  public SystemConfig putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.onboardingContentUrl, systemConfig.onboardingContentUrl) &&
        ...
        Objects.equals(this.additionalProperties, systemConfig.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(onboardingContentUrl, samlEnabled, oktaEnabled, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SystemConfig>() {
           ...
           public SystemConfig read(JsonReader in) throws IOException {
             ...
             SystemConfig instance = thisAdapter.fromJsonTree(jsonObj);
