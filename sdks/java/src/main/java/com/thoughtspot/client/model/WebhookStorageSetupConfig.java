...
public class WebhookStorageSetupConfig implements Serializable {
  ...
  public WebhookStorageSetupConfig configType(@javax.annotation.Nonnull ConfigTypeEnum configType) {
  ...
  public WebhookStorageSetupConfig gcpServiceAccountId(@javax.annotation.Nullable String gcpServiceAccountId) {
  ...
  public WebhookStorageSetupConfig trustPolicyTemplate(@javax.annotation.Nullable Object trustPolicyTemplate) {
  ...
  public WebhookStorageSetupConfig serviceAccountEmail(@javax.annotation.Nullable String serviceAccountEmail) {
  ...
  public WebhookStorageSetupConfig setupInstructions(@javax.annotation.Nonnull List<String> setupInstructions) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configType, webhookStorageSetupConfig.configType) &&
        ...
        Objects.equals(this.gcpServiceAccountId, webhookStorageSetupConfig.gcpServiceAccountId) &&
        Objects.equals(this.oidcProvider, webhookStorageSetupConfig.oidcProvider) &&
        Objects.equals(this.trustPolicyTemplate, webhookStorageSetupConfig.trustPolicyTemplate) &&
        Objects.equals(this.serviceAccountEmail, webhookStorageSetupConfig.serviceAccountEmail) &&
        Objects.equals(this.requiredRole, webhookStorageSetupConfig.requiredRole) &&
        Objects.equals(this.setupInstructions, webhookStorageSetupConfig.setupInstructions)&&
        Objects.equals(this.additionalProperties, webhookStorageSetupConfig.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(configType, awsAccountId, gcpServiceAccountId, oidcProvider, trustPolicyTemplate, serviceAccountEmail, requiredRole, setupInstructions, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    gcpServiceAccountId: ").append(toIndentedString(gcpServiceAccountId)).append("\n");
    sb.append("    oidcProvider: ").append(toIndentedString(oidcProvider)).append("\n");
    sb.append("    trustPolicyTemplate: ").append(toIndentedString(trustPolicyTemplate)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookStorageSetupConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookStorageSetupConfig is not found in the empty JSON string", WebhookStorageSetupConfig.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("aws_account_id") != null && !jsonObj.get("aws_account_id").isJsonNull()) && !jsonObj.get("aws_account_id").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("gcp_service_account_id") != null && !jsonObj.get("gcp_service_account_id").isJsonNull()) && !jsonObj.get("gcp_service_account_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `gcp_service_account_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("gcp_service_account_id").toString()));
      }
      if ((jsonObj.get("oidc_provider") != null && !jsonObj.get("oidc_provider").isJsonNull()) && !jsonObj.get("oidc_provider").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `oidc_provider` to be a primitive type in the JSON string but got `%s`", jsonObj.get("oidc_provider").toString()));
      }
      ...
      if ((jsonObj.get("required_role") != null && !jsonObj.get("required_role").isJsonNull()) && !jsonObj.get("required_role").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `required_role` to be a primitive type in the JSON string but got `%s`", jsonObj.get("required_role").toString()));
      }
      // ensure the required json array is present
      if (jsonObj.get("setup_instructions") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("setup_instructions").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `setup_instructions` to be an array in the JSON string but got `%s`", jsonObj.get("setup_instructions").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookStorageSetupConfig.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookStorageSetupConfig' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookStorageSetupConfig>() {
           @Override
           public void write(JsonWriter out, WebhookStorageSetupConfig value) throws IOException {
