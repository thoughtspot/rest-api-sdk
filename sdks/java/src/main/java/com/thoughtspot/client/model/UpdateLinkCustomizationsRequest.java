...
import com.thoughtspot.client.model.LinkTemplateInput;
...
public class UpdateLinkCustomizationsRequest implements Serializable {
   ...
   */
  @javax.annotation.Nonnull
  public List<LinkTemplateInput> getTemplates() {
    return templates;
  }

  public void setTemplates(@javax.annotation.Nonnull List<LinkTemplateInput> templates) {
    this.templates = templates;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(scope, operation, templates, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (int i = 0; i < jsonArraytemplates.size(); i++) {
        LinkTemplateInput.validateJsonElement(jsonArraytemplates.get(i));
      };
  }
