...
public class LogResponse implements Serializable {
   ...
   * @return the LogResponse instance itself
   */
  public LogResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.date, logResponse.date) &&
        ...
        Objects.equals(this.additionalProperties, logResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, log, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LogResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LogResponse>() {
           ...
           public LogResponse read(JsonReader in) throws IOException {
             ...
             LogResponse instance = thisAdapter.fromJsonTree(jsonObj);
