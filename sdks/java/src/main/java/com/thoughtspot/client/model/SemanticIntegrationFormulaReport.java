...
public class SemanticIntegrationFormulaReport implements Serializable {
  ...
  public SemanticIntegrationFormulaReport description(@javax.annotation.Nullable String description) {
  ...
  public SemanticIntegrationFormulaReport sourceExpression(@javax.annotation.Nullable String sourceExpression) {
  ...
  public SemanticIntegrationFormulaReport translatedFormula(@javax.annotation.Nullable String translatedFormula) {
  ...
  public SemanticIntegrationFormulaReport importStatus(@javax.annotation.Nullable ImportStatusEnum importStatus) {
  ...
  public SemanticIntegrationFormulaReport changeStatus(@javax.annotation.Nullable ChangeStatusEnum changeStatus) {
  ...
  public boolean equals(Object o) {
    ...
    SemanticIntegrationFormulaReport semanticIntegrationFormulaReport = (SemanticIntegrationFormulaReport) o;
    return Objects.equals(this.id, semanticIntegrationFormulaReport.id) &&
        ...
        Objects.equals(this.sourceExpression, semanticIntegrationFormulaReport.sourceExpression) &&
        Objects.equals(this.translatedFormula, semanticIntegrationFormulaReport.translatedFormula) &&
        ...
        Objects.equals(this.additionalProperties, semanticIntegrationFormulaReport.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, sourceExpression, translatedFormula, importStatus, changeStatus, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    translatedFormula: ").append(toIndentedString(translatedFormula)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SemanticIntegrationFormulaReport
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SemanticIntegrationFormulaReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SemanticIntegrationFormulaReport is not found in the empty JSON string", SemanticIntegrationFormulaReport.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("source_expression") != null && !jsonObj.get("source_expression").isJsonNull()) && !jsonObj.get("source_expression").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `source_expression` to be a primitive type in the JSON string but got `%s`", jsonObj.get("source_expression").toString()));
      }
      if ((jsonObj.get("translated_formula") != null && !jsonObj.get("translated_formula").isJsonNull()) && !jsonObj.get("translated_formula").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `translated_formula` to be a primitive type in the JSON string but got `%s`", jsonObj.get("translated_formula").toString()));
      }
      if ((jsonObj.get("import_status") != null && !jsonObj.get("import_status").isJsonNull()) && !jsonObj.get("import_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `import_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("import_status").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SemanticIntegrationFormulaReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SemanticIntegrationFormulaReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SemanticIntegrationFormulaReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SemanticIntegrationFormulaReport.class));

       return (TypeAdapter<T>) new TypeAdapter<SemanticIntegrationFormulaReport>() {
           @Override
           public void write(JsonWriter out, SemanticIntegrationFormulaReport value) throws IOException {
           ...
           @Override
           public SemanticIntegrationFormulaReport read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SemanticIntegrationFormulaReport instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to SemanticIntegrationFormulaReport
   */
