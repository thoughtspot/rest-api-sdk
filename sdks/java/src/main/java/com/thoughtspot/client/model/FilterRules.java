...
public class FilterRules implements Serializable {
   ...
   * @return the FilterRules instance itself
   */
  public FilterRules putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnName, filterRules.columnName) &&
        ...
        Objects.equals(this.additionalProperties, filterRules.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(columnName, operator, values, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FilterRules.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FilterRules>() {
           ...
           public FilterRules read(JsonReader in) throws IOException {
             ...
             FilterRules instance = thisAdapter.fromJsonTree(jsonObj);
