...
public class FavoriteMetadataItem implements Serializable {
     ...
     * @return the FavoriteMetadataItem instance itself
     */
    public FavoriteMetadataItem putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, favoriteMetadataItem.id)
                ...
                && Objects.equals(
                        this.additionalProperties, favoriteMetadataItem.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FavoriteMetadataItem.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FavoriteMetadataItem is not found in"
                                        + " the empty JSON string",
                                FavoriteMetadataItem.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<FavoriteMetadataItem>() {
                        @Override
                        public void write(JsonWriter out, FavoriteMetadataItem value)
                                throws IOException {
                        ...
                        public FavoriteMetadataItem read(JsonReader in) throws IOException {
                            ...
                            FavoriteMetadataItem instance = thisAdapter.fromJsonTree(jsonObj);
