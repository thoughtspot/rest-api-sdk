...
public class WebhookAuthBasicAuth implements Serializable {
   ...
   * @return the WebhookAuthBasicAuth instance itself
   */
  public WebhookAuthBasicAuth putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.username, webhookAuthBasicAuth.username) &&
        ...
        Objects.equals(this.additionalProperties, webhookAuthBasicAuth.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookAuthBasicAuth.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookAuthBasicAuth is not found in the empty JSON string", WebhookAuthBasicAuth.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookAuthBasicAuth>() {
           @Override
           public void write(JsonWriter out, WebhookAuthBasicAuth value) throws IOException {
           ...
           public WebhookAuthBasicAuth read(JsonReader in) throws IOException {
             ...
             WebhookAuthBasicAuth instance = thisAdapter.fromJsonTree(jsonObj);
