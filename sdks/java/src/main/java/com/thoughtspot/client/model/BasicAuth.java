...
public class BasicAuth implements Serializable {
   ...
   * @return the BasicAuth instance itself
   */
  public BasicAuth putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.password, basicAuth.password) &&
        ...
        Objects.equals(this.additionalProperties, basicAuth.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasicAuth>() {
           ...
           public BasicAuth read(JsonReader in) throws IOException {
             ...
             BasicAuth instance = thisAdapter.fromJsonTree(jsonObj);
