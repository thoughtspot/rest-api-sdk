...
public class TagsApi {
     ...
     */
    public okhttp3.Call unassignTagCall(UnassignTagRequest unassignTagRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call unassignTagValidateBeforeCall(UnassignTagRequest unassignTagRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'unassignTagRequest' is set
        if (unassignTagRequest == null) {
            throw new ApiException("Missing the required parameter 'unassignTagRequest' when calling unassignTag(Async)");
        }
     ...
     */
    public ApiResponse<Void> unassignTagWithHttpInfo(UnassignTagRequest unassignTagRequest) throws ApiException {
     ...
     */
    public okhttp3.Call unassignTagAsync(UnassignTagRequest unassignTagRequest, final ApiCallback<Void> _callback) throws ApiException {
