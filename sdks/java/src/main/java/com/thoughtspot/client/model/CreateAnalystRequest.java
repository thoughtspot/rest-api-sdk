...
public class CreateAnalystRequest implements Serializable {
  ...
  public CreateAnalystRequest sources(@javax.annotation.Nonnull List<AnalystSourceInput> sources) {
  ...
  public CreateAnalystRequest mcpConnectorIdentifiers(@javax.annotation.Nullable List<String> mcpConnectorIdentifiers) {
  ...
  public CreateAnalystRequest starterPrompts(@javax.annotation.Nullable List<String> starterPrompts) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createAnalystRequest.name) &&
        ...
        Objects.equals(this.mcpConnectorIdentifiers, createAnalystRequest.mcpConnectorIdentifiers) &&
        Objects.equals(this.starterPrompts, createAnalystRequest.starterPrompts)&&
        Objects.equals(this.additionalProperties, createAnalystRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAnalystRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateAnalystRequest is not found in the empty JSON string", CreateAnalystRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateAnalystRequest>() {
           @Override
           public void write(JsonWriter out, CreateAnalystRequest value) throws IOException {
