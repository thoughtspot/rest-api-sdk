...
public class PermissionsMetadataTypeInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, permissionsMetadataTypeInput.type) &&
        ...
        Objects.equals(this.additionalProperties, permissionsMetadataTypeInput.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to PermissionsMetadataTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PermissionsMetadataTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PermissionsMetadataTypeInput>() {
           ...
           public PermissionsMetadataTypeInput read(JsonReader in) throws IOException {
             ...
             PermissionsMetadataTypeInput instance = thisAdapter.fromJsonTree(jsonObj);
