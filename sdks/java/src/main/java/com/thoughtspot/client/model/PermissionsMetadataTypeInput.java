...
public class PermissionsMetadataTypeInput implements Serializable {
    ...
    public PermissionsMetadataTypeInput type(@javax.annotation.Nullable TypeEnum type) {
        this.type = type;
        return this;
    }
    ...
    public PermissionsMetadataTypeInput identifier(@javax.annotation.Nonnull String identifier) {
     ...
     * @return the PermissionsMetadataTypeInput instance itself
     */
    public PermissionsMetadataTypeInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        PermissionsMetadataTypeInput permissionsMetadataTypeInput =
                (PermissionsMetadataTypeInput) o;
        return Objects.equals(this.type, permissionsMetadataTypeInput.type)
                ...
                && Objects.equals(
                        ...
                        permissionsMetadataTypeInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!PermissionsMetadataTypeInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in PermissionsMetadataTypeInput is not"
                                        + " found in the empty JSON string",
                                PermissionsMetadataTypeInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!PermissionsMetadataTypeInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'PermissionsMetadataTypeInput' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<PermissionsMetadataTypeInput> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(PermissionsMetadataTypeInput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<PermissionsMetadataTypeInput>() {
                        @Override
                        public void write(JsonWriter out, PermissionsMetadataTypeInput value)
                                throws IOException {
                        ...
                        public PermissionsMetadataTypeInput read(JsonReader in) throws IOException {
                            ...
                            PermissionsMetadataTypeInput instance =
