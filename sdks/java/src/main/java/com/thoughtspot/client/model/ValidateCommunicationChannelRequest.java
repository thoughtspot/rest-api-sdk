...
public class ValidateCommunicationChannelRequest implements Serializable {
  ...
  public ValidateCommunicationChannelRequest channelType(@javax.annotation.Nonnull ChannelTypeEnum channelType) {
  ...
  public ValidateCommunicationChannelRequest channelIdentifier(@javax.annotation.Nonnull String channelIdentifier) {
  ...
  public ValidateCommunicationChannelRequest eventType(@javax.annotation.Nonnull EventTypeEnum eventType) {
   ...
   * @return the ValidateCommunicationChannelRequest instance itself
   */
  public ValidateCommunicationChannelRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ValidateCommunicationChannelRequest validateCommunicationChannelRequest = (ValidateCommunicationChannelRequest) o;
    return Objects.equals(this.channelType, validateCommunicationChannelRequest.channelType) &&
        Objects.equals(this.channelIdentifier, validateCommunicationChannelRequest.channelIdentifier) &&
        Objects.equals(this.eventType, validateCommunicationChannelRequest.eventType)&&
        Objects.equals(this.additionalProperties, validateCommunicationChannelRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelType, channelIdentifier, eventType, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ValidateCommunicationChannelRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ValidateCommunicationChannelRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ValidateCommunicationChannelRequest is not found in the empty JSON string", ValidateCommunicationChannelRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("channel_identifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `channel_identifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("channel_identifier").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ValidateCommunicationChannelRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ValidateCommunicationChannelRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ValidateCommunicationChannelRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ValidateCommunicationChannelRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ValidateCommunicationChannelRequest>() {
           @Override
           public void write(JsonWriter out, ValidateCommunicationChannelRequest value) throws IOException {
           ...
           @Override
           public ValidateCommunicationChannelRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ValidateCommunicationChannelRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   */
  public static ValidateCommunicationChannelRequest fromJson(String jsonString) throws IOException {
