...
public class WebhookKeyValuePair implements Serializable {
   ...
   * @return the WebhookKeyValuePair instance itself
   */
  public WebhookKeyValuePair putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, webhookKeyValuePair.key) &&
        ...
        Objects.equals(this.additionalProperties, webhookKeyValuePair.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookKeyValuePair.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookKeyValuePair is not found in the empty JSON string", WebhookKeyValuePair.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookKeyValuePair>() {
           @Override
           public void write(JsonWriter out, WebhookKeyValuePair value) throws IOException {
           ...
           public WebhookKeyValuePair read(JsonReader in) throws IOException {
             ...
             WebhookKeyValuePair instance = thisAdapter.fromJsonTree(jsonObj);
