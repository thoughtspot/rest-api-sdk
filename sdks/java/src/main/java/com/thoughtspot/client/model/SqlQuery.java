...
public class SqlQuery implements Serializable {
   ...
   * @return the SqlQuery instance itself
   */
  public SqlQuery putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataId, sqlQuery.metadataId) &&
        ...
        Objects.equals(this.additionalProperties, sqlQuery.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataId, metadataName, sqlQuery, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SqlQuery>() {
           ...
           public SqlQuery read(JsonReader in) throws IOException {
             ...
             SqlQuery instance = thisAdapter.fromJsonTree(jsonObj);
