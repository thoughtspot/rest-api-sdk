...
public class CreateCalendarRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createCalendarRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, createCalendarRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, creationMethod, tableReference, startDate, endDate, calendarType, monthOffset, startDayOfWeek, quarterNamePrefix, yearNamePrefix, additionalProperties);
  }
