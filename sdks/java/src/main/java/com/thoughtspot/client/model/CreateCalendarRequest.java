...
public class CreateCalendarRequest implements Serializable {
    ...
    public enum CreationMethodEnum {
        ...
        public static class Adapter extends TypeAdapter<CreationMethodEnum> {
            @Override
            public void write(final JsonWriter jsonWriter, final CreationMethodEnum enumeration)
                    throws IOException {
    ...
    public CreateCalendarRequest creationMethod(
            @javax.annotation.Nonnull CreationMethodEnum creationMethod) {
    ...
    public CreateCalendarRequest tableReference(
     ...
     * \&quot;table_name\&quot;:\&quot;tb1\&quot;}&#x60;. The given table will be created if
    ...
    public CreateCalendarRequest calendarType(
    ...
    public CreateCalendarRequest monthOffset(
    ...
    public CreateCalendarRequest startDayOfWeek(
    ...
    public CreateCalendarRequest quarterNamePrefix(
     ...
     * @return the CreateCalendarRequest instance itself
     */
    public CreateCalendarRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, createCalendarRequest.name)
                ...
                && Objects.equals(
                        this.additionalProperties, createCalendarRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CreateCalendarRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CreateCalendarRequest is not found in"
                                        + " the empty JSON string",
                                CreateCalendarRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        if (!jsonObj.get("creation_method").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `creation_method` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("creation_method").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CreateCalendarRequest>() {
                        @Override
                        public void write(JsonWriter out, CreateCalendarRequest value)
                                throws IOException {
                        ...
                        public CreateCalendarRequest read(JsonReader in) throws IOException {
                            ...
                            CreateCalendarRequest instance = thisAdapter.fromJsonTree(jsonObj);
