...
import com.thoughtspot.client.model.FeatureDetail;
...
public class FeatureGroup implements Serializable {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("feature_group") != null && !jsonObj.get("feature_group").isJsonNull()) && !jsonObj.get("feature_group").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `feature_group` to be a primitive type in the JSON string but got `%s`", jsonObj.get("feature_group").toString()));
      }
