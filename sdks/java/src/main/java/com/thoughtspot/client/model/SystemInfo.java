...
public class SystemInfo implements Serializable {
     ...
     * @return the SystemInfo instance itself
     */
    public SystemInfo putAdditionalProperty(String key, Object value) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SystemInfo>() {
                        ...
                        public SystemInfo read(JsonReader in) throws IOException {
                            ...
                            SystemInfo instance = thisAdapter.fromJsonTree(jsonObj);
