...
public class WebhookOrg implements Serializable {
     ...
     * @return the WebhookOrg instance itself
     */
    public WebhookOrg putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, webhookOrg.id)
                ...
                && Objects.equals(this.additionalProperties, webhookOrg.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookOrg.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookOrg is not found in the empty"
                                        + " JSON string",
                                WebhookOrg.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookOrg>() {
                        ...
                        public WebhookOrg read(JsonReader in) throws IOException {
                            ...
                            WebhookOrg instance = thisAdapter.fromJsonTree(jsonObj);
