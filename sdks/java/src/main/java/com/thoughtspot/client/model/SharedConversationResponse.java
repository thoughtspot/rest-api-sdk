...
import com.thoughtspot.client.model.CodeExecutionFileMetadata;
import com.thoughtspot.client.model.ConversationMessage;
import com.thoughtspot.client.model.DataSourceEntry;
...
public class SharedConversationResponse implements Serializable {
  ...
  public SharedConversationResponse conversationId(@javax.annotation.Nonnull String conversationId) {
  ...
  public SharedConversationResponse sharedConversationId(@javax.annotation.Nonnull String sharedConversationId) {
  ...
  public SharedConversationResponse conversationTitle(@javax.annotation.Nullable String conversationTitle) {
  ...
  public SharedConversationResponse creatorUserId(@javax.annotation.Nullable String creatorUserId) {
  ...
  public SharedConversationResponse dataSources(@javax.annotation.Nonnull List<DataSourceEntry> dataSources) {
  ...
  public SharedConversationResponse analystIds(@javax.annotation.Nonnull List<String> analystIds) {
  ...
  public SharedConversationResponse messages(@javax.annotation.Nonnull List<ConversationMessage> messages) {
  ...
  public SharedConversationResponse codeExecutionFiles(@javax.annotation.Nonnull List<CodeExecutionFileMetadata> codeExecutionFiles) {
    this.codeExecutionFiles = codeExecutionFiles;
    return this;
  }

  public SharedConversationResponse addCodeExecutionFilesItem(CodeExecutionFileMetadata codeExecutionFilesItem) {
  ...
  public void setCodeExecutionFiles(@javax.annotation.Nonnull List<CodeExecutionFileMetadata> codeExecutionFiles) {
    this.codeExecutionFiles = codeExecutionFiles;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conversationId, sharedConversationResponse.conversationId) &&
        Objects.equals(this.sharedConversationId, sharedConversationResponse.sharedConversationId) &&
        Objects.equals(this.conversationTitle, sharedConversationResponse.conversationTitle) &&
        ...
        Objects.equals(this.codeExecutionFiles, sharedConversationResponse.codeExecutionFiles)&&
        Objects.equals(this.additionalProperties, sharedConversationResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conversationId, sharedConversationId, conversationTitle, creatorUserId, dataSources, analystIds, messages, codeExecutionFiles, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    sharedConversationId: ").append(toIndentedString(sharedConversationId)).append("\n");
    ...
    sb.append("    codeExecutionFiles: ").append(toIndentedString(codeExecutionFiles)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SharedConversationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SharedConversationResponse is not found in the empty JSON string", SharedConversationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("shared_conversation_id").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `shared_conversation_id` to be a primitive type in the JSON string but got `%s`", jsonObj.get("shared_conversation_id").toString()));
      }
      if ((jsonObj.get("conversation_title") != null && !jsonObj.get("conversation_title").isJsonNull()) && !jsonObj.get("conversation_title").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `conversation_title` to be a primitive type in the JSON string but got `%s`", jsonObj.get("conversation_title").toString()));
      }
      ...
      if (jsonObj.get("analyst_ids") == null) {
        ...
        throw new IllegalArgumentException(String.format("Expected the field `analyst_ids` to be an array in the JSON string but got `%s`", jsonObj.get("analyst_ids").toString()));
      }
      // ensure the json data is an array
      ...
      if (!jsonObj.get("code_execution_files").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `code_execution_files` to be an array in the JSON string but got `%s`", jsonObj.get("code_execution_files").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SharedConversationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SharedConversationResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SharedConversationResponse>() {
           @Override
           public void write(JsonWriter out, SharedConversationResponse value) throws IOException {
