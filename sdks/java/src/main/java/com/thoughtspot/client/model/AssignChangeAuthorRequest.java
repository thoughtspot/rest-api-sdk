...
import com.thoughtspot.client.model.AuthorMetadataTypeInput;
...
public class AssignChangeAuthorRequest implements Serializable {
   ...
   * @return the AssignChangeAuthorRequest instance itself
   */
  public AssignChangeAuthorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, assignChangeAuthorRequest.metadata) &&
        ...
        Objects.equals(this.additionalProperties, assignChangeAuthorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadata, userIdentifier, currentOwnerIdentifier, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AssignChangeAuthorRequest>() {
           ...
           public AssignChangeAuthorRequest read(JsonReader in) throws IOException {
             ...
             AssignChangeAuthorRequest instance = thisAdapter.fromJsonTree(jsonObj);
