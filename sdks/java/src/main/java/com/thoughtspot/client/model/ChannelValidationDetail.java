...
import com.thoughtspot.client.model.ChannelValidationAwsS3Info;
import com.thoughtspot.client.model.ChannelValidationGcpGcsInfo;
...
public class ChannelValidationDetail implements Serializable {
  ...
  public enum ValidationStepEnum {
    ...
    public static class Adapter extends TypeAdapter<ValidationStepEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ValidationStepEnum enumeration) throws IOException {
  ...
  public ChannelValidationDetail validationStep(@javax.annotation.Nonnull ValidationStepEnum validationStep) {
  ...
  public ChannelValidationDetail awsS3Info(@javax.annotation.Nullable ChannelValidationAwsS3Info awsS3Info) {
  ...
  public ChannelValidationDetail gcpGcsInfo(@javax.annotation.Nullable ChannelValidationGcpGcsInfo gcpGcsInfo) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.validationStep, channelValidationDetail.validationStep) &&
        ...
        Objects.equals(this.additionalProperties, channelValidationDetail.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validationStep, status, httpStatus, errorMessage, awsS3Info, gcpGcsInfo, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelValidationDetail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelValidationDetail is not found in the empty JSON string", ChannelValidationDetail.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("validation_step").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `validation_step` to be a primitive type in the JSON string but got `%s`", jsonObj.get("validation_step").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelValidationDetail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelValidationDetail' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChannelValidationDetail>() {
           @Override
           public void write(JsonWriter out, ChannelValidationDetail value) throws IOException {
