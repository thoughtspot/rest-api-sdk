...
public class RuntimeSort implements Serializable {
   ...
   * @return the RuntimeSort instance itself
   */
  public RuntimeSort putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.runtimeSort, runtimeSort.runtimeSort)&&
        Objects.equals(this.additionalProperties, runtimeSort.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(runtimeSort, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RuntimeSort.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RuntimeSort is not found in the empty JSON string", RuntimeSort.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RuntimeSort>() {
           @Override
           ...
           public RuntimeSort read(JsonReader in) throws IOException {
             ...
             RuntimeSort instance = thisAdapter.fromJsonTree(jsonObj);
