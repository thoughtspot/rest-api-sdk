...
public class ScheduleHistoryRunsOptionsInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.includeHistoryRuns, scheduleHistoryRunsOptionsInput.includeHistoryRuns) &&
        ...
        Objects.equals(this.additionalProperties, scheduleHistoryRunsOptionsInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ScheduleHistoryRunsOptionsInput>() {
           ...
           public ScheduleHistoryRunsOptionsInput read(JsonReader in) throws IOException {
             ...
             ScheduleHistoryRunsOptionsInput instance = thisAdapter.fromJsonTree(jsonObj);
