...
public class SingleAnswerRequest implements Serializable {
    ...
    public SingleAnswerRequest metadataIdentifier(
     ...
     * @return the SingleAnswerRequest instance itself
     */
    public SingleAnswerRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.query, singleAnswerRequest.query)
                ...
                && Objects.equals(
                        this.additionalProperties, singleAnswerRequest.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(query, metadataIdentifier, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SingleAnswerRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SingleAnswerRequest is not found in"
                                        + " the empty JSON string",
                                SingleAnswerRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SingleAnswerRequest>() {
                        @Override
                        public void write(JsonWriter out, SingleAnswerRequest value)
                                throws IOException {
                        ...
                        public SingleAnswerRequest read(JsonReader in) throws IOException {
                            ...
                            SingleAnswerRequest instance = thisAdapter.fromJsonTree(jsonObj);
