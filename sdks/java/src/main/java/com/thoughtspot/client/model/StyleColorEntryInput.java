...
public class StyleColorEntryInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.primary, styleColorEntryInput.primary) &&
        ...
        Objects.equals(this.additionalProperties, styleColorEntryInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StyleColorEntryInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StyleColorEntryInput is not found in the empty JSON string", StyleColorEntryInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("secondary") != null && !jsonObj.get("secondary").isJsonNull() && !jsonObj.get("secondary").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StyleColorEntryInput>() {
           @Override
           public void write(JsonWriter out, StyleColorEntryInput value) throws IOException {
