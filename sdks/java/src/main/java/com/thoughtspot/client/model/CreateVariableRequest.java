...
public class CreateVariableRequest implements Serializable {
   ...
   * @return the CreateVariableRequest instance itself
   */
  public CreateVariableRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, createVariableRequest.type) &&
        ...
        Objects.equals(this.additionalProperties, createVariableRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, name, isSensitive, dataType, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateVariableRequest>() {
           ...
           public CreateVariableRequest read(JsonReader in) throws IOException {
             ...
             CreateVariableRequest instance = thisAdapter.fromJsonTree(jsonObj);
