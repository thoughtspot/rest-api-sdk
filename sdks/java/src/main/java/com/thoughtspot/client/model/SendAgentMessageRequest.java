...
public class SendAgentMessageRequest implements Serializable {
   ...
   * @return the SendAgentMessageRequest instance itself
   */
  public SendAgentMessageRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.messages, sendAgentMessageRequest.messages)&&
        Objects.equals(this.additionalProperties, sendAgentMessageRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendAgentMessageRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendAgentMessageRequest is not found in the empty JSON string", SendAgentMessageRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendAgentMessageRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendAgentMessageRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SendAgentMessageRequest>() {
           @Override
           public void write(JsonWriter out, SendAgentMessageRequest value) throws IOException {
           ...
           public SendAgentMessageRequest read(JsonReader in) throws IOException {
             ...
             SendAgentMessageRequest instance = thisAdapter.fromJsonTree(jsonObj);
