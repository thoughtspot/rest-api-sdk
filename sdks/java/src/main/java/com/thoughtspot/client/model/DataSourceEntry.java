...
public class DataSourceEntry implements Serializable {
    ...
    public DataSourceEntry id(@javax.annotation.Nonnull String id) {
        this.id = id;
        return this;
    }
    ...
    public DataSourceEntry name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the DataSourceEntry instance itself
     */
    public DataSourceEntry putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, dataSourceEntry.id)
                && Objects.equals(this.name, dataSourceEntry.name)
                && Objects.equals(this.additionalProperties, dataSourceEntry.additionalProperties);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to DataSourceEntry
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DataSourceEntry.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DataSourceEntry is not found in the"
                                        + " empty JSON string",
                                DataSourceEntry.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DataSourceEntry>() {
                        @Override
                        public void write(JsonWriter out, DataSourceEntry value)
                                throws IOException {
                        ...
                        public DataSourceEntry read(JsonReader in) throws IOException {
                            ...
                            DataSourceEntry instance = thisAdapter.fromJsonTree(jsonObj);
