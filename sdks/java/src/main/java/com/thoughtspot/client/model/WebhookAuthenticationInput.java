...
import com.thoughtspot.client.model.WebhookAuthApiKeyInput;
import com.thoughtspot.client.model.WebhookAuthBasicAuthInput;
import com.thoughtspot.client.model.WebhookAuthOAuth2Input;
...
public class WebhookAuthenticationInput implements Serializable {
  ...
  public WebhookAuthenticationInput API_KEY(@javax.annotation.Nullable WebhookAuthApiKeyInput API_KEY) {
  ...
  public WebhookAuthenticationInput BASIC_AUTH(@javax.annotation.Nullable WebhookAuthBasicAuthInput BASIC_AUTH) {
  ...
  public WebhookAuthenticationInput OAUTH2(@javax.annotation.Nullable WebhookAuthOAuth2Input OAUTH2) {
    this.OAUTH2 = OAUTH2;
    return this;
  }
   ...
   * @return the WebhookAuthenticationInput instance itself
   */
  public WebhookAuthenticationInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.API_KEY, webhookAuthenticationInput.API_KEY) &&
        ...
        Objects.equals(this.additionalProperties, webhookAuthenticationInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(API_KEY, BASIC_AUTH, BEARER_TOKEN, OAUTH2, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookAuthenticationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookAuthenticationInput is not found in the empty JSON string", WebhookAuthenticationInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookAuthenticationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookAuthenticationInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookAuthenticationInput>() {
           @Override
           public void write(JsonWriter out, WebhookAuthenticationInput value) throws IOException {
           ...
           public WebhookAuthenticationInput read(JsonReader in) throws IOException {
             ...
             WebhookAuthenticationInput instance = thisAdapter.fromJsonTree(jsonObj);
