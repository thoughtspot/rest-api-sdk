...
import com.thoughtspot.client.model.AnswerContent;
...
public class AnswerDataResponse implements Serializable {
   ...
   * @return the AnswerDataResponse instance itself
   */
  public AnswerDataResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataId, answerDataResponse.metadataId) &&
        ...
        Objects.equals(this.additionalProperties, answerDataResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataId, metadataName, contents, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnswerDataResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnswerDataResponse>() {
           ...
           public AnswerDataResponse read(JsonReader in) throws IOException {
             ...
             AnswerDataResponse instance = thisAdapter.fromJsonTree(jsonObj);
