...
import com.thoughtspot.client.model.APIKeyInput;
import com.thoughtspot.client.model.BasicAuthInput;
...
public class AuthenticationInput implements Serializable {
   ...
   * @return the AuthenticationInput instance itself
   */
  public AuthenticationInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.apIKey, authenticationInput.apIKey) &&
        ...
        Objects.equals(this.additionalProperties, authenticationInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(apIKey, basicAuth, bearerToken, noAuth, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthenticationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AuthenticationInput>() {
           ...
           public AuthenticationInput read(JsonReader in) throws IOException {
             ...
             AuthenticationInput instance = thisAdapter.fromJsonTree(jsonObj);
