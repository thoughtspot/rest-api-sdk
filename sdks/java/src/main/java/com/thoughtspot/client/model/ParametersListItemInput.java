...
public class ParametersListItemInput implements Serializable {
   ...
   * @return the ParametersListItemInput instance itself
   */
  public ParametersListItemInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, parametersListItemInput.key) &&
        ...
        Objects.equals(this.additionalProperties, parametersListItemInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParametersListItemInput>() {
           ...
           public ParametersListItemInput read(JsonReader in) throws IOException {
             ...
             ParametersListItemInput instance = thisAdapter.fromJsonTree(jsonObj);
