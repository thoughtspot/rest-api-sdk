...
public class StyleFontDeleteAffectedAssignment implements Serializable {
  ...
  public StyleFontDeleteAffectedAssignment visualizationAreas(@javax.annotation.Nullable List<VisualizationAreasEnum> visualizationAreas) {
    this.visualizationAreas = visualizationAreas;
    return this;
  }

  public StyleFontDeleteAffectedAssignment addVisualizationAreasItem(VisualizationAreasEnum visualizationAreasItem) {
  ...
  public boolean equals(Object o) {
    ...
    StyleFontDeleteAffectedAssignment styleFontDeleteAffectedAssignment = (StyleFontDeleteAffectedAssignment) o;
    return Objects.equals(this.org, styleFontDeleteAffectedAssignment.org) &&
        Objects.equals(this.visualizationAreas, styleFontDeleteAffectedAssignment.visualizationAreas)&&
        Objects.equals(this.additionalProperties, styleFontDeleteAffectedAssignment.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to StyleFontDeleteAffectedAssignment
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StyleFontDeleteAffectedAssignment.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StyleFontDeleteAffectedAssignment is not found in the empty JSON string", StyleFontDeleteAffectedAssignment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StyleFontDeleteAffectedAssignment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StyleFontDeleteAffectedAssignment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StyleFontDeleteAffectedAssignment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StyleFontDeleteAffectedAssignment.class));

       return (TypeAdapter<T>) new TypeAdapter<StyleFontDeleteAffectedAssignment>() {
           @Override
           public void write(JsonWriter out, StyleFontDeleteAffectedAssignment value) throws IOException {
           ...
           @Override
           public StyleFontDeleteAffectedAssignment read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             StyleFontDeleteAffectedAssignment instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to StyleFontDeleteAffectedAssignment
   */
