...
public class ExportMetadataTypeInput implements Serializable {
  ...
  public ExportMetadataTypeInput type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ExportMetadataTypeInput sessionIdentifier(@javax.annotation.Nullable String sessionIdentifier) {
  ...
  public ExportMetadataTypeInput generationNumber(@javax.annotation.Nullable Integer generationNumber) {
   ...
   * @return the ExportMetadataTypeInput instance itself
   */
  public ExportMetadataTypeInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, exportMetadataTypeInput.type) &&
        ...
        Objects.equals(this.additionalProperties, exportMetadataTypeInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, identifier, sessionIdentifier, generationNumber, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportMetadataTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportMetadataTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExportMetadataTypeInput>() {
           ...
           public ExportMetadataTypeInput read(JsonReader in) throws IOException {
             ...
             ExportMetadataTypeInput instance = thisAdapter.fromJsonTree(jsonObj);
