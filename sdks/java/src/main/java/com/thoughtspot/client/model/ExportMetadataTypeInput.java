...
public class ExportMetadataTypeInput implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.type, exportMetadataTypeInput.type)
                ...
                && Objects.equals(
                        this.additionalProperties, exportMetadataTypeInput.additionalProperties);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                type, identifier, sessionIdentifier, generationNumber, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExportMetadataTypeInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ExportMetadataTypeInput is not found"
                                        + " in the empty JSON string",
                                ExportMetadataTypeInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExportMetadataTypeInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExportMetadataTypeInput' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ExportMetadataTypeInput>() {
                        @Override
                        public void write(JsonWriter out, ExportMetadataTypeInput value)
                                throws IOException {
