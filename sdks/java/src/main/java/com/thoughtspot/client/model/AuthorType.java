...
public class AuthorType implements Serializable {
   ...
   * @return the AuthorType instance itself
   */
  public AuthorType putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, authorType.email) &&
        ...
        Objects.equals(this.additionalProperties, authorType.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AuthorType.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AuthorType>() {
           ...
           public AuthorType read(JsonReader in) throws IOException {
             ...
             AuthorType instance = thisAdapter.fromJsonTree(jsonObj);
