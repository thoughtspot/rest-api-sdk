...
public class TableFontAssignmentInput implements Serializable {
  ...
  public TableFontAssignmentInput visualizationArea(@javax.annotation.Nonnull VisualizationAreaEnum visualizationArea) {
  ...
  public TableFontAssignmentInput fontIdentifier(@javax.annotation.Nonnull String fontIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visualizationArea, tableFontAssignmentInput.visualizationArea) &&
        ...
        Objects.equals(this.additionalProperties, tableFontAssignmentInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TableFontAssignmentInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TableFontAssignmentInput is not found in the empty JSON string", TableFontAssignmentInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TableFontAssignmentInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TableFontAssignmentInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<TableFontAssignmentInput>() {
           @Override
           public void write(JsonWriter out, TableFontAssignmentInput value) throws IOException {
