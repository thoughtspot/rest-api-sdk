...
import com.thoughtspot.client.model.VariableUpdateAssignmentInput;
import com.thoughtspot.client.model.VariableUpdateScopeInput;
...
public class UpdateVariableValuesRequest implements Serializable {
  ...
  public UpdateVariableValuesRequest variableAssignment(@javax.annotation.Nonnull List<VariableUpdateAssignmentInput> variableAssignment) {
    this.variableAssignment = variableAssignment;
    return this;
  }

  public UpdateVariableValuesRequest addVariableAssignmentItem(VariableUpdateAssignmentInput variableAssignmentItem) {
  ...
  public void setVariableAssignment(@javax.annotation.Nonnull List<VariableUpdateAssignmentInput> variableAssignment) {
    this.variableAssignment = variableAssignment;
  }


  public UpdateVariableValuesRequest variableValueScope(@javax.annotation.Nonnull List<VariableUpdateScopeInput> variableValueScope) {
    this.variableValueScope = variableValueScope;
    return this;
  }

  public UpdateVariableValuesRequest addVariableValueScopeItem(VariableUpdateScopeInput variableValueScopeItem) {
  ...
  public void setVariableValueScope(@javax.annotation.Nonnull List<VariableUpdateScopeInput> variableValueScope) {
    this.variableValueScope = variableValueScope;
  }
   ...
   * @return the UpdateVariableValuesRequest instance itself
   */
  public UpdateVariableValuesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.variableAssignment, updateVariableValuesRequest.variableAssignment) &&
        Objects.equals(this.variableValueScope, updateVariableValuesRequest.variableValueScope)&&
        Objects.equals(this.additionalProperties, updateVariableValuesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variableAssignment, variableValueScope, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateVariableValuesRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateVariableValuesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateVariableValuesRequest is not found in the empty JSON string", UpdateVariableValuesRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("variable_assignment").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `variable_assignment` to be an array in the JSON string but got `%s`", jsonObj.get("variable_assignment").toString()));
      }
      ...
      if (!jsonObj.get("variable_value_scope").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `variable_value_scope` to be an array in the JSON string but got `%s`", jsonObj.get("variable_value_scope").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateVariableValuesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateVariableValuesRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateVariableValuesRequest>() {
           @Override
           public void write(JsonWriter out, UpdateVariableValuesRequest value) throws IOException {
           ...
           public UpdateVariableValuesRequest read(JsonReader in) throws IOException {
             ...
             UpdateVariableValuesRequest instance = thisAdapter.fromJsonTree(jsonObj);
