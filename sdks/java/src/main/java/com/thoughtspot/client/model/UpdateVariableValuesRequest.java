...
import com.thoughtspot.client.model.VariableValueInput;
...
public class UpdateVariableValuesRequest implements Serializable {
  ...
  public UpdateVariableValuesRequest variableUpdates(@javax.annotation.Nonnull List<VariableValueInput> variableUpdates) {
    this.variableUpdates = variableUpdates;
    return this;
  }

  public UpdateVariableValuesRequest addVariableUpdatesItem(VariableValueInput variableUpdatesItem) {
  ...
  public void setVariableUpdates(@javax.annotation.Nonnull List<VariableValueInput> variableUpdates) {
    this.variableUpdates = variableUpdates;
  }


  public UpdateVariableValuesRequest operation(@javax.annotation.Nonnull OperationEnum operation) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (!jsonObj.get("variable_updates").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `variable_updates` to be an array in the JSON string but got `%s`", jsonObj.get("variable_updates").toString()));
      }
