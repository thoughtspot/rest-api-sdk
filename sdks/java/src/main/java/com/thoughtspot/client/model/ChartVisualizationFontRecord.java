...
public class ChartVisualizationFontRecord implements Serializable {
  ...
  public ChartVisualizationFontRecord visualizationArea(@javax.annotation.Nullable VisualizationAreaEnum visualizationArea) {
  ...
  public ChartVisualizationFontRecord isOverridden(@javax.annotation.Nullable Boolean isOverridden) {
  ...
  public boolean equals(Object o) {
    ...
    ChartVisualizationFontRecord chartVisualizationFontRecord = (ChartVisualizationFontRecord) o;
    return Objects.equals(this.visualizationArea, chartVisualizationFontRecord.visualizationArea) &&
        ...
        Objects.equals(this.additionalProperties, chartVisualizationFontRecord.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChartVisualizationFontRecord
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChartVisualizationFontRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChartVisualizationFontRecord is not found in the empty JSON string", ChartVisualizationFontRecord.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChartVisualizationFontRecord.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChartVisualizationFontRecord' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChartVisualizationFontRecord> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChartVisualizationFontRecord.class));

       return (TypeAdapter<T>) new TypeAdapter<ChartVisualizationFontRecord>() {
           @Override
           public void write(JsonWriter out, ChartVisualizationFontRecord value) throws IOException {
           ...
           public ChartVisualizationFontRecord read(JsonReader in) throws IOException {
             ...
             ChartVisualizationFontRecord instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to ChartVisualizationFontRecord
   */
