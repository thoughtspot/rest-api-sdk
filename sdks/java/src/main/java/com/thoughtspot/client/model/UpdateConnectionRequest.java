...
public class UpdateConnectionRequest implements Serializable {
   ...
   * @return the UpdateConnectionRequest instance itself
   */
  public UpdateConnectionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionIdentifier, updateConnectionRequest.connectionIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, updateConnectionRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(connectionIdentifier, name, description, dataWarehouseConfig, validate, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateConnectionRequest>() {
           ...
           public UpdateConnectionRequest read(JsonReader in) throws IOException {
             ...
             UpdateConnectionRequest instance = thisAdapter.fromJsonTree(jsonObj);
