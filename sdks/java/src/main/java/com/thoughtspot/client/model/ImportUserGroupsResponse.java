...
public class ImportUserGroupsResponse implements Serializable {
    ...
    public ImportUserGroupsResponse groupsAdded(
            @javax.annotation.Nonnull List<UserGroup> groupsAdded) {
    ...
    public ImportUserGroupsResponse groupsDeleted(
            @javax.annotation.Nonnull List<UserGroup> groupsDeleted) {
    ...
    public ImportUserGroupsResponse groupsUpdated(
            @javax.annotation.Nonnull List<UserGroup> groupsUpdated) {
     ...
     * @return the ImportUserGroupsResponse instance itself
     */
    public ImportUserGroupsResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.groupsAdded, importUserGroupsResponse.groupsAdded)
                ...
                && Objects.equals(
                        this.additionalProperties, importUserGroupsResponse.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(groupsAdded, groupsDeleted, groupsUpdated, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImportUserGroupsResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ImportUserGroupsResponse is not found"
                                        + " in the empty JSON string",
                                ImportUserGroupsResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        if (!jsonObj.get("groups_added").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `groups_added` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("groups_added").toString()));
        }
        ...
        if (!jsonObj.get("groups_deleted").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `groups_deleted` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("groups_deleted").toString()));
        }
        ...
        if (!jsonObj.get("groups_updated").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `groups_updated` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("groups_updated").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ImportUserGroupsResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ImportUserGroupsResponse' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ImportUserGroupsResponse>() {
                        @Override
                        public void write(JsonWriter out, ImportUserGroupsResponse value)
                                throws IOException {
                        ...
                        public ImportUserGroupsResponse read(JsonReader in) throws IOException {
                            ...
                            ImportUserGroupsResponse instance = thisAdapter.fromJsonTree(jsonObj);
