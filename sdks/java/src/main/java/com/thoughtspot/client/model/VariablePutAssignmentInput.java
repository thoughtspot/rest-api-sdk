...
public class VariablePutAssignmentInput implements Serializable {
    ...
    public VariablePutAssignmentInput assignedValues(
            @javax.annotation.Nonnull List<String> assignedValues) {
    ...
    public VariablePutAssignmentInput orgIdentifier(
    ...
    public VariablePutAssignmentInput principalType(
    ...
    public VariablePutAssignmentInput principalIdentifier(
    ...
    public VariablePutAssignmentInput modelIdentifier(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.assignedValues, variablePutAssignmentInput.assignedValues)
                ...
                && Objects.equals(
                        this.principalIdentifier, variablePutAssignmentInput.principalIdentifier)
                ...
                && Objects.equals(
                        this.additionalProperties, variablePutAssignmentInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VariablePutAssignmentInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in VariablePutAssignmentInput is not"
                                        + " found in the empty JSON string",
                                VariablePutAssignmentInput.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("assigned_values") == null) {
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `assigned_values` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("assigned_values").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VariablePutAssignmentInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VariablePutAssignmentInput' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<VariablePutAssignmentInput>() {
                        @Override
                        public void write(JsonWriter out, VariablePutAssignmentInput value)
                                throws IOException {
