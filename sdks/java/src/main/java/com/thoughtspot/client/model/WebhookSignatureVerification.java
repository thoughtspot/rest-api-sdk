...
public class WebhookSignatureVerification implements Serializable {
    ...
    public WebhookSignatureVerification algorithm(
     ...
     * @return the WebhookSignatureVerification instance itself
     */
    public WebhookSignatureVerification putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        WebhookSignatureVerification webhookSignatureVerification =
                (WebhookSignatureVerification) o;
        return Objects.equals(this.type, webhookSignatureVerification.type)
                ...
                && Objects.equals(
                        ...
                        webhookSignatureVerification.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookSignatureVerification.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookSignatureVerification is not"
                                        + " found in the empty JSON string",
                                WebhookSignatureVerification.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WebhookSignatureVerification.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WebhookSignatureVerification' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<WebhookSignatureVerification> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(WebhookSignatureVerification.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookSignatureVerification>() {
                        @Override
                        public void write(JsonWriter out, WebhookSignatureVerification value)
                                throws IOException {
                        ...
                        public WebhookSignatureVerification read(JsonReader in) throws IOException {
                            ...
                            WebhookSignatureVerification instance =
