...
public class ChannelValidationGcpGcsInfo implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bucketName, channelValidationGcpGcsInfo.bucketName) &&
        ...
        Objects.equals(this.additionalProperties, channelValidationGcpGcsInfo.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ChannelValidationGcpGcsInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelValidationGcpGcsInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelValidationGcpGcsInfo is not found in the empty JSON string", ChannelValidationGcpGcsInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelValidationGcpGcsInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelValidationGcpGcsInfo' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChannelValidationGcpGcsInfo>() {
           @Override
           public void write(JsonWriter out, ChannelValidationGcpGcsInfo value) throws IOException {
           ...
           public ChannelValidationGcpGcsInfo read(JsonReader in) throws IOException {
             ...
             ChannelValidationGcpGcsInfo instance = thisAdapter.fromJsonTree(jsonObj);
