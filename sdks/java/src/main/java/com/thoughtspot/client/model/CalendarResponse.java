...
public class CalendarResponse implements Serializable {
  ...
  public CalendarResponse modificationTimeInMillis(@javax.annotation.Nullable String modificationTimeInMillis) {
  ...
  public void setModificationTimeInMillis(@javax.annotation.Nullable String modificationTimeInMillis) {
    this.modificationTimeInMillis = modificationTimeInMillis;
  }
   ...
   * @return the CalendarResponse instance itself
   */
  public CalendarResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.calendarName, calendarResponse.calendarName) &&
        ...
        Objects.equals(this.modificationTimeInMillis, calendarResponse.modificationTimeInMillis) &&
        ...
        Objects.equals(this.additionalProperties, calendarResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(calendarName, connectionName, dataWarehouseType, modificationTimeInMillis, authorName, connectionId, calendarId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("calendar_name") != null && !jsonObj.get("calendar_name").isJsonNull()) && !jsonObj.get("calendar_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `calendar_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("calendar_name").toString()));
      }
      ...
      if ((jsonObj.get("modification_time_in_millis") != null && !jsonObj.get("modification_time_in_millis").isJsonNull()) && !jsonObj.get("modification_time_in_millis").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `modification_time_in_millis` to be a primitive type in the JSON string but got `%s`", jsonObj.get("modification_time_in_millis").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CalendarResponse>() {
           ...
           public CalendarResponse read(JsonReader in) throws IOException {
             ...
             CalendarResponse instance = thisAdapter.fromJsonTree(jsonObj);
