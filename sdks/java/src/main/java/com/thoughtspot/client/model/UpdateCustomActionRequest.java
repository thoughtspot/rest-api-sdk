...
import com.thoughtspot.client.model.ActionDetailsInput;
import com.thoughtspot.client.model.AssociateMetadataInput;
import com.thoughtspot.client.model.DefaultActionConfigInput;
...
public class UpdateCustomActionRequest implements Serializable {
   ...
   * @return the UpdateCustomActionRequest instance itself
   */
  public UpdateCustomActionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionDetails, updateCustomActionRequest.actionDetails) &&
        ...
        Objects.equals(this.additionalProperties, updateCustomActionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actionDetails, associateMetadata, defaultActionConfig, groupIdentifiers, name, operation, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateCustomActionRequest>() {
           ...
           public UpdateCustomActionRequest read(JsonReader in) throws IOException {
             ...
             UpdateCustomActionRequest instance = thisAdapter.fromJsonTree(jsonObj);
