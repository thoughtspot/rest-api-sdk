...
public class CollectionDeleteTypeIdentifiers implements Serializable {
  ...
  public CollectionDeleteTypeIdentifiers identifiers(@javax.annotation.Nullable List<GenericInfo> identifiers) {
   ...
   * @return the CollectionDeleteTypeIdentifiers instance itself
   */
  public CollectionDeleteTypeIdentifiers putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CollectionDeleteTypeIdentifiers collectionDeleteTypeIdentifiers = (CollectionDeleteTypeIdentifiers) o;
    return Objects.equals(this.type, collectionDeleteTypeIdentifiers.type) &&
        ...
        Objects.equals(this.additionalProperties, collectionDeleteTypeIdentifiers.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CollectionDeleteTypeIdentifiers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionDeleteTypeIdentifiers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionDeleteTypeIdentifiers is not found in the empty JSON string", CollectionDeleteTypeIdentifiers.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionDeleteTypeIdentifiers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionDeleteTypeIdentifiers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectionDeleteTypeIdentifiers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectionDeleteTypeIdentifiers.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectionDeleteTypeIdentifiers>() {
           @Override
           public void write(JsonWriter out, CollectionDeleteTypeIdentifiers value) throws IOException {
           ...
           @Override
           public CollectionDeleteTypeIdentifiers read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CollectionDeleteTypeIdentifiers instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to CollectionDeleteTypeIdentifiers
   */
