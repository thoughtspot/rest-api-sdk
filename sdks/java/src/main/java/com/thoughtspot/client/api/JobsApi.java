...
public class JobsApi {
     ...
     */
    public okhttp3.Call searchChannelHistoryCall(SearchChannelHistoryRequest searchChannelHistoryRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call searchChannelHistoryValidateBeforeCall(SearchChannelHistoryRequest searchChannelHistoryRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'searchChannelHistoryRequest' is set
        if (searchChannelHistoryRequest == null) {
            throw new ApiException("Missing the required parameter 'searchChannelHistoryRequest' when calling searchChannelHistory(Async)");
        }
     ...
     */
    public SearchChannelHistoryResponse searchChannelHistory(SearchChannelHistoryRequest searchChannelHistoryRequest) throws ApiException {
        ApiResponse<SearchChannelHistoryResponse> localVarResp = searchChannelHistoryWithHttpInfo(searchChannelHistoryRequest);
     ...
     */
    public ApiResponse<SearchChannelHistoryResponse> searchChannelHistoryWithHttpInfo(SearchChannelHistoryRequest searchChannelHistoryRequest) throws ApiException {
        okhttp3.Call localVarCall = searchChannelHistoryValidateBeforeCall(searchChannelHistoryRequest, null);
     ...
     */
    public okhttp3.Call searchChannelHistoryAsync(SearchChannelHistoryRequest searchChannelHistoryRequest, final ApiCallback<SearchChannelHistoryResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchChannelHistoryValidateBeforeCall(searchChannelHistoryRequest, _callback);
        Type localVarReturnType = new TypeToken<SearchChannelHistoryResponse>(){}.getType();
