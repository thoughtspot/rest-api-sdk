...
public class DataSourceContextInput implements Serializable {
  ...
  public DataSourceContextInput dataSourceIdentifier(@javax.annotation.Nullable String dataSourceIdentifier) {
  ...
  public DataSourceContextInput dataSourceIdentifiers(@javax.annotation.Nullable List<String> dataSourceIdentifiers) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSourceIdentifier, dataSourceContextInput.dataSourceIdentifier) &&
        Objects.equals(this.dataSourceIdentifiers, dataSourceContextInput.dataSourceIdentifiers) &&
        Objects.equals(this.guid, dataSourceContextInput.guid)&&
        Objects.equals(this.additionalProperties, dataSourceContextInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataSourceIdentifier, dataSourceIdentifiers, guid, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataSourceContextInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataSourceContextInput is not found in the empty JSON string", DataSourceContextInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataSourceContextInput>() {
           @Override
           public void write(JsonWriter out, DataSourceContextInput value) throws IOException {
