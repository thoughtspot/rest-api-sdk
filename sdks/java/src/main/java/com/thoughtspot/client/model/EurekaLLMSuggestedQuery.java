...
public class EurekaLLMSuggestedQuery implements Serializable {
   ...
   * @return the EurekaLLMSuggestedQuery instance itself
   */
  public EurekaLLMSuggestedQuery putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.query, eurekaLLMSuggestedQuery.query) &&
        ...
        Objects.equals(this.additionalProperties, eurekaLLMSuggestedQuery.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(query, worksheetId, worksheetName, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<EurekaLLMSuggestedQuery>() {
           ...
           public EurekaLLMSuggestedQuery read(JsonReader in) throws IOException {
             ...
             EurekaLLMSuggestedQuery instance = thisAdapter.fromJsonTree(jsonObj);
