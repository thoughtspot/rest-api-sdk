...
/**
 * Action details includes Type and Configuration for Custom Actions, either Callback or URL is
 * required. When both callback and url are provided, callback would be considered
 */
...
public class ActionDetailsInputCreate implements Serializable {
    ...
    public ActionDetailsInputCreate CALLBACK(
            @javax.annotation.Nullable CALLBACKInputMandatory CALLBACK) {
     ...
     * @return the ActionDetailsInputCreate instance itself
     */
    public ActionDetailsInputCreate putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.CALLBACK, actionDetailsInputCreate.CALLBACK)
                ...
                && Objects.equals(
                        this.additionalProperties, actionDetailsInputCreate.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ActionDetailsInputCreate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ActionDetailsInputCreate is not found"
                                        + " in the empty JSON string",
                                ActionDetailsInputCreate.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ActionDetailsInputCreate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ActionDetailsInputCreate' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ActionDetailsInputCreate>() {
                        @Override
                        public void write(JsonWriter out, ActionDetailsInputCreate value)
                                throws IOException {
                        ...
                        public ActionDetailsInputCreate read(JsonReader in) throws IOException {
                            ...
                            ActionDetailsInputCreate instance = thisAdapter.fromJsonTree(jsonObj);
