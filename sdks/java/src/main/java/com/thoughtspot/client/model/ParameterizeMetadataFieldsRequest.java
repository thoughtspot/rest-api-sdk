...
public class ParameterizeMetadataFieldsRequest implements Serializable {
  ...
  public ParameterizeMetadataFieldsRequest metadataType(@javax.annotation.Nullable MetadataTypeEnum metadataType) {
  ...
  public ParameterizeMetadataFieldsRequest metadataIdentifier(@javax.annotation.Nonnull String metadataIdentifier) {
  ...
  public ParameterizeMetadataFieldsRequest fieldType(@javax.annotation.Nonnull FieldTypeEnum fieldType) {
  ...
  public ParameterizeMetadataFieldsRequest fieldNames(@javax.annotation.Nonnull List<String> fieldNames) {
  ...
  public ParameterizeMetadataFieldsRequest variableIdentifier(@javax.annotation.Nonnull String variableIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    ParameterizeMetadataFieldsRequest parameterizeMetadataFieldsRequest = (ParameterizeMetadataFieldsRequest) o;
    return Objects.equals(this.metadataType, parameterizeMetadataFieldsRequest.metadataType) &&
        Objects.equals(this.metadataIdentifier, parameterizeMetadataFieldsRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.variableIdentifier, parameterizeMetadataFieldsRequest.variableIdentifier)&&
        Objects.equals(this.additionalProperties, parameterizeMetadataFieldsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataType, metadataIdentifier, fieldType, fieldNames, variableIdentifier, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParameterizeMetadataFieldsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterizeMetadataFieldsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParameterizeMetadataFieldsRequest is not found in the empty JSON string", ParameterizeMetadataFieldsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterizeMetadataFieldsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterizeMetadataFieldsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ParameterizeMetadataFieldsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ParameterizeMetadataFieldsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ParameterizeMetadataFieldsRequest>() {
           @Override
           public void write(JsonWriter out, ParameterizeMetadataFieldsRequest value) throws IOException {
           ...
           @Override
           public ParameterizeMetadataFieldsRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             ParameterizeMetadataFieldsRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to ParameterizeMetadataFieldsRequest
   */
