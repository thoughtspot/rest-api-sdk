...
public class ApiClient {
     ...
     *
     * @param apiClientConfiguration a {@link com.thoughtspot.client.ApiClientConfiguration} object
     */
    ...
    private void init() {
        ...
        setUserAgent("ThoughtSpot-Client/java/${sdkVersionFromMap}");
    ...
    */
     ...
     * @throws com.thoughtspot.client.ApiException If fail to serialize the given object
     */
