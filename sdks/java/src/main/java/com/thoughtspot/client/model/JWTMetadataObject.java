...
public class JWTMetadataObject implements Serializable {
   ...
   * @return the JWTMetadataObject instance itself
   */
  public JWTMetadataObject putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, jwTMetadataObject.identifier) &&
        ...
        Objects.equals(this.additionalProperties, jwTMetadataObject.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!JWTMetadataObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JWTMetadataObject>() {
           ...
           public JWTMetadataObject read(JsonReader in) throws IOException {
             ...
             JWTMetadataObject instance = thisAdapter.fromJsonTree(jsonObj);
