...
public class CollectionMetadataInput implements Serializable {
   ...
   * @return the CollectionMetadataInput instance itself
   */
  public CollectionMetadataInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, collectionMetadataInput.type) &&
        ...
        Objects.equals(this.additionalProperties, collectionMetadataInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionMetadataInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionMetadataInput is not found in the empty JSON string", CollectionMetadataInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionMetadataInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionMetadataInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollectionMetadataInput>() {
           @Override
           public void write(JsonWriter out, CollectionMetadataInput value) throws IOException {
           ...
           public CollectionMetadataInput read(JsonReader in) throws IOException {
             ...
             CollectionMetadataInput instance = thisAdapter.fromJsonTree(jsonObj);
