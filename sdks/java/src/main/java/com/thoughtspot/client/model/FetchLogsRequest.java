...
public class FetchLogsRequest implements Serializable {
   ...
   * @return the FetchLogsRequest instance itself
   */
  public FetchLogsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.logType, fetchLogsRequest.logType) &&
        ...
        Objects.equals(this.additionalProperties, fetchLogsRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(logType, startEpochTimeInMillis, endEpochTimeInMillis, getAllLogs, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FetchLogsRequest>() {
           ...
           public FetchLogsRequest read(JsonReader in) throws IOException {
             ...
             FetchLogsRequest instance = thisAdapter.fromJsonTree(jsonObj);
