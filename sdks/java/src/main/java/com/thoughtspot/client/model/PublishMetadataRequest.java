...
public class PublishMetadataRequest implements Serializable {
  ...
  public PublishMetadataRequest metadata(@javax.annotation.Nonnull List<PublishMetadataListItem> metadata) {
  ...
  public PublishMetadataRequest orgIdentifiers(@javax.annotation.Nonnull List<String> orgIdentifiers) {
  ...
  public PublishMetadataRequest skipValidation(@javax.annotation.Nullable Boolean skipValidation) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublishMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublishMetadataRequest is not found in the empty JSON string", PublishMetadataRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!PublishMetadataRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PublishMetadataRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PublishMetadataRequest>() {
           @Override
           public void write(JsonWriter out, PublishMetadataRequest value) throws IOException {
