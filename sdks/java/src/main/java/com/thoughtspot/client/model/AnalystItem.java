...
import com.thoughtspot.client.model.AnalystItemSource;
import com.thoughtspot.client.model.AnalystItemStarterPrompt;
import com.thoughtspot.client.model.AnalystMcpConnector;
import com.thoughtspot.client.model.AnalystUser;
...
public class AnalystItem implements Serializable {
  ...
  public static final String SERIALIZED_NAME_LAST_ACCESSED_TIME_IN_MILLIS = "last_accessed_time_in_millis";
  ...
  public AnalystItem mcpConnectors(@javax.annotation.Nonnull List<AnalystMcpConnector> mcpConnectors) {
  ...
  public void setMcpConnectors(@javax.annotation.Nonnull List<AnalystMcpConnector> mcpConnectors) {
    this.mcpConnectors = mcpConnectors;
  }
  ...
  public AnalystItem starterPrompts(@javax.annotation.Nonnull List<AnalystItemStarterPrompt> starterPrompts) {
  ...
  public void setStarterPrompts(@javax.annotation.Nonnull List<AnalystItemStarterPrompt> starterPrompts) {
    this.starterPrompts = starterPrompts;
  }
  ...
  public AnalystItem lastAccessedTimeInMillis(@javax.annotation.Nullable Object lastAccessedTimeInMillis) {
  ...
  public void setLastAccessedTimeInMillis(@javax.annotation.Nullable Object lastAccessedTimeInMillis) {
    this.lastAccessedTimeInMillis = lastAccessedTimeInMillis;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, analystItem.id) &&
        ...
        Objects.equals(this.lastAccessedTimeInMillis, analystItem.lastAccessedTimeInMillis) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, instructions, sources, mcpConnectors, iconId, starterPrompts, updatedTimeInMillis, lastAccessedTimeInMillis, createdBy, updatedBy, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    lastAccessedTimeInMillis: ").append(toIndentedString(lastAccessedTimeInMillis)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalystItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalystItem is not found in the empty JSON string", AnalystItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnalystItem>() {
           @Override
