...
public class CollectionMetadataItem implements Serializable {
  ...
  public CollectionMetadataItem identifiers(@javax.annotation.Nullable List<CollectionEntityIdentifier> identifiers) {
  ...
  public void setIdentifiers(@javax.annotation.Nullable List<CollectionEntityIdentifier> identifiers) {
    this.identifiers = identifiers;
  }
   ...
   * @return the CollectionMetadataItem instance itself
   */
  public CollectionMetadataItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, collectionMetadataItem.type) &&
        ...
        Objects.equals(this.additionalProperties, collectionMetadataItem.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionMetadataItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionMetadataItem is not found in the empty JSON string", CollectionMetadataItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollectionMetadataItem>() {
           @Override
           public void write(JsonWriter out, CollectionMetadataItem value) throws IOException {
           ...
           public CollectionMetadataItem read(JsonReader in) throws IOException {
             ...
             CollectionMetadataItem instance = thisAdapter.fromJsonTree(jsonObj);
