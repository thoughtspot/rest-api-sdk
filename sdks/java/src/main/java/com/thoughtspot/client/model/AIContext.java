...
public class AIContext implements Serializable {
   ...
   * @return the AIContext instance itself
   */
  public AIContext putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.instructions, aiContext.instructions) &&
        ...
        Objects.equals(this.additionalProperties, aiContext.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(instructions, content, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AIContext.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AIContext is not found in the empty JSON string", AIContext.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AIContext>() {
           @Override
           ...
           public AIContext read(JsonReader in) throws IOException {
             ...
             AIContext instance = thisAdapter.fromJsonTree(jsonObj);
