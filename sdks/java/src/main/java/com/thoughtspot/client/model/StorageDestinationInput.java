...
public class StorageDestinationInput implements Serializable {
  ...
  public StorageDestinationInput storageType(@javax.annotation.Nonnull StorageTypeEnum storageType) {
  ...
  public StorageDestinationInput storageConfig(@javax.annotation.Nonnull StorageConfigInput storageConfig) {
   ...
   * @return the StorageDestinationInput instance itself
   */
  public StorageDestinationInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.storageType, storageDestinationInput.storageType) &&
        ...
        Objects.equals(this.additionalProperties, storageDestinationInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(storageType, storageConfig, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageDestinationInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StorageDestinationInput is not found in the empty JSON string", StorageDestinationInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StorageDestinationInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StorageDestinationInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<StorageDestinationInput>() {
           @Override
           public void write(JsonWriter out, StorageDestinationInput value) throws IOException {
           ...
           public StorageDestinationInput read(JsonReader in) throws IOException {
             ...
             StorageDestinationInput instance = thisAdapter.fromJsonTree(jsonObj);
