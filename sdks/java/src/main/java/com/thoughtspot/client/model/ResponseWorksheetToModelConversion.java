...
public class ResponseWorksheetToModelConversion implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, responseWorksheetToModelConversion.name) &&
        ...
        Objects.equals(this.additionalProperties, responseWorksheetToModelConversion.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, successCount, failureCount, incompleteCount, postUpgradeFailedCount, totalTimeInMillis, successfulEntities, failedEntities, incompleteEntities, postUpgradeFailedEntities, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseWorksheetToModelConversion>() {
           ...
           public ResponseWorksheetToModelConversion read(JsonReader in) throws IOException {
             ...
             ResponseWorksheetToModelConversion instance = thisAdapter.fromJsonTree(jsonObj);
