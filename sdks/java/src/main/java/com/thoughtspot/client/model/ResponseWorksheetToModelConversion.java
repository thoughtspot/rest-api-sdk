...
public class ResponseWorksheetToModelConversion implements Serializable {
    ...
    public static final String SERIALIZED_NAME_POST_UPGRADE_FAILED_COUNT =
    ...
    public static final String SERIALIZED_NAME_POST_UPGRADE_FAILED_ENTITIES =
    ...
    public ResponseWorksheetToModelConversion successCount(
            @javax.annotation.Nonnull Integer successCount) {
    ...
    public ResponseWorksheetToModelConversion failureCount(
    ...
    public ResponseWorksheetToModelConversion incompleteCount(
            @javax.annotation.Nonnull Integer incompleteCount) {
    ...
    public ResponseWorksheetToModelConversion postUpgradeFailedCount(
            @javax.annotation.Nonnull Integer postUpgradeFailedCount) {
    ...
    public void setPostUpgradeFailedCount(
            @javax.annotation.Nonnull Integer postUpgradeFailedCount) {
        this.postUpgradeFailedCount = postUpgradeFailedCount;
    }

    public ResponseWorksheetToModelConversion totalTimeInMillis(
            @javax.annotation.Nonnull Integer totalTimeInMillis) {
    ...
    public ResponseWorksheetToModelConversion successfulEntities(
            @javax.annotation.Nonnull ResponseSuccessfulEntities successfulEntities) {
    ...
    public void setSuccessfulEntities(
            @javax.annotation.Nonnull ResponseSuccessfulEntities successfulEntities) {
        this.successfulEntities = successfulEntities;
    }

    public ResponseWorksheetToModelConversion failedEntities(
            @javax.annotation.Nonnull ResponseFailedEntities failedEntities) {
    ...
    public ResponseWorksheetToModelConversion incompleteEntities(
            @javax.annotation.Nonnull ResponseIncompleteEntities incompleteEntities) {
    ...
    public void setIncompleteEntities(
            @javax.annotation.Nonnull ResponseIncompleteEntities incompleteEntities) {
        this.incompleteEntities = incompleteEntities;
    }

    public ResponseWorksheetToModelConversion postUpgradeFailedEntities(
            @javax.annotation.Nonnull ResponsePostUpgradeFailedEntities postUpgradeFailedEntities) {
    ...
    public void setPostUpgradeFailedEntities(
            @javax.annotation.Nonnull ResponsePostUpgradeFailedEntities postUpgradeFailedEntities) {
        this.postUpgradeFailedEntities = postUpgradeFailedEntities;
    }
     ...
     * @return the ResponseWorksheetToModelConversion instance itself
     */
    public ResponseWorksheetToModelConversion putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        ResponseWorksheetToModelConversion responseWorksheetToModelConversion =
                (ResponseWorksheetToModelConversion) o;
        return Objects.equals(this.name, responseWorksheetToModelConversion.name)
                && Objects.equals(
                        this.successCount, responseWorksheetToModelConversion.successCount)
                && Objects.equals(
                        this.failureCount, responseWorksheetToModelConversion.failureCount)
                && Objects.equals(
                        this.incompleteCount, responseWorksheetToModelConversion.incompleteCount)
                && Objects.equals(
                        this.postUpgradeFailedCount,
                        responseWorksheetToModelConversion.postUpgradeFailedCount)
                && Objects.equals(
                        this.totalTimeInMillis,
                        responseWorksheetToModelConversion.totalTimeInMillis)
                && Objects.equals(
                        this.successfulEntities,
                        responseWorksheetToModelConversion.successfulEntities)
                && Objects.equals(
                        this.failedEntities, responseWorksheetToModelConversion.failedEntities)
                && Objects.equals(
                        this.incompleteEntities,
                        responseWorksheetToModelConversion.incompleteEntities)
                && Objects.equals(
                        this.postUpgradeFailedEntities,
                        responseWorksheetToModelConversion.postUpgradeFailedEntities)
                && Objects.equals(
                        this.additionalProperties,
                        responseWorksheetToModelConversion.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    postUpgradeFailedCount: ")
                .append(toIndentedString(postUpgradeFailedCount))
                .append("\n");
        sb.append("    totalTimeInMillis: ")
                .append(toIndentedString(totalTimeInMillis))
                .append("\n");
        sb.append("    successfulEntities: ")
                .append(toIndentedString(successfulEntities))
                .append("\n");
        sb.append("    failedEntities: ").append(toIndentedString(failedEntities)).append("\n");
        sb.append("    incompleteEntities: ")
                .append(toIndentedString(incompleteEntities))
                .append("\n");
        sb.append("    postUpgradeFailedEntities: ")
                .append(toIndentedString(postUpgradeFailedEntities))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ResponseWorksheetToModelConversion.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ResponseWorksheetToModelConversion is"
                                        + " not found in the empty JSON string",
                                ResponseWorksheetToModelConversion.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        ResponsePostUpgradeFailedEntities.validateJsonElement(
                jsonObj.get("post_upgrade_failed_entities"));
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ResponseWorksheetToModelConversion.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ResponseWorksheetToModelConversion' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ResponseWorksheetToModelConversion> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ResponseWorksheetToModelConversion.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ResponseWorksheetToModelConversion>() {
                        @Override
                        public void write(JsonWriter out, ResponseWorksheetToModelConversion value)
                                throws IOException {
                        ...
                        @Override
                        public ResponseWorksheetToModelConversion read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            ResponseWorksheetToModelConversion instance =
     ...
     *     ResponseWorksheetToModelConversion
     */
    public static ResponseWorksheetToModelConversion fromJson(String jsonString)
            throws IOException {
