...
public class UpdateCalendarRequest implements Serializable {
  ...
  public UpdateCalendarRequest updateMethod(@javax.annotation.Nullable UpdateMethodEnum updateMethod) {
  ...
  public UpdateCalendarRequest tableReference(@javax.annotation.Nonnull ExternalTableInput tableReference) {
  ...
  public UpdateCalendarRequest calendarType(@javax.annotation.Nullable CalendarTypeEnum calendarType) {
  ...
  public UpdateCalendarRequest monthOffset(@javax.annotation.Nullable MonthOffsetEnum monthOffset) {
  ...
  public UpdateCalendarRequest startDayOfWeek(@javax.annotation.Nullable StartDayOfWeekEnum startDayOfWeek) {
  ...
  public UpdateCalendarRequest quarterNamePrefix(@javax.annotation.Nullable String quarterNamePrefix) {
   ...
   * @return the UpdateCalendarRequest instance itself
   */
  public UpdateCalendarRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.updateMethod, updateCalendarRequest.updateMethod) &&
        ...
        Objects.equals(this.additionalProperties, updateCalendarRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updateMethod, tableReference, startDate, endDate, calendarType, monthOffset, startDayOfWeek, quarterNamePrefix, yearNamePrefix, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("update_method") != null && !jsonObj.get("update_method").isJsonNull()) && !jsonObj.get("update_method").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `update_method` to be a primitive type in the JSON string but got `%s`", jsonObj.get("update_method").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateCalendarRequest>() {
           ...
           public UpdateCalendarRequest read(JsonReader in) throws IOException {
             ...
             UpdateCalendarRequest instance = thisAdapter.fromJsonTree(jsonObj);
