...
import com.thoughtspot.client.model.WebhookDeleteFailure;
...
public class WebhookDeleteResponse implements Serializable {
  ...
  public WebhookDeleteResponse deletedWebhooks(@javax.annotation.Nonnull List<WebhookResponse> deletedWebhooks) {
  ...
  public void setDeletedWebhooks(@javax.annotation.Nonnull List<WebhookResponse> deletedWebhooks) {
    this.deletedWebhooks = deletedWebhooks;
  }


  public WebhookDeleteResponse failedWebhooks(@javax.annotation.Nonnull List<WebhookDeleteFailure> failedWebhooks) {
  ...
  public void setFailedWebhooks(@javax.annotation.Nonnull List<WebhookDeleteFailure> failedWebhooks) {
    this.failedWebhooks = failedWebhooks;
  }
   ...
   * @return the WebhookDeleteResponse instance itself
   */
  public WebhookDeleteResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.deletedCount, webhookDeleteResponse.deletedCount) &&
        ...
        Objects.equals(this.additionalProperties, webhookDeleteResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(deletedCount, failedCount, deletedWebhooks, failedWebhooks, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookDeleteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookDeleteResponse is not found in the empty JSON string", WebhookDeleteResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("deleted_webhooks").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `deleted_webhooks` to be an array in the JSON string but got `%s`", jsonObj.get("deleted_webhooks").toString()));
      }
      ...
      if (!jsonObj.get("failed_webhooks").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `failed_webhooks` to be an array in the JSON string but got `%s`", jsonObj.get("failed_webhooks").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookDeleteResponse>() {
           @Override
           public void write(JsonWriter out, WebhookDeleteResponse value) throws IOException {
           ...
           public WebhookDeleteResponse read(JsonReader in) throws IOException {
             ...
             WebhookDeleteResponse instance = thisAdapter.fromJsonTree(jsonObj);
