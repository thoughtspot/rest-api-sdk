...
public class ResourceResponseItem implements Serializable {
  ...
  public ResourceResponseItem timestampInMillis(@javax.annotation.Nullable Object timestampInMillis) {
  ...
  public ResourceResponseItem transportType(@javax.annotation.Nullable TransportTypeEnum transportType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, resourceResponseItem.type) &&
        ...
        Objects.equals(this.additionalProperties, resourceResponseItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, timestampInMillis, isThinking, stepTitle, title, uri, name, mimeType, description, size, connectorId, connectorName, connectorSlug, transportType, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResourceResponseItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResourceResponseItem is not found in the empty JSON string", ResourceResponseItem.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("connector_slug") != null && !jsonObj.get("connector_slug").isJsonNull()) && !jsonObj.get("connector_slug").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `connector_slug` to be a primitive type in the JSON string but got `%s`", jsonObj.get("connector_slug").toString()));
      }
      if ((jsonObj.get("transport_type") != null && !jsonObj.get("transport_type").isJsonNull()) && !jsonObj.get("transport_type").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `transport_type` to be a primitive type in the JSON string but got `%s`", jsonObj.get("transport_type").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceResponseItem>() {
           @Override
           public void write(JsonWriter out, ResourceResponseItem value) throws IOException {
