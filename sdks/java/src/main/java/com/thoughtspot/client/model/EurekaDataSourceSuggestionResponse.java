...
public class EurekaDataSourceSuggestionResponse implements Serializable {
    ...
    public EurekaDataSourceSuggestionResponse dataSources(
            @javax.annotation.Nullable List<DataSource> dataSources) {
     ...
     * @return the EurekaDataSourceSuggestionResponse instance itself
     */
    public EurekaDataSourceSuggestionResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        EurekaDataSourceSuggestionResponse eurekaDataSourceSuggestionResponse =
                (EurekaDataSourceSuggestionResponse) o;
        return Objects.equals(this.dataSources, eurekaDataSourceSuggestionResponse.dataSources)
                && Objects.equals(
                        this.additionalProperties,
                        eurekaDataSourceSuggestionResponse.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(dataSources, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!EurekaDataSourceSuggestionResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in EurekaDataSourceSuggestionResponse is"
                                        + " not found in the empty JSON string",
                                EurekaDataSourceSuggestionResponse.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!EurekaDataSourceSuggestionResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'EurekaDataSourceSuggestionResponse' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<EurekaDataSourceSuggestionResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(EurekaDataSourceSuggestionResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<EurekaDataSourceSuggestionResponse>() {
                        @Override
                        public void write(JsonWriter out, EurekaDataSourceSuggestionResponse value)
                                throws IOException {
                        ...
                        @Override
                        public EurekaDataSourceSuggestionResponse read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            EurekaDataSourceSuggestionResponse instance =
     ...
     *     EurekaDataSourceSuggestionResponse
     */
    public static EurekaDataSourceSuggestionResponse fromJson(String jsonString)
            throws IOException {
