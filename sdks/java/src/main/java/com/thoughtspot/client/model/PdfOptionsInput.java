...
public class PdfOptionsInput implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(pageSize, zoomLevel, includeCoverPage, includeCustomLogo, includeFilterPage, includePageNumber, pageOrientation, truncateTable, pageFooterText, additionalProperties);
  }
