...
public class PdfOptionsInput implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(includeCoverPage, includeCustomLogo, includeFilterPage, includePageNumber, pageOrientation, truncateTable, pageFooterText, additionalProperties);
  }
