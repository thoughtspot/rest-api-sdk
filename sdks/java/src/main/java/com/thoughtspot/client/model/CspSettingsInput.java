...
import com.thoughtspot.client.model.ScriptSrcUrlsInput;
...
public class CspSettingsInput implements Serializable {
  ...
  public CspSettingsInput visualEmbedHosts(@javax.annotation.Nullable List<String> visualEmbedHosts) {
  ...
  public CspSettingsInput scriptSrcUrls(@javax.annotation.Nullable ScriptSrcUrlsInput scriptSrcUrls) {
   ...
   * @return the CspSettingsInput instance itself
   */
  public CspSettingsInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectSrcUrls, cspSettingsInput.connectSrcUrls) &&
        ...
        Objects.equals(this.additionalProperties, cspSettingsInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CspSettingsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CspSettingsInput is not found in the empty JSON string", CspSettingsInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CspSettingsInput>() {
           @Override
           public void write(JsonWriter out, CspSettingsInput value) throws IOException {
           ...
           public CspSettingsInput read(JsonReader in) throws IOException {
             ...
             CspSettingsInput instance = thisAdapter.fromJsonTree(jsonObj);
