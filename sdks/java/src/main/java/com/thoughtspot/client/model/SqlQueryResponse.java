...
import com.thoughtspot.client.model.SqlQuery;
...
public class SqlQueryResponse implements Serializable {
   ...
   * @return the SqlQueryResponse instance itself
   */
  public SqlQueryResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataId, sqlQueryResponse.metadataId) &&
        ...
        Objects.equals(this.additionalProperties, sqlQueryResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataId, metadataName, metadataType, sqlQueries, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SqlQueryResponse>() {
           ...
           public SqlQueryResponse read(JsonReader in) throws IOException {
             ...
             SqlQueryResponse instance = thisAdapter.fromJsonTree(jsonObj);
