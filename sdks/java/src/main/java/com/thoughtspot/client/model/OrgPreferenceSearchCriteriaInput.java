...
public class OrgPreferenceSearchCriteriaInput implements Serializable {
    ...
    public enum EventTypesEnum {
        ...
        public static class Adapter extends TypeAdapter<EventTypesEnum> {
            @Override
            public void write(final JsonWriter jsonWriter, final EventTypesEnum enumeration)
                    throws IOException {
    ...
    public OrgPreferenceSearchCriteriaInput orgIdentifier(
    ...
    public OrgPreferenceSearchCriteriaInput eventTypes(
            @javax.annotation.Nullable List<EventTypesEnum> eventTypes) {
     ...
     * @return the OrgPreferenceSearchCriteriaInput instance itself
     */
    public OrgPreferenceSearchCriteriaInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        OrgPreferenceSearchCriteriaInput orgPreferenceSearchCriteriaInput =
                (OrgPreferenceSearchCriteriaInput) o;
        return Objects.equals(this.orgIdentifier, orgPreferenceSearchCriteriaInput.orgIdentifier)
                ...
                && Objects.equals(
                        ...
                        orgPreferenceSearchCriteriaInput.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(orgIdentifier, eventTypes, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrgPreferenceSearchCriteriaInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrgPreferenceSearchCriteriaInput is"
                                        + " not found in the empty JSON string",
                                OrgPreferenceSearchCriteriaInput.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("event_types") != null
                && !jsonObj.get("event_types").isJsonNull()
                && !jsonObj.get("event_types").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `event_types` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("event_types").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrgPreferenceSearchCriteriaInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrgPreferenceSearchCriteriaInput' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<OrgPreferenceSearchCriteriaInput> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(OrgPreferenceSearchCriteriaInput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<OrgPreferenceSearchCriteriaInput>() {
                        @Override
                        public void write(JsonWriter out, OrgPreferenceSearchCriteriaInput value)
                                throws IOException {
                        ...
                        @Override
                        public OrgPreferenceSearchCriteriaInput read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            OrgPreferenceSearchCriteriaInput instance =
