...
public class CreateRoleRequest implements Serializable {
  ...
  public CreateRoleRequest privileges(@javax.annotation.Nullable List<PrivilegesEnum> privileges) {
   ...
   * @return the CreateRoleRequest instance itself
   */
  public CreateRoleRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createRoleRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, createRoleRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, privileges, readOnly, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateRoleRequest>() {
           ...
           public CreateRoleRequest read(JsonReader in) throws IOException {
             ...
             CreateRoleRequest instance = thisAdapter.fromJsonTree(jsonObj);
