...
public class MetadataSearchSortOptions implements Serializable {
     ...
     * @return the MetadataSearchSortOptions instance itself
     */
    public MetadataSearchSortOptions putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.fieldName, metadataSearchSortOptions.fieldName)
                ...
                && Objects.equals(
                        this.additionalProperties, metadataSearchSortOptions.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MetadataSearchSortOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in MetadataSearchSortOptions is not"
                                        + " found in the empty JSON string",
                                MetadataSearchSortOptions.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!MetadataSearchSortOptions.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'MetadataSearchSortOptions' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<MetadataSearchSortOptions>() {
                        @Override
                        public void write(JsonWriter out, MetadataSearchSortOptions value)
                                throws IOException {
                        ...
                        public MetadataSearchSortOptions read(JsonReader in) throws IOException {
                            ...
                            MetadataSearchSortOptions instance = thisAdapter.fromJsonTree(jsonObj);
