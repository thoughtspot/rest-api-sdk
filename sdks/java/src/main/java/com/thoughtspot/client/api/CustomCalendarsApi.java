...
public class CustomCalendarsApi {
     ...
     */
    public CalendarResponse createCalendar(CreateCalendarRequest createCalendarRequest) throws ApiException {
        ApiResponse<CalendarResponse> localVarResp = createCalendarWithHttpInfo(createCalendarRequest);
     ...
     */
    public ApiResponse<CalendarResponse> createCalendarWithHttpInfo(CreateCalendarRequest createCalendarRequest) throws ApiException {
     ...
     */
    public okhttp3.Call createCalendarAsync(CreateCalendarRequest createCalendarRequest, final ApiCallback<CalendarResponse> _callback) throws ApiException {
    ...
    public okhttp3.Call deleteCalendarCall(String calendarIdentifier, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/calendars/{calendar_identifier}/delete"
            .replace("{" + "calendar_identifier" + "}", localVarApiClient.escapeString(calendarIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteCalendarValidateBeforeCall(String calendarIdentifier, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'calendarIdentifier' is set
        if (calendarIdentifier == null) {
            throw new ApiException("Missing the required parameter 'calendarIdentifier' when calling deleteCalendar(Async)");
        }
     ...
     */
    public ApiResponse<Void> deleteCalendarWithHttpInfo(String calendarIdentifier) throws ApiException {
     ...
     */
    public okhttp3.Call deleteCalendarAsync(String calendarIdentifier, final ApiCallback<Void> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call generateCSVValidateBeforeCall(GenerateCSVRequest generateCSVRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'generateCSVRequest' is set
        if (generateCSVRequest == null) {
            throw new ApiException("Missing the required parameter 'generateCSVRequest' when calling generateCSV(Async)");
        }
     ...
     */
    public ApiResponse<Object> generateCSVWithHttpInfo(GenerateCSVRequest generateCSVRequest) throws ApiException {
     ...
     */
    public okhttp3.Call generateCSVAsync(GenerateCSVRequest generateCSVRequest, final ApiCallback<Object> _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchCalendarsValidateBeforeCall(SearchCalendarsRequest searchCalendarsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'searchCalendarsRequest' is set
        if (searchCalendarsRequest == null) {
            throw new ApiException("Missing the required parameter 'searchCalendarsRequest' when calling searchCalendars(Async)");
        }
     ...
     */
    public List<CalendarResponse> searchCalendars(SearchCalendarsRequest searchCalendarsRequest) throws ApiException {
        ApiResponse<List<CalendarResponse>> localVarResp = searchCalendarsWithHttpInfo(searchCalendarsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<CalendarResponse>> searchCalendarsWithHttpInfo(SearchCalendarsRequest searchCalendarsRequest) throws ApiException {
     ...
     */
    public okhttp3.Call searchCalendarsAsync(SearchCalendarsRequest searchCalendarsRequest, final ApiCallback<List<CalendarResponse>> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchCalendarsValidateBeforeCall(searchCalendarsRequest, _callback);
        Type localVarReturnType = new TypeToken<List<CalendarResponse>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call updateCalendarCall(String calendarIdentifier, UpdateCalendarRequest updateCalendarRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/calendars/{calendar_identifier}/update"
            .replace("{" + "calendar_identifier" + "}", localVarApiClient.escapeString(calendarIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateCalendarValidateBeforeCall(String calendarIdentifier, UpdateCalendarRequest updateCalendarRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'calendarIdentifier' is set
        if (calendarIdentifier == null) {
            throw new ApiException("Missing the required parameter 'calendarIdentifier' when calling updateCalendar(Async)");
        }
     ...
     */
    public void updateCalendar(String calendarIdentifier, UpdateCalendarRequest updateCalendarRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateCalendarWithHttpInfo(String calendarIdentifier, UpdateCalendarRequest updateCalendarRequest) throws ApiException {
        okhttp3.Call localVarCall = updateCalendarValidateBeforeCall(calendarIdentifier, updateCalendarRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateCalendarAsync(String calendarIdentifier, UpdateCalendarRequest updateCalendarRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateCalendarValidateBeforeCall(calendarIdentifier, updateCalendarRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
