...
public class UpdateStyleFontRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.scope, updateStyleFontRequest.scope) &&
        ...
        Objects.equals(this.additionalProperties, updateStyleFontRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateStyleFontRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateStyleFontRequest is not found in the empty JSON string", UpdateStyleFontRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateStyleFontRequest>() {
           @Override
           public void write(JsonWriter out, UpdateStyleFontRequest value) throws IOException {
