...
import com.thoughtspot.client.model.MemorySources;
...
public class ExportMemoryRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.sources, exportMemoryRequest.sources)&&
        Objects.equals(this.additionalProperties, exportMemoryRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportMemoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportMemoryRequest is not found in the empty JSON string", ExportMemoryRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExportMemoryRequest>() {
           @Override
           public void write(JsonWriter out, ExportMemoryRequest value) throws IOException {
