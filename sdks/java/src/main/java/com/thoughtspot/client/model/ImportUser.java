...
public class ImportUser implements Serializable {
    ...
    /**
     * Visibility of the users. The SHARABLE property makes a user visible to other users and group,
     * who can share objects with the user.
     */
    ...
    public ImportUser showOnboardingExperience(
    ...
    public ImportUser onboardingExperienceCompleted(
    ...
    public ImportUser homeLiveboardIdentifier(
    ...
    public ImportUser favoriteMetadata(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.userIdentifier, importUser.userIdentifier)
                ...
                && Objects.equals(
                        this.showOnboardingExperience, importUser.showOnboardingExperience)
                && Objects.equals(
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImportUser.openapiRequiredFields
