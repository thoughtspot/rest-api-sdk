...
public class ImportUser implements Serializable {
  ...
  public ImportUser preferredLocale(@javax.annotation.Nullable PreferredLocaleEnum preferredLocale) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(userIdentifier, displayName, password, accountType, accountStatus, email, orgIdentifiers, groupIdentifiers, visibility, notifyOnShare, showOnboardingExperience, onboardingExperienceCompleted, homeLiveboardIdentifier, favoriteMetadata, preferredLocale, useBrowserLanguage, additionalProperties);
  }
