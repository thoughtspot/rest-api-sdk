...
public class WebhookSortOptionsInput implements Serializable {
     ...
     * @return the WebhookSortOptionsInput instance itself
     */
    public WebhookSortOptionsInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.fieldName, webhookSortOptionsInput.fieldName)
                ...
                && Objects.equals(
                        this.additionalProperties, webhookSortOptionsInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookSortOptionsInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in WebhookSortOptionsInput is not found"
                                        + " in the empty JSON string",
                                WebhookSortOptionsInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!WebhookSortOptionsInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'WebhookSortOptionsInput' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookSortOptionsInput>() {
                        @Override
                        public void write(JsonWriter out, WebhookSortOptionsInput value)
                                throws IOException {
                        ...
                        public WebhookSortOptionsInput read(JsonReader in) throws IOException {
                            ...
                            WebhookSortOptionsInput instance = thisAdapter.fromJsonTree(jsonObj);
