...
public class ForceLogoutUsersRequest implements Serializable {
  ...
  public ForceLogoutUsersRequest userIdentifiers(@javax.annotation.Nullable List<String> userIdentifiers) {
   ...
   * @return the ForceLogoutUsersRequest instance itself
   */
  public ForceLogoutUsersRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.userIdentifiers, forceLogoutUsersRequest.userIdentifiers)&&
        Objects.equals(this.additionalProperties, forceLogoutUsersRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(userIdentifiers, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForceLogoutUsersRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ForceLogoutUsersRequest>() {
           ...
           public ForceLogoutUsersRequest read(JsonReader in) throws IOException {
             ...
             ForceLogoutUsersRequest instance = thisAdapter.fromJsonTree(jsonObj);
