...
public class CollectionsApi {
     ...
     */
    public Collection createCollection(CreateCollectionRequest createCollectionRequest) throws ApiException {
        ApiResponse<Collection> localVarResp = createCollectionWithHttpInfo(createCollectionRequest);
     ...
     */
    public ApiResponse<Collection> createCollectionWithHttpInfo(CreateCollectionRequest createCollectionRequest) throws ApiException {
     ...
     */
    public okhttp3.Call createCollectionAsync(CreateCollectionRequest createCollectionRequest, final ApiCallback<Collection> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call deleteCollectionCall(DeleteCollectionRequest deleteCollectionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteCollectionValidateBeforeCall(DeleteCollectionRequest deleteCollectionRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public CollectionDeleteResponse deleteCollection(DeleteCollectionRequest deleteCollectionRequest) throws ApiException {
        ApiResponse<CollectionDeleteResponse> localVarResp = deleteCollectionWithHttpInfo(deleteCollectionRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionDeleteResponse> deleteCollectionWithHttpInfo(DeleteCollectionRequest deleteCollectionRequest) throws ApiException {
        okhttp3.Call localVarCall = deleteCollectionValidateBeforeCall(deleteCollectionRequest, null);
     ...
     */
    public okhttp3.Call deleteCollectionAsync(DeleteCollectionRequest deleteCollectionRequest, final ApiCallback<CollectionDeleteResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteCollectionValidateBeforeCall(deleteCollectionRequest, _callback);
        Type localVarReturnType = new TypeToken<CollectionDeleteResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call searchCollectionsCall(SearchCollectionsRequest searchCollectionsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchCollectionsValidateBeforeCall(SearchCollectionsRequest searchCollectionsRequest, final ApiCallback _callback) throws ApiException {
     ...
     */
    public CollectionSearchResponse searchCollections(SearchCollectionsRequest searchCollectionsRequest) throws ApiException {
        ApiResponse<CollectionSearchResponse> localVarResp = searchCollectionsWithHttpInfo(searchCollectionsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CollectionSearchResponse> searchCollectionsWithHttpInfo(SearchCollectionsRequest searchCollectionsRequest) throws ApiException {
        okhttp3.Call localVarCall = searchCollectionsValidateBeforeCall(searchCollectionsRequest, null);
     ...
     */
    public okhttp3.Call searchCollectionsAsync(SearchCollectionsRequest searchCollectionsRequest, final ApiCallback<CollectionSearchResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchCollectionsValidateBeforeCall(searchCollectionsRequest, _callback);
        Type localVarReturnType = new TypeToken<CollectionSearchResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param collectionIdentifier Unique GUID of the collection. Note: Collection names cannot be used as identifiers since duplicate names are allowed. (required)
     ...
     */
    public okhttp3.Call updateCollectionCall(String collectionIdentifier, UpdateCollectionRequest updateCollectionRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/collections/{collection_identifier}/update"
            .replace("{" + "collection_identifier" + "}", localVarApiClient.escapeString(collectionIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateCollectionValidateBeforeCall(String collectionIdentifier, UpdateCollectionRequest updateCollectionRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'collectionIdentifier' is set
        if (collectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'collectionIdentifier' when calling updateCollection(Async)");
        }
     ...
     */
    public void updateCollection(String collectionIdentifier, UpdateCollectionRequest updateCollectionRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateCollectionWithHttpInfo(String collectionIdentifier, UpdateCollectionRequest updateCollectionRequest) throws ApiException {
        okhttp3.Call localVarCall = updateCollectionValidateBeforeCall(collectionIdentifier, updateCollectionRequest, null);
     ...
     */
    public okhttp3.Call updateCollectionAsync(String collectionIdentifier, UpdateCollectionRequest updateCollectionRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateCollectionValidateBeforeCall(collectionIdentifier, updateCollectionRequest, _callback);
