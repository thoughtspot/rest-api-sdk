...
import com.thoughtspot.client.model.VariablePutAssignmentInput;
...
public class PutVariableValuesRequest implements Serializable {
  ...
  public PutVariableValuesRequest variableAssignment(@javax.annotation.Nonnull List<VariablePutAssignmentInput> variableAssignment) {
    this.variableAssignment = variableAssignment;
    return this;
  }

  public PutVariableValuesRequest addVariableAssignmentItem(VariablePutAssignmentInput variableAssignmentItem) {
  ...
  public void setVariableAssignment(@javax.annotation.Nonnull List<VariablePutAssignmentInput> variableAssignment) {
    this.variableAssignment = variableAssignment;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.operation, putVariableValuesRequest.operation) &&
        Objects.equals(this.variableAssignment, putVariableValuesRequest.variableAssignment)&&
        Objects.equals(this.additionalProperties, putVariableValuesRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PutVariableValuesRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PutVariableValuesRequest is not found in the empty JSON string", PutVariableValuesRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PutVariableValuesRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PutVariableValuesRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<PutVariableValuesRequest>() {
           @Override
           public void write(JsonWriter out, PutVariableValuesRequest value) throws IOException {
