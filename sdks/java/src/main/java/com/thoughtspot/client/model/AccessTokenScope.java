...
public class AccessTokenScope implements Serializable {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AccessTokenScope.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AccessTokenScope is not found in the empty JSON string", AccessTokenScope.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("org_ids") != null && !jsonObj.get("org_ids").isJsonNull()) {
        ...
        if (jsonArrayorgIds != null) {
          ...
          if (!jsonObj.get("org_ids").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `org_ids` to be an array in the JSON string but got `%s`", jsonObj.get("org_ids").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AccessTokenScope>() {
           @Override
           public void write(JsonWriter out, AccessTokenScope value) throws IOException {
