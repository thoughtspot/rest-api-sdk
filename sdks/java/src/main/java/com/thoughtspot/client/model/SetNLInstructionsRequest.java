...
import com.thoughtspot.client.model.NLInstructionsInfoInput;
...
public class SetNLInstructionsRequest implements Serializable {
  ...
  public SetNLInstructionsRequest dataSourceIdentifier(@javax.annotation.Nonnull String dataSourceIdentifier) {
  ...
  public SetNLInstructionsRequest nlInstructionsInfo(@javax.annotation.Nonnull List<NLInstructionsInfoInput> nlInstructionsInfo) {
    this.nlInstructionsInfo = nlInstructionsInfo;
    return this;
  }

  public SetNLInstructionsRequest addNlInstructionsInfoItem(NLInstructionsInfoInput nlInstructionsInfoItem) {
  ...
  public void setNlInstructionsInfo(@javax.annotation.Nonnull List<NLInstructionsInfoInput> nlInstructionsInfo) {
    this.nlInstructionsInfo = nlInstructionsInfo;
  }
   ...
   * @return the SetNLInstructionsRequest instance itself
   */
  public SetNLInstructionsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSourceIdentifier, setNLInstructionsRequest.dataSourceIdentifier) &&
        Objects.equals(this.nlInstructionsInfo, setNLInstructionsRequest.nlInstructionsInfo)&&
        Objects.equals(this.additionalProperties, setNLInstructionsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataSourceIdentifier, nlInstructionsInfo, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SetNLInstructionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SetNLInstructionsRequest is not found in the empty JSON string", SetNLInstructionsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SetNLInstructionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SetNLInstructionsRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SetNLInstructionsRequest>() {
           @Override
           public void write(JsonWriter out, SetNLInstructionsRequest value) throws IOException {
           ...
           public SetNLInstructionsRequest read(JsonReader in) throws IOException {
             ...
             SetNLInstructionsRequest instance = thisAdapter.fromJsonTree(jsonObj);
