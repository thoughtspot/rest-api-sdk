...
public class ToolResultResponseItem implements Serializable {
  ...
  public ToolResultResponseItem timestampInMillis(@javax.annotation.Nullable Object timestampInMillis) {
  ...
  public ToolResultResponseItem contentType(@javax.annotation.Nullable ContentTypeEnum contentType) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, toolResultResponseItem.type) &&
        ...
        Objects.equals(this.additionalProperties, toolResultResponseItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, timestampInMillis, isThinking, stepTitle, toolCallId, toolName, content, contentType, success, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ToolResultResponseItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ToolResultResponseItem is not found in the empty JSON string", ToolResultResponseItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ToolResultResponseItem>() {
           @Override
           public void write(JsonWriter out, ToolResultResponseItem value) throws IOException {
