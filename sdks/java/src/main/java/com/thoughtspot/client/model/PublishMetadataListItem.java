...
public class PublishMetadataListItem implements Serializable {
   ...
   * @return the PublishMetadataListItem instance itself
   */
  public PublishMetadataListItem putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, publishMetadataListItem.identifier) &&
        ...
        Objects.equals(this.additionalProperties, publishMetadataListItem.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PublishMetadataListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PublishMetadataListItem is not found in the empty JSON string", PublishMetadataListItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PublishMetadataListItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PublishMetadataListItem' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<PublishMetadataListItem>() {
           @Override
           public void write(JsonWriter out, PublishMetadataListItem value) throws IOException {
           ...
           public PublishMetadataListItem read(JsonReader in) throws IOException {
             ...
             PublishMetadataListItem instance = thisAdapter.fromJsonTree(jsonObj);
