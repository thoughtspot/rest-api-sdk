...
import com.thoughtspot.client.model.WebhookStorageSetupConfig;
...
public class WebhookStorageConfigInfo implements Serializable {
  ...
  public WebhookStorageConfigInfo storageType(@javax.annotation.Nonnull StorageTypeEnum storageType) {
  ...
  public WebhookStorageConfigInfo config(@javax.annotation.Nonnull WebhookStorageSetupConfig config) {
    this.config = config;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.storageType, webhookStorageConfigInfo.storageType) &&
        ...
        Objects.equals(this.additionalProperties, webhookStorageConfigInfo.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookStorageConfigInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookStorageConfigInfo is not found in the empty JSON string", WebhookStorageConfigInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookStorageConfigInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookStorageConfigInfo' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookStorageConfigInfo>() {
           @Override
           public void write(JsonWriter out, WebhookStorageConfigInfo value) throws IOException {
