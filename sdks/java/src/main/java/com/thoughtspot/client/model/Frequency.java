...
import com.thoughtspot.client.model.CronExpression;
...
public class Frequency implements Serializable {
   ...
   * @return the Frequency instance itself
   */
  public Frequency putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.cronExpression, frequency.cronExpression)&&
        Objects.equals(this.additionalProperties, frequency.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cronExpression, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Frequency>() {
           ...
           public Frequency read(JsonReader in) throws IOException {
             ...
             Frequency instance = thisAdapter.fromJsonTree(jsonObj);
