...
public class CreateConnectionResponse implements Serializable {
  ...
  public CreateConnectionResponse dataWarehouseType(@javax.annotation.Nonnull DataWarehouseTypeEnum dataWarehouseType) {
   ...
   * @return the CreateConnectionResponse instance itself
   */
  public CreateConnectionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, createConnectionResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, createConnectionResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, dataWarehouseType, details, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateConnectionResponse>() {
           ...
           public CreateConnectionResponse read(JsonReader in) throws IOException {
             ...
             CreateConnectionResponse instance = thisAdapter.fromJsonTree(jsonObj);
