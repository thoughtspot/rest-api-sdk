...
public class MetadataListItemInput implements Serializable {
   ...
   * @return the MetadataListItemInput instance itself
   */
  public MetadataListItemInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, metadataListItemInput.identifier) &&
        ...
        Objects.equals(this.additionalProperties, metadataListItemInput.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identifier, objIdentifier, namePattern, type, subtypes, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetadataListItemInput>() {
           ...
           public MetadataListItemInput read(JsonReader in) throws IOException {
             ...
             MetadataListItemInput instance = thisAdapter.fromJsonTree(jsonObj);
