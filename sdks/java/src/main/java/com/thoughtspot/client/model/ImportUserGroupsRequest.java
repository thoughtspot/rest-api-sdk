...
import com.thoughtspot.client.model.GroupsImportListInput;
...
public class ImportUserGroupsRequest implements Serializable {
   ...
   * @return the ImportUserGroupsRequest instance itself
   */
  public ImportUserGroupsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.groups, importUserGroupsRequest.groups) &&
        ...
        Objects.equals(this.additionalProperties, importUserGroupsRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groups, deleteUnspecifiedGroups, dryRun, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportUserGroupsRequest>() {
           ...
           public ImportUserGroupsRequest read(JsonReader in) throws IOException {
             ...
             ImportUserGroupsRequest instance = thisAdapter.fromJsonTree(jsonObj);
