...
public class AgentConversation implements Serializable {
  ...
  public AgentConversation conversationIdentifier(@javax.annotation.Nonnull String conversationIdentifier) {
   ...
   * @return the AgentConversation instance itself
   */
  public AgentConversation putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.conversationId, agentConversation.conversationId) &&
        Objects.equals(this.conversationIdentifier, agentConversation.conversationIdentifier) &&
        Objects.equals(this.analystId, agentConversation.analystId)&&
        Objects.equals(this.additionalProperties, agentConversation.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conversationId, conversationIdentifier, analystId, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentConversation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentConversation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentConversation is not found in the empty JSON string", AgentConversation.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AgentConversation.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentConversation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentConversation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentConversation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentConversation.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentConversation>() {
           @Override
           public void write(JsonWriter out, AgentConversation value) throws IOException {
           ...
           @Override
           public AgentConversation read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentConversation instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of AgentConversation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AgentConversation
   * @throws IOException if the JSON string is invalid with respect to AgentConversation
   */
  public static AgentConversation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AgentConversation.class);
  }

  /**
   * Convert an instance of AgentConversation to an JSON string
   *
   * @return JSON string
   */
