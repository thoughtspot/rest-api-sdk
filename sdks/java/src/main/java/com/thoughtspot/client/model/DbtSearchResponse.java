...
public class DbtSearchResponse implements Serializable {
  ...
  public DbtSearchResponse dbtConnectionIdentifier(@javax.annotation.Nullable String dbtConnectionIdentifier) {
  ...
  public void setDbtConnectionIdentifier(@javax.annotation.Nullable String dbtConnectionIdentifier) {
    this.dbtConnectionIdentifier = dbtConnectionIdentifier;
  }
   ...
   * @return the DbtSearchResponse instance itself
   */
  public DbtSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dbtConnectionIdentifier, dbtSearchResponse.dbtConnectionIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, dbtSearchResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dbtConnectionIdentifier, projectName, connectionId, connectionName, cdwDatabase, importType, authorName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DbtSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DbtSearchResponse>() {
           ...
           public DbtSearchResponse read(JsonReader in) throws IOException {
             ...
             DbtSearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
