...
public class DeployCommitRequest implements Serializable {
   ...
   * @return the DeployCommitRequest instance itself
   */
  public DeployCommitRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.commitId, deployCommitRequest.commitId) &&
        ...
        Objects.equals(this.additionalProperties, deployCommitRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(commitId, branchName, deployType, deployPolicy, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeployCommitRequest>() {
           ...
           public DeployCommitRequest read(JsonReader in) throws IOException {
             ...
             DeployCommitRequest instance = thisAdapter.fromJsonTree(jsonObj);
