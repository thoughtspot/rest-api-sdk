...
import com.thoughtspot.client.model.AgentConversationList;
...
public class AgentConversationHistoryResponse implements Serializable {
  ...
  public AgentConversationHistoryResponse conversations(@javax.annotation.Nullable List<AgentConversationList> conversations) {
    this.conversations = conversations;
    return this;
  }

  public AgentConversationHistoryResponse addConversationsItem(AgentConversationList conversationsItem) {
  ...
  public void setConversations(@javax.annotation.Nullable List<AgentConversationList> conversations) {
    this.conversations = conversations;
  }
  ...
  public boolean equals(Object o) {
    ...
    AgentConversationHistoryResponse agentConversationHistoryResponse = (AgentConversationHistoryResponse) o;
    return Objects.equals(this.conversations, agentConversationHistoryResponse.conversations) &&
        ...
        Objects.equals(this.additionalProperties, agentConversationHistoryResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to AgentConversationHistoryResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AgentConversationHistoryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AgentConversationHistoryResponse is not found in the empty JSON string", AgentConversationHistoryResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AgentConversationHistoryResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AgentConversationHistoryResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AgentConversationHistoryResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AgentConversationHistoryResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AgentConversationHistoryResponse>() {
           @Override
           public void write(JsonWriter out, AgentConversationHistoryResponse value) throws IOException {
           ...
           @Override
           public AgentConversationHistoryResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             AgentConversationHistoryResponse instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to AgentConversationHistoryResponse
   */
