...
public class URLInputMandatory implements Serializable {
    ...
    public URLInputMandatory authentication(
            @javax.annotation.Nullable AuthenticationInput authentication) {
    ...
    public URLInputMandatory parameters(
     ...
     * @return the URLInputMandatory instance itself
     */
    public URLInputMandatory putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.authentication, urLInputMandatory.authentication)
                ...
                && Objects.equals(
                        this.additionalProperties, urLInputMandatory.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(authentication, parameters, url, reference, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!URLInputMandatory.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in URLInputMandatory is not found in the"
                                        + " empty JSON string",
                                URLInputMandatory.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<URLInputMandatory>() {
                        @Override
                        public void write(JsonWriter out, URLInputMandatory value)
                                throws IOException {
                        ...
                        public URLInputMandatory read(JsonReader in) throws IOException {
                            ...
                            URLInputMandatory instance = thisAdapter.fromJsonTree(jsonObj);
