...
import com.thoughtspot.client.model.SortOption;
...
public class SearchCalendarsRequest implements Serializable {
  ...
  public SearchCalendarsRequest connectionIdentifier(@javax.annotation.Nullable String connectionIdentifier) {
   ...
   * @return the SearchCalendarsRequest instance itself
   */
  public SearchCalendarsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.connectionIdentifier, searchCalendarsRequest.connectionIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, searchCalendarsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectionIdentifier, namePattern, recordOffset, recordSize, sortOptions, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchCalendarsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchCalendarsRequest is not found in the empty JSON string", SearchCalendarsRequest.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if ((jsonObj.get("connection_identifier") != null && !jsonObj.get("connection_identifier").isJsonNull()) && !jsonObj.get("connection_identifier").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchCalendarsRequest>() {
           @Override
           public void write(JsonWriter out, SearchCalendarsRequest value) throws IOException {
           ...
           public SearchCalendarsRequest read(JsonReader in) throws IOException {
             ...
             SearchCalendarsRequest instance = thisAdapter.fromJsonTree(jsonObj);
