...
public class FetchPermissionsOnMetadataRequest implements Serializable {
    ...
    public FetchPermissionsOnMetadataRequest metadata(
            @javax.annotation.Nonnull List<PermissionsMetadataTypeInput> metadata) {
        this.metadata = metadata;
        return this;
    }

    public FetchPermissionsOnMetadataRequest addMetadataItem(
    ...
    public FetchPermissionsOnMetadataRequest principals(
    ...
    /**
     * User or group objects for which you want to fetch permissions. If not specified, the API
     * returns all users and groups that can access the specified metadata objects.
     *
     * @return principals
     */
    @javax.annotation.Nullable
    ...
    public FetchPermissionsOnMetadataRequest includeDependentObjects(
    ...
    public FetchPermissionsOnMetadataRequest recordOffset(
    ...
    public FetchPermissionsOnMetadataRequest recordSize(
    ...
    public FetchPermissionsOnMetadataRequest permissionType(
            @javax.annotation.Nullable String permissionType) {
        this.permissionType = permissionType;
        return this;
    }

    /**
     * &lt;div&gt;Version: 10.3.0.cl or later &lt;/div&gt; Specifies the type of permission. Valid
     * values are: EFFECTIVE - If the user permission to the metadata objects is granted by the
     * privileges assigned to the groups to which they belong. DEFINED - If a user or user group
     * received access to metadata objects via object sharing by another user.
     *
     ...
     * @return the FetchPermissionsOnMetadataRequest instance itself
     */
    public FetchPermissionsOnMetadataRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        FetchPermissionsOnMetadataRequest fetchPermissionsOnMetadataRequest =
                (FetchPermissionsOnMetadataRequest) o;
        return Objects.equals(this.metadata, fetchPermissionsOnMetadataRequest.metadata)
                ...
                && Objects.equals(
                        ...
                        fetchPermissionsOnMetadataRequest.includeDependentObjects)
                ...
                && Objects.equals(
                        this.permissionType, fetchPermissionsOnMetadataRequest.permissionType)
                && Objects.equals(
                        this.additionalProperties,
                        fetchPermissionsOnMetadataRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FetchPermissionsOnMetadataRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FetchPermissionsOnMetadataRequest is"
                                        + " not found in the empty JSON string",
                                FetchPermissionsOnMetadataRequest.openapiRequiredFields
                                        .toString()));
            }
        }
        ...
        if ((jsonObj.get("permission_type") != null && !jsonObj.get("permission_type").isJsonNull())
                && !jsonObj.get("permission_type").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `permission_type` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("permission_type").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!FetchPermissionsOnMetadataRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'FetchPermissionsOnMetadataRequest' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<FetchPermissionsOnMetadataRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(FetchPermissionsOnMetadataRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<FetchPermissionsOnMetadataRequest>() {
                        @Override
                        public void write(JsonWriter out, FetchPermissionsOnMetadataRequest value)
                                throws IOException {
                        ...
                        @Override
                        public FetchPermissionsOnMetadataRequest read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            FetchPermissionsOnMetadataRequest instance =
