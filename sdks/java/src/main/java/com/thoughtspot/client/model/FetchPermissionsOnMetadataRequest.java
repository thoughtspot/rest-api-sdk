...
public class FetchPermissionsOnMetadataRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, fetchPermissionsOnMetadataRequest.metadata) &&
        ...
        Objects.equals(this.additionalProperties, fetchPermissionsOnMetadataRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadata, principals, includeDependentObjects, recordOffset, recordSize, permissionType, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FetchPermissionsOnMetadataRequest>() {
           ...
           public FetchPermissionsOnMetadataRequest read(JsonReader in) throws IOException {
             ...
             FetchPermissionsOnMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
