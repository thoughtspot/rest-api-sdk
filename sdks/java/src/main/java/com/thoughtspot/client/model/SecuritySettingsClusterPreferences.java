...
import com.thoughtspot.client.model.ClusterNonEmbedAccess;
import com.thoughtspot.client.model.CspSettings;
...
public class SecuritySettingsClusterPreferences implements Serializable {
  ...
  public enum TrustedAuthStatusEnum {
    ...
    public static class Adapter extends TypeAdapter<TrustedAuthStatusEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final TrustedAuthStatusEnum enumeration) throws IOException {
  ...
  public SecuritySettingsClusterPreferences enablePartitionedCookies(@javax.annotation.Nullable Boolean enablePartitionedCookies) {
  ...
  public SecuritySettingsClusterPreferences corsWhitelistedUrls(@javax.annotation.Nullable List<String> corsWhitelistedUrls) {
    this.corsWhitelistedUrls = corsWhitelistedUrls;
    return this;
  }

  public SecuritySettingsClusterPreferences addCorsWhitelistedUrlsItem(String corsWhitelistedUrlsItem) {
  ...
  public SecuritySettingsClusterPreferences cspSettings(@javax.annotation.Nullable CspSettings cspSettings) {
  ...
  public SecuritySettingsClusterPreferences samlRedirectUrls(@javax.annotation.Nullable List<String> samlRedirectUrls) {
  ...
  public SecuritySettingsClusterPreferences nonEmbedAccess(@javax.annotation.Nullable ClusterNonEmbedAccess nonEmbedAccess) {
  ...
  public SecuritySettingsClusterPreferences trustedAuthStatus(@javax.annotation.Nullable TrustedAuthStatusEnum trustedAuthStatus) {
  ...
  public void setTrustedAuthStatus(@javax.annotation.Nullable TrustedAuthStatusEnum trustedAuthStatus) {
    this.trustedAuthStatus = trustedAuthStatus;
  }
  ...
  public boolean equals(Object o) {
    ...
    SecuritySettingsClusterPreferences securitySettingsClusterPreferences = (SecuritySettingsClusterPreferences) o;
    return Objects.equals(this.enablePartitionedCookies, securitySettingsClusterPreferences.enablePartitionedCookies) &&
        Objects.equals(this.corsWhitelistedUrls, securitySettingsClusterPreferences.corsWhitelistedUrls) &&
        Objects.equals(this.cspSettings, securitySettingsClusterPreferences.cspSettings) &&
        Objects.equals(this.samlRedirectUrls, securitySettingsClusterPreferences.samlRedirectUrls) &&
        Objects.equals(this.nonEmbedAccess, securitySettingsClusterPreferences.nonEmbedAccess) &&
        Objects.equals(this.trustedAuthStatus, securitySettingsClusterPreferences.trustedAuthStatus)&&
        Objects.equals(this.additionalProperties, securitySettingsClusterPreferences.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enablePartitionedCookies, corsWhitelistedUrls, cspSettings, samlRedirectUrls, nonEmbedAccess, trustedAuthStatus, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SecuritySettingsClusterPreferences
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SecuritySettingsClusterPreferences.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SecuritySettingsClusterPreferences is not found in the empty JSON string", SecuritySettingsClusterPreferences.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("trusted_auth_status") != null && !jsonObj.get("trusted_auth_status").isJsonNull()) && !jsonObj.get("trusted_auth_status").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `trusted_auth_status` to be a primitive type in the JSON string but got `%s`", jsonObj.get("trusted_auth_status").toString()));
      }
      // validate the optional field `trusted_auth_status`
      if (jsonObj.get("trusted_auth_status") != null && !jsonObj.get("trusted_auth_status").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SecuritySettingsClusterPreferences.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SecuritySettingsClusterPreferences' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SecuritySettingsClusterPreferences> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SecuritySettingsClusterPreferences.class));

       return (TypeAdapter<T>) new TypeAdapter<SecuritySettingsClusterPreferences>() {
           @Override
           public void write(JsonWriter out, SecuritySettingsClusterPreferences value) throws IOException {
           ...
           @Override
           public SecuritySettingsClusterPreferences read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SecuritySettingsClusterPreferences instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to SecuritySettingsClusterPreferences
   */
  public static SecuritySettingsClusterPreferences fromJson(String jsonString) throws IOException {
