...
public class CustomActionMetadataTypeInput implements Serializable {
   ...
   * @return the CustomActionMetadataTypeInput instance itself
   */
  public CustomActionMetadataTypeInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomActionMetadataTypeInput customActionMetadataTypeInput = (CustomActionMetadataTypeInput) o;
    return Objects.equals(this.type, customActionMetadataTypeInput.type) &&
        ...
        Objects.equals(this.additionalProperties, customActionMetadataTypeInput.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CustomActionMetadataTypeInput
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CustomActionMetadataTypeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomActionMetadataTypeInput is not found in the empty JSON string", CustomActionMetadataTypeInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomActionMetadataTypeInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomActionMetadataTypeInput' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomActionMetadataTypeInput> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomActionMetadataTypeInput.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomActionMetadataTypeInput>() {
           @Override
           public void write(JsonWriter out, CustomActionMetadataTypeInput value) throws IOException {
           ...
           @Override
           public CustomActionMetadataTypeInput read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CustomActionMetadataTypeInput instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to CustomActionMetadataTypeInput
   */
