...
public class ExportAnswerReportRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, sessionIdentifier, generationNumber, fileFormat, runtimeFilter, runtimeSort, runtimeParamOverride, regionalSettings, additionalProperties);
  }
