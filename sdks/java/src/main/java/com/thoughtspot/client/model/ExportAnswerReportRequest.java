...
import com.thoughtspot.client.model.AnswerPngOptionsInput;
...
public class ExportAnswerReportRequest implements Serializable {
  ...
  public ExportAnswerReportRequest pngOptions(@javax.annotation.Nullable AnswerPngOptionsInput pngOptions) {
  ...
  public ExportAnswerReportRequest personalisedViewIdentifier(@javax.annotation.Nullable String personalisedViewIdentifier) {
   ...
   * @return the ExportAnswerReportRequest instance itself
   */
  public ExportAnswerReportRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataIdentifier, exportAnswerReportRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.personalisedViewIdentifier, exportAnswerReportRequest.personalisedViewIdentifier) &&
        Objects.equals(this.type, exportAnswerReportRequest.type)&&
        Objects.equals(this.additionalProperties, exportAnswerReportRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, sessionIdentifier, generationNumber, fileFormat, runtimeFilter, runtimeSort, runtimeParamOverride, regionalSettings, pngOptions, personalisedViewIdentifier, type, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ExportAnswerReportRequest>() {
           ...
           public ExportAnswerReportRequest read(JsonReader in) throws IOException {
             ...
             ExportAnswerReportRequest instance = thisAdapter.fromJsonTree(jsonObj);
