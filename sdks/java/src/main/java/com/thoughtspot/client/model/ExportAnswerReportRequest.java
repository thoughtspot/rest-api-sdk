...
public class ExportAnswerReportRequest implements Serializable {
    ...
    public ExportAnswerReportRequest sessionIdentifier(
    ...
    public ExportAnswerReportRequest generationNumber(
    ...
    public ExportAnswerReportRequest fileFormat(
    ...
    public ExportAnswerReportRequest runtimeFilter(
    ...
    public ExportAnswerReportRequest runtimeParamOverride(
    ...
    public ExportAnswerReportRequest regionalSettings(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadataIdentifier, exportAnswerReportRequest.metadataIdentifier)
                && Objects.equals(
                        this.sessionIdentifier, exportAnswerReportRequest.sessionIdentifier)
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExportAnswerReportRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ExportAnswerReportRequest is not"
                                        + " found in the empty JSON string",
                                ExportAnswerReportRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExportAnswerReportRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExportAnswerReportRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ExportAnswerReportRequest>() {
                        @Override
                        public void write(JsonWriter out, ExportAnswerReportRequest value)
                                throws IOException {
