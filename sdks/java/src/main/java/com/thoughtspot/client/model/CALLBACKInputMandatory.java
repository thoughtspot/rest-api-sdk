...
public class CALLBACKInputMandatory implements Serializable {
   ...
   * @return the CALLBACKInputMandatory instance itself
   */
  public CALLBACKInputMandatory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.reference, caLLBACKInputMandatory.reference)&&
        Objects.equals(this.additionalProperties, caLLBACKInputMandatory.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CALLBACKInputMandatory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CALLBACKInputMandatory is not found in the empty JSON string", CALLBACKInputMandatory.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CALLBACKInputMandatory>() {
           @Override
           public void write(JsonWriter out, CALLBACKInputMandatory value) throws IOException {
           ...
           public CALLBACKInputMandatory read(JsonReader in) throws IOException {
             ...
             CALLBACKInputMandatory instance = thisAdapter.fromJsonTree(jsonObj);
