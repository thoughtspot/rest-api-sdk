...
public class FetchAnswerDataRequest implements Serializable {
   ...
   * @return the FetchAnswerDataRequest instance itself
   */
  public FetchAnswerDataRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataIdentifier, fetchAnswerDataRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, fetchAnswerDataRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, dataFormat, recordOffset, recordSize, runtimeFilter, runtimeSort, runtimeParamOverride, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FetchAnswerDataRequest>() {
           ...
           public FetchAnswerDataRequest read(JsonReader in) throws IOException {
             ...
             FetchAnswerDataRequest instance = thisAdapter.fromJsonTree(jsonObj);
