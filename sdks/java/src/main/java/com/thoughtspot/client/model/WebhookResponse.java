...
import com.thoughtspot.client.model.StorageDestination;
import com.thoughtspot.client.model.WebhookAuthentication;
import com.thoughtspot.client.model.WebhookKeyValuePair;
...
public class WebhookResponse implements Serializable {
  ...
  public WebhookResponse additionalHeaders(@javax.annotation.Nullable List<WebhookKeyValuePair> additionalHeaders) {
  ...
  public void setAdditionalHeaders(@javax.annotation.Nullable List<WebhookKeyValuePair> additionalHeaders) {
    this.additionalHeaders = additionalHeaders;
  }
  ...
  public WebhookResponse storageDestination(@javax.annotation.Nullable StorageDestination storageDestination) {
  ...
  public void setStorageDestination(@javax.annotation.Nullable StorageDestination storageDestination) {
    this.storageDestination = storageDestination;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, org, url, urlParams, events, authentication, signatureVerification, additionalHeaders, creationTimeInMillis, modificationTimeInMillis, createdBy, lastModifiedBy, storageDestination, status, additionalProperties);
  }
