...
public class WebhookResponse implements Serializable {
    ...
    public WebhookResponse authentication(
            @javax.annotation.Nullable WebhookAuthentication authentication) {
    ...
    public WebhookResponse signatureVerification(
            @javax.annotation.Nullable WebhookSignatureVerification signatureVerification) {
    ...
    public WebhookResponse modificationTimeInMillis(
            @javax.annotation.Nonnull Float modificationTimeInMillis) {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!WebhookResponse.openapiRequiredFields
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<WebhookResponse>() {
                        @Override
