...
public class WebhookResponse implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, org, url, urlParams, events, authentication, signatureVerification, creationTimeInMillis, modificationTimeInMillis, createdBy, lastModifiedBy, storageDestination, additionalProperties);
  }
