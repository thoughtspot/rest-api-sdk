...
public class ChannelValidationAwsS3Info implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.bucketName, channelValidationAwsS3Info.bucketName) &&
        ...
        Objects.equals(this.additionalProperties, channelValidationAwsS3Info.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelValidationAwsS3Info.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelValidationAwsS3Info is not found in the empty JSON string", ChannelValidationAwsS3Info.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChannelValidationAwsS3Info.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChannelValidationAwsS3Info' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChannelValidationAwsS3Info>() {
           @Override
           public void write(JsonWriter out, ChannelValidationAwsS3Info value) throws IOException {
