...
import com.thoughtspot.client.model.GenericInfo;
...
public class SearchRoleResponse implements Serializable {
  ...
  public enum PrivilegesEnum {
    ...
    CAN_MANAGE_AGENTSPOT("CAN_MANAGE_AGENTSPOT"),
    
    CAN_ACCESS_AGENTSPOT("CAN_ACCESS_AGENTSPOT"),
  ...
  public SearchRoleResponse groupsAssignedCount(@javax.annotation.Nullable Integer groupsAssignedCount) {
  ...
  public SearchRoleResponse privileges(@javax.annotation.Nonnull List<PrivilegesEnum> privileges) {
  ...
  public SearchRoleResponse creationTimeInMillis(@javax.annotation.Nullable Object creationTimeInMillis) {
  ...
  public SearchRoleResponse modificationTimeInMillis(@javax.annotation.Nullable Object modificationTimeInMillis) {
  ...
  public SearchRoleResponse sharedViaConnection(@javax.annotation.Nullable Boolean sharedViaConnection) {
   ...
   * @return the SearchRoleResponse instance itself
   */
  public SearchRoleResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, searchRoleResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, searchRoleResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, objId, description, groupsAssignedCount, orgs, groups, privileges, permission, authorId, modifierId, creationTimeInMillis, modificationTimeInMillis, deleted, deprecated, external, hidden, sharedViaConnection, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchRoleResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchRoleResponse>() {
           ...
           public SearchRoleResponse read(JsonReader in) throws IOException {
             ...
             SearchRoleResponse instance = thisAdapter.fromJsonTree(jsonObj);
