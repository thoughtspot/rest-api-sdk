...
import com.thoughtspot.client.model.GroupInfo;
...
public class ClusterNonEmbedAccess implements Serializable {
  ...
  public ClusterNonEmbedAccess blockFullAppAccess(@javax.annotation.Nullable Boolean blockFullAppAccess) {
  ...
  public ClusterNonEmbedAccess groupsWithAccess(@javax.annotation.Nullable List<GroupInfo> groupsWithAccess) {
   ...
   * @return the ClusterNonEmbedAccess instance itself
   */
  public ClusterNonEmbedAccess putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blockFullAppAccess, clusterNonEmbedAccess.blockFullAppAccess) &&
        ...
        Objects.equals(this.additionalProperties, clusterNonEmbedAccess.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(blockFullAppAccess, groupsWithAccess, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterNonEmbedAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterNonEmbedAccess is not found in the empty JSON string", ClusterNonEmbedAccess.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("groups_with_access") != null && !jsonObj.get("groups_with_access").isJsonNull()) {
        ...
        if (jsonArraygroupsWithAccess != null) {
          ...
          if (!jsonObj.get("groups_with_access").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `groups_with_access` to be an array in the JSON string but got `%s`", jsonObj.get("groups_with_access").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClusterNonEmbedAccess>() {
           @Override
           public void write(JsonWriter out, ClusterNonEmbedAccess value) throws IOException {
           ...
           public ClusterNonEmbedAccess read(JsonReader in) throws IOException {
             ...
             ClusterNonEmbedAccess instance = thisAdapter.fromJsonTree(jsonObj);
