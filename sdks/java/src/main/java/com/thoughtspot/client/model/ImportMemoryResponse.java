...
import com.thoughtspot.client.model.ImportDiagnostic;
import com.thoughtspot.client.model.ImportFailure;
import com.thoughtspot.client.model.ImportSummary;
...
public class ImportMemoryResponse implements Serializable {
  ...
  public ImportMemoryResponse validationFailures(@javax.annotation.Nullable List<ImportFailure> validationFailures) {
  ...
  public void setValidationFailures(@javax.annotation.Nullable List<ImportFailure> validationFailures) {
    this.validationFailures = validationFailures;
  }


  public ImportMemoryResponse diagnostics(@javax.annotation.Nullable List<ImportDiagnostic> diagnostics) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.status, importMemoryResponse.status) &&
        ...
        Objects.equals(this.additionalProperties, importMemoryResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, summary, validationFailures, diagnostics, operationId, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportMemoryResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportMemoryResponse is not found in the empty JSON string", ImportMemoryResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("validation_failures") != null && !jsonObj.get("validation_failures").isJsonNull()) {
        ...
        if (jsonArrayvalidationFailures != null) {
          ...
          if (!jsonObj.get("validation_failures").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `validation_failures` to be an array in the JSON string but got `%s`", jsonObj.get("validation_failures").toString()));
          }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportMemoryResponse>() {
           @Override
           public void write(JsonWriter out, ImportMemoryResponse value) throws IOException {
