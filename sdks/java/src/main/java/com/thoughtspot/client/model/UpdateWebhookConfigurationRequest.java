...
public class UpdateWebhookConfigurationRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, description, url, urlParams, events, authentication, signatureVerification, storageDestination, additionalHeaders, status, resetOptions, additionalProperties);
  }
