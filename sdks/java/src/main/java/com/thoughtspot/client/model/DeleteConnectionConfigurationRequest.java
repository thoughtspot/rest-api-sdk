...
public class DeleteConnectionConfigurationRequest implements Serializable {
    ...
    public DeleteConnectionConfigurationRequest configurationIdentifier(
            @javax.annotation.Nonnull String configurationIdentifier) {
    ...
    public DeleteConnectionConfigurationRequest connectionIdentifier(
     ...
     * @return the DeleteConnectionConfigurationRequest instance itself
     */
    public DeleteConnectionConfigurationRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        DeleteConnectionConfigurationRequest deleteConnectionConfigurationRequest =
                (DeleteConnectionConfigurationRequest) o;
        return Objects.equals(
                        this.configurationIdentifier,
                        deleteConnectionConfigurationRequest.configurationIdentifier)
                && Objects.equals(
                        this.connectionIdentifier,
                        deleteConnectionConfigurationRequest.connectionIdentifier)
                && Objects.equals(
                        this.additionalProperties,
                        deleteConnectionConfigurationRequest.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(configurationIdentifier, connectionIdentifier, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DeleteConnectionConfigurationRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeleteConnectionConfigurationRequest"
                                        + " is not found in the empty JSON string",
                                DeleteConnectionConfigurationRequest.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteConnectionConfigurationRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteConnectionConfigurationRequest'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DeleteConnectionConfigurationRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(DeleteConnectionConfigurationRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<DeleteConnectionConfigurationRequest>() {
                        @Override
                        public void write(
                                JsonWriter out, DeleteConnectionConfigurationRequest value)
                                throws IOException {
                        ...
                        @Override
                        public DeleteConnectionConfigurationRequest read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            DeleteConnectionConfigurationRequest instance =
     ...
     *     DeleteConnectionConfigurationRequest
     */
    public static DeleteConnectionConfigurationRequest fromJson(String jsonString)
            throws IOException {
