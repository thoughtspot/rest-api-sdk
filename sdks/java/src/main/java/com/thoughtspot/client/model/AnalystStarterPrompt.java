...
public class AnalystStarterPrompt implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, analystStarterPrompt.label) &&
        ...
        Objects.equals(this.additionalProperties, analystStarterPrompt.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalystStarterPrompt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalystStarterPrompt is not found in the empty JSON string", AnalystStarterPrompt.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnalystStarterPrompt>() {
           @Override
           public void write(JsonWriter out, AnalystStarterPrompt value) throws IOException {
