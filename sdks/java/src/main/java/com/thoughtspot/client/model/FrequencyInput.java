...
public class FrequencyInput implements Serializable {
    ...
    public FrequencyInput cronExpression(
            @javax.annotation.Nonnull CronExpressionInput cronExpression) {
     ...
     * @return the FrequencyInput instance itself
     */
    public FrequencyInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.cronExpression, frequencyInput.cronExpression)
                && Objects.equals(this.additionalProperties, frequencyInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!FrequencyInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in FrequencyInput is not found in the"
                                        + " empty JSON string",
                                FrequencyInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<FrequencyInput>() {
                        @Override
                        ...
                        public FrequencyInput read(JsonReader in) throws IOException {
                            ...
                            FrequencyInput instance = thisAdapter.fromJsonTree(jsonObj);
