...
import com.thoughtspot.client.model.HeaderAttributeInput;
...
public class HeaderUpdateInput implements Serializable {
   ...
   * @return the HeaderUpdateInput instance itself
   */
  public HeaderUpdateInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, headerUpdateInput.identifier) &&
        ...
        Objects.equals(this.additionalProperties, headerUpdateInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(identifier, objIdentifier, type, attributes, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<HeaderUpdateInput>() {
           ...
           public HeaderUpdateInput read(JsonReader in) throws IOException {
             ...
             HeaderUpdateInput instance = thisAdapter.fromJsonTree(jsonObj);
