...
public class UpdateObjIdInput implements Serializable {
   ...
   * @return the UpdateObjIdInput instance itself
   */
  public UpdateObjIdInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataIdentifier, updateObjIdInput.metadataIdentifier) &&
        ...
        Objects.equals(this.additionalProperties, updateObjIdInput.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataIdentifier, type, currentObjId, newObjId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateObjIdInput>() {
           ...
           public UpdateObjIdInput read(JsonReader in) throws IOException {
             ...
             UpdateObjIdInput instance = thisAdapter.fromJsonTree(jsonObj);
