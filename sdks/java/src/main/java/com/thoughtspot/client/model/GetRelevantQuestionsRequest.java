...
public class GetRelevantQuestionsRequest implements Serializable {
    ...
    public static final String SERIALIZED_NAME_LIMIT_RELEVANT_QUESTIONS =
    ...
    public GetRelevantQuestionsRequest metadataContext(
            @javax.annotation.Nonnull MetadataContext metadataContext) {
        this.metadataContext = metadataContext;
        return this;
    }

    /**
     * metadata for the query to enable generation of relevant sub-questions; at least one context
    ...
    public GetRelevantQuestionsRequest limitRelevantQuestions(
            @javax.annotation.Nullable Integer limitRelevantQuestions) {
    ...
    public void setLimitRelevantQuestions(
            @javax.annotation.Nullable Integer limitRelevantQuestions) {
        this.limitRelevantQuestions = limitRelevantQuestions;
    }
     ...
     * @return the GetRelevantQuestionsRequest instance itself
     */
    public GetRelevantQuestionsRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadataContext, getRelevantQuestionsRequest.metadataContext)
                && Objects.equals(
                        this.limitRelevantQuestions,
                        getRelevantQuestionsRequest.limitRelevantQuestions)
                ...
                && Objects.equals(
                        ...
                        getRelevantQuestionsRequest.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    limitRelevantQuestions: ")
                .append(toIndentedString(limitRelevantQuestions))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!GetRelevantQuestionsRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in GetRelevantQuestionsRequest is not"
                                        + " found in the empty JSON string",
                                GetRelevantQuestionsRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!GetRelevantQuestionsRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'GetRelevantQuestionsRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<GetRelevantQuestionsRequest>() {
                        @Override
                        public void write(JsonWriter out, GetRelevantQuestionsRequest value)
                                throws IOException {
                        ...
                        public GetRelevantQuestionsRequest read(JsonReader in) throws IOException {
                            ...
                            GetRelevantQuestionsRequest instance =
