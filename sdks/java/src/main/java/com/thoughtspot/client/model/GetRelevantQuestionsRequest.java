...
public class GetRelevantQuestionsRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataContext, getRelevantQuestionsRequest.metadataContext) &&
        ...
        Objects.equals(this.additionalProperties, getRelevantQuestionsRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadataContext, limitRelevantQuestions, bypassCache, query, aiContext, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetRelevantQuestionsRequest>() {
           ...
           public GetRelevantQuestionsRequest read(JsonReader in) throws IOException {
             ...
             GetRelevantQuestionsRequest instance = thisAdapter.fromJsonTree(jsonObj);
