...
public class SearchEmailCustomizationRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orgIdentifiers, searchEmailCustomizationRequest.orgIdentifiers)&&
        Objects.equals(this.additionalProperties, searchEmailCustomizationRequest.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchEmailCustomizationRequest>() {
           ...
           public SearchEmailCustomizationRequest read(JsonReader in) throws IOException {
             ...
             SearchEmailCustomizationRequest instance = thisAdapter.fromJsonTree(jsonObj);
