...
public class SearchEmailCustomizationRequest implements Serializable {
  ...
  public SearchEmailCustomizationRequest orgIdentifiers(@javax.annotation.Nullable List<String> orgIdentifiers) {
  ...
  public boolean equals(Object o) {
    ...
    SearchEmailCustomizationRequest searchEmailCustomizationRequest = (SearchEmailCustomizationRequest) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchEmailCustomizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchEmailCustomizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchEmailCustomizationRequest is not found in the empty JSON string", SearchEmailCustomizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchEmailCustomizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchEmailCustomizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchEmailCustomizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchEmailCustomizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchEmailCustomizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchEmailCustomizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchEmailCustomizationRequest>() {
           @Override
           public void write(JsonWriter out, SearchEmailCustomizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SearchEmailCustomizationRequest read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to SearchEmailCustomizationRequest
   */
