...
import com.thoughtspot.client.model.ActionDetailsInputCreate;
import com.thoughtspot.client.model.AssociateMetadataInputCreate;
import com.thoughtspot.client.model.DefaultActionConfigInputCreate;
...
public class CreateCustomActionRequest implements Serializable {
   ...
   * @return the CreateCustomActionRequest instance itself
   */
  public CreateCustomActionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createCustomActionRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, createCustomActionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, actionDetails, associateMetadata, defaultActionConfig, groupIdentifiers, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateCustomActionRequest>() {
           ...
           public CreateCustomActionRequest read(JsonReader in) throws IOException {
             ...
             CreateCustomActionRequest instance = thisAdapter.fromJsonTree(jsonObj);
