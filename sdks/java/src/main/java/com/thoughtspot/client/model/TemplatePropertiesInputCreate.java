...
public class TemplatePropertiesInputCreate implements Serializable {
  ...
  public static final String SERIALIZED_NAME_HIDE_CONTACT_SUPPORT_URL = "hide_contact_support_url";
  ...
  public TemplatePropertiesInputCreate contactSupportUrl(@javax.annotation.Nullable String contactSupportUrl) {
  ...
  public TemplatePropertiesInputCreate hideContactSupportUrl(@javax.annotation.Nullable Boolean hideContactSupportUrl) {
  ...
  public TemplatePropertiesInputCreate hideLogoUrl(@javax.annotation.Nullable Boolean hideLogoUrl) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ctaButtonBgColor, templatePropertiesInputCreate.ctaButtonBgColor) &&
        ...
        Objects.equals(this.hideContactSupportUrl, templatePropertiesInputCreate.hideContactSupportUrl) &&
        Objects.equals(this.hideLogoUrl, templatePropertiesInputCreate.hideLogoUrl)&&
        Objects.equals(this.additionalProperties, templatePropertiesInputCreate.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("contact_support_url") != null && !jsonObj.get("contact_support_url").isJsonNull()) && !jsonObj.get("contact_support_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `contact_support_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("contact_support_url").toString()));
      }
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TemplatePropertiesInputCreate>() {
           ...
           public TemplatePropertiesInputCreate read(JsonReader in) throws IOException {
             ...
             TemplatePropertiesInputCreate instance = thisAdapter.fromJsonTree(jsonObj);
