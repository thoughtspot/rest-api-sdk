...
public class TemplatePropertiesInputCreate implements Serializable {
    ...
    public static final String SERIALIZED_NAME_REPLACEMENT_VALUE_FOR_LIVEBOARD =
    ...
    public static final String SERIALIZED_NAME_REPLACEMENT_VALUE_FOR_ANSWER =
    ...
    public static final String SERIALIZED_NAME_REPLACEMENT_VALUE_FOR_SPOT_IQ =
    ...
    public static final String SERIALIZED_NAME_HIDE_MANAGE_NOTIFICATION =
    ...
    public static final String SERIALIZED_NAME_HIDE_TS_VOCABULARY_DEFINITIONS =
    ...
    public static final String SERIALIZED_NAME_HIDE_NOTIFICATION_STATUS =
    ...
    public TemplatePropertiesInputCreate ctaButtonBgColor(
            @javax.annotation.Nullable String ctaButtonBgColor) {
    ...
    public TemplatePropertiesInputCreate ctaTextFontColor(
            @javax.annotation.Nullable String ctaTextFontColor) {
    ...
    public TemplatePropertiesInputCreate primaryBgColor(
            @javax.annotation.Nullable String primaryBgColor) {
    ...
    public TemplatePropertiesInputCreate productName(
            @javax.annotation.Nullable String productName) {
    ...
    public TemplatePropertiesInputCreate footerAddress(
            @javax.annotation.Nullable String footerAddress) {
    ...
    public TemplatePropertiesInputCreate footerPhone(
            @javax.annotation.Nullable String footerPhone) {
    ...
    public TemplatePropertiesInputCreate replacementValueForLiveboard(
            @javax.annotation.Nullable String replacementValueForLiveboard) {
    ...
    public void setReplacementValueForLiveboard(
            @javax.annotation.Nullable String replacementValueForLiveboard) {
        this.replacementValueForLiveboard = replacementValueForLiveboard;
    }

    public TemplatePropertiesInputCreate replacementValueForAnswer(
            @javax.annotation.Nullable String replacementValueForAnswer) {
    ...
    public void setReplacementValueForAnswer(
            @javax.annotation.Nullable String replacementValueForAnswer) {
        this.replacementValueForAnswer = replacementValueForAnswer;
    }

    public TemplatePropertiesInputCreate replacementValueForSpotIq(
            @javax.annotation.Nullable String replacementValueForSpotIq) {
    ...
    public void setReplacementValueForSpotIq(
            @javax.annotation.Nullable String replacementValueForSpotIq) {
        this.replacementValueForSpotIq = replacementValueForSpotIq;
    }

    public TemplatePropertiesInputCreate hideFooterAddress(
            @javax.annotation.Nullable Boolean hideFooterAddress) {
    ...
    public TemplatePropertiesInputCreate hideFooterPhone(
            @javax.annotation.Nullable Boolean hideFooterPhone) {
    ...
    public TemplatePropertiesInputCreate hideManageNotification(
            @javax.annotation.Nullable Boolean hideManageNotification) {
    ...
    public void setHideManageNotification(
            @javax.annotation.Nullable Boolean hideManageNotification) {
        this.hideManageNotification = hideManageNotification;
    }

    public TemplatePropertiesInputCreate hideMobileAppNudge(
            @javax.annotation.Nullable Boolean hideMobileAppNudge) {
    ...
    public TemplatePropertiesInputCreate hidePrivacyPolicy(
            @javax.annotation.Nullable Boolean hidePrivacyPolicy) {
    ...
    public TemplatePropertiesInputCreate hideProductName(
            @javax.annotation.Nullable Boolean hideProductName) {
    ...
    public TemplatePropertiesInputCreate hideTsVocabularyDefinitions(
            @javax.annotation.Nullable Boolean hideTsVocabularyDefinitions) {
    ...
    public void setHideTsVocabularyDefinitions(
            @javax.annotation.Nullable Boolean hideTsVocabularyDefinitions) {
        this.hideTsVocabularyDefinitions = hideTsVocabularyDefinitions;
    }

    public TemplatePropertiesInputCreate hideNotificationStatus(
            @javax.annotation.Nullable Boolean hideNotificationStatus) {
    ...
    public void setHideNotificationStatus(
            @javax.annotation.Nullable Boolean hideNotificationStatus) {
        this.hideNotificationStatus = hideNotificationStatus;
    }

    public TemplatePropertiesInputCreate hideErrorMessage(
            @javax.annotation.Nullable Boolean hideErrorMessage) {
    ...
    public TemplatePropertiesInputCreate hideUnsubscribeLink(
            @javax.annotation.Nullable Boolean hideUnsubscribeLink) {
    ...
    public TemplatePropertiesInputCreate hideModifyAlert(
            @javax.annotation.Nullable Boolean hideModifyAlert) {
     ...
     * @return the TemplatePropertiesInputCreate instance itself
     */
    public TemplatePropertiesInputCreate putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        TemplatePropertiesInputCreate templatePropertiesInputCreate =
                (TemplatePropertiesInputCreate) o;
        return Objects.equals(this.ctaButtonBgColor, templatePropertiesInputCreate.ctaButtonBgColor)
                && Objects.equals(
                        this.ctaTextFontColor, templatePropertiesInputCreate.ctaTextFontColor)
                ...
                && Objects.equals(
                        this.replacementValueForLiveboard,
                        templatePropertiesInputCreate.replacementValueForLiveboard)
                && Objects.equals(
                        this.replacementValueForAnswer,
                        templatePropertiesInputCreate.replacementValueForAnswer)
                && Objects.equals(
                        this.replacementValueForSpotIq,
                        templatePropertiesInputCreate.replacementValueForSpotIq)
                && Objects.equals(
                        this.hideFooterAddress, templatePropertiesInputCreate.hideFooterAddress)
                && Objects.equals(
                        this.hideFooterPhone, templatePropertiesInputCreate.hideFooterPhone)
                && Objects.equals(
                        this.hideManageNotification,
                        templatePropertiesInputCreate.hideManageNotification)
                && Objects.equals(
                        this.hideMobileAppNudge, templatePropertiesInputCreate.hideMobileAppNudge)
                && Objects.equals(
                        this.hidePrivacyPolicy, templatePropertiesInputCreate.hidePrivacyPolicy)
                && Objects.equals(
                        this.hideProductName, templatePropertiesInputCreate.hideProductName)
                && Objects.equals(
                        this.hideTsVocabularyDefinitions,
                        templatePropertiesInputCreate.hideTsVocabularyDefinitions)
                && Objects.equals(
                        this.hideNotificationStatus,
                        templatePropertiesInputCreate.hideNotificationStatus)
                && Objects.equals(
                        this.hideErrorMessage, templatePropertiesInputCreate.hideErrorMessage)
                && Objects.equals(
    ...
    public int hashCode() {
        return Objects.hash(
                ...
                footerAddress,
                footerPhone,
                replacementValueForLiveboard,
                replacementValueForAnswer,
                replacementValueForSpotIq,
                hideFooterAddress,
                hideFooterPhone,
    ...
    public String toString() {
        ...
        sb.append("    replacementValueForLiveboard: ")
                .append(toIndentedString(replacementValueForLiveboard))
                .append("\n");
        sb.append("    replacementValueForAnswer: ")
                .append(toIndentedString(replacementValueForAnswer))
                .append("\n");
        sb.append("    replacementValueForSpotIq: ")
                .append(toIndentedString(replacementValueForSpotIq))
                .append("\n");
        sb.append("    hideFooterAddress: ")
                .append(toIndentedString(hideFooterAddress))
                .append("\n");
        sb.append("    hideFooterPhone: ").append(toIndentedString(hideFooterPhone)).append("\n");
        sb.append("    hideManageNotification: ")
                .append(toIndentedString(hideManageNotification))
                .append("\n");
        sb.append("    hideMobileAppNudge: ")
                .append(toIndentedString(hideMobileAppNudge))
                .append("\n");
        sb.append("    hidePrivacyPolicy: ")
                .append(toIndentedString(hidePrivacyPolicy))
                .append("\n");
        sb.append("    hideProductName: ").append(toIndentedString(hideProductName)).append("\n");
        sb.append("    hideTsVocabularyDefinitions: ")
                .append(toIndentedString(hideTsVocabularyDefinitions))
                .append("\n");
        sb.append("    hideNotificationStatus: ")
                .append(toIndentedString(hideNotificationStatus))
                .append("\n");
        sb.append("    hideErrorMessage: ").append(toIndentedString(hideErrorMessage)).append("\n");
        sb.append("    hideUnsubscribeLink: ")
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!TemplatePropertiesInputCreate.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in TemplatePropertiesInputCreate is not"
                                        + " found in the empty JSON string",
                                TemplatePropertiesInputCreate.openapiRequiredFields.toString()));
            }
        }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
        if ((jsonObj.get("cta_button_bg_color") != null
                        && !jsonObj.get("cta_button_bg_color").isJsonNull())
                && !jsonObj.get("cta_button_bg_color").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `cta_button_bg_color` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("cta_button_bg_color").toString()));
        }
        if ((jsonObj.get("cta_text_font_color") != null
                        && !jsonObj.get("cta_text_font_color").isJsonNull())
                && !jsonObj.get("cta_text_font_color").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `cta_text_font_color` to be a primitive type in"
                                    + " the JSON string but got `%s`",
                            jsonObj.get("cta_text_font_color").toString()));
        }
        if ((jsonObj.get("primary_bg_color") != null
                        && !jsonObj.get("primary_bg_color").isJsonNull())
                && !jsonObj.get("primary_bg_color").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `primary_bg_color` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("primary_bg_color").toString()));
        }
        if ((jsonObj.get("home_url") != null && !jsonObj.get("home_url").isJsonNull())
                && !jsonObj.get("home_url").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `home_url` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("home_url").toString()));
        }
        if ((jsonObj.get("logo_url") != null && !jsonObj.get("logo_url").isJsonNull())
                && !jsonObj.get("logo_url").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `logo_url` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("logo_url").toString()));
        }
        if ((jsonObj.get("font_family") != null && !jsonObj.get("font_family").isJsonNull())
                && !jsonObj.get("font_family").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `font_family` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("font_family").toString()));
        }
        if ((jsonObj.get("product_name") != null && !jsonObj.get("product_name").isJsonNull())
                && !jsonObj.get("product_name").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `product_name` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("product_name").toString()));
        }
        if ((jsonObj.get("footer_address") != null && !jsonObj.get("footer_address").isJsonNull())
                && !jsonObj.get("footer_address").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `footer_address` to be a primitive type in the"
                                    + " JSON string but got `%s`",
                            jsonObj.get("footer_address").toString()));
        }
        if ((jsonObj.get("footer_phone") != null && !jsonObj.get("footer_phone").isJsonNull())
                && !jsonObj.get("footer_phone").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `footer_phone` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("footer_phone").toString()));
        }
        if ((jsonObj.get("replacement_value_for_liveboard") != null
                        && !jsonObj.get("replacement_value_for_liveboard").isJsonNull())
                && !jsonObj.get("replacement_value_for_liveboard").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `replacement_value_for_liveboard` to be a"
                                    + " primitive type in the JSON string but got `%s`",
                            jsonObj.get("replacement_value_for_liveboard").toString()));
        }
        if ((jsonObj.get("replacement_value_for_answer") != null
                        && !jsonObj.get("replacement_value_for_answer").isJsonNull())
                && !jsonObj.get("replacement_value_for_answer").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `replacement_value_for_answer` to be a primitive"
                                    + " type in the JSON string but got `%s`",
                            jsonObj.get("replacement_value_for_answer").toString()));
        }
        if ((jsonObj.get("replacement_value_for_spot_iq") != null
                        && !jsonObj.get("replacement_value_for_spot_iq").isJsonNull())
                && !jsonObj.get("replacement_value_for_spot_iq").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!TemplatePropertiesInputCreate.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'TemplatePropertiesInputCreate' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<TemplatePropertiesInputCreate> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(TemplatePropertiesInputCreate.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<TemplatePropertiesInputCreate>() {
                        @Override
                        public void write(JsonWriter out, TemplatePropertiesInputCreate value)
                                throws IOException {
                        ...
                        @Override
                        public TemplatePropertiesInputCreate read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            TemplatePropertiesInputCreate instance =
