...
public class UpdateInputTableRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columns, updateInputTableRequest.columns) &&
        ...
        Objects.equals(this.additionalProperties, updateInputTableRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateInputTableRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateInputTableRequest is not found in the empty JSON string", UpdateInputTableRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateInputTableRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateInputTableRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateInputTableRequest>() {
           @Override
           public void write(JsonWriter out, UpdateInputTableRequest value) throws IOException {
