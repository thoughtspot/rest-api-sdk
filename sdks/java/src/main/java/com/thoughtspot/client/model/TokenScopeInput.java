...
public class TokenScopeInput implements Serializable {
  ...
  public enum OrgScopeEnum {
    ...
    public static class Adapter extends TypeAdapter<OrgScopeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final OrgScopeEnum enumeration) throws IOException {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TokenScopeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TokenScopeInput is not found in the empty JSON string", TokenScopeInput.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("org_scope").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `org_scope` to be a primitive type in the JSON string but got `%s`", jsonObj.get("org_scope").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TokenScopeInput>() {
           @Override
           public void write(JsonWriter out, TokenScopeInput value) throws IOException {
