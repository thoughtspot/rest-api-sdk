...
import com.thoughtspot.client.model.StyleFontAssignment;
...
public class StyleFontRecord implements Serializable {
  ...
  public StyleFontRecord creationTimeInMillis(@javax.annotation.Nullable Float creationTimeInMillis) {
  ...
  public StyleFontRecord assignments(@javax.annotation.Nullable List<StyleFontAssignment> assignments) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, scope, org, name, weight, style, color, creationTimeInMillis, assignments, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StyleFontRecord.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StyleFontRecord is not found in the empty JSON string", StyleFontRecord.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StyleFontRecord>() {
           @Override
           public void write(JsonWriter out, StyleFontRecord value) throws IOException {
