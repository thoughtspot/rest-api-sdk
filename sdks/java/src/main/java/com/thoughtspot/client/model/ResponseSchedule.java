...
public class ResponseSchedule implements Serializable {
  ...
  public ResponseSchedule creationTimeInMillis(@javax.annotation.Nullable Object creationTimeInMillis) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(author, creationTimeInMillis, description, fileFormat, frequency, id, liveboardOptions, metadata, name, pdfOptions, recipientDetails, status, timeZone, historyRuns, personalisedViewId, additionalProperties);
  }
