...
public class ResponseSchedule implements Serializable {
    ...
    public ResponseSchedule liveboardOptions(
            @javax.annotation.Nullable LiveboardOptions liveboardOptions) {
    ...
    public ResponseSchedule recipientDetails(
            @javax.annotation.Nonnull RecipientDetails recipientDetails) {
    ...
    public ResponseSchedule historyRuns(
            @javax.annotation.Nullable List<ResponseScheduleRun> historyRuns) {
     ...
     * @return the ResponseSchedule instance itself
     */
    public ResponseSchedule putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.author, responseSchedule.author)
                ...
                && Objects.equals(this.additionalProperties, responseSchedule.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ResponseSchedule.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ResponseSchedule is not found in the"
                                        + " empty JSON string",
                                ResponseSchedule.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("history_runs") != null && !jsonObj.get("history_runs").isJsonNull()) {
            ...
            if (jsonArrayhistoryRuns != null) {
                ...
                if (!jsonObj.get("history_runs").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `history_runs` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("history_runs").toString()));
                }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ResponseSchedule>() {
                        @Override
                        public void write(JsonWriter out, ResponseSchedule value)
                                throws IOException {
                        ...
                        public ResponseSchedule read(JsonReader in) throws IOException {
                            ...
                            ResponseSchedule instance = thisAdapter.fromJsonTree(jsonObj);
