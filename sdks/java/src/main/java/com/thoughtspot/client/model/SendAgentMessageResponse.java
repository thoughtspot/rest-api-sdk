...
public class SendAgentMessageResponse implements Serializable {
     ...
     * @return the SendAgentMessageResponse instance itself
     */
    public SendAgentMessageResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.success, sendAgentMessageResponse.success)
                ...
                && Objects.equals(
                        this.additionalProperties, sendAgentMessageResponse.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SendAgentMessageResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SendAgentMessageResponse is not found"
                                        + " in the empty JSON string",
                                SendAgentMessageResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!SendAgentMessageResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'SendAgentMessageResponse' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SendAgentMessageResponse>() {
                        @Override
                        public void write(JsonWriter out, SendAgentMessageResponse value)
                                throws IOException {
                        ...
                        public SendAgentMessageResponse read(JsonReader in) throws IOException {
                            ...
                            SendAgentMessageResponse instance = thisAdapter.fromJsonTree(jsonObj);
