...
public class GetAsyncImportStatusResponse implements Serializable {
   ...
   * @return the GetAsyncImportStatusResponse instance itself
   */
  public GetAsyncImportStatusResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.statusList, getAsyncImportStatusResponse.statusList) &&
        ...
        Objects.equals(this.additionalProperties, getAsyncImportStatusResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(statusList, lastBatch, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetAsyncImportStatusResponse>() {
           ...
           public GetAsyncImportStatusResponse read(JsonReader in) throws IOException {
             ...
             GetAsyncImportStatusResponse instance = thisAdapter.fromJsonTree(jsonObj);
