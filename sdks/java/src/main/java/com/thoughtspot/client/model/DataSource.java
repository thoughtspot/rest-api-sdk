...
import com.thoughtspot.client.model.EntityHeader;
...
public class DataSource implements Serializable {
   ...
   * @return the DataSource instance itself
   */
  public DataSource putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.confidence, dataSource.confidence) &&
        ...
        Objects.equals(this.additionalProperties, dataSource.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(confidence, details, reasoning, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataSource>() {
           ...
           public DataSource read(JsonReader in) throws IOException {
             ...
             DataSource instance = thisAdapter.fromJsonTree(jsonObj);
