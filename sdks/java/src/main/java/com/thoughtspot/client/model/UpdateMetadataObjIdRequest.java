...
public class UpdateMetadataObjIdRequest implements Serializable {
    ...
    public UpdateMetadataObjIdRequest metadata(
            @javax.annotation.Nonnull List<UpdateObjIdInput> metadata) {
     ...
     * @return the UpdateMetadataObjIdRequest instance itself
     */
    public UpdateMetadataObjIdRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadata, updateMetadataObjIdRequest.metadata)
                && Objects.equals(
                        this.additionalProperties, updateMetadataObjIdRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateMetadataObjIdRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateMetadataObjIdRequest is not"
                                        + " found in the empty JSON string",
                                UpdateMetadataObjIdRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateMetadataObjIdRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateMetadataObjIdRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateMetadataObjIdRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateMetadataObjIdRequest value)
                                throws IOException {
                        ...
                        public UpdateMetadataObjIdRequest read(JsonReader in) throws IOException {
                            ...
                            UpdateMetadataObjIdRequest instance = thisAdapter.fromJsonTree(jsonObj);
