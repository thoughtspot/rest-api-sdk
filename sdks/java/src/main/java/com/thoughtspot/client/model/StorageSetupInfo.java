...
public class StorageSetupInfo implements Serializable {
    ...
    public static final String SERIALIZED_NAME_S3_CONFIG = "s3_config";

    @SerializedName(SERIALIZED_NAME_S3_CONFIG)
    @javax.annotation.Nullable
    private S3StorageSetupConfig s3Config;

    public StorageSetupInfo() {}

    public StorageSetupInfo s3Config(@javax.annotation.Nullable S3StorageSetupConfig s3Config) {
     ...
     */
    @javax.annotation.Nullable
    public S3StorageSetupConfig getS3Config() {
        return s3Config;
    }

    public void setS3Config(@javax.annotation.Nullable S3StorageSetupConfig s3Config) {
        this.s3Config = s3Config;
    }
     ...
     * @return the StorageSetupInfo instance itself
     */
    public StorageSetupInfo putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.s3Config, storageSetupInfo.s3Config)
                && Objects.equals(this.additionalProperties, storageSetupInfo.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(s3Config, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        // validate the optional field `s3_config`
        if (jsonObj.get("s3_config") != null && !jsonObj.get("s3_config").isJsonNull()) {
            S3StorageSetupConfig.validateJsonElement(jsonObj.get("s3_config"));
        }
    }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<StorageSetupInfo>() {
                        ...
                        public StorageSetupInfo read(JsonReader in) throws IOException {
                            ...
                            StorageSetupInfo instance = thisAdapter.fromJsonTree(jsonObj);
