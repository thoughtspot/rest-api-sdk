...
public class RuntimeSorts implements Serializable {
   ...
   * @return the RuntimeSorts instance itself
   */
  public RuntimeSorts putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnName, runtimeSorts.columnName) &&
        ...
        Objects.equals(this.additionalProperties, runtimeSorts.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(columnName, order, persist, objects, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RuntimeSorts>() {
           ...
           public RuntimeSorts read(JsonReader in) throws IOException {
             ...
             RuntimeSorts instance = thisAdapter.fromJsonTree(jsonObj);
