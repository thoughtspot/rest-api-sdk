...
public class ImportMetadataTMLAsyncRequest implements Serializable {
  ...
  public static final String SERIALIZED_NAME_ENABLE_PERSONALIZED_VIEW_UPSERT = "enable_personalized_view_upsert";
  ...
  public ImportMetadataTMLAsyncRequest metadataTmls(@javax.annotation.Nonnull List<String> metadataTmls) {
  ...
  public ImportMetadataTMLAsyncRequest importPolicy(@javax.annotation.Nullable ImportPolicyEnum importPolicy) {
  ...
  public ImportMetadataTMLAsyncRequest enableLargeMetadataValidation(@javax.annotation.Nullable Boolean enableLargeMetadataValidation) {
  ...
  public ImportMetadataTMLAsyncRequest enablePersonalizedViewUpsert(@javax.annotation.Nullable Boolean enablePersonalizedViewUpsert) {
  ...
  public void setEnablePersonalizedViewUpsert(@javax.annotation.Nullable Boolean enablePersonalizedViewUpsert) {
    this.enablePersonalizedViewUpsert = enablePersonalizedViewUpsert;
  }
   ...
   * @return the ImportMetadataTMLAsyncRequest instance itself
   */
  public ImportMetadataTMLAsyncRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataTmls, importMetadataTMLAsyncRequest.metadataTmls) &&
        ...
        Objects.equals(this.enablePersonalizedViewUpsert, importMetadataTMLAsyncRequest.enablePersonalizedViewUpsert)&&
        Objects.equals(this.additionalProperties, importMetadataTMLAsyncRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataTmls, createNew, allOrgsOverride, importPolicy, skipDiffCheck, enableLargeMetadataValidation, enablePersonalizedViewUpsert, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    enablePersonalizedViewUpsert: ").append(toIndentedString(enablePersonalizedViewUpsert)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportMetadataTMLAsyncRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportMetadataTMLAsyncRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportMetadataTMLAsyncRequest>() {
           ...
           public ImportMetadataTMLAsyncRequest read(JsonReader in) throws IOException {
             ...
             ImportMetadataTMLAsyncRequest instance = thisAdapter.fromJsonTree(jsonObj);
