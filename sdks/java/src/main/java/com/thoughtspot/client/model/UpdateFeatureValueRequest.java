...
public class UpdateFeatureValueRequest implements Serializable {
  ...
  public UpdateFeatureValueRequest orgIdentifier(@javax.annotation.Nullable Integer orgIdentifier) {
  ...
  public UpdateFeatureValueRequest featureIdentifier(@javax.annotation.Nonnull String featureIdentifier) {
  ...
  public UpdateFeatureValueRequest resetOrgOverrides(@javax.annotation.Nullable Boolean resetOrgOverrides) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.scope, updateFeatureValueRequest.scope) &&
        ...
        Objects.equals(this.featureIdentifier, updateFeatureValueRequest.featureIdentifier) &&
        Objects.equals(this.featureValue, updateFeatureValueRequest.featureValue) &&
        Objects.equals(this.resetOrgOverrides, updateFeatureValueRequest.resetOrgOverrides)&&
        Objects.equals(this.additionalProperties, updateFeatureValueRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(scope, orgIdentifier, featureIdentifier, featureValue, resetOrgOverrides, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    resetOrgOverrides: ").append(toIndentedString(resetOrgOverrides)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFeatureValueRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFeatureValueRequest is not found in the empty JSON string", UpdateFeatureValueRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFeatureValueRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFeatureValueRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateFeatureValueRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFeatureValueRequest value) throws IOException {
