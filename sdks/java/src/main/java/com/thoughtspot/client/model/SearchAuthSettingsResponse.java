...
import com.thoughtspot.client.model.AuthClusterPreferences;
import com.thoughtspot.client.model.AuthOrgPreference;
...
public class SearchAuthSettingsResponse implements Serializable {
  ...
  public SearchAuthSettingsResponse clusterPreferences(@javax.annotation.Nullable AuthClusterPreferences clusterPreferences) {
  ...
  public void setClusterPreferences(@javax.annotation.Nullable AuthClusterPreferences clusterPreferences) {
    this.clusterPreferences = clusterPreferences;
  }


  public SearchAuthSettingsResponse orgPreferences(@javax.annotation.Nullable List<AuthOrgPreference> orgPreferences) {
  ...
  public void setOrgPreferences(@javax.annotation.Nullable List<AuthOrgPreference> orgPreferences) {
    this.orgPreferences = orgPreferences;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authType, searchAuthSettingsResponse.authType) &&
        Objects.equals(this.clusterPreferences, searchAuthSettingsResponse.clusterPreferences) &&
        Objects.equals(this.orgPreferences, searchAuthSettingsResponse.orgPreferences)&&
        Objects.equals(this.additionalProperties, searchAuthSettingsResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchAuthSettingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchAuthSettingsResponse is not found in the empty JSON string", SearchAuthSettingsResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchAuthSettingsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchAuthSettingsResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchAuthSettingsResponse>() {
           @Override
           public void write(JsonWriter out, SearchAuthSettingsResponse value) throws IOException {
