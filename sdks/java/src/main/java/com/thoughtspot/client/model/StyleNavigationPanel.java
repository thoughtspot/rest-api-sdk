...
public class StyleNavigationPanel implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.theme, styleNavigationPanel.theme) &&
        ...
        Objects.equals(this.additionalProperties, styleNavigationPanel.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StyleNavigationPanel.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StyleNavigationPanel is not found in the empty JSON string", StyleNavigationPanel.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StyleNavigationPanel>() {
           @Override
           public void write(JsonWriter out, StyleNavigationPanel value) throws IOException {
