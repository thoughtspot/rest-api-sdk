...
public class APIKeyInput implements Serializable {
   ...
   * @return the APIKeyInput instance itself
   */
  public APIKeyInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, apIKeyInput.key) &&
        ...
        Objects.equals(this.additionalProperties, apIKeyInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!APIKeyInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<APIKeyInput>() {
           ...
           public APIKeyInput read(JsonReader in) throws IOException {
             ...
             APIKeyInput instance = thisAdapter.fromJsonTree(jsonObj);
