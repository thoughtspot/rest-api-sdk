...
public class ImportEPackAsyncTaskStatus implements Serializable {
    ...
    public ImportEPackAsyncTaskStatus importResponse(
            @javax.annotation.Nullable Object importResponse) {
    ...
    public ImportEPackAsyncTaskStatus taskStatus(
            @javax.annotation.Nullable TaskStatusEnum taskStatus) {
    ...
    public ImportEPackAsyncTaskStatus importPolicy(
    ...
    public ImportEPackAsyncTaskStatus totalObjectCount(
            @javax.annotation.Nullable Integer totalObjectCount) {
    ...
    public ImportEPackAsyncTaskStatus objectProcessedCount(
            @javax.annotation.Nullable Integer objectProcessedCount) {
     ...
     * @return the ImportEPackAsyncTaskStatus instance itself
     */
    public ImportEPackAsyncTaskStatus putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.tenantId, importEPackAsyncTaskStatus.tenantId)
                ...
                && Objects.equals(
                        this.additionalProperties, importEPackAsyncTaskStatus.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    objectProcessedCount: ")
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ImportEPackAsyncTaskStatus.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ImportEPackAsyncTaskStatus is not"
                                        + " found in the empty JSON string",
                                ImportEPackAsyncTaskStatus.openapiRequiredFields.toString()));
            }
        }
        ...
        if ((jsonObj.get("task_id") != null && !jsonObj.get("task_id").isJsonNull())
            ...
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `task_id` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("task_id").toString()));
        }
        if ((jsonObj.get("task_name") != null && !jsonObj.get("task_name").isJsonNull())
                && !jsonObj.get("task_name").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `task_name` to be a primitive type in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("task_name").toString()));
        }
        if ((jsonObj.get("task_status") != null && !jsonObj.get("task_status").isJsonNull())
                && !jsonObj.get("task_status").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `task_status` to be a primitive type in the JSON"
                                    + " string but got `%s`",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ImportEPackAsyncTaskStatus.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ImportEPackAsyncTaskStatus' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ImportEPackAsyncTaskStatus>() {
                        @Override
                        public void write(JsonWriter out, ImportEPackAsyncTaskStatus value)
                                throws IOException {
                        ...
                        public ImportEPackAsyncTaskStatus read(JsonReader in) throws IOException {
                            ...
                            ImportEPackAsyncTaskStatus instance = thisAdapter.fromJsonTree(jsonObj);
