...
public class ImportEPackAsyncTaskStatus implements Serializable {
  ...
  public ImportEPackAsyncTaskStatus authorDisplayName(@javax.annotation.Nullable String authorDisplayName) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantId, importEPackAsyncTaskStatus.tenantId) &&
        ...
        Objects.equals(this.authorDisplayName, importEPackAsyncTaskStatus.authorDisplayName)&&
        Objects.equals(this.additionalProperties, importEPackAsyncTaskStatus.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, orgId, taskId, taskName, importResponse, taskStatus, authorId, importPolicy, createdAt, inProgressAt, completedAt, totalObjectCount, objectProcessedCount, modifiedAt, authorDisplayName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("author_display_name") != null && !jsonObj.get("author_display_name").isJsonNull()) && !jsonObj.get("author_display_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `author_display_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("author_display_name").toString()));
      }
  }
