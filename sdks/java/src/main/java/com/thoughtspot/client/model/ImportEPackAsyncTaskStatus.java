...
public class ImportEPackAsyncTaskStatus implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(tenantId, orgId, taskId, taskName, importResponse, taskStatus, authorId, importPolicy, createdAt, inProgressAt, completedAt, totalObjectCount, objectProcessedCount, modifiedAt, authorDisplayName);
  }
