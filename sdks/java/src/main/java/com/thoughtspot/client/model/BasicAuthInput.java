...
public class BasicAuthInput implements Serializable {
   ...
   * @return the BasicAuthInput instance itself
   */
  public BasicAuthInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.password, basicAuthInput.password) &&
        ...
        Objects.equals(this.additionalProperties, basicAuthInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<BasicAuthInput>() {
           ...
           public BasicAuthInput read(JsonReader in) throws IOException {
             ...
             BasicAuthInput instance = thisAdapter.fromJsonTree(jsonObj);
