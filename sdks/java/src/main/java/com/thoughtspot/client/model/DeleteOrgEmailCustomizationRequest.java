...
public class DeleteOrgEmailCustomizationRequest implements Serializable {
    ...
    public DeleteOrgEmailCustomizationRequest orgIdentifiers(
     ...
     * @return the DeleteOrgEmailCustomizationRequest instance itself
     */
    public DeleteOrgEmailCustomizationRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        DeleteOrgEmailCustomizationRequest deleteOrgEmailCustomizationRequest =
                (DeleteOrgEmailCustomizationRequest) o;
        return Objects.equals(
                        this.orgIdentifiers, deleteOrgEmailCustomizationRequest.orgIdentifiers)
                && Objects.equals(
                        this.additionalProperties,
                        deleteOrgEmailCustomizationRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DeleteOrgEmailCustomizationRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeleteOrgEmailCustomizationRequest is"
                                        + " not found in the empty JSON string",
                                DeleteOrgEmailCustomizationRequest.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!DeleteOrgEmailCustomizationRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'DeleteOrgEmailCustomizationRequest' and
                // its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<DeleteOrgEmailCustomizationRequest> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(DeleteOrgEmailCustomizationRequest.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<DeleteOrgEmailCustomizationRequest>() {
                        @Override
                        public void write(JsonWriter out, DeleteOrgEmailCustomizationRequest value)
                                throws IOException {
                        ...
                        @Override
                        public DeleteOrgEmailCustomizationRequest read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            DeleteOrgEmailCustomizationRequest instance =
     ...
     *     DeleteOrgEmailCustomizationRequest
     */
    public static DeleteOrgEmailCustomizationRequest fromJson(String jsonString)
            throws IOException {
