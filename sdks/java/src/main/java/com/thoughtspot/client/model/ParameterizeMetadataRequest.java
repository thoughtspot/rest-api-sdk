...
public class ParameterizeMetadataRequest implements Serializable {
  ...
  public ParameterizeMetadataRequest metadataType(@javax.annotation.Nullable MetadataTypeEnum metadataType) {
  ...
  public ParameterizeMetadataRequest metadataIdentifier(@javax.annotation.Nonnull String metadataIdentifier) {
  ...
  public ParameterizeMetadataRequest fieldType(@javax.annotation.Nonnull FieldTypeEnum fieldType) {
  ...
  public ParameterizeMetadataRequest variableIdentifier(@javax.annotation.Nonnull String variableIdentifier) {
   ...
   * @return the ParameterizeMetadataRequest instance itself
   */
  public ParameterizeMetadataRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataType, parameterizeMetadataRequest.metadataType) &&
        Objects.equals(this.metadataIdentifier, parameterizeMetadataRequest.metadataIdentifier) &&
        ...
        Objects.equals(this.variableIdentifier, parameterizeMetadataRequest.variableIdentifier)&&
        Objects.equals(this.additionalProperties, parameterizeMetadataRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataType, metadataIdentifier, fieldType, fieldName, variableIdentifier, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ParameterizeMetadataRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ParameterizeMetadataRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ParameterizeMetadataRequest is not found in the empty JSON string", ParameterizeMetadataRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ParameterizeMetadataRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ParameterizeMetadataRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ParameterizeMetadataRequest>() {
           @Override
           public void write(JsonWriter out, ParameterizeMetadataRequest value) throws IOException {
           ...
           public ParameterizeMetadataRequest read(JsonReader in) throws IOException {
             ...
             ParameterizeMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
