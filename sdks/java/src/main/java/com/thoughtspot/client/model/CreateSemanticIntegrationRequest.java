...
public class CreateSemanticIntegrationRequest implements Serializable {
  ...
  public CreateSemanticIntegrationRequest connectionIdentifier(@javax.annotation.Nonnull String connectionIdentifier) {
  ...
  public CreateSemanticIntegrationRequest databaseName(@javax.annotation.Nonnull String databaseName) {
  ...
  public CreateSemanticIntegrationRequest schemaName(@javax.annotation.Nonnull String schemaName) {
  ...
  public CreateSemanticIntegrationRequest semanticViewName(@javax.annotation.Nonnull String semanticViewName) {
  ...
  public CreateSemanticIntegrationRequest description(@javax.annotation.Nullable String description) {
  ...
  public boolean equals(Object o) {
    ...
    CreateSemanticIntegrationRequest createSemanticIntegrationRequest = (CreateSemanticIntegrationRequest) o;
    return Objects.equals(this.connectionIdentifier, createSemanticIntegrationRequest.connectionIdentifier) &&
        ...
        Objects.equals(this.semanticViewName, createSemanticIntegrationRequest.semanticViewName) &&
        ...
        Objects.equals(this.additionalProperties, createSemanticIntegrationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(connectionIdentifier, name, databaseName, schemaName, semanticViewName, type, description, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSemanticIntegrationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSemanticIntegrationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CreateSemanticIntegrationRequest is not found in the empty JSON string", CreateSemanticIntegrationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("semantic_view_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `semantic_view_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("semantic_view_name").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSemanticIntegrationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSemanticIntegrationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSemanticIntegrationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSemanticIntegrationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSemanticIntegrationRequest>() {
           @Override
           public void write(JsonWriter out, CreateSemanticIntegrationRequest value) throws IOException {
           ...
           @Override
           public CreateSemanticIntegrationRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CreateSemanticIntegrationRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to CreateSemanticIntegrationRequest
   */
