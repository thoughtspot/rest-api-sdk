...
import com.thoughtspot.client.model.WebhookPagination;
...
public class WebhookSearchResponse implements Serializable {
  ...
  public WebhookSearchResponse webhooks(@javax.annotation.Nonnull List<WebhookResponse> webhooks) {
  ...
  public WebhookSearchResponse pagination(@javax.annotation.Nonnull WebhookPagination pagination) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookSearchResponse is not found in the empty JSON string", WebhookSearchResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!WebhookSearchResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WebhookSearchResponse` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookSearchResponse>() {
           @Override
           public void write(JsonWriter out, WebhookSearchResponse value) throws IOException {
