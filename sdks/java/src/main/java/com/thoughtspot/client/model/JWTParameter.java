...
public class JWTParameter implements Serializable {
   ...
   * @return the JWTParameter instance itself
   */
  public JWTParameter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.runtimeFilter, jwTParameter.runtimeFilter) &&
        ...
        Objects.equals(this.additionalProperties, jwTParameter.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(runtimeFilter, runtimeSort, runtimeParamOverride, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<JWTParameter>() {
           ...
           public JWTParameter read(JsonReader in) throws IOException {
             ...
             JWTParameter instance = thisAdapter.fromJsonTree(jsonObj);
