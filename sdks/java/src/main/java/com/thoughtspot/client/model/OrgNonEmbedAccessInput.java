...
public class OrgNonEmbedAccessInput implements Serializable {
  ...
  public OrgNonEmbedAccessInput blockFullAppAccess(@javax.annotation.Nullable Boolean blockFullAppAccess) {
  ...
  public OrgNonEmbedAccessInput groupsIdentifiersWithAccess(@javax.annotation.Nullable List<String> groupsIdentifiersWithAccess) {
    this.groupsIdentifiersWithAccess = groupsIdentifiersWithAccess;
    return this;
  }

  public OrgNonEmbedAccessInput addGroupsIdentifiersWithAccessItem(String groupsIdentifiersWithAccessItem) {
   ...
   * @return the OrgNonEmbedAccessInput instance itself
   */
  public OrgNonEmbedAccessInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blockFullAppAccess, orgNonEmbedAccessInput.blockFullAppAccess) &&
        Objects.equals(this.groupsIdentifiersWithAccess, orgNonEmbedAccessInput.groupsIdentifiersWithAccess)&&
        Objects.equals(this.additionalProperties, orgNonEmbedAccessInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgNonEmbedAccessInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgNonEmbedAccessInput is not found in the empty JSON string", OrgNonEmbedAccessInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrgNonEmbedAccessInput>() {
           @Override
           public void write(JsonWriter out, OrgNonEmbedAccessInput value) throws IOException {
           ...
           public OrgNonEmbedAccessInput read(JsonReader in) throws IOException {
             ...
             OrgNonEmbedAccessInput instance = thisAdapter.fromJsonTree(jsonObj);
