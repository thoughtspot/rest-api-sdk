...
public class Conversation implements Serializable {
  ...
  public Conversation conversationIdentifier(@javax.annotation.Nonnull String conversationIdentifier) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(conversationIdentifier, additionalProperties);
  }
