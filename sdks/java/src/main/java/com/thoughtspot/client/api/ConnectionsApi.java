...
public class ConnectionsApi {
     ...
     * @param connectionIdentifier Unique ID or name of the connection whose refresh tokens need to be revoked. All the users associated with the connection will have their refresh tokens revoked except the author. (required)
     ...
     */
    public okhttp3.Call revokeRefreshTokensCall(String connectionIdentifier, RevokeRefreshTokensRequest revokeRefreshTokensRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/connections/{connection_identifier}/revoke-refresh-tokens"
            .replace("{" + "connection_identifier" + "}", localVarApiClient.escapeString(connectionIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call revokeRefreshTokensValidateBeforeCall(String connectionIdentifier, RevokeRefreshTokensRequest revokeRefreshTokensRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'connectionIdentifier' is set
        if (connectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'connectionIdentifier' when calling revokeRefreshTokens(Async)");
        }

        // verify the required parameter 'revokeRefreshTokensRequest' is set
        if (revokeRefreshTokensRequest == null) {
            throw new ApiException("Missing the required parameter 'revokeRefreshTokensRequest' when calling revokeRefreshTokens(Async)");
        }
     ...
     */
    public RevokeRefreshTokensResponse revokeRefreshTokens(String connectionIdentifier, RevokeRefreshTokensRequest revokeRefreshTokensRequest) throws ApiException {
        ApiResponse<RevokeRefreshTokensResponse> localVarResp = revokeRefreshTokensWithHttpInfo(connectionIdentifier, revokeRefreshTokensRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<RevokeRefreshTokensResponse> revokeRefreshTokensWithHttpInfo(String connectionIdentifier, RevokeRefreshTokensRequest revokeRefreshTokensRequest) throws ApiException {
        okhttp3.Call localVarCall = revokeRefreshTokensValidateBeforeCall(connectionIdentifier, revokeRefreshTokensRequest, null);
     ...
     */
    public okhttp3.Call revokeRefreshTokensAsync(String connectionIdentifier, RevokeRefreshTokensRequest revokeRefreshTokensRequest, final ApiCallback<RevokeRefreshTokensResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = revokeRefreshTokensValidateBeforeCall(connectionIdentifier, revokeRefreshTokensRequest, _callback);
        Type localVarReturnType = new TypeToken<RevokeRefreshTokensResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call syncMetadataCall(String connectionIdentifier, SyncMetadataRequest syncMetadataRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/connections/{connection_identifier}/resync-metadata"
            .replace("{" + "connection_identifier" + "}", localVarApiClient.escapeString(connectionIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call syncMetadataValidateBeforeCall(String connectionIdentifier, SyncMetadataRequest syncMetadataRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'connectionIdentifier' is set
        if (connectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'connectionIdentifier' when calling syncMetadata(Async)");
        }

        // verify the required parameter 'syncMetadataRequest' is set
        if (syncMetadataRequest == null) {
            throw new ApiException("Missing the required parameter 'syncMetadataRequest' when calling syncMetadata(Async)");
        }
     ...
     */
    public SyncMetadataResponse syncMetadata(String connectionIdentifier, SyncMetadataRequest syncMetadataRequest) throws ApiException {
        ApiResponse<SyncMetadataResponse> localVarResp = syncMetadataWithHttpInfo(connectionIdentifier, syncMetadataRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SyncMetadataResponse> syncMetadataWithHttpInfo(String connectionIdentifier, SyncMetadataRequest syncMetadataRequest) throws ApiException {
        okhttp3.Call localVarCall = syncMetadataValidateBeforeCall(connectionIdentifier, syncMetadataRequest, null);
     ...
     */
    public okhttp3.Call syncMetadataAsync(String connectionIdentifier, SyncMetadataRequest syncMetadataRequest, final ApiCallback<SyncMetadataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = syncMetadataValidateBeforeCall(connectionIdentifier, syncMetadataRequest, _callback);
        Type localVarReturnType = new TypeToken<SyncMetadataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call updateConnectionStatusCall(String connectionIdentifier, UpdateConnectionStatusRequest updateConnectionStatusRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/api/rest/2.0/connections/{connection_identifier}/status"
            .replace("{" + "connection_identifier" + "}", localVarApiClient.escapeString(connectionIdentifier.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateConnectionStatusValidateBeforeCall(String connectionIdentifier, UpdateConnectionStatusRequest updateConnectionStatusRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'connectionIdentifier' is set
        if (connectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'connectionIdentifier' when calling updateConnectionStatus(Async)");
        }

        // verify the required parameter 'updateConnectionStatusRequest' is set
        if (updateConnectionStatusRequest == null) {
            throw new ApiException("Missing the required parameter 'updateConnectionStatusRequest' when calling updateConnectionStatus(Async)");
        }

        return updateConnectionStatusCall(connectionIdentifier, updateConnectionStatusRequest, _callback);
     ...
     */
    public void updateConnectionStatus(String connectionIdentifier, UpdateConnectionStatusRequest updateConnectionStatusRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateConnectionStatusWithHttpInfo(String connectionIdentifier, UpdateConnectionStatusRequest updateConnectionStatusRequest) throws ApiException {
        okhttp3.Call localVarCall = updateConnectionStatusValidateBeforeCall(connectionIdentifier, updateConnectionStatusRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateConnectionStatusAsync(String connectionIdentifier, UpdateConnectionStatusRequest updateConnectionStatusRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateConnectionStatusValidateBeforeCall(connectionIdentifier, updateConnectionStatusRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
