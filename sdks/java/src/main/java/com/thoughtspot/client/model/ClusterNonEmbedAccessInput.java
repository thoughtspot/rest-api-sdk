...
public class ClusterNonEmbedAccessInput implements Serializable {
  ...
  public static final String SERIALIZED_NAME_GROUPS_IDENTIFIERS_WITH_ACCESS = "groups_identifiers_with_access";
  ...
  public ClusterNonEmbedAccessInput blockFullAppAccess(@javax.annotation.Nullable Boolean blockFullAppAccess) {
  ...
  public ClusterNonEmbedAccessInput groupsIdentifiersWithAccess(@javax.annotation.Nullable List<String> groupsIdentifiersWithAccess) {
    this.groupsIdentifiersWithAccess = groupsIdentifiersWithAccess;
    return this;
  }

  public ClusterNonEmbedAccessInput addGroupsIdentifiersWithAccessItem(String groupsIdentifiersWithAccessItem) {
  ...
  public void setGroupsIdentifiersWithAccess(@javax.annotation.Nullable List<String> groupsIdentifiersWithAccess) {
    this.groupsIdentifiersWithAccess = groupsIdentifiersWithAccess;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blockFullAppAccess, clusterNonEmbedAccessInput.blockFullAppAccess) &&
        Objects.equals(this.groupsIdentifiersWithAccess, clusterNonEmbedAccessInput.groupsIdentifiersWithAccess)&&
        Objects.equals(this.additionalProperties, clusterNonEmbedAccessInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ClusterNonEmbedAccessInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ClusterNonEmbedAccessInput is not found in the empty JSON string", ClusterNonEmbedAccessInput.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("groups_identifiers_with_access") != null && !jsonObj.get("groups_identifiers_with_access").isJsonNull() && !jsonObj.get("groups_identifiers_with_access").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `groups_identifiers_with_access` to be an array in the JSON string but got `%s`", jsonObj.get("groups_identifiers_with_access").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ClusterNonEmbedAccessInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ClusterNonEmbedAccessInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ClusterNonEmbedAccessInput>() {
           @Override
           public void write(JsonWriter out, ClusterNonEmbedAccessInput value) throws IOException {
