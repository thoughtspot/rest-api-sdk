...
import com.thoughtspot.client.model.StyleNavigationPanel;
import com.thoughtspot.client.model.StyleOrgInfo;
import com.thoughtspot.client.model.StyleVisualizationFonts;
...
public class StylePreference implements Serializable {
  ...
  public StylePreference navigationPanel(@javax.annotation.Nullable StyleNavigationPanel navigationPanel) {
  ...
  public StylePreference chartColorPalette(@javax.annotation.Nullable StyleChartColorPalette chartColorPalette) {
  ...
  public void setChartColorPalette(@javax.annotation.Nullable StyleChartColorPalette chartColorPalette) {
    this.chartColorPalette = chartColorPalette;
  }


  public StylePreference embeddedFooterText(@javax.annotation.Nullable StyleEmbeddedFooterText embeddedFooterText) {
  ...
  public void setEmbeddedFooterText(@javax.annotation.Nullable StyleEmbeddedFooterText embeddedFooterText) {
    this.embeddedFooterText = embeddedFooterText;
  }
  ...
  public StylePreference visualizationFonts(@javax.annotation.Nullable StyleVisualizationFonts visualizationFonts) {
  ...
  public void setVisualizationFonts(@javax.annotation.Nullable StyleVisualizationFonts visualizationFonts) {
    this.visualizationFonts = visualizationFonts;
  }
  ...
  public String toString() {
    ...
    sb.append("    visualizationFonts: ").append(toIndentedString(visualizationFonts)).append("\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StylePreference.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StylePreference is not found in the empty JSON string", StylePreference.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("embedded_footer_text") != null && !jsonObj.get("embedded_footer_text").isJsonNull()) {
      ...
      if (jsonObj.get("visualization_fonts") != null && !jsonObj.get("visualization_fonts").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StylePreference>() {
           @Override
           public void write(JsonWriter out, StylePreference value) throws IOException {
