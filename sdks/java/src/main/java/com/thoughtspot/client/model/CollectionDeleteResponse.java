...
public class CollectionDeleteResponse implements Serializable {
  ...
  public CollectionDeleteResponse metadataDeleted(@javax.annotation.Nullable List<CollectionDeleteTypeIdentifiers> metadataDeleted) {
    this.metadataDeleted = metadataDeleted;
    return this;
  }

  public CollectionDeleteResponse addMetadataDeletedItem(CollectionDeleteTypeIdentifiers metadataDeletedItem) {
  ...
  public void setMetadataDeleted(@javax.annotation.Nullable List<CollectionDeleteTypeIdentifiers> metadataDeleted) {
    this.metadataDeleted = metadataDeleted;
  }


  public CollectionDeleteResponse metadataSkipped(@javax.annotation.Nullable List<CollectionDeleteTypeIdentifiers> metadataSkipped) {
    this.metadataSkipped = metadataSkipped;
    return this;
  }

  public CollectionDeleteResponse addMetadataSkippedItem(CollectionDeleteTypeIdentifiers metadataSkippedItem) {
  ...
  public void setMetadataSkipped(@javax.annotation.Nullable List<CollectionDeleteTypeIdentifiers> metadataSkipped) {
    this.metadataSkipped = metadataSkipped;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataDeleted, collectionDeleteResponse.metadataDeleted) &&
        ...
        Objects.equals(this.additionalProperties, collectionDeleteResponse.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionDeleteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionDeleteResponse is not found in the empty JSON string", CollectionDeleteResponse.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("metadata_deleted") != null && !jsonObj.get("metadata_deleted").isJsonNull()) {
        ...
        if (jsonArraymetadataDeleted != null) {
          ...
          if (!jsonObj.get("metadata_deleted").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `metadata_deleted` to be an array in the JSON string but got `%s`", jsonObj.get("metadata_deleted").toString()));
          }

          // validate the optional field `metadata_deleted` (array)
          for (int i = 0; i < jsonArraymetadataDeleted.size(); i++) {
            CollectionDeleteTypeIdentifiers.validateJsonElement(jsonArraymetadataDeleted.get(i));
          };
        }
      }
      if (jsonObj.get("metadata_skipped") != null && !jsonObj.get("metadata_skipped").isJsonNull()) {
        ...
        if (jsonArraymetadataSkipped != null) {
          ...
          if (!jsonObj.get("metadata_skipped").isJsonArray()) {
            throw new IllegalArgumentException(String.format("Expected the field `metadata_skipped` to be an array in the JSON string but got `%s`", jsonObj.get("metadata_skipped").toString()));
          }

          // validate the optional field `metadata_skipped` (array)
          for (int i = 0; i < jsonArraymetadataSkipped.size(); i++) {
            CollectionDeleteTypeIdentifiers.validateJsonElement(jsonArraymetadataSkipped.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectionDeleteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectionDeleteResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollectionDeleteResponse>() {
           @Override
           public void write(JsonWriter out, CollectionDeleteResponse value) throws IOException {
