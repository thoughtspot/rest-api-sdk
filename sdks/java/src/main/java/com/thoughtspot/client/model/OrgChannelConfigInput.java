...
public class OrgChannelConfigInput implements Serializable {
    ...
    /**
     * Operation to perform. REPLACE: Update preferences (default). RESET: Remove org-specific
     * configurations, causing fallback to cluster-level preferences.
     */
    ...
    public enum ResetEventsEnum {
        ...
        public static class Adapter extends TypeAdapter<ResetEventsEnum> {
            @Override
            public void write(final JsonWriter jsonWriter, final ResetEventsEnum enumeration)
                    throws IOException {
                jsonWriter.value(enumeration.getValue());
            }
    ...
    public OrgChannelConfigInput preferences(
            @javax.annotation.Nullable List<EventChannelConfigInput> preferences) {
    ...
    public OrgChannelConfigInput resetEvents(
            @javax.annotation.Nullable List<ResetEventsEnum> resetEvents) {
    ...
    /**
     * Event types to reset. Required for RESET operation. Org-specific configurations for these
     * events will be removed, causing fallback to cluster-level preferences.
     *
     * @return resetEvents
     */
    @javax.annotation.Nullable
     ...
     * @return the OrgChannelConfigInput instance itself
     */
    public OrgChannelConfigInput putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.orgIdentifier, orgChannelConfigInput.orgIdentifier)
                ...
                && Objects.equals(
                        this.additionalProperties, orgChannelConfigInput.additionalProperties);
    }
    ...
    public int hashCode() {
        return Objects.hash(
                orgIdentifier, operation, preferences, resetEvents, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrgChannelConfigInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrgChannelConfigInput is not found in"
                                        + " the empty JSON string",
                                OrgChannelConfigInput.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("preferences") != null && !jsonObj.get("preferences").isJsonNull()) {
            ...
            if (jsonArraypreferences != null) {
                ...
                if (!jsonObj.get("preferences").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `preferences` to be an array in the JSON"
                                            + " string but got `%s`",
                                    jsonObj.get("preferences").toString()));
                }
        ...
        if (jsonObj.get("reset_events") != null
                && !jsonObj.get("reset_events").isJsonNull()
                && !jsonObj.get("reset_events").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `reset_events` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("reset_events").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<OrgChannelConfigInput>() {
                        @Override
                        public void write(JsonWriter out, OrgChannelConfigInput value)
                                throws IOException {
                        ...
                        public OrgChannelConfigInput read(JsonReader in) throws IOException {
                            ...
                            OrgChannelConfigInput instance = thisAdapter.fromJsonTree(jsonObj);
