...
public class CodeExecutionFileMetadata implements Serializable {
  ...
  public CodeExecutionFileMetadata createdTimeInMillis(@javax.annotation.Nullable Object createdTimeInMillis) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fileId, codeExecutionFileMetadata.fileId) &&
        ...
        Objects.equals(this.createdTimeInMillis, codeExecutionFileMetadata.createdTimeInMillis) &&
        Objects.equals(this.expired, codeExecutionFileMetadata.expired)&&
        Objects.equals(this.additionalProperties, codeExecutionFileMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fileId, displayName, fileType, createdTimeInMillis, expired, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CodeExecutionFileMetadata.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CodeExecutionFileMetadata is not found in the empty JSON string", CodeExecutionFileMetadata.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CodeExecutionFileMetadata.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CodeExecutionFileMetadata' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<CodeExecutionFileMetadata>() {
           @Override
           public void write(JsonWriter out, CodeExecutionFileMetadata value) throws IOException {
