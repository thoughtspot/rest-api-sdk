...
public class MetadataContext implements Serializable {
    ...
    public MetadataContext dataSourceIdentifiers(
    ...
    /**
     * List of data_source_identifiers to provide context for breaking down user query into
     * analytical queries that can be run on them.
     *
    ...
    public MetadataContext answerIdentifiers(
            @javax.annotation.Nullable List<String> answerIdentifiers) {
    ...
    public MetadataContext conversationIdentifier(
            @javax.annotation.Nullable String conversationIdentifier) {
    ...
    public void setConversationIdentifier(
            @javax.annotation.Nullable String conversationIdentifier) {
        this.conversationIdentifier = conversationIdentifier;
    }

    public MetadataContext liveboardIdentifiers(
            @javax.annotation.Nullable List<String> liveboardIdentifiers) {
    ...
    public void setLiveboardIdentifiers(
            @javax.annotation.Nullable List<String> liveboardIdentifiers) {
        this.liveboardIdentifiers = liveboardIdentifiers;
    }
     ...
     * @return the MetadataContext instance itself
     */
    public MetadataContext putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.dataSourceIdentifiers, metadataContext.dataSourceIdentifiers)
                ...
                && Objects.equals(
                        this.conversationIdentifier, metadataContext.conversationIdentifier)
                && Objects.equals(this.liveboardIdentifiers, metadataContext.liveboardIdentifiers)
                && Objects.equals(this.additionalProperties, metadataContext.additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    dataSourceIdentifiers: ")
                ...
                .append("\n");
        sb.append("    answerIdentifiers: ")
                .append(toIndentedString(answerIdentifiers))
                .append("\n");
        sb.append("    conversationIdentifier: ")
                .append(toIndentedString(conversationIdentifier))
                .append("\n");
        sb.append("    liveboardIdentifiers: ")
                .append(toIndentedString(liveboardIdentifiers))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!MetadataContext.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in MetadataContext is not found in the"
                                        + " empty JSON string",
                                MetadataContext.openapiRequiredFields.toString()));
            }
        }
        ...
        // ensure the optional json data is an array if present
        if (jsonObj.get("answer_identifiers") != null
                && !jsonObj.get("answer_identifiers").isJsonNull()
                && !jsonObj.get("answer_identifiers").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `answer_identifiers` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("answer_identifiers").toString()));
        }
        if ((jsonObj.get("conversation_identifier") != null
                        && !jsonObj.get("conversation_identifier").isJsonNull())
                && !jsonObj.get("conversation_identifier").isJsonPrimitive()) {
            throw new IllegalArgumentException(
                    String.format(
        ...
        // ensure the optional json data is an array if present
        if (jsonObj.get("liveboard_identifiers") != null
                && !jsonObj.get("liveboard_identifiers").isJsonNull()
                && !jsonObj.get("liveboard_identifiers").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `liveboard_identifiers` to be an array in the JSON"
                                    + " string but got `%s`",
                            jsonObj.get("liveboard_identifiers").toString()));
        }
    }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<MetadataContext>() {
                        @Override
                        public void write(JsonWriter out, MetadataContext value)
                                throws IOException {
                        ...
                        public MetadataContext read(JsonReader in) throws IOException {
                            ...
                            MetadataContext instance = thisAdapter.fromJsonTree(jsonObj);
