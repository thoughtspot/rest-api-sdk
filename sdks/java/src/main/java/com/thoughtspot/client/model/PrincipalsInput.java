...
public class PrincipalsInput implements Serializable {
   ...
   * @return the PrincipalsInput instance itself
   */
  public PrincipalsInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, principalsInput.identifier) &&
        ...
        Objects.equals(this.additionalProperties, principalsInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<PrincipalsInput>() {
           ...
           public PrincipalsInput read(JsonReader in) throws IOException {
             ...
             PrincipalsInput instance = thisAdapter.fromJsonTree(jsonObj);
