...
public class ResponseFailedEntity implements Serializable {
   ...
   * @return the ResponseFailedEntity instance itself
   */
  public ResponseFailedEntity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, responseFailedEntity.id) &&
        ...
        Objects.equals(this.additionalProperties, responseFailedEntity.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseFailedEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseFailedEntity is not found in the empty JSON string", ResponseFailedEntity.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseFailedEntity>() {
           @Override
           public void write(JsonWriter out, ResponseFailedEntity value) throws IOException {
           ...
           public ResponseFailedEntity read(JsonReader in) throws IOException {
             ...
             ResponseFailedEntity instance = thisAdapter.fromJsonTree(jsonObj);
