...
public class StyleFontAssignment implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.org, styleFontAssignment.org)
                ...
                && Objects.equals(
                        this.additionalProperties, styleFontAssignment.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!StyleFontAssignment.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in StyleFontAssignment is not found in"
                                        + " the empty JSON string",
                                StyleFontAssignment.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<StyleFontAssignment>() {
                        @Override
                        public void write(JsonWriter out, StyleFontAssignment value)
                                throws IOException {
