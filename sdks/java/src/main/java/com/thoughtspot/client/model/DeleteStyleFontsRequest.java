...
public class DeleteStyleFontsRequest implements Serializable {
  ...
  public DeleteStyleFontsRequest fontIdentifiers(@javax.annotation.Nonnull List<String> fontIdentifiers) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.scope, deleteStyleFontsRequest.scope) &&
        ...
        Objects.equals(this.additionalProperties, deleteStyleFontsRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteStyleFontsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DeleteStyleFontsRequest is not found in the empty JSON string", DeleteStyleFontsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("font_identifiers") == null) {
        ...
        throw new IllegalArgumentException(String.format("Expected the field `font_identifiers` to be an array in the JSON string but got `%s`", jsonObj.get("font_identifiers").toString()));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteStyleFontsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteStyleFontsRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<DeleteStyleFontsRequest>() {
           @Override
           public void write(JsonWriter out, DeleteStyleFontsRequest value) throws IOException {
