...
public class RevokeRefreshTokensResponse implements Serializable {
   ...
   * @return the RevokeRefreshTokensResponse instance itself
   */
  public RevokeRefreshTokensResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, revokeRefreshTokensResponse.data)&&
        Objects.equals(this.additionalProperties, revokeRefreshTokensResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to RevokeRefreshTokensResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RevokeRefreshTokensResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RevokeRefreshTokensResponse is not found in the empty JSON string", RevokeRefreshTokensResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RevokeRefreshTokensResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RevokeRefreshTokensResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevokeRefreshTokensResponse>() {
           @Override
           public void write(JsonWriter out, RevokeRefreshTokensResponse value) throws IOException {
           ...
           public RevokeRefreshTokensResponse read(JsonReader in) throws IOException {
             ...
             RevokeRefreshTokensResponse instance = thisAdapter.fromJsonTree(jsonObj);
