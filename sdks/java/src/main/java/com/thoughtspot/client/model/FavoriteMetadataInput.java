...
public class FavoriteMetadataInput implements Serializable {
   ...
   * @return the FavoriteMetadataInput instance itself
   */
  public FavoriteMetadataInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, favoriteMetadataInput.identifier) &&
        ...
        Objects.equals(this.additionalProperties, favoriteMetadataInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!FavoriteMetadataInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FavoriteMetadataInput>() {
           ...
           public FavoriteMetadataInput read(JsonReader in) throws IOException {
             ...
             FavoriteMetadataInput instance = thisAdapter.fromJsonTree(jsonObj);
