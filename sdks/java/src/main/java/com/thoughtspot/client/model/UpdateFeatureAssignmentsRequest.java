...
public class UpdateFeatureAssignmentsRequest implements Serializable {
  ...
  public UpdateFeatureAssignmentsRequest featureIdentifier(@javax.annotation.Nonnull String featureIdentifier) {
  ...
  public UpdateFeatureAssignmentsRequest orgIdentifiers(@javax.annotation.Nonnull List<Integer> orgIdentifiers) {
  ...
  public UpdateFeatureAssignmentsRequest operation(@javax.annotation.Nullable OperationEnum operation) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateFeatureAssignmentsRequest updateFeatureAssignmentsRequest = (UpdateFeatureAssignmentsRequest) o;
    return Objects.equals(this.featureIdentifier, updateFeatureAssignmentsRequest.featureIdentifier) &&
        Objects.equals(this.orgIdentifiers, updateFeatureAssignmentsRequest.orgIdentifiers) &&
        Objects.equals(this.operation, updateFeatureAssignmentsRequest.operation)&&
        Objects.equals(this.additionalProperties, updateFeatureAssignmentsRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    featureIdentifier: ").append(toIndentedString(featureIdentifier)).append("\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateFeatureAssignmentsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateFeatureAssignmentsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateFeatureAssignmentsRequest is not found in the empty JSON string", UpdateFeatureAssignmentsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if (!jsonObj.get("feature_identifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `feature_identifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("feature_identifier").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateFeatureAssignmentsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateFeatureAssignmentsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateFeatureAssignmentsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateFeatureAssignmentsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateFeatureAssignmentsRequest>() {
           @Override
           public void write(JsonWriter out, UpdateFeatureAssignmentsRequest value) throws IOException {
           ...
           @Override
           public UpdateFeatureAssignmentsRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             UpdateFeatureAssignmentsRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to UpdateFeatureAssignmentsRequest
   */
