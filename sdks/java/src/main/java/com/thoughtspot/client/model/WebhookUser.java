...
public class WebhookUser implements Serializable {
   ...
   * @return the WebhookUser instance itself
   */
  public WebhookUser putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, webhookUser.id) &&
        ...
        Objects.equals(this.additionalProperties, webhookUser.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookUser is not found in the empty JSON string", WebhookUser.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookUser>() {
           @Override
           ...
           public WebhookUser read(JsonReader in) throws IOException {
             ...
             WebhookUser instance = thisAdapter.fromJsonTree(jsonObj);
