...
public class AnswerPngOptionsInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.xResolution, answerPngOptionsInput.xResolution) &&
        ...
        Objects.equals(this.additionalProperties, answerPngOptionsInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnswerPngOptionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnswerPngOptionsInput is not found in the empty JSON string", AnswerPngOptionsInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnswerPngOptionsInput>() {
           @Override
           public void write(JsonWriter out, AnswerPngOptionsInput value) throws IOException {
