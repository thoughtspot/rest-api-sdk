...
import com.thoughtspot.client.model.ResponseFailedEntity;
...
public class ResponseFailedEntities implements Serializable {
   ...
   * @return the ResponseFailedEntities instance itself
   */
  public ResponseFailedEntities putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, responseFailedEntities.data)&&
        Objects.equals(this.additionalProperties, responseFailedEntities.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ResponseFailedEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ResponseFailedEntities is not found in the empty JSON string", ResponseFailedEntities.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseFailedEntities>() {
           @Override
           public void write(JsonWriter out, ResponseFailedEntities value) throws IOException {
           ...
           public ResponseFailedEntities read(JsonReader in) throws IOException {
             ...
             ResponseFailedEntities instance = thisAdapter.fromJsonTree(jsonObj);
