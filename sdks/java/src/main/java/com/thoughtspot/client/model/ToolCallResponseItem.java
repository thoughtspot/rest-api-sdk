...
public class ToolCallResponseItem implements Serializable {
  ...
  public ToolCallResponseItem timestampInMillis(@javax.annotation.Nullable Object timestampInMillis) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, toolCallResponseItem.type) &&
        ...
        Objects.equals(this.additionalProperties, toolCallResponseItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, timestampInMillis, isThinking, stepTitle, toolCallId, toolName, arguments, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ToolCallResponseItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ToolCallResponseItem is not found in the empty JSON string", ToolCallResponseItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ToolCallResponseItem>() {
           @Override
           public void write(JsonWriter out, ToolCallResponseItem value) throws IOException {
