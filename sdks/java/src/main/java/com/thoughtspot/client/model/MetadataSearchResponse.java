...
public class MetadataSearchResponse implements Serializable {
   ...
   * @return the MetadataSearchResponse instance itself
   */
  public MetadataSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataId, metadataSearchResponse.metadataId) &&
        ...
        Objects.equals(this.additionalProperties, metadataSearchResponse.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetadataSearchResponse>() {
           ...
           public MetadataSearchResponse read(JsonReader in) throws IOException {
             ...
             MetadataSearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
