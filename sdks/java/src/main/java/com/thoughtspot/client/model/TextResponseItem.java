...
import com.thoughtspot.client.model.FileReference;
...
public class TextResponseItem implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, timestampInMillis, isThinking, stepTitle, content, contentType, fileReference, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TextResponseItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TextResponseItem is not found in the empty JSON string", TextResponseItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TextResponseItem>() {
           @Override
           public void write(JsonWriter out, TextResponseItem value) throws IOException {
