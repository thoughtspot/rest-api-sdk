...
public class CreateConfigRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(repositoryUrl, username, accessToken, orgIdentifier, branchNames, commitBranchName, enableGuidMapping, configurationBranchName, additionalProperties);
  }
