...
public class StyleResetOptionsInput implements Serializable {
  ...
  public StyleResetOptionsInput visualizationAreas(@javax.annotation.Nullable List<VisualizationAreasEnum> visualizationAreas) {
    this.visualizationAreas = visualizationAreas;
    return this;
  }

  public StyleResetOptionsInput addVisualizationAreasItem(VisualizationAreasEnum visualizationAreasItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.style, styleResetOptionsInput.style) &&
        Objects.equals(this.visualizationAreas, styleResetOptionsInput.visualizationAreas)&&
        Objects.equals(this.additionalProperties, styleResetOptionsInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StyleResetOptionsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StyleResetOptionsInput is not found in the empty JSON string", StyleResetOptionsInput.openapiRequiredFields.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      // ensure the optional json data is an array if present
      if (jsonObj.get("style") != null && !jsonObj.get("style").isJsonNull() && !jsonObj.get("style").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StyleResetOptionsInput>() {
           @Override
           public void write(JsonWriter out, StyleResetOptionsInput value) throws IOException {
