...
import com.thoughtspot.client.model.Database;
...
public class DataWarehouseObjects implements Serializable {
   ...
   * @return the DataWarehouseObjects instance itself
   */
  public DataWarehouseObjects putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.databases, dataWarehouseObjects.databases)&&
        Objects.equals(this.additionalProperties, dataWarehouseObjects.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(databases, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DataWarehouseObjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DataWarehouseObjects is not found in the empty JSON string", DataWarehouseObjects.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<DataWarehouseObjects>() {
           @Override
           public void write(JsonWriter out, DataWarehouseObjects value) throws IOException {
           ...
           public DataWarehouseObjects read(JsonReader in) throws IOException {
             ...
             DataWarehouseObjects instance = thisAdapter.fromJsonTree(jsonObj);
