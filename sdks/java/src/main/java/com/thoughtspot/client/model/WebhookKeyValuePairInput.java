...
public class WebhookKeyValuePairInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.key, webhookKeyValuePairInput.key) &&
        ...
        Objects.equals(this.additionalProperties, webhookKeyValuePairInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookKeyValuePairInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookKeyValuePairInput is not found in the empty JSON string", WebhookKeyValuePairInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WebhookKeyValuePairInput.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WebhookKeyValuePairInput' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookKeyValuePairInput>() {
           @Override
           public void write(JsonWriter out, WebhookKeyValuePairInput value) throws IOException {
