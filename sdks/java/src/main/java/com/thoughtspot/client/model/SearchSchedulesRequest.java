...
public class SearchSchedulesRequest implements Serializable {
   ...
   * @return the SearchSchedulesRequest instance itself
   */
  public SearchSchedulesRequest putAdditionalProperty(String key, Object value) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadata, recordOffset, recordSize, sortOptions, historyRunsOptions, scheduleIdentifiers, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchSchedulesRequest>() {
           ...
           public SearchSchedulesRequest read(JsonReader in) throws IOException {
             ...
             SearchSchedulesRequest instance = thisAdapter.fromJsonTree(jsonObj);
