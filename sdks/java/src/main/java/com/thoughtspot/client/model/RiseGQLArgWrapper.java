...
public class RiseGQLArgWrapper implements Serializable {
   ...
   * @return the RiseGQLArgWrapper instance itself
   */
  public RiseGQLArgWrapper putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, riseGQLArgWrapper.name) &&
        ...
        Objects.equals(this.additionalProperties, riseGQLArgWrapper.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RiseGQLArgWrapper.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RiseGQLArgWrapper is not found in the empty JSON string", RiseGQLArgWrapper.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RiseGQLArgWrapper>() {
           @Override
           public void write(JsonWriter out, RiseGQLArgWrapper value) throws IOException {
           ...
           public RiseGQLArgWrapper read(JsonReader in) throws IOException {
             ...
             RiseGQLArgWrapper instance = thisAdapter.fromJsonTree(jsonObj);
