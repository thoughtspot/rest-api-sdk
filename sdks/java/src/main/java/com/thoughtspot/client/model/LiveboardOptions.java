...
public class LiveboardOptions implements Serializable {
    ...
    public LiveboardOptions visualizationIdentifiers(
            @javax.annotation.Nonnull List<String> visualizationIdentifiers) {
        this.visualizationIdentifiers = visualizationIdentifiers;
        return this;
    }

    public LiveboardOptions addVisualizationIdentifiersItem(String visualizationIdentifiersItem) {
     ...
     * @return the LiveboardOptions instance itself
     */
    public LiveboardOptions putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        LiveboardOptions liveboardOptions = (LiveboardOptions) o;
        return Objects.equals(
                        this.visualizationIdentifiers, liveboardOptions.visualizationIdentifiers)
                && Objects.equals(this.additionalProperties, liveboardOptions.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(visualizationIdentifiers, additionalProperties);
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class LiveboardOptions {\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!LiveboardOptions.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in LiveboardOptions is not found in the"
                                        + " empty JSON string",
                                LiveboardOptions.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!LiveboardOptions.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'LiveboardOptions' and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<LiveboardOptions> thisAdapter =
                    gson.getDelegateAdapter(this, TypeToken.get(LiveboardOptions.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<LiveboardOptions>() {
                        @Override
                        public void write(JsonWriter out, LiveboardOptions value)
                                throws IOException {
                        ...
                        public LiveboardOptions read(JsonReader in) throws IOException {
                            ...
                            LiveboardOptions instance = thisAdapter.fromJsonTree(jsonObj);
