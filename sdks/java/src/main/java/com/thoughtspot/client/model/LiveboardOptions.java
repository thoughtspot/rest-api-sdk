...
public class LiveboardOptions implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.visualizationIdentifiers, liveboardOptions.visualizationIdentifiers)&&
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LiveboardOptions>() {
           @Override
           public void write(JsonWriter out, LiveboardOptions value) throws IOException {
