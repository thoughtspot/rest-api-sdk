...
public class UpdateVariableRequest implements Serializable {
    ...
    public UpdateVariableRequest name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the UpdateVariableRequest instance itself
     */
    public UpdateVariableRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, updateVariableRequest.name)
                && Objects.equals(
                        this.additionalProperties, updateVariableRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateVariableRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateVariableRequest is not found in"
                                        + " the empty JSON string",
                                UpdateVariableRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateVariableRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateVariableRequest value)
                                throws IOException {
                        ...
                        public UpdateVariableRequest read(JsonReader in) throws IOException {
                            ...
                            UpdateVariableRequest instance = thisAdapter.fromJsonTree(jsonObj);
