...
public class OrgChannelConfigResponse implements Serializable {
    ...
    public OrgChannelConfigResponse preferences(
            @javax.annotation.Nonnull List<EventChannelConfig> preferences) {
     ...
     * @return the OrgChannelConfigResponse instance itself
     */
    public OrgChannelConfigResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.org, orgChannelConfigResponse.org)
                ...
                && Objects.equals(
                        this.additionalProperties, orgChannelConfigResponse.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(org, preferences, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrgChannelConfigResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrgChannelConfigResponse is not found"
                                        + " in the empty JSON string",
                                OrgChannelConfigResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        if (!jsonObj.get("preferences").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `preferences` to be an array in the JSON string"
                                    + " but got `%s`",
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!OrgChannelConfigResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'OrgChannelConfigResponse' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<OrgChannelConfigResponse>() {
                        @Override
                        public void write(JsonWriter out, OrgChannelConfigResponse value)
                                throws IOException {
                        ...
                        public OrgChannelConfigResponse read(JsonReader in) throws IOException {
                            ...
                            OrgChannelConfigResponse instance = thisAdapter.fromJsonTree(jsonObj);
