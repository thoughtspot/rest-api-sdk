...
public class SystemApi {
    ...
    /**
     * Build call for configureSecuritySettings
     * @param configureSecuritySettingsRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Successfully configured the security settings. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized access. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden access. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Unexpected error </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call configureSecuritySettingsCall(ConfigureSecuritySettingsRequest configureSecuritySettingsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = configureSecuritySettingsRequest;

        // create path and map variables
        String localVarPath = "/api/rest/2.0/system/security-settings/configure";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call configureSecuritySettingsValidateBeforeCall(ConfigureSecuritySettingsRequest configureSecuritySettingsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'configureSecuritySettingsRequest' is set
        if (configureSecuritySettingsRequest == null) {
            throw new ApiException("Missing the required parameter 'configureSecuritySettingsRequest' when calling configureSecuritySettings(Async)");
        }

        return configureSecuritySettingsCall(configureSecuritySettingsRequest, _callback);
     ...
     */
    public void configureSecuritySettings(ConfigureSecuritySettingsRequest configureSecuritySettingsRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> configureSecuritySettingsWithHttpInfo(ConfigureSecuritySettingsRequest configureSecuritySettingsRequest) throws ApiException {
        okhttp3.Call localVarCall = configureSecuritySettingsValidateBeforeCall(configureSecuritySettingsRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call configureSecuritySettingsAsync(ConfigureSecuritySettingsRequest configureSecuritySettingsRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = configureSecuritySettingsValidateBeforeCall(configureSecuritySettingsRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    /**
     * Build call for searchSecuritySettings
     * @param searchSecuritySettingsRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Successfully retrieved the list of security settings. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> Invalid request. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Unauthorized access. </td><td>  -  </td></tr>
        <tr><td> 403 </td><td> Forbidden access. </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Unexpected error </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call searchSecuritySettingsCall(SearchSecuritySettingsRequest searchSecuritySettingsRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = searchSecuritySettingsRequest;

        // create path and map variables
        String localVarPath = "/api/rest/2.0/system/security-settings/search";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchSecuritySettingsValidateBeforeCall(SearchSecuritySettingsRequest searchSecuritySettingsRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'searchSecuritySettingsRequest' is set
        if (searchSecuritySettingsRequest == null) {
            throw new ApiException("Missing the required parameter 'searchSecuritySettingsRequest' when calling searchSecuritySettings(Async)");
        }

        return searchSecuritySettingsCall(searchSecuritySettingsRequest, _callback);
     ...
     */
    public SecuritySettingsResponse searchSecuritySettings(SearchSecuritySettingsRequest searchSecuritySettingsRequest) throws ApiException {
        ApiResponse<SecuritySettingsResponse> localVarResp = searchSecuritySettingsWithHttpInfo(searchSecuritySettingsRequest);
        return localVarResp.getData();
    }
     ...
     *   Version: 26.2.0.cl or later   Fetch security settings for your ThoughtSpot application instance. - Use &#x60;scope: CLUSTER&#x60; to retrieve cluster-level security settings, including CORS and CSP allowlists, SAML redirect URLs, and settings that control access to non-embedded pages. - Use &#x60;scope: ORG&#x60; to retrieve Org-level security settings. If your instance has [Orgs](https://docs.thoughtspot.com/cloud/latest/orgs-overview), this returns CORS and non-embed access settings specific to the Org. - If &#x60;scope&#x60; is not specified, returns both cluster and Org-specific settings based on user privileges.  Requires &#x60;ADMINISTRATION&#x60; (**Can administer ThoughtSpot**) or &#x60;DEVELOPER&#x60; (**Has developer privilege**) privilege. See [Security Settings](https://developers.thoughtspot.com/docs/security-settings) for more details.     
     * @param searchSecuritySettingsRequest  (required)
     * @return ApiResponse&lt;SecuritySettingsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
     ...
     */
    public ApiResponse<SecuritySettingsResponse> searchSecuritySettingsWithHttpInfo(SearchSecuritySettingsRequest searchSecuritySettingsRequest) throws ApiException {
        okhttp3.Call localVarCall = searchSecuritySettingsValidateBeforeCall(searchSecuritySettingsRequest, null);
     ...
     */
    public okhttp3.Call searchSecuritySettingsAsync(SearchSecuritySettingsRequest searchSecuritySettingsRequest, final ApiCallback<SecuritySettingsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchSecuritySettingsValidateBeforeCall(searchSecuritySettingsRequest, _callback);
        Type localVarReturnType = new TypeToken<SecuritySettingsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call validateCommunicationChannelCall(ValidateCommunicationChannelRequest validateCommunicationChannelRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call validateCommunicationChannelValidateBeforeCall(ValidateCommunicationChannelRequest validateCommunicationChannelRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'validateCommunicationChannelRequest' is set
        if (validateCommunicationChannelRequest == null) {
            throw new ApiException("Missing the required parameter 'validateCommunicationChannelRequest' when calling validateCommunicationChannel(Async)");
        }
     ...
     */
    public CommunicationChannelValidateResponse validateCommunicationChannel(ValidateCommunicationChannelRequest validateCommunicationChannelRequest) throws ApiException {
        ApiResponse<CommunicationChannelValidateResponse> localVarResp = validateCommunicationChannelWithHttpInfo(validateCommunicationChannelRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CommunicationChannelValidateResponse> validateCommunicationChannelWithHttpInfo(ValidateCommunicationChannelRequest validateCommunicationChannelRequest) throws ApiException {
        okhttp3.Call localVarCall = validateCommunicationChannelValidateBeforeCall(validateCommunicationChannelRequest, null);
        Type localVarReturnType = new TypeToken<CommunicationChannelValidateResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call validateCommunicationChannelAsync(ValidateCommunicationChannelRequest validateCommunicationChannelRequest, final ApiCallback<CommunicationChannelValidateResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = validateCommunicationChannelValidateBeforeCall(validateCommunicationChannelRequest, _callback);
        Type localVarReturnType = new TypeToken<CommunicationChannelValidateResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
