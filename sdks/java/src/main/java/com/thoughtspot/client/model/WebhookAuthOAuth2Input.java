...
public class WebhookAuthOAuth2Input implements Serializable {
  ...
  public WebhookAuthOAuth2Input authorizationUrl(@javax.annotation.Nonnull String authorizationUrl) {
   ...
   * @return the WebhookAuthOAuth2Input instance itself
   */
  public WebhookAuthOAuth2Input putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authorizationUrl, webhookAuthOAuth2Input.authorizationUrl) &&
        ...
        Objects.equals(this.additionalProperties, webhookAuthOAuth2Input.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(authorizationUrl, clientId, clientSecret, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!WebhookAuthOAuth2Input.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in WebhookAuthOAuth2Input is not found in the empty JSON string", WebhookAuthOAuth2Input.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<WebhookAuthOAuth2Input>() {
           @Override
           public void write(JsonWriter out, WebhookAuthOAuth2Input value) throws IOException {
           ...
           public WebhookAuthOAuth2Input read(JsonReader in) throws IOException {
             ...
             WebhookAuthOAuth2Input instance = thisAdapter.fromJsonTree(jsonObj);
