...
public class UpdateEmailCustomizationRequest implements Serializable {
  ...
  public UpdateEmailCustomizationRequest templateProperties(@javax.annotation.Nonnull TemplatePropertiesInputCreate templateProperties) {
  ...
  public UpdateEmailCustomizationRequest orgIdentifier(@javax.annotation.Nullable String orgIdentifier) {
  ...
  public boolean equals(Object o) {
    ...
    UpdateEmailCustomizationRequest updateEmailCustomizationRequest = (UpdateEmailCustomizationRequest) o;
    return Objects.equals(this.templateProperties, updateEmailCustomizationRequest.templateProperties) &&
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEmailCustomizationRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEmailCustomizationRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UpdateEmailCustomizationRequest is not found in the empty JSON string", UpdateEmailCustomizationRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEmailCustomizationRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateEmailCustomizationRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEmailCustomizationRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEmailCustomizationRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEmailCustomizationRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEmailCustomizationRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEmailCustomizationRequest>() {
           @Override
           public void write(JsonWriter out, UpdateEmailCustomizationRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEmailCustomizationRequest read(JsonReader in) throws IOException {
   ...
   * @throws IOException if the JSON string is invalid with respect to UpdateEmailCustomizationRequest
   */
