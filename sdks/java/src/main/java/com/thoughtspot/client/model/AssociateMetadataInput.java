...
import com.thoughtspot.client.model.ActionConfigInput;
...
public class AssociateMetadataInput implements Serializable {
  ...
  public AssociateMetadataInput actionConfig(@javax.annotation.Nullable ActionConfigInput actionConfig) {
   ...
   * @return the AssociateMetadataInput instance itself
   */
  public AssociateMetadataInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actionConfig, associateMetadataInput.actionConfig) &&
        ...
        Objects.equals(this.additionalProperties, associateMetadataInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AssociateMetadataInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AssociateMetadataInput>() {
           ...
           public AssociateMetadataInput read(JsonReader in) throws IOException {
             ...
             AssociateMetadataInput instance = thisAdapter.fromJsonTree(jsonObj);
