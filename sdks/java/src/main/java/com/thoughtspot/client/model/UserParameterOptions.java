...
import com.thoughtspot.client.model.RuntimeFilters;
import com.thoughtspot.client.model.RuntimeParameters;
import com.thoughtspot.client.model.RuntimeSorts;
...
public class UserParameterOptions implements Serializable {
   ...
   * @return the UserParameterOptions instance itself
   */
  public UserParameterOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.objects, userParameterOptions.objects) &&
        ...
        Objects.equals(this.additionalProperties, userParameterOptions.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(objects, runtimeFilters, runtimeSorts, parameters, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<UserParameterOptions>() {
           ...
           public UserParameterOptions read(JsonReader in) throws IOException {
             ...
             UserParameterOptions instance = thisAdapter.fromJsonTree(jsonObj);
