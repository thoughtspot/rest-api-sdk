...
public class OrgDetails implements Serializable {
     ...
     * @return the OrgDetails instance itself
     */
    public OrgDetails putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, orgDetails.id)
                ...
                && Objects.equals(this.additionalProperties, orgDetails.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!OrgDetails.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in OrgDetails is not found in the empty"
                                        + " JSON string",
                                OrgDetails.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<OrgDetails>() {
                        ...
                        public OrgDetails read(JsonReader in) throws IOException {
                            ...
                            OrgDetails instance = thisAdapter.fromJsonTree(jsonObj);
