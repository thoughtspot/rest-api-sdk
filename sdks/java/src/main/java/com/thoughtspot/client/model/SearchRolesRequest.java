...
public class SearchRolesRequest implements Serializable {
   ...
   * @return the SearchRolesRequest instance itself
   */
  public SearchRolesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.roleIdentifiers, searchRolesRequest.roleIdentifiers) &&
        ...
        Objects.equals(this.additionalProperties, searchRolesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(roleIdentifiers, orgIdentifiers, groupIdentifiers, privileges, deprecated, external, sharedViaConnection, permissions, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchRolesRequest>() {
           ...
           public SearchRolesRequest read(JsonReader in) throws IOException {
             ...
             SearchRolesRequest instance = thisAdapter.fromJsonTree(jsonObj);
