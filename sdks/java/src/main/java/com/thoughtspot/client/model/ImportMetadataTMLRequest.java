...
public class ImportMetadataTMLRequest implements Serializable {
  ...
  public ImportMetadataTMLRequest skipDiffCheck(@javax.annotation.Nullable Boolean skipDiffCheck) {
  ...
  public ImportMetadataTMLRequest enablePersonalizedViewUpsert(@javax.annotation.Nullable Boolean enablePersonalizedViewUpsert) {
   ...
   * @return the ImportMetadataTMLRequest instance itself
   */
  public ImportMetadataTMLRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadataTmls, importMetadataTMLRequest.metadataTmls) &&
        ...
        Objects.equals(this.enablePersonalizedViewUpsert, importMetadataTMLRequest.enablePersonalizedViewUpsert)&&
        Objects.equals(this.additionalProperties, importMetadataTMLRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadataTmls, importPolicy, createNew, allOrgsOverride, skipDiffCheck, enableLargeMetadataValidation, enablePersonalizedViewUpsert, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportMetadataTMLRequest>() {
           ...
           public ImportMetadataTMLRequest read(JsonReader in) throws IOException {
             ...
             ImportMetadataTMLRequest instance = thisAdapter.fromJsonTree(jsonObj);
