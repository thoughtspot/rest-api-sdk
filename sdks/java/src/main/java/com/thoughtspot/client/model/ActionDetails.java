...
public class ActionDetails implements Serializable {
     ...
     * @return the ActionDetails instance itself
     */
    public ActionDetails putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.callback, actionDetails.callback)
                ...
                && Objects.equals(this.additionalProperties, actionDetails.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ActionDetails.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ActionDetails is not found in the"
                                        + " empty JSON string",
                                ActionDetails.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ActionDetails>() {
                        ...
                        public ActionDetails read(JsonReader in) throws IOException {
                            ...
                            ActionDetails instance = thisAdapter.fromJsonTree(jsonObj);
