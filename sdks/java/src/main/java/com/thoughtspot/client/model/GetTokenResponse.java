...
public class GetTokenResponse implements Serializable {
   ...
   * @return the GetTokenResponse instance itself
   */
  public GetTokenResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.token, getTokenResponse.token) &&
        ...
        Objects.equals(this.additionalProperties, getTokenResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(token, creationTimeInMillis, expirationTimeInMillis, validForUserId, validForUsername, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetTokenResponse>() {
           ...
           public GetTokenResponse read(JsonReader in) throws IOException {
             ...
             GetTokenResponse instance = thisAdapter.fromJsonTree(jsonObj);
