...
public class SearchUsersRequest implements Serializable {
    ...
    public static final String SERIALIZED_NAME_INCLUDE_FAVORITE_METADATA =
    ...
    public SearchUsersRequest groupIdentifiers(
    ...
    public SearchUsersRequest privileges(
    ...
    public SearchUsersRequest accountStatus(
    ...
    public SearchUsersRequest showOnboardingExperience(
    ...
    public SearchUsersRequest onboardingExperienceCompleted(
    ...
    public SearchUsersRequest orgIdentifiers(
    ...
    public SearchUsersRequest homeLiveboardIdentifier(
    ...
    public SearchUsersRequest favoriteMetadata(
    ...
    public SearchUsersRequest roleIdentifiers(
    ...
    public SearchUsersRequest includeFavoriteMetadata(
            @javax.annotation.Nullable Boolean includeFavoriteMetadata) {
    ...
    public void setIncludeFavoriteMetadata(
            @javax.annotation.Nullable Boolean includeFavoriteMetadata) {
        this.includeFavoriteMetadata = includeFavoriteMetadata;
    }
     ...
     * @return the SearchUsersRequest instance itself
     */
    public SearchUsersRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.userIdentifier, searchUsersRequest.userIdentifier)
                ...
                && Objects.equals(
                        this.showOnboardingExperience, searchUsersRequest.showOnboardingExperience)
                && Objects.equals(
                        this.onboardingExperienceCompleted,
                        searchUsersRequest.onboardingExperienceCompleted)
                && Objects.equals(this.orgIdentifiers, searchUsersRequest.orgIdentifiers)
                && Objects.equals(
                        this.homeLiveboardIdentifier, searchUsersRequest.homeLiveboardIdentifier)
                ...
                && Objects.equals(
                        this.additionalProperties, searchUsersRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SearchUsersRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SearchUsersRequest is not found in"
                                        + " the empty JSON string",
                                SearchUsersRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SearchUsersRequest>() {
                        @Override
                        public void write(JsonWriter out, SearchUsersRequest value)
                                throws IOException {
                        ...
                        public SearchUsersRequest read(JsonReader in) throws IOException {
                            ...
                            SearchUsersRequest instance = thisAdapter.fromJsonTree(jsonObj);
