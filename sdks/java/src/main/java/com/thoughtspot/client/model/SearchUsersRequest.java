...
public class SearchUsersRequest implements Serializable {
  ...
  public SearchUsersRequest includeVariableValues(@javax.annotation.Nullable Boolean includeVariableValues) {
