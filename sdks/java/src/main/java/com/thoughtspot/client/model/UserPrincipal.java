...
public class UserPrincipal implements Serializable {
    ...
    public UserPrincipal id(@javax.annotation.Nullable String id) {
        this.id = id;
        return this;
    }
    ...
    public UserPrincipal name(@javax.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public UserPrincipal type(@javax.annotation.Nullable String type) {
        this.type = type;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, userPrincipal.id)
                ...
                && Objects.equals(this.type, userPrincipal.type);
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to UserPrincipal
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UserPrincipal.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UserPrincipal is not found in the"
                                        + " empty JSON string",
                                UserPrincipal.openapiRequiredFields.toString()));
            }
        }
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!UserPrincipal.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the"
                                        + " `UserPrincipal` properties. JSON: %s",
