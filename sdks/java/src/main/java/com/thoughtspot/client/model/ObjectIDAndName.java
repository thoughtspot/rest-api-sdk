...
public class ObjectIDAndName implements Serializable {
   ...
   * @return the ObjectIDAndName instance itself
   */
  public ObjectIDAndName putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, objectIDAndName.id) &&
        ...
        Objects.equals(this.additionalProperties, objectIDAndName.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ObjectIDAndName.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ObjectIDAndName is not found in the empty JSON string", ObjectIDAndName.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ObjectIDAndName>() {
           @Override
           public void write(JsonWriter out, ObjectIDAndName value) throws IOException {
           ...
           public ObjectIDAndName read(JsonReader in) throws IOException {
             ...
             ObjectIDAndName instance = thisAdapter.fromJsonTree(jsonObj);
