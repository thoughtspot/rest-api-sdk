...
public class AnswerContent implements Serializable {
   ...
   * @return the AnswerContent instance itself
   */
  public AnswerContent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableDataRowCount, answerContent.availableDataRowCount) &&
        ...
        Objects.equals(this.additionalProperties, answerContent.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(availableDataRowCount, columnNames, dataRows, recordOffset, recordSize, returnedDataRowCount, samplingRatio, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnswerContent>() {
           ...
           public AnswerContent read(JsonReader in) throws IOException {
             ...
             AnswerContent instance = thisAdapter.fromJsonTree(jsonObj);
