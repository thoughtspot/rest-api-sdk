...
public class RuntimeFilters implements Serializable {
   ...
   * @return the RuntimeFilters instance itself
   */
  public RuntimeFilters putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.columnName, runtimeFilters.columnName) &&
        ...
        Objects.equals(this.additionalProperties, runtimeFilters.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(columnName, values, operator, persist, objects, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RuntimeFilters>() {
           ...
           public RuntimeFilters read(JsonReader in) throws IOException {
             ...
             RuntimeFilters instance = thisAdapter.fromJsonTree(jsonObj);
