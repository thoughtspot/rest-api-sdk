...
public class OrgNonEmbedAccess implements Serializable {
  ...
  public OrgNonEmbedAccess blockFullAppAccess(@javax.annotation.Nullable Boolean blockFullAppAccess) {
  ...
  public OrgNonEmbedAccess groupsWithAccess(@javax.annotation.Nullable List<GroupInfo> groupsWithAccess) {
   ...
   * @return the OrgNonEmbedAccess instance itself
   */
  public OrgNonEmbedAccess putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.blockFullAppAccess, orgNonEmbedAccess.blockFullAppAccess) &&
        ...
        Objects.equals(this.additionalProperties, orgNonEmbedAccess.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrgNonEmbedAccess.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrgNonEmbedAccess is not found in the empty JSON string", OrgNonEmbedAccess.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<OrgNonEmbedAccess>() {
           @Override
           public void write(JsonWriter out, OrgNonEmbedAccess value) throws IOException {
           ...
           public OrgNonEmbedAccess read(JsonReader in) throws IOException {
             ...
             OrgNonEmbedAccess instance = thisAdapter.fromJsonTree(jsonObj);
