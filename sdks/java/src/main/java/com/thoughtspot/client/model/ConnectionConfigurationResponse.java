...
public class ConnectionConfigurationResponse implements Serializable {
    ...
    public ConnectionConfigurationResponse description(
    ...
    public ConnectionConfigurationResponse _configuration(
    ...
    public ConnectionConfigurationResponse policyPrincipals(
            @javax.annotation.Nullable List<UserPrincipal> policyPrincipals) {
        this.policyPrincipals = policyPrincipals;
        return this;
    }

    public ConnectionConfigurationResponse addPolicyPrincipalsItem(
            UserPrincipal policyPrincipalsItem) {
    ...
    public void setPolicyPrincipals(
            @javax.annotation.Nullable List<UserPrincipal> policyPrincipals) {
        this.policyPrincipals = policyPrincipals;
    }

    public ConnectionConfigurationResponse policyProcesses(
            @javax.annotation.Nullable List<PolicyProcessesEnum> policyProcesses) {
        this.policyProcesses = policyProcesses;
        return this;
    }

    public ConnectionConfigurationResponse addPolicyProcessesItem(
    ...
    public ConnectionConfigurationResponse dataWarehouseType(
            @javax.annotation.Nullable DataWarehouseTypeEnum dataWarehouseType) {
    ...
    public ConnectionConfigurationResponse policyType(
     ...
     * @return the ConnectionConfigurationResponse instance itself
     */
    public ConnectionConfigurationResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        ConnectionConfigurationResponse connectionConfigurationResponse =
                (ConnectionConfigurationResponse) o;
        return Objects.equals(
                        this.configurationIdentifier,
                        connectionConfigurationResponse.configurationIdentifier)
                ...
                && Objects.equals(
                        this._configuration, connectionConfigurationResponse._configuration)
                && Objects.equals(
                        this.policyPrincipals, connectionConfigurationResponse.policyPrincipals)
                && Objects.equals(
                        this.policyProcesses, connectionConfigurationResponse.policyProcesses)
                ...
                && Objects.equals(
                        ...
                        connectionConfigurationResponse.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ConnectionConfigurationResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ConnectionConfigurationResponse is"
                                        + " not found in the empty JSON string",
                                ConnectionConfigurationResponse.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("policy_principals") != null
            ...
            if (jsonArraypolicyPrincipals != null) {
                ...
                if (!jsonObj.get("policy_principals").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `policy_principals` to be an array in the"
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ConnectionConfigurationResponse.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ConnectionConfigurationResponse' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ConnectionConfigurationResponse> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ConnectionConfigurationResponse.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ConnectionConfigurationResponse>() {
                        @Override
                        public void write(JsonWriter out, ConnectionConfigurationResponse value)
                                throws IOException {
                        ...
                        @Override
                        public ConnectionConfigurationResponse read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            ConnectionConfigurationResponse instance =
