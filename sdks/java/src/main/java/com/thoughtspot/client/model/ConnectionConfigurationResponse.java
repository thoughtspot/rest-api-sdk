...
import com.thoughtspot.client.model.PolicyProcessOptions;
...
public class ConnectionConfigurationResponse implements Serializable {
  ...
  public ConnectionConfigurationResponse sameAsParent(@javax.annotation.Nullable Boolean sameAsParent) {
  ...
  public ConnectionConfigurationResponse policyProcessOptions(@javax.annotation.Nullable PolicyProcessOptions policyProcessOptions) {
  ...
  public void setPolicyProcessOptions(@javax.annotation.Nullable PolicyProcessOptions policyProcessOptions) {
    this.policyProcessOptions = policyProcessOptions;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.configurationIdentifier, connectionConfigurationResponse.configurationIdentifier) &&
        ...
        Objects.equals(this.policyProcessOptions, connectionConfigurationResponse.policyProcessOptions)&&
        Objects.equals(this.additionalProperties, connectionConfigurationResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(configurationIdentifier, name, description, _configuration, policyPrincipals, policyProcesses, disabled, dataWarehouseType, policyType, sameAsParent, policyProcessOptions, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConnectionConfigurationResponse>() {
           ...
           public ConnectionConfigurationResponse read(JsonReader in) throws IOException {
             ...
             ConnectionConfigurationResponse instance = thisAdapter.fromJsonTree(jsonObj);
