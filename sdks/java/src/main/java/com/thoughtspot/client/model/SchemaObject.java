...
public class SchemaObject implements Serializable {
     ...
     * @return the SchemaObject instance itself
     */
    public SchemaObject putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, schemaObject.name)
                ...
                && Objects.equals(this.additionalProperties, schemaObject.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SchemaObject.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SchemaObject is not found in the"
                                        + " empty JSON string",
                                SchemaObject.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("tables") != null && !jsonObj.get("tables").isJsonNull()) {
            ...
            if (jsonArraytables != null) {
                ...
                if (!jsonObj.get("tables").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `tables` to be an array in the JSON string"
                                            + " but got `%s`",
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SchemaObject>() {
                        ...
                        public SchemaObject read(JsonReader in) throws IOException {
                            ...
                            SchemaObject instance = thisAdapter.fromJsonTree(jsonObj);
