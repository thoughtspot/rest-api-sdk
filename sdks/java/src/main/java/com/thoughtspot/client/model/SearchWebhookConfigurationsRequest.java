...
public class SearchWebhookConfigurationsRequest implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(orgIdentifier, webhookIdentifier, eventType, recordOffset, recordSize, sortOptions);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SearchWebhookConfigurationsRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SearchWebhookConfigurationsRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
