...
import com.thoughtspot.client.model.WebhookSortOptionsInput;
...
public class SearchWebhookConfigurationsRequest implements Serializable {
  ...
  public SearchWebhookConfigurationsRequest orgIdentifier(@javax.annotation.Nullable String orgIdentifier) {
  ...
  public SearchWebhookConfigurationsRequest webhookIdentifier(@javax.annotation.Nullable String webhookIdentifier) {
  ...
  public SearchWebhookConfigurationsRequest eventType(@javax.annotation.Nullable EventTypeEnum eventType) {
  ...
  public SearchWebhookConfigurationsRequest recordOffset(@javax.annotation.Nullable Integer recordOffset) {
  ...
  public SearchWebhookConfigurationsRequest recordSize(@javax.annotation.Nullable Integer recordSize) {
  ...
  public SearchWebhookConfigurationsRequest sortOptions(@javax.annotation.Nullable WebhookSortOptionsInput sortOptions) {
   ...
   * @return the SearchWebhookConfigurationsRequest instance itself
   */
  public SearchWebhookConfigurationsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SearchWebhookConfigurationsRequest searchWebhookConfigurationsRequest = (SearchWebhookConfigurationsRequest) o;
    return Objects.equals(this.orgIdentifier, searchWebhookConfigurationsRequest.orgIdentifier) &&
        Objects.equals(this.webhookIdentifier, searchWebhookConfigurationsRequest.webhookIdentifier) &&
        Objects.equals(this.eventType, searchWebhookConfigurationsRequest.eventType) &&
        Objects.equals(this.recordOffset, searchWebhookConfigurationsRequest.recordOffset) &&
        ...
        Objects.equals(this.additionalProperties, searchWebhookConfigurationsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orgIdentifier, webhookIdentifier, eventType, recordOffset, recordSize, sortOptions, status, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SearchWebhookConfigurationsRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchWebhookConfigurationsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchWebhookConfigurationsRequest is not found in the empty JSON string", SearchWebhookConfigurationsRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("webhook_identifier") != null && !jsonObj.get("webhook_identifier").isJsonNull()) && !jsonObj.get("webhook_identifier").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `webhook_identifier` to be a primitive type in the JSON string but got `%s`", jsonObj.get("webhook_identifier").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchWebhookConfigurationsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchWebhookConfigurationsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchWebhookConfigurationsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchWebhookConfigurationsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchWebhookConfigurationsRequest>() {
           @Override
           public void write(JsonWriter out, SearchWebhookConfigurationsRequest value) throws IOException {
           ...
           @Override
           public SearchWebhookConfigurationsRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SearchWebhookConfigurationsRequest instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to SearchWebhookConfigurationsRequest
   */
  public static SearchWebhookConfigurationsRequest fromJson(String jsonString) throws IOException {
