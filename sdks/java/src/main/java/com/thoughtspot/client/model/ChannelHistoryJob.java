...
import com.thoughtspot.client.model.ChannelHistoryEventInfo;
import com.thoughtspot.client.model.JobRecipient;
...
public class ChannelHistoryJob implements Serializable {
  ...
  public ChannelHistoryJob creationTimeInMillis(@javax.annotation.Nonnull Float creationTimeInMillis) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, channelHistoryJob.id) &&
        ...
        Objects.equals(this.additionalProperties, channelHistoryJob.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, status, creationTimeInMillis, event, recipients, detail, tryCount, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ChannelHistoryJob.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChannelHistoryJob is not found in the empty JSON string", ChannelHistoryJob.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ChannelHistoryJob>() {
           @Override
           public void write(JsonWriter out, ChannelHistoryJob value) throws IOException {
