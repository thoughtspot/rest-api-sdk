...
public class SearchVariablesRequest implements Serializable {
  ...
  public SearchVariablesRequest responseContent(@javax.annotation.Nullable ResponseContentEnum responseContent) {
   ...
   * @return the SearchVariablesRequest instance itself
   */
  public SearchVariablesRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.variableDetails, searchVariablesRequest.variableDetails) &&
        ...
        Objects.equals(this.additionalProperties, searchVariablesRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(variableDetails, valueScope, recordOffset, recordSize, responseContent, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("response_content") != null && !jsonObj.get("response_content").isJsonNull()) && !jsonObj.get("response_content").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `response_content` to be a primitive type in the JSON string but got `%s`", jsonObj.get("response_content").toString()));
      }
      // validate the optional field `response_content`
      if (jsonObj.get("response_content") != null && !jsonObj.get("response_content").isJsonNull()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchVariablesRequest>() {
           ...
           public SearchVariablesRequest read(JsonReader in) throws IOException {
             ...
             SearchVariablesRequest instance = thisAdapter.fromJsonTree(jsonObj);
