...
public class AdvancedChartVisualizationFontRecord implements Serializable {
    ...
    public AdvancedChartVisualizationFontRecord visualizationArea(
    ...
    public AdvancedChartVisualizationFontRecord fontName(
            @javax.annotation.Nullable String fontName) {
    ...
    public AdvancedChartVisualizationFontRecord isOverridden(
    ...
    public boolean equals(Object o) {
        ...
        AdvancedChartVisualizationFontRecord advancedChartVisualizationFontRecord =
                (AdvancedChartVisualizationFontRecord) o;
        return Objects.equals(
                        this.visualizationArea,
                        advancedChartVisualizationFontRecord.visualizationArea)
                ...
                && Objects.equals(
                        this.isOverridden, advancedChartVisualizationFontRecord.isOverridden)
                && Objects.equals(
                        this.additionalProperties,
                        advancedChartVisualizationFontRecord.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AdvancedChartVisualizationFontRecord.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AdvancedChartVisualizationFontRecord"
                                        + " is not found in the empty JSON string",
                                AdvancedChartVisualizationFontRecord.openapiRequiredFields
                                        .toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!AdvancedChartVisualizationFontRecord.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'AdvancedChartVisualizationFontRecord'
                // and its subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<AdvancedChartVisualizationFontRecord> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(AdvancedChartVisualizationFontRecord.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<AdvancedChartVisualizationFontRecord>() {
                        @Override
                        public void write(
                                JsonWriter out, AdvancedChartVisualizationFontRecord value)
                                throws IOException {
                        ...
                        @Override
                        public AdvancedChartVisualizationFontRecord read(JsonReader in)
                                throws IOException {
                            JsonElement jsonElement = elementAdapter.read(in);
                            validateJsonElement(jsonElement);
                            JsonObject jsonObj = jsonElement.getAsJsonObject();
                            // store additional fields in the deserialized instance
                            AdvancedChartVisualizationFontRecord instance =
     ...
     *     AdvancedChartVisualizationFontRecord
     */
    public static AdvancedChartVisualizationFontRecord fromJson(String jsonString)
            throws IOException {
