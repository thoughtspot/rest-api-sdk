...
public class ExcludeMetadataListItemInput implements Serializable {
     ...
     * column of any data object such as table, worksheet or view 5. CONNECTION for connection
     * objects 6. TAG for tag objects 7. USER for user objects 8. USER_GROUP for group objects 9.
     * LOGICAL_RELATIONSHIP for table or worksheet joins. A join combines from one or several data
     * object by using matching values. 10. INSIGHT_SPEC for SpotIQ objects 11. COLLECTION for
     * collection objects
     */
    ...
    public boolean equals(Object o) {
        ...
        ExcludeMetadataListItemInput excludeMetadataListItemInput =
                (ExcludeMetadataListItemInput) o;
        return Objects.equals(this.identifier, excludeMetadataListItemInput.identifier)
                ...
                && Objects.equals(
                        ...
                        excludeMetadataListItemInput.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ExcludeMetadataListItemInput.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ExcludeMetadataListItemInput is not"
                                        + " found in the empty JSON string",
                                ExcludeMetadataListItemInput.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ExcludeMetadataListItemInput.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ExcludeMetadataListItemInput' and its
                // subtypes
            }
            final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
            final TypeAdapter<ExcludeMetadataListItemInput> thisAdapter =
                    gson.getDelegateAdapter(
                            this, TypeToken.get(ExcludeMetadataListItemInput.class));

            return (TypeAdapter<T>)
                    new TypeAdapter<ExcludeMetadataListItemInput>() {
                        @Override
                        public void write(JsonWriter out, ExcludeMetadataListItemInput value)
                                throws IOException {
                        ...
                        public ExcludeMetadataListItemInput read(JsonReader in) throws IOException {
                            ...
                            ExcludeMetadataListItemInput instance =
