...
public class VariableValue implements Serializable {
   ...
   * @return the VariableValue instance itself
   */
  public VariableValue putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.value, variableValue.value) &&
        ...
        Objects.equals(this.additionalProperties, variableValue.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(value, valueList, orgIdentifier, principalType, principalIdentifier, modelIdentifier, priority, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("value_list") != null && !jsonObj.get("value_list").isJsonNull() && !jsonObj.get("value_list").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `value_list` to be an array in the JSON string but got `%s`", jsonObj.get("value_list").toString()));
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<VariableValue>() {
           ...
           public VariableValue read(JsonReader in) throws IOException {
             ...
             VariableValue instance = thisAdapter.fromJsonTree(jsonObj);
