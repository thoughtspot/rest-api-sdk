...
public class VariableValue implements Serializable {
    ...
    public VariableValue principalIdentifier(
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!VariableValue.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in VariableValue is not found in the"
                                        + " empty JSON string",
                                VariableValue.openapiRequiredFields.toString()));
            }
        }
