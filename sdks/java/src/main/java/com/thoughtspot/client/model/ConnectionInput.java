...
import com.thoughtspot.client.model.DataWarehouseObjectInput;
...
public class ConnectionInput implements Serializable {
  ...
  public ConnectionInput dataWarehouseObjects(@javax.annotation.Nullable List<DataWarehouseObjectInput> dataWarehouseObjects) {
  ...
  public void setDataWarehouseObjects(@javax.annotation.Nullable List<DataWarehouseObjectInput> dataWarehouseObjects) {
    this.dataWarehouseObjects = dataWarehouseObjects;
  }
      ...
      if (jsonObj.get("data_warehouse_objects") != null && !jsonObj.get("data_warehouse_objects").isJsonNull()) {
        ...
        if (jsonArraydataWarehouseObjects != null) {
          ...
          for (int i = 0; i < jsonArraydataWarehouseObjects.size(); i++) {
            DataWarehouseObjectInput.validateJsonElement(jsonArraydataWarehouseObjects.get(i));
          };
        }
      }
  }
