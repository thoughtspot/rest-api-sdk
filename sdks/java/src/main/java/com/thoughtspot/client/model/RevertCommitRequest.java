...
public class RevertCommitRequest implements Serializable {
   ...
   * @return the RevertCommitRequest instance itself
   */
  public RevertCommitRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, revertCommitRequest.metadata) &&
        ...
        Objects.equals(this.additionalProperties, revertCommitRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(metadata, branchName, revertPolicy, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevertCommitRequest>() {
           ...
           public RevertCommitRequest read(JsonReader in) throws IOException {
             ...
             RevertCommitRequest instance = thisAdapter.fromJsonTree(jsonObj);
