...
public class UpdateMetadataHeaderRequest implements Serializable {
    ...
    public UpdateMetadataHeaderRequest headersUpdate(
            @javax.annotation.Nonnull List<HeaderUpdateInput> headersUpdate) {
    ...
    public UpdateMetadataHeaderRequest orgIdentifier(
     ...
     * @return the UpdateMetadataHeaderRequest instance itself
     */
    public UpdateMetadataHeaderRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.headersUpdate, updateMetadataHeaderRequest.headersUpdate)
                ...
                && Objects.equals(
                        ...
                        updateMetadataHeaderRequest.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(headersUpdate, orgIdentifier, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateMetadataHeaderRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateMetadataHeaderRequest is not"
                                        + " found in the empty JSON string",
                                UpdateMetadataHeaderRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        if (!jsonObj.get("headers_update").isJsonArray()) {
            throw new IllegalArgumentException(
                    String.format(
                            "Expected the field `headers_update` to be an array in the JSON string"
                                    + " but got `%s`",
                            jsonObj.get("headers_update").toString()));
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateMetadataHeaderRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateMetadataHeaderRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateMetadataHeaderRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateMetadataHeaderRequest value)
                                throws IOException {
                        ...
                        public UpdateMetadataHeaderRequest read(JsonReader in) throws IOException {
                            ...
                            UpdateMetadataHeaderRequest instance =
