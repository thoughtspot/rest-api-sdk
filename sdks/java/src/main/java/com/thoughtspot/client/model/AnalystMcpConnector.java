...
public class AnalystMcpConnector implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, analystMcpConnector.id) &&
        ...
        Objects.equals(this.additionalProperties, analystMcpConnector.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AnalystMcpConnector.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AnalystMcpConnector is not found in the empty JSON string", AnalystMcpConnector.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AnalystMcpConnector>() {
           @Override
           public void write(JsonWriter out, AnalystMcpConnector value) throws IOException {
