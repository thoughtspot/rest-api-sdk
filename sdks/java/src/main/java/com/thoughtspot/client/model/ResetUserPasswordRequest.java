...
public class ResetUserPasswordRequest implements Serializable {
    ...
    public ResetUserPasswordRequest userIdentifier(
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.newPassword, resetUserPasswordRequest.newPassword)
                ...
                && Objects.equals(
                        this.additionalProperties, resetUserPasswordRequest.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(newPassword, userIdentifier, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!ResetUserPasswordRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in ResetUserPasswordRequest is not found"
                                        + " in the empty JSON string",
                                ResetUserPasswordRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ResetUserPasswordRequest.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ResetUserPasswordRequest' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<ResetUserPasswordRequest>() {
                        @Override
                        public void write(JsonWriter out, ResetUserPasswordRequest value)
                                throws IOException {
