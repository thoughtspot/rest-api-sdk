...
public class CreateUserRequest implements Serializable {
  ...
  public CreateUserRequest useBrowserLanguage(@javax.annotation.Nullable Boolean useBrowserLanguage) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, displayName, password, email, accountType, accountStatus, orgIdentifiers, groupIdentifiers, visibility, notifyOnShare, showOnboardingExperience, onboardingExperienceCompleted, homeLiveboardIdentifier, favoriteMetadata, preferredLocale, useBrowserLanguage, extendedProperties, extendedPreferences, triggerWelcomeEmail, triggerActivationEmail, additionalProperties);
  }
