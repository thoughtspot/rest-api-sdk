...
public class SearchUserGroupsRequest implements Serializable {
  ...
  public SearchUserGroupsRequest includeSubGroups(@javax.annotation.Nullable Boolean includeSubGroups) {
   ...
   * @return the SearchUserGroupsRequest instance itself
   */
  public SearchUserGroupsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultLiveboardIdentifiers, searchUserGroupsRequest.defaultLiveboardIdentifiers) &&
        ...
        Objects.equals(this.additionalProperties, searchUserGroupsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(defaultLiveboardIdentifiers, description, displayName, namePattern, groupIdentifier, orgIdentifiers, privileges, subGroupIdentifiers, type, userIdentifiers, visibility, roleIdentifiers, recordOffset, recordSize, sortOptions, includeUsers, includeSubGroups, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchUserGroupsRequest>() {
           ...
           public SearchUserGroupsRequest read(JsonReader in) throws IOException {
             ...
             SearchUserGroupsRequest instance = thisAdapter.fromJsonTree(jsonObj);
