...
import com.thoughtspot.client.model.AuthenticationInput;
import com.thoughtspot.client.model.ParametersListItemInput;
...
public class URLInput implements Serializable {
  ...
  public URLInput parameters(@javax.annotation.Nullable List<ParametersListItemInput> parameters) {
   ...
   * @return the URLInput instance itself
   */
  public URLInput putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.authentication, urLInput.authentication) &&
        ...
        Objects.equals(this.additionalProperties, urLInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<URLInput>() {
           ...
           public URLInput read(JsonReader in) throws IOException {
             ...
             URLInput instance = thisAdapter.fromJsonTree(jsonObj);
