...
public class GetNLInstructionsRequest implements Serializable {
  ...
  public GetNLInstructionsRequest dataSourceIdentifier(@javax.annotation.Nonnull String dataSourceIdentifier) {
   ...
   * @return the GetNLInstructionsRequest instance itself
   */
  public GetNLInstructionsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dataSourceIdentifier, getNLInstructionsRequest.dataSourceIdentifier)&&
        Objects.equals(this.additionalProperties, getNLInstructionsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataSourceIdentifier, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetNLInstructionsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetNLInstructionsRequest is not found in the empty JSON string", GetNLInstructionsRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetNLInstructionsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetNLInstructionsRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<GetNLInstructionsRequest>() {
           @Override
           public void write(JsonWriter out, GetNLInstructionsRequest value) throws IOException {
           ...
           public GetNLInstructionsRequest read(JsonReader in) throws IOException {
             ...
             GetNLInstructionsRequest instance = thisAdapter.fromJsonTree(jsonObj);
