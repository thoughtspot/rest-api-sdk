...
import com.thoughtspot.client.model.SemanticIntegrationTagReference;
...
public class SemanticIntegrationSearchResponse implements Serializable {
  ...
  public SemanticIntegrationSearchResponse description(@javax.annotation.Nullable String description) {
  ...
  public SemanticIntegrationSearchResponse modelName(@javax.annotation.Nullable String modelName) {
  ...
  public SemanticIntegrationSearchResponse importType(@javax.annotation.Nullable ImportTypeEnum importType) {
  ...
  public SemanticIntegrationSearchResponse connectionId(@javax.annotation.Nullable String connectionId) {
  ...
  public SemanticIntegrationSearchResponse connectionName(@javax.annotation.Nullable String connectionName) {
  ...
  public SemanticIntegrationSearchResponse authorName(@javax.annotation.Nullable String authorName) {
  ...
  public SemanticIntegrationSearchResponse creationTimeInMillis(@javax.annotation.Nullable Float creationTimeInMillis) {
  ...
  public SemanticIntegrationSearchResponse modificationTimeInMillis(@javax.annotation.Nullable Float modificationTimeInMillis) {
  ...
  public SemanticIntegrationSearchResponse tags(@javax.annotation.Nullable List<SemanticIntegrationTagReference> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SemanticIntegrationSearchResponse semanticIntegrationSearchResponse = (SemanticIntegrationSearchResponse) o;
    return Objects.equals(this.id, semanticIntegrationSearchResponse.id) &&
        ...
        Objects.equals(this.connectionName, semanticIntegrationSearchResponse.connectionName) &&
        ...
        Objects.equals(this.creationTimeInMillis, semanticIntegrationSearchResponse.creationTimeInMillis) &&
        Objects.equals(this.modificationTimeInMillis, semanticIntegrationSearchResponse.modificationTimeInMillis) &&
        Objects.equals(this.tags, semanticIntegrationSearchResponse.tags)&&
        Objects.equals(this.additionalProperties, semanticIntegrationSearchResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, modelId, modelName, importType, type, connectionId, connectionName, authorId, authorName, creationTimeInMillis, modificationTimeInMillis, tags, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SemanticIntegrationSearchResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SemanticIntegrationSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SemanticIntegrationSearchResponse is not found in the empty JSON string", SemanticIntegrationSearchResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SemanticIntegrationSearchResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SemanticIntegrationSearchResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SemanticIntegrationSearchResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SemanticIntegrationSearchResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SemanticIntegrationSearchResponse>() {
           @Override
           public void write(JsonWriter out, SemanticIntegrationSearchResponse value) throws IOException {
           ...
           @Override
           public SemanticIntegrationSearchResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SemanticIntegrationSearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to SemanticIntegrationSearchResponse
   */
