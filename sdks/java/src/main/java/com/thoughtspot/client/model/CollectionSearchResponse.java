...
public class CollectionSearchResponse implements Serializable {
  ...
  public CollectionSearchResponse collections(@javax.annotation.Nonnull List<Collection> collections) {
   ...
   * @return the CollectionSearchResponse instance itself
   */
  public CollectionSearchResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.collections, collectionSearchResponse.collections) &&
        ...
        Objects.equals(this.additionalProperties, collectionSearchResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(collections, recordOffset, recordSize, isLastBatch, count, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CollectionSearchResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectionSearchResponse is not found in the empty JSON string", CollectionSearchResponse.openapiRequiredFields.toString()));
        }
      }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollectionSearchResponse>() {
           ...
           public CollectionSearchResponse read(JsonReader in) throws IOException {
             ...
             CollectionSearchResponse instance = thisAdapter.fromJsonTree(jsonObj);
