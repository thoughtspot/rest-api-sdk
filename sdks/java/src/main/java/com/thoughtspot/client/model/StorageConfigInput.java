...
import com.thoughtspot.client.model.AwsS3ConfigInput;
import com.thoughtspot.client.model.GcpGcsConfigInput;
...
public class StorageConfigInput implements Serializable {
  ...
  public StorageConfigInput gcpGcsConfig(@javax.annotation.Nullable GcpGcsConfigInput gcpGcsConfig) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.awsS3Config, storageConfigInput.awsS3Config) &&
        ...
        Objects.equals(this.additionalProperties, storageConfigInput.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!StorageConfigInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StorageConfigInput is not found in the empty JSON string", StorageConfigInput.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<StorageConfigInput>() {
           @Override
           public void write(JsonWriter out, StorageConfigInput value) throws IOException {
