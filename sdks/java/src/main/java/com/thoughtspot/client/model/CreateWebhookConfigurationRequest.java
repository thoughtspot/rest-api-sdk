...
public class CreateWebhookConfigurationRequest implements Serializable {
  ...
  public CreateWebhookConfigurationRequest storageDestination(@javax.annotation.Nullable StorageDestinationInput storageDestination) {
  ...
  public CreateWebhookConfigurationRequest additionalHeaders(@javax.annotation.Nullable List<WebhookKeyValuePairInput> additionalHeaders) {
    this.additionalHeaders = additionalHeaders;
    return this;
  }

  public CreateWebhookConfigurationRequest addAdditionalHeadersItem(WebhookKeyValuePairInput additionalHeadersItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createWebhookConfigurationRequest.name) &&
        ...
        Objects.equals(this.storageDestination, createWebhookConfigurationRequest.storageDestination) &&
        Objects.equals(this.additionalHeaders, createWebhookConfigurationRequest.additionalHeaders) &&
        Objects.equals(this.status, createWebhookConfigurationRequest.status)&&
        Objects.equals(this.additionalProperties, createWebhookConfigurationRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, url, urlParams, events, authentication, signatureVerification, storageDestination, additionalHeaders, status, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateWebhookConfigurationRequest>() {
           ...
           public CreateWebhookConfigurationRequest read(JsonReader in) throws IOException {
             ...
             CreateWebhookConfigurationRequest instance = thisAdapter.fromJsonTree(jsonObj);
