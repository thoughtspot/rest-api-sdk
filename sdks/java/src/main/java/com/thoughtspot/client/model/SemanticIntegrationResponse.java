...
public class SemanticIntegrationResponse implements Serializable {
  ...
  public SemanticIntegrationResponse semanticReport(@javax.annotation.Nullable SemanticIntegrationReport semanticReport) {
  ...
  public void setSemanticReport(@javax.annotation.Nullable SemanticIntegrationReport semanticReport) {
    this.semanticReport = semanticReport;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, semanticIntegrationResponse.id) &&
        ...
        Objects.equals(this.additionalProperties, semanticIntegrationResponse.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SemanticIntegrationResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SemanticIntegrationResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SemanticIntegrationResponse is not found in the empty JSON string", SemanticIntegrationResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("semantic_report") != null && !jsonObj.get("semantic_report").isJsonNull()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SemanticIntegrationResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SemanticIntegrationResponse' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SemanticIntegrationResponse>() {
           @Override
           public void write(JsonWriter out, SemanticIntegrationResponse value) throws IOException {
           ...
           public SemanticIntegrationResponse read(JsonReader in) throws IOException {
             ...
             SemanticIntegrationResponse instance = thisAdapter.fromJsonTree(jsonObj);
