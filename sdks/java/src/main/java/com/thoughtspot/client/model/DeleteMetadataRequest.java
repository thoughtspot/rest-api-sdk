...
public class DeleteMetadataRequest implements Serializable {
    ...
    public DeleteMetadataRequest metadata(
            @javax.annotation.Nonnull List<DeleteMetadataTypeInput> metadata) {
    ...
    public DeleteMetadataRequest deleteDisabledObjects(
            @javax.annotation.Nullable Boolean deleteDisabledObjects) {
     ...
     * @return the DeleteMetadataRequest instance itself
     */
    public DeleteMetadataRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadata, deleteMetadataRequest.metadata)
                && Objects.equals(
                        this.deleteDisabledObjects, deleteMetadataRequest.deleteDisabledObjects)
                && Objects.equals(
                        this.additionalProperties, deleteMetadataRequest.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(metadata, deleteDisabledObjects, additionalProperties);
    }
    ...
    public String toString() {
        ...
        sb.append("    deleteDisabledObjects: ")
                .append(toIndentedString(deleteDisabledObjects))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!DeleteMetadataRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in DeleteMetadataRequest is not found in"
                                        + " the empty JSON string",
                                DeleteMetadataRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<DeleteMetadataRequest>() {
                        @Override
                        public void write(JsonWriter out, DeleteMetadataRequest value)
                                throws IOException {
                        ...
                        public DeleteMetadataRequest read(JsonReader in) throws IOException {
                            ...
                            DeleteMetadataRequest instance = thisAdapter.fromJsonTree(jsonObj);
