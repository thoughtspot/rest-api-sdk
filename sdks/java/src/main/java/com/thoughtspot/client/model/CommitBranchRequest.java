...
import com.thoughtspot.client.model.MetadataObject;
...
public class CommitBranchRequest implements Serializable {
   ...
   * @return the CommitBranchRequest instance itself
   */
  public CommitBranchRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.metadata, commitBranchRequest.metadata) &&
        ...
        Objects.equals(this.additionalProperties, commitBranchRequest.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(metadata, deleteAware, branchName, comment, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CommitBranchRequest>() {
           ...
           public CommitBranchRequest read(JsonReader in) throws IOException {
             ...
             CommitBranchRequest instance = thisAdapter.fromJsonTree(jsonObj);
