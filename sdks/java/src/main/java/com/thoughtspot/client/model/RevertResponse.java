...
import com.thoughtspot.client.model.AuthorType;
import com.thoughtspot.client.model.CommitFileType;
import com.thoughtspot.client.model.CommiterType;
import com.thoughtspot.client.model.RevertedMetadata;
...
public class RevertResponse implements Serializable {
   ...
   * @return the RevertResponse instance itself
   */
  public RevertResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.committer, revertResponse.committer) &&
        ...
        Objects.equals(this.additionalProperties, revertResponse.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(committer, author, comment, commitTime, commitId, branch, committedFiles, revertedMetadata, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RevertResponse>() {
           ...
           public RevertResponse read(JsonReader in) throws IOException {
             ...
             RevertResponse instance = thisAdapter.fromJsonTree(jsonObj);
