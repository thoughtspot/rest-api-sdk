...
public class ColumnSecurityRuleTableInput implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.identifier, columnSecurityRuleTableInput.identifier) &&
        ...
        Objects.equals(this.additionalProperties, columnSecurityRuleTableInput.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ColumnSecurityRuleTableInput>() {
           ...
           public ColumnSecurityRuleTableInput read(JsonReader in) throws IOException {
             ...
             ColumnSecurityRuleTableInput instance = thisAdapter.fromJsonTree(jsonObj);
