...
public class SearchDatasetsResponseItem implements Serializable {
  ...
  public SearchDatasetsResponseItem timestampInMillis(@javax.annotation.Nullable Object timestampInMillis) {
  ...
  public SearchDatasetsResponseItem dataSources(@javax.annotation.Nullable List<DataSourceInfo> dataSources) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, searchDatasetsResponseItem.type) &&
        Objects.equals(this.timestampInMillis, searchDatasetsResponseItem.timestampInMillis) &&
        ...
        Objects.equals(this.additionalProperties, searchDatasetsResponseItem.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, timestampInMillis, isThinking, stepTitle, text, dataSources, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SearchDatasetsResponseItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchDatasetsResponseItem is not found in the empty JSON string", SearchDatasetsResponseItem.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchDatasetsResponseItem.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchDatasetsResponseItem' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<SearchDatasetsResponseItem>() {
           @Override
           public void write(JsonWriter out, SearchDatasetsResponseItem value) throws IOException {
