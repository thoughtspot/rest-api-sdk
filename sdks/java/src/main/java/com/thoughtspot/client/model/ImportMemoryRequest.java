...
public class ImportMemoryRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, importMemoryRequest.content) &&
        ...
        Objects.equals(this.additionalProperties, importMemoryRequest.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportMemoryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ImportMemoryRequest is not found in the empty JSON string", ImportMemoryRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ImportMemoryRequest>() {
           @Override
           public void write(JsonWriter out, ImportMemoryRequest value) throws IOException {
