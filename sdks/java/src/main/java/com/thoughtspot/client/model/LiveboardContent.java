...
public class LiveboardContent implements Serializable {
  ...
  public LiveboardContent availableDataRowCount(@javax.annotation.Nonnull Integer availableDataRowCount) {
  ...
  public LiveboardContent returnedDataRowCount(@javax.annotation.Nonnull Integer returnedDataRowCount) {
   ...
   * @return the LiveboardContent instance itself
   */
  public LiveboardContent putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.availableDataRowCount, liveboardContent.availableDataRowCount) &&
        ...
        Objects.equals(this.additionalProperties, liveboardContent.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(availableDataRowCount, columnNames, dataRows, recordOffset, recordSize, returnedDataRowCount, samplingRatio, visualizationId, visualizationName, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LiveboardContent.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LiveboardContent>() {
           ...
           public LiveboardContent read(JsonReader in) throws IOException {
             ...
             LiveboardContent instance = thisAdapter.fromJsonTree(jsonObj);
