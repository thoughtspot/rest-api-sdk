...
public class UpdateScheduleRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, updateScheduleRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, updateScheduleRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, metadataType, metadataIdentifier, fileFormat, liveboardOptions, pdfOptions, timeZone, frequency, recipientDetails, status, personalisedViewId, additionalProperties);
  }
