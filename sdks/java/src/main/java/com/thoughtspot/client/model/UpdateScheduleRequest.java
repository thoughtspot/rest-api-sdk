...
public class UpdateScheduleRequest implements Serializable {
    ...
    public UpdateScheduleRequest metadataType(
    ...
    public UpdateScheduleRequest metadataIdentifier(
    ...
    public UpdateScheduleRequest liveboardOptions(
    ...
    public UpdateScheduleRequest pdfOptions(
    ...
    public UpdateScheduleRequest recipientDetails(
            @javax.annotation.Nullable RecipientDetailsInput recipientDetails) {
        this.recipientDetails = recipientDetails;
        return this;
    }

    /**
     * Recipients of the scheduled job notifications. You can add the ID or name of the ThoughtSpot
     * users or groups as recipients in the &#x60;principals&#x60; array. If a recipient is not a
     ...
     * @return the UpdateScheduleRequest instance itself
     */
    public UpdateScheduleRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, updateScheduleRequest.name)
                ...
                && Objects.equals(
                        this.additionalProperties, updateScheduleRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateScheduleRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateScheduleRequest is not found in"
                                        + " the empty JSON string",
                                UpdateScheduleRequest.openapiRequiredFields.toString()));
            }
        }
        ...
        if (jsonObj.get("recipient_details") != null
                && !jsonObj.get("recipient_details").isJsonNull()) {
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateScheduleRequest>() {
                        @Override
                        public void write(JsonWriter out, UpdateScheduleRequest value)
                                throws IOException {
                        ...
                        public UpdateScheduleRequest read(JsonReader in) throws IOException {
                            ...
                            UpdateScheduleRequest instance = thisAdapter.fromJsonTree(jsonObj);
