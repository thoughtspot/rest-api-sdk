...
public class ResponseActivationURL implements Serializable {
   ...
   * @return the ResponseActivationURL instance itself
   */
  public ResponseActivationURL putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.activationLink, responseActivationURL.activationLink)&&
        Objects.equals(this.additionalProperties, responseActivationURL.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activationLink, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResponseActivationURL>() {
           ...
           public ResponseActivationURL read(JsonReader in) throws IOException {
             ...
             ResponseActivationURL instance = thisAdapter.fromJsonTree(jsonObj);
