...
public class DbtApi {
     ...
     * @param worksheets List of worksheets is mandatory when import_Worksheets is type SELECTED (optional)
     * @param fileContent Upload DBT Manifest and Catalog artifact files as a ZIP file. This field is mandatory if the connection was created with import_type ‘ZIP_FILE’ (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dbtGenerateTmlValidateBeforeCall(String dbtConnectionIdentifier, String importWorksheets, String modelTables, String worksheets, File fileContent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dbtConnectionIdentifier' is set
        if (dbtConnectionIdentifier == null) {
        ...
        return dbtGenerateTmlCall(dbtConnectionIdentifier, importWorksheets, modelTables, worksheets, fileContent, _callback);
     ...
     */
    public Object dbtGenerateTml(String dbtConnectionIdentifier, String importWorksheets, String modelTables, String worksheets, File fileContent) throws ApiException {
        ApiResponse<Object> localVarResp = dbtGenerateTmlWithHttpInfo(dbtConnectionIdentifier, importWorksheets, modelTables, worksheets, fileContent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> dbtGenerateTmlWithHttpInfo(String dbtConnectionIdentifier, String importWorksheets, String modelTables, String worksheets, File fileContent) throws ApiException {
        okhttp3.Call localVarCall = dbtGenerateTmlValidateBeforeCall(dbtConnectionIdentifier, importWorksheets, modelTables, worksheets, fileContent, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call dbtGenerateTmlAsync(String dbtConnectionIdentifier, String importWorksheets, String modelTables, String worksheets, File fileContent, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = dbtGenerateTmlValidateBeforeCall(dbtConnectionIdentifier, importWorksheets, modelTables, worksheets, fileContent, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
