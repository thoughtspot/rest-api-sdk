...
public class DbtApi {
     ...
     * @param fileContent Upload DBT Manifest and Catalog artifact files as a ZIP file. This field is Mandatory when Import Type is &#39;ZIP_FILE&#39; (optional)
    ...
    private okhttp3.Call dbtConnectionValidateBeforeCall(String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'connectionName' is set
        if (connectionName == null) {
            throw new ApiException("Missing the required parameter 'connectionName' when calling dbtConnection(Async)");
        }

        // verify the required parameter 'databaseName' is set
        if (databaseName == null) {
            throw new ApiException("Missing the required parameter 'databaseName' when calling dbtConnection(Async)");
        }

        return dbtConnectionCall(connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent, _callback);
     ...
     */
    public Object dbtConnection(String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent) throws ApiException {
        ApiResponse<Object> localVarResp = dbtConnectionWithHttpInfo(connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent);
     ...
     */
    public ApiResponse<Object> dbtConnectionWithHttpInfo(String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent) throws ApiException {
        okhttp3.Call localVarCall = dbtConnectionValidateBeforeCall(connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent, null);
     ...
     */
    public okhttp3.Call dbtConnectionAsync(String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = dbtConnectionValidateBeforeCall(connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
     ...
     * @param fileContent Upload DBT Manifest and Catalog artifact files as a ZIP file. This field is mandatory if the connection was created with import_type ‘ZIP_FILE’ (optional)
     ...
     */
    public okhttp3.Call dbtGenerateSyncTmlCall(String dbtConnectionIdentifier, File fileContent, Boolean includeSemanticReport, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dbtGenerateSyncTmlValidateBeforeCall(String dbtConnectionIdentifier, File fileContent, Boolean includeSemanticReport, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dbtConnectionIdentifier' is set
        if (dbtConnectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'dbtConnectionIdentifier' when calling dbtGenerateSyncTml(Async)");
        }

        return dbtGenerateSyncTmlCall(dbtConnectionIdentifier, fileContent, includeSemanticReport, _callback);
     ...
     */
    public Object dbtGenerateSyncTml(String dbtConnectionIdentifier, File fileContent, Boolean includeSemanticReport) throws ApiException {
        ApiResponse<Object> localVarResp = dbtGenerateSyncTmlWithHttpInfo(dbtConnectionIdentifier, fileContent, includeSemanticReport);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> dbtGenerateSyncTmlWithHttpInfo(String dbtConnectionIdentifier, File fileContent, Boolean includeSemanticReport) throws ApiException {
        okhttp3.Call localVarCall = dbtGenerateSyncTmlValidateBeforeCall(dbtConnectionIdentifier, fileContent, includeSemanticReport, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call dbtGenerateSyncTmlAsync(String dbtConnectionIdentifier, File fileContent, Boolean includeSemanticReport, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = dbtGenerateSyncTmlValidateBeforeCall(dbtConnectionIdentifier, fileContent, includeSemanticReport, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param dbtConnectionIdentifier Unique ID of the DBT connection. (required)
     * @param modelTables List of Models and their respective Tables Example: &#39;[{\\\&quot;model_name\\\&quot;: \\\&quot;model_name\\\&quot;, \\\&quot;model_path\\\&quot;: \\\&quot;model_path\\\&quot;, \\\&quot;tables\\\&quot;: [\\\&quot;table_name\\\&quot;]}]&#39; (required)
     * @param importWorksheets Mention the worksheet tmls to import (required)
     * @param worksheets List of worksheets is mandatory when import_Worksheets is type SELECTED Example: [\\\&quot;worksheet_name\\\&quot;] (optional)
     * @param fileContent Upload DBT Manifest and Catalog artifact files as a ZIP file. This field is mandatory if the connection was created with import_type ‘ZIP_FILE’ (optional)
     * @param includeSemanticReport If true, includes a &#x60;semantic_report&#x60; per model showing which components were imported or skipped. Each component includes its name, type (such as dimension, measure, or metric), import status, SQL expression, and the corresponding generated ThoughtSpot formula. Note: supported only for Snowflake and Databricks connections. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call dbtGenerateTmlCall(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, Boolean includeSemanticReport, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dbtGenerateTmlValidateBeforeCall(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, Boolean includeSemanticReport, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dbtConnectionIdentifier' is set
        if (dbtConnectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'dbtConnectionIdentifier' when calling dbtGenerateTml(Async)");
        }

        // verify the required parameter 'modelTables' is set
        if (modelTables == null) {
            throw new ApiException("Missing the required parameter 'modelTables' when calling dbtGenerateTml(Async)");
        }

        // verify the required parameter 'importWorksheets' is set
        if (importWorksheets == null) {
            throw new ApiException("Missing the required parameter 'importWorksheets' when calling dbtGenerateTml(Async)");
        }

        return dbtGenerateTmlCall(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, includeSemanticReport, _callback);
     ...
     */
    public Object dbtGenerateTml(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, Boolean includeSemanticReport) throws ApiException {
        ApiResponse<Object> localVarResp = dbtGenerateTmlWithHttpInfo(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, includeSemanticReport);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> dbtGenerateTmlWithHttpInfo(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, Boolean includeSemanticReport) throws ApiException {
        okhttp3.Call localVarCall = dbtGenerateTmlValidateBeforeCall(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, includeSemanticReport, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call dbtGenerateTmlAsync(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, Boolean includeSemanticReport, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = dbtGenerateTmlValidateBeforeCall(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, includeSemanticReport, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateDbtConnectionValidateBeforeCall(String dbtConnectionIdentifier, String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dbtConnectionIdentifier' is set
        if (dbtConnectionIdentifier == null) {
            throw new ApiException("Missing the required parameter 'dbtConnectionIdentifier' when calling updateDbtConnection(Async)");
        }

        return updateDbtConnectionCall(dbtConnectionIdentifier, connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent, _callback);
     ...
     */
    public Object updateDbtConnection(String dbtConnectionIdentifier, String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent) throws ApiException {
        ApiResponse<Object> localVarResp = updateDbtConnectionWithHttpInfo(dbtConnectionIdentifier, connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> updateDbtConnectionWithHttpInfo(String dbtConnectionIdentifier, String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent) throws ApiException {
        okhttp3.Call localVarCall = updateDbtConnectionValidateBeforeCall(dbtConnectionIdentifier, connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateDbtConnectionAsync(String dbtConnectionIdentifier, String connectionName, String databaseName, String importType, String accessToken, String dbtUrl, String accountId, String projectId, String dbtEnvId, String projectName, File fileContent, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateDbtConnectionValidateBeforeCall(dbtConnectionIdentifier, connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
