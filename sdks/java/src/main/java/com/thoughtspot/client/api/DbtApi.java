...
public class DbtApi {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dbtGenerateSyncTmlValidateBeforeCall(String dbtConnectionIdentifier, File fileContent, final ApiCallback _callback) throws ApiException {
     ...
     */
    public Object dbtGenerateSyncTml(String dbtConnectionIdentifier, File fileContent) throws ApiException {
        ApiResponse<Object> localVarResp = dbtGenerateSyncTmlWithHttpInfo(dbtConnectionIdentifier, fileContent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> dbtGenerateSyncTmlWithHttpInfo(String dbtConnectionIdentifier, File fileContent) throws ApiException {
        okhttp3.Call localVarCall = dbtGenerateSyncTmlValidateBeforeCall(dbtConnectionIdentifier, fileContent, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call dbtGenerateSyncTmlAsync(String dbtConnectionIdentifier, File fileContent, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = dbtGenerateSyncTmlValidateBeforeCall(dbtConnectionIdentifier, fileContent, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param dbtConnectionIdentifier Unique ID of the DBT connection. (required)
     * @param modelTables List of Models and their respective Tables Example: &#39;[{\\\&quot;model_name\\\&quot;: \\\&quot;model_name\\\&quot;, \\\&quot;tables\\\&quot;: [\\\&quot;table_name\\\&quot;]}]&#39; (required)
     ...
     */
    public okhttp3.Call dbtGenerateTmlCall(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call dbtGenerateTmlValidateBeforeCall(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'dbtConnectionIdentifier' is set
        if (dbtConnectionIdentifier == null) {
        ...
        return dbtGenerateTmlCall(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, _callback);
     ...
     */
    public Object dbtGenerateTml(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent) throws ApiException {
        ApiResponse<Object> localVarResp = dbtGenerateTmlWithHttpInfo(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> dbtGenerateTmlWithHttpInfo(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent) throws ApiException {
        okhttp3.Call localVarCall = dbtGenerateTmlValidateBeforeCall(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call dbtGenerateTmlAsync(String dbtConnectionIdentifier, String modelTables, String importWorksheets, String worksheets, File fileContent, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = dbtGenerateTmlValidateBeforeCall(dbtConnectionIdentifier, modelTables, importWorksheets, worksheets, fileContent, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
