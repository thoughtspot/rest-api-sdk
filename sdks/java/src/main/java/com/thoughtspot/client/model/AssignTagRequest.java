...
public class AssignTagRequest implements Serializable {
    ...
    public AssignTagRequest metadata(
     ...
     * @return the AssignTagRequest instance itself
     */
    public AssignTagRequest putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.metadata, assignTagRequest.metadata)
                ...
                && Objects.equals(this.additionalProperties, assignTagRequest.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!AssignTagRequest.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in AssignTagRequest is not found in the"
                                        + " empty JSON string",
                                AssignTagRequest.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<AssignTagRequest>() {
                        @Override
                        public void write(JsonWriter out, AssignTagRequest value)
                                throws IOException {
                        ...
                        public AssignTagRequest read(JsonReader in) throws IOException {
                            ...
                            AssignTagRequest instance = thisAdapter.fromJsonTree(jsonObj);
