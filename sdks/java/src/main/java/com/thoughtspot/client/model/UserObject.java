...
public class UserObject implements Serializable {
     ...
     * @return the UserObject instance itself
     */
    public UserObject putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.type, userObject.type)
                ...
                && Objects.equals(this.additionalProperties, userObject.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UserObject.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UserObject is not found in the empty"
                                        + " JSON string",
                                UserObject.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UserObject>() {
                        ...
                        public UserObject read(JsonReader in) throws IOException {
                            ...
                            UserObject instance = thisAdapter.fromJsonTree(jsonObj);
