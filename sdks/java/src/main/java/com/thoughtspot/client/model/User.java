...
public class User implements Serializable {
    ...
    /**
     * Visibility of the users. The &#x60;SHARABLE&#x60; property makes a user visible to other
     * users and group, who can share objects with the user.
     */
    ...
    public static final String SERIALIZED_NAME_FIRST_LOGIN_TIME_IN_MILLIS =
    ...
    public User favoriteMetadata(
            @javax.annotation.Nullable List<FavoriteMetadataItem> favoriteMetadata) {
    ...
    public User modificationTimeInMillis(
    ...
    public User onboardingExperienceCompleted(
    ...
    public User showOnboardingExperience(
    ...
    public User userInheritedGroups(
            @javax.annotation.Nullable List<ObjectIDAndName> userInheritedGroups) {
    ...
    public void setUserInheritedGroups(
            @javax.annotation.Nullable List<ObjectIDAndName> userInheritedGroups) {
        this.userInheritedGroups = userInheritedGroups;
    }
    ...
    public void setAccessControlProperties(
            @javax.annotation.Nullable Object accessControlProperties) {
        this.accessControlProperties = accessControlProperties;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.id, user.id)
                ...
                && Objects.equals(
                        this.onboardingExperienceCompleted, user.onboardingExperienceCompleted)
    ...
    public String toString() {
        ...
        sb.append("    canChangePassword: ")
                .append(toIndentedString(canChangePassword))
                .append("\n");
        ...
        sb.append("    firstLoginTimeInMillis: ")
                .append(toIndentedString(firstLoginTimeInMillis))
                .append("\n");
        ...
        sb.append("    incompleteDetails: ")
                .append(toIndentedString(incompleteDetails))
                .append("\n");
        ...
        sb.append("    userInheritedGroups: ")
                .append(toIndentedString(userInheritedGroups))
                .append("\n");
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (jsonObj.get("user_inherited_groups") != null
                && !jsonObj.get("user_inherited_groups").isJsonNull()) {
            JsonArray jsonArrayuserInheritedGroups =
                    jsonObj.getAsJsonArray("user_inherited_groups");
            if (jsonArrayuserInheritedGroups != null) {
                // ensure the json data is an array
                if (!jsonObj.get("user_inherited_groups").isJsonArray()) {
                    throw new IllegalArgumentException(
                            String.format(
                                    "Expected the field `user_inherited_groups` to be an array in"
                                            + " the JSON string but got `%s`",
                                    jsonObj.get("user_inherited_groups").toString()));
                }
