...
public class RuntimeFilter implements Serializable {
     ...
     * @return the RuntimeFilter instance itself
     */
    public RuntimeFilter putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.runtimeFilter, runtimeFilter.runtimeFilter)
                && Objects.equals(this.additionalProperties, runtimeFilter.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(runtimeFilter, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!RuntimeFilter.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in RuntimeFilter is not found in the"
                                        + " empty JSON string",
                                RuntimeFilter.openapiRequiredFields.toString()));
            }
        }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<RuntimeFilter>() {
                        ...
                        public RuntimeFilter read(JsonReader in) throws IOException {
                            ...
                            RuntimeFilter instance = thisAdapter.fromJsonTree(jsonObj);
