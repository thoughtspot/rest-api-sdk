...
public class CreateScheduleRequest implements Serializable {
  ...
  public CreateScheduleRequest metadataType(@javax.annotation.Nonnull MetadataTypeEnum metadataType) {
  ...
  public CreateScheduleRequest metadataIdentifier(@javax.annotation.Nonnull String metadataIdentifier) {
  ...
  public CreateScheduleRequest liveboardOptions(@javax.annotation.Nullable LiveboardOptionsInput liveboardOptions) {
  ...
  public CreateScheduleRequest pdfOptions(@javax.annotation.Nullable SchedulesPdfOptionsInput pdfOptions) {
  ...
  public CreateScheduleRequest recipientDetails(@javax.annotation.Nonnull RecipientDetailsInput recipientDetails) {
   ...
   * @return the CreateScheduleRequest instance itself
   */
  public CreateScheduleRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createScheduleRequest.name) &&
        ...
        Objects.equals(this.additionalProperties, createScheduleRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, metadataType, metadataIdentifier, fileFormat, liveboardOptions, pdfOptions, timeZone, frequency, recipientDetails, personalisedViewId, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CreateScheduleRequest>() {
           ...
           public CreateScheduleRequest read(JsonReader in) throws IOException {
             ...
             CreateScheduleRequest instance = thisAdapter.fromJsonTree(jsonObj);
