...
public class CommitHistoryResponse implements Serializable {
     ...
     * @return the CommitHistoryResponse instance itself
     */
    public CommitHistoryResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.committer, commitHistoryResponse.committer)
                ...
                && Objects.equals(
                        this.additionalProperties, commitHistoryResponse.additionalProperties);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                committer, author, comment, commitTime, commitId, branch, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CommitHistoryResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CommitHistoryResponse is not found in"
                                        + " the empty JSON string",
                                CommitHistoryResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<CommitHistoryResponse>() {
                        @Override
                        public void write(JsonWriter out, CommitHistoryResponse value)
                                throws IOException {
                        ...
                        public CommitHistoryResponse read(JsonReader in) throws IOException {
                            ...
                            CommitHistoryResponse instance = thisAdapter.fromJsonTree(jsonObj);
