...
public class CspSettings implements Serializable {
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!CspSettings.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in CspSettings is not found in the empty"
                                        + " JSON string",
                                CspSettings.openapiRequiredFields.toString()));
            }
        }
