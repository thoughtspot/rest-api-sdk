...
import com.thoughtspot.client.model.VariableOrgInfo;
import com.thoughtspot.client.model.VariableValue;
...
public class Variable implements Serializable {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, objId, variableType, sensitive, values, org, additionalProperties);
  }
