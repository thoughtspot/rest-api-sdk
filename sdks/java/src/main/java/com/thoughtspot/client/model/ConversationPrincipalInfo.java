...
public class ConversationPrincipalInfo implements Serializable {
  ...
  public ConversationPrincipalInfo permission(@javax.annotation.Nonnull PermissionEnum permission) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, conversationPrincipalInfo.id) &&
        ...
        Objects.equals(this.additionalProperties, conversationPrincipalInfo.additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ConversationPrincipalInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConversationPrincipalInfo is not found in the empty JSON string", ConversationPrincipalInfo.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConversationPrincipalInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConversationPrincipalInfo' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<ConversationPrincipalInfo>() {
           @Override
           public void write(JsonWriter out, ConversationPrincipalInfo value) throws IOException {
