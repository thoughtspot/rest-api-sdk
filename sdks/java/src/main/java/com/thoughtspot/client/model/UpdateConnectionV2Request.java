...
public class UpdateConnectionV2Request implements Serializable {
    ...
    public UpdateConnectionV2Request dataWarehouseConfig(
     ...
     * @return the UpdateConnectionV2Request instance itself
     */
    public UpdateConnectionV2Request putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, updateConnectionV2Request.name)
                ...
                && Objects.equals(
                        this.dataWarehouseConfig, updateConnectionV2Request.dataWarehouseConfig)
                && Objects.equals(this.validate, updateConnectionV2Request.validate)
                && Objects.equals(
                        this.additionalProperties, updateConnectionV2Request.additionalProperties);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, description, dataWarehouseConfig, validate, additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!UpdateConnectionV2Request.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in UpdateConnectionV2Request is not"
                                        + " found in the empty JSON string",
                                UpdateConnectionV2Request.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!UpdateConnectionV2Request.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'UpdateConnectionV2Request' and its
                // subtypes
            }
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<UpdateConnectionV2Request>() {
                        @Override
                        public void write(JsonWriter out, UpdateConnectionV2Request value)
                                throws IOException {
                        ...
                        public UpdateConnectionV2Request read(JsonReader in) throws IOException {
                            ...
                            UpdateConnectionV2Request instance = thisAdapter.fromJsonTree(jsonObj);
