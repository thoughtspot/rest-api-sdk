...
public class SearchDataResponse implements Serializable {
     ...
     * @return the SearchDataResponse instance itself
     */
    public SearchDataResponse putAdditionalProperty(String key, Object value) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.contents, searchDataResponse.contents)
                && Objects.equals(
                        this.additionalProperties, searchDataResponse.additionalProperties);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!SearchDataResponse.openapiRequiredFields
                    .isEmpty()) { // has required fields but JSON element is null
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in SearchDataResponse is not found in"
                                        + " the empty JSON string",
                                SearchDataResponse.openapiRequiredFields.toString()));
            }
        }
    ...
    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            return (TypeAdapter<T>)
                    new TypeAdapter<SearchDataResponse>() {
                        @Override
                        public void write(JsonWriter out, SearchDataResponse value)
                                throws IOException {
                        ...
                        public SearchDataResponse read(JsonReader in) throws IOException {
                            ...
                            SearchDataResponse instance = thisAdapter.fromJsonTree(jsonObj);
