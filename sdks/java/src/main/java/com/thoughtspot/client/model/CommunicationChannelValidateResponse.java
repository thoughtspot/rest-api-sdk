...
import com.thoughtspot.client.model.ChannelValidationDetail;
...
public class CommunicationChannelValidateResponse implements Serializable {
  ...
  public CommunicationChannelValidateResponse channelType(@javax.annotation.Nonnull ChannelTypeEnum channelType) {
  ...
  public CommunicationChannelValidateResponse channelId(@javax.annotation.Nonnull String channelId) {
  ...
  public CommunicationChannelValidateResponse channelName(@javax.annotation.Nullable String channelName) {
  ...
  public CommunicationChannelValidateResponse eventType(@javax.annotation.Nonnull EventTypeEnum eventType) {
  ...
  public CommunicationChannelValidateResponse resultCode(@javax.annotation.Nonnull ResultCodeEnum resultCode) {
  ...
  public CommunicationChannelValidateResponse details(@javax.annotation.Nullable List<ChannelValidationDetail> details) {
    this.details = details;
    return this;
  }

  public CommunicationChannelValidateResponse addDetailsItem(ChannelValidationDetail detailsItem) {
   ...
   * @return the CommunicationChannelValidateResponse instance itself
   */
  public CommunicationChannelValidateResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommunicationChannelValidateResponse communicationChannelValidateResponse = (CommunicationChannelValidateResponse) o;
    return Objects.equals(this.channelType, communicationChannelValidateResponse.channelType) &&
        ...
        Objects.equals(this.channelName, communicationChannelValidateResponse.channelName) &&
        ...
        Objects.equals(this.additionalProperties, communicationChannelValidateResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(channelType, channelId, channelName, eventType, jobId, resultCode, details, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CommunicationChannelValidateResponse
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CommunicationChannelValidateResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommunicationChannelValidateResponse is not found in the empty JSON string", CommunicationChannelValidateResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommunicationChannelValidateResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommunicationChannelValidateResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommunicationChannelValidateResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommunicationChannelValidateResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CommunicationChannelValidateResponse>() {
           @Override
           public void write(JsonWriter out, CommunicationChannelValidateResponse value) throws IOException {
           ...
           @Override
           public CommunicationChannelValidateResponse read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             CommunicationChannelValidateResponse instance = thisAdapter.fromJsonTree(jsonObj);
   ...
   * @throws IOException if the JSON string is invalid with respect to CommunicationChannelValidateResponse
   */
  public static CommunicationChannelValidateResponse fromJson(String jsonString) throws IOException {
