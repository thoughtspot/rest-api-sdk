...
public class CALLBACKInputMandatory {
  ...
  public CALLBACKInputMandatory reference(String reference) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CALLBACKInputMandatory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CALLBACKInputMandatory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CALLBACKInputMandatory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CALLBACKInputMandatory` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
