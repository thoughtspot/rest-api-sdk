...
public class ObjectIDAndName {
  ...
  public ObjectIDAndName id(String id) {
  ...
  **/
  ...
  public ObjectIDAndName name(String name) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ObjectIDAndName
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ObjectIDAndName.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ObjectIDAndName.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ObjectIDAndName` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
