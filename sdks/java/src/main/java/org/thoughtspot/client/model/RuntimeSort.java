...
public class RuntimeSort {
  ...
  public RuntimeSort runtimeSort(Object runtimeSort) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RuntimeSort
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RuntimeSort.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RuntimeSort.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RuntimeSort` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
