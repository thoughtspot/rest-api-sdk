...
public class RegionalSettingsInput {
  ...
  public RegionalSettingsInput currencyFormat(CurrencyFormatEnum currencyFormat) {
  ...
  **/
  ...
  public RegionalSettingsInput userLocale(UserLocaleEnum userLocale) {
  ...
  **/
  ...
  public RegionalSettingsInput numberFormatLocale(NumberFormatLocaleEnum numberFormatLocale) {
  ...
  **/
  ...
  public RegionalSettingsInput dateFormatLocale(DateFormatLocaleEnum dateFormatLocale) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegionalSettingsInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegionalSettingsInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RegionalSettingsInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RegionalSettingsInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
