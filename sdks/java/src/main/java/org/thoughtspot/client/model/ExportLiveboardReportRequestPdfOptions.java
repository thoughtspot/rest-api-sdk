...
public class ExportLiveboardReportRequestPdfOptions {
  ...
  public ExportLiveboardReportRequestPdfOptions() {
  }

  public ExportLiveboardReportRequestPdfOptions includeCoverPage(Boolean includeCoverPage) {
  ...
  **/
  ...
  public ExportLiveboardReportRequestPdfOptions includeCustomLogo(Boolean includeCustomLogo) {
  ...
  **/
  ...
  public ExportLiveboardReportRequestPdfOptions includeFilterPage(Boolean includeFilterPage) {
  ...
  **/
  ...
  public ExportLiveboardReportRequestPdfOptions includePageNumber(Boolean includePageNumber) {
  ...
  **/
  ...
  public ExportLiveboardReportRequestPdfOptions pageOrientation(PageOrientationEnum pageOrientation) {
  ...
  **/
  ...
  public ExportLiveboardReportRequestPdfOptions truncateTable(Boolean truncateTable) {
  ...
  **/
  ...
  public ExportLiveboardReportRequestPdfOptions pageFooterText(String pageFooterText) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ExportLiveboardReportRequestPdfOptions exportLiveboardReportRequestPdfOptions = (ExportLiveboardReportRequestPdfOptions) o;
    return Objects.equals(this.includeCoverPage, exportLiveboardReportRequestPdfOptions.includeCoverPage) &&
        Objects.equals(this.includeCustomLogo, exportLiveboardReportRequestPdfOptions.includeCustomLogo) &&
        Objects.equals(this.includeFilterPage, exportLiveboardReportRequestPdfOptions.includeFilterPage) &&
        Objects.equals(this.includePageNumber, exportLiveboardReportRequestPdfOptions.includePageNumber) &&
        Objects.equals(this.pageOrientation, exportLiveboardReportRequestPdfOptions.pageOrientation) &&
        Objects.equals(this.truncateTable, exportLiveboardReportRequestPdfOptions.truncateTable) &&
        Objects.equals(this.pageFooterText, exportLiveboardReportRequestPdfOptions.pageFooterText);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportLiveboardReportRequestPdfOptions {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExportLiveboardReportRequestPdfOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExportLiveboardReportRequestPdfOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExportLiveboardReportRequestPdfOptions is not found in the empty JSON string", ExportLiveboardReportRequestPdfOptions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ExportLiveboardReportRequestPdfOptions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ExportLiveboardReportRequestPdfOptions` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportLiveboardReportRequestPdfOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportLiveboardReportRequestPdfOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportLiveboardReportRequestPdfOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportLiveboardReportRequestPdfOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportLiveboardReportRequestPdfOptions>() {
           @Override
           public void write(JsonWriter out, ExportLiveboardReportRequestPdfOptions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportLiveboardReportRequestPdfOptions read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ExportLiveboardReportRequestPdfOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExportLiveboardReportRequestPdfOptions
  * @throws IOException if the JSON string is invalid with respect to ExportLiveboardReportRequestPdfOptions
  */
  public static ExportLiveboardReportRequestPdfOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportLiveboardReportRequestPdfOptions.class);
  }

 /**
  * Convert an instance of ExportLiveboardReportRequestPdfOptions to an JSON string
  *
  * @return JSON string
  */
