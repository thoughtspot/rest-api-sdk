...
public class DefaultActionConfigInput {
  ...
  public DefaultActionConfigInput visibility(Boolean visibility) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DefaultActionConfigInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DefaultActionConfigInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DefaultActionConfigInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DefaultActionConfigInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
