...
public class ResponseFailedEntities {
  ...
  public ResponseFailedEntities data(List<ResponseFailedEntity> data) {
  ...
  **/
  ...
  public void setData(List<ResponseFailedEntity> data) {
    this.data = data;
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResponseFailedEntities
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResponseFailedEntities.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseFailedEntities.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseFailedEntities` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      for (int i = 0; i < jsonArraydata.size(); i++) {
        ResponseFailedEntity.validateJsonObject(jsonArraydata.get(i).getAsJsonObject());
      };
  }
