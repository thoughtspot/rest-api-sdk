...
public class TokenAccessScopeObject {
  /**
  ...
  public TokenAccessScopeObject type(TypeEnum type) {
  ...
  **/
  ...
  public TokenAccessScopeObject identifier(String identifier) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TokenAccessScopeObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TokenAccessScopeObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TokenAccessScopeObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TokenAccessScopeObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
