...
public class ResponsePostUpgradeFailedEntity {
  ...
  public ResponsePostUpgradeFailedEntity id(String id) {
  ...
  **/
  ...
  public ResponsePostUpgradeFailedEntity name(String name) {
  ...
  **/
  ...
  public ResponsePostUpgradeFailedEntity error(String error) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResponsePostUpgradeFailedEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResponsePostUpgradeFailedEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponsePostUpgradeFailedEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponsePostUpgradeFailedEntity` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
