...
public class UpdateDbtConnectionRequest implements Serializable {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.dbtConnectionIdentifier, updateDbtConnectionRequest.dbtConnectionIdentifier) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dbtConnectionIdentifier, connectionName, databaseName, importType, accessToken, dbtUrl, accountId, projectId, dbtEnvId, projectName, fileContent);
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateDbtConnectionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateDbtConnectionRequest' and its subtypes
       }
       ...
       return (TypeAdapter<T>) new TypeAdapter<UpdateDbtConnectionRequest>() {
           @Override
           public void write(JsonWriter out, UpdateDbtConnectionRequest value) throws IOException {
