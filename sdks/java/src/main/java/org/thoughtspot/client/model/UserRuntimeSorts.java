...
public class UserRuntimeSorts {
  ...
  public UserRuntimeSorts() {
  }

  public UserRuntimeSorts columnName(String columnName) {
  ...
  **/
  ...
  public UserRuntimeSorts order(OrderEnum order) {
  ...
  **/
  ...
  public UserRuntimeSorts persist(Boolean persist) {
  ...
  **/
  ...
  public UserRuntimeSorts objects(List<UserObject> objects) {
    
    this.objects = objects;
    return this;
  }

  public UserRuntimeSorts addObjectsItem(UserObject objectsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserRuntimeSorts userRuntimeSorts = (UserRuntimeSorts) o;
    return Objects.equals(this.columnName, userRuntimeSorts.columnName) &&
        Objects.equals(this.order, userRuntimeSorts.order) &&
        Objects.equals(this.persist, userRuntimeSorts.persist) &&
        Objects.equals(this.objects, userRuntimeSorts.objects);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserRuntimeSorts {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserRuntimeSorts
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserRuntimeSorts.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserRuntimeSorts is not found in the empty JSON string", UserRuntimeSorts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UserRuntimeSorts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserRuntimeSorts` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserRuntimeSorts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserRuntimeSorts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserRuntimeSorts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserRuntimeSorts.class));

       return (TypeAdapter<T>) new TypeAdapter<UserRuntimeSorts>() {
           @Override
           public void write(JsonWriter out, UserRuntimeSorts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserRuntimeSorts read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserRuntimeSorts given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserRuntimeSorts
  * @throws IOException if the JSON string is invalid with respect to UserRuntimeSorts
  */
  public static UserRuntimeSorts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserRuntimeSorts.class);
  }

 /**
  * Convert an instance of UserRuntimeSorts to an JSON string
  *
  * @return JSON string
  */
