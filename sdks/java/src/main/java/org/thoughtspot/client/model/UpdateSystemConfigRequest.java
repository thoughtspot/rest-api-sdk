...
public class UpdateSystemConfigRequest {
  ...
  public UpdateSystemConfigRequest _configuration(Object _configuration) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to UpdateSystemConfigRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UpdateSystemConfigRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UpdateSystemConfigRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateSystemConfigRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
