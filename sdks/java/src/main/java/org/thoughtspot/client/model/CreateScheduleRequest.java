...
public class CreateScheduleRequest {
  ...
  **/
  ...
  public CreateScheduleRequest metadataType(MetadataTypeEnum metadataType) {
  ...
  **/
  ...
  public CreateScheduleRequest metadataIdentifier(String metadataIdentifier) {
  ...
  **/
  ...
  public CreateScheduleRequest fileFormat(FileFormatEnum fileFormat) {
  ...
  **/
  ...
  public CreateScheduleRequest timeZone(TimeZoneEnum timeZone) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreateScheduleRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CreateScheduleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CreateScheduleRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CreateScheduleRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
