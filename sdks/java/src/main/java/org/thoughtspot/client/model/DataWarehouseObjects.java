...
public class DataWarehouseObjects {
  ...
  public DataWarehouseObjects databases(List<Database> databases) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DataWarehouseObjects
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DataWarehouseObjects.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DataWarehouseObjects.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DataWarehouseObjects` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
