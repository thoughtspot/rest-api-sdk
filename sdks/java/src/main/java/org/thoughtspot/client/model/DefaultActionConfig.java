...
public class DefaultActionConfig {
  ...
  public DefaultActionConfig visibility(Boolean visibility) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to DefaultActionConfig
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DefaultActionConfig.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!DefaultActionConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DefaultActionConfig` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
