...
public class ResponseCopyObject {
  ...
  public ResponseCopyObject metadataId(String metadataId) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResponseCopyObject
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResponseCopyObject.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseCopyObject.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseCopyObject` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
