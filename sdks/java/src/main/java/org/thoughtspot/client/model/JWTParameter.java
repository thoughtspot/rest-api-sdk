...
public class JWTParameter {
  ...
  public JWTParameter runtimeFilter(Object runtimeFilter) {
  ...
  **/
  ...
  public JWTParameter runtimeSort(Object runtimeSort) {
  ...
  **/
  ...
  public JWTParameter runtimeParamOverride(Object runtimeParamOverride) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to JWTParameter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JWTParameter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!JWTParameter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JWTParameter` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
