...
public class PrincipalsListItem {
  ...
  public PrincipalsListItem identifier(String identifier) {
  ...
  **/
  ...
  public PrincipalsListItem type(String type) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrincipalsListItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrincipalsListItem.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PrincipalsListItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PrincipalsListItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
