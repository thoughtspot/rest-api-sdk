...
public class ParameterValues {
  ...
  public ParameterValues name(String name) {
  ...
  **/
  ...
  public ParameterValues values(List<FilterRulesValuesInner> values) {
    
    this.values = values;
    return this;
  }

  public ParameterValues addValuesItem(FilterRulesValuesInner valuesItem) {
    if (this.values == null) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ParameterValues
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ParameterValues.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ParameterValues.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ParameterValues` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
