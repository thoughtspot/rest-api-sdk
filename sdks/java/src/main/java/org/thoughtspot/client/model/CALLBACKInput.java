...
public class CALLBACKInput {
  ...
  public CALLBACKInput reference(String reference) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CALLBACKInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CALLBACKInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CALLBACKInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CALLBACKInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
