...
public class GetFullAccessTokenRequestUserParameters {
  ...
  public GetFullAccessTokenRequestUserParameters() {
  }

  public GetFullAccessTokenRequestUserParameters objects(List<UserObject> objects) {
    
    this.objects = objects;
    return this;
  }

  public GetFullAccessTokenRequestUserParameters addObjectsItem(UserObject objectsItem) {
  ...
  **/
  ...
  public GetFullAccessTokenRequestUserParameters runtimeFilters(List<RuntimeFilters> runtimeFilters) {
    
    this.runtimeFilters = runtimeFilters;
    return this;
  }

  public GetFullAccessTokenRequestUserParameters addRuntimeFiltersItem(RuntimeFilters runtimeFiltersItem) {
  ...
  **/
  ...
  public GetFullAccessTokenRequestUserParameters runtimeSorts(List<RuntimeSorts> runtimeSorts) {
    
    this.runtimeSorts = runtimeSorts;
    return this;
  }

  public GetFullAccessTokenRequestUserParameters addRuntimeSortsItem(RuntimeSorts runtimeSortsItem) {
  ...
  **/
  ...
  public GetFullAccessTokenRequestUserParameters parameters(List<RuntimeParameters> parameters) {
    
    this.parameters = parameters;
    return this;
  }

  public GetFullAccessTokenRequestUserParameters addParametersItem(RuntimeParameters parametersItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetFullAccessTokenRequestUserParameters getFullAccessTokenRequestUserParameters = (GetFullAccessTokenRequestUserParameters) o;
    return Objects.equals(this.objects, getFullAccessTokenRequestUserParameters.objects) &&
        Objects.equals(this.runtimeFilters, getFullAccessTokenRequestUserParameters.runtimeFilters) &&
        Objects.equals(this.runtimeSorts, getFullAccessTokenRequestUserParameters.runtimeSorts) &&
        Objects.equals(this.parameters, getFullAccessTokenRequestUserParameters.parameters);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetFullAccessTokenRequestUserParameters {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GetFullAccessTokenRequestUserParameters
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GetFullAccessTokenRequestUserParameters.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GetFullAccessTokenRequestUserParameters is not found in the empty JSON string", GetFullAccessTokenRequestUserParameters.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!GetFullAccessTokenRequestUserParameters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetFullAccessTokenRequestUserParameters` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetFullAccessTokenRequestUserParameters.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetFullAccessTokenRequestUserParameters' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetFullAccessTokenRequestUserParameters> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetFullAccessTokenRequestUserParameters.class));

       return (TypeAdapter<T>) new TypeAdapter<GetFullAccessTokenRequestUserParameters>() {
           @Override
           public void write(JsonWriter out, GetFullAccessTokenRequestUserParameters value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetFullAccessTokenRequestUserParameters read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of GetFullAccessTokenRequestUserParameters given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GetFullAccessTokenRequestUserParameters
  * @throws IOException if the JSON string is invalid with respect to GetFullAccessTokenRequestUserParameters
  */
  public static GetFullAccessTokenRequestUserParameters fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetFullAccessTokenRequestUserParameters.class);
  }

 /**
  * Convert an instance of GetFullAccessTokenRequestUserParameters to an JSON string
  *
  * @return JSON string
  */
