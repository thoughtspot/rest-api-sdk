...
public class ApiClient {
     ...
     * @throws org.thoughtspot.client.ApiException If fail to deserialize response body, i.e. cannot
     ...
     * @throws org.thoughtspot.client.ApiException If fail to read file content from response and
     *     write to disk
     ...
     * @param returnType Return type
     * @return Type
     * @throws org.thoughtspot.client.ApiException If the response has an unsuccessful status code
     ...
     * @throws org.thoughtspot.client.ApiException If fail to serialize the request body object into
     *     a string
     */
