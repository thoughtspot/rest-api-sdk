...
public class HeaderAttributeInput {
  ...
  public HeaderAttributeInput name(String name) {
  ...
  **/
  ...
  public HeaderAttributeInput value(String value) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to HeaderAttributeInput
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HeaderAttributeInput.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!HeaderAttributeInput.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `HeaderAttributeInput` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
