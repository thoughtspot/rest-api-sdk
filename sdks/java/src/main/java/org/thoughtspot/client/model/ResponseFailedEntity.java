...
public class ResponseFailedEntity {
  ...
  public ResponseFailedEntity id(String id) {
  ...
  **/
  ...
  public ResponseFailedEntity name(String name) {
  ...
  **/
  ...
  public ResponseFailedEntity error(String error) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResponseFailedEntity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResponseFailedEntity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ResponseFailedEntity.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ResponseFailedEntity` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
