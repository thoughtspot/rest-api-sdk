...
public class APIKey implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.key, apIKey.key) && Objects.equals(this.value, apIKey.value);
    }
    ...
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        if (jsonElement == null) {
            if (!APIKey.openapiRequiredFields
                ...
                throw new IllegalArgumentException(
                        String.format(
                                "The required field(s) %s in APIKey is not found in the empty JSON"
                                        + " string",
        ...
        for (Map.Entry<String, JsonElement> entry : entries) {
            if (!APIKey.openapiFields.contains(entry.getKey())) {
                throw new IllegalArgumentException(
                        String.format(
                                "The field `%s` in the JSON string is not defined in the `APIKey`"
                                        + " properties. JSON: %s",
