...
export class SearchDataRequest {
    ...
    */
    'dataFormat'?: SearchDataRequest.DataFormatEnum = SearchDataRequest.DataFormatEnum.Compact;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "SearchDataRequest.DataFormatEnum"
        },
        {
            "name": "recordOffset",
...
export namespace SearchDataRequest {
