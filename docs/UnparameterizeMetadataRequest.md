# ThoughtSpot.Client.Model.UnparameterizeMetadataRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**MetadataType** | **string** | Type of metadata object to unparameterize. | [optional] 
**MetadataIdentifier** | **string** | Unique ID or name of the metadata object to unparameterize. | 
**FieldType** | **string** | Type of field in the metadata to unparameterize. | 
