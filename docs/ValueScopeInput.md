# ThoughtSpot.Client.Model.ValueScopeInput
...
**PrincipalType** | **string** | Type of principal to filter by. Use USER to filter values assigned to specific users, or USER_GROUP to filter values assigned to groups. | [optional] 
