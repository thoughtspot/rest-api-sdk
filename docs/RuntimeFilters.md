# ThoughtSpot.Client.Model.RuntimeFilters
...
**Operator** | **string** | Operator value. Example: EQ | 
**Persist** | **bool?** | Flag to persist the runtime filters.    Version: 9.12.0.cl or later  | [optional] [default to false]
