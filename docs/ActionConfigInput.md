# ThoughtSpot.Client.Model.ActionConfigInput
...
**Visibility** | **bool?** | Visibility of the metadata association with custom action. Earlier naming convention: enabled | [optional] 
