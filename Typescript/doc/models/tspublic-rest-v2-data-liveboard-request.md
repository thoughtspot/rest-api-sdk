...
| `vizId` | `string[] \| undefined` | Optional | A JSON array of GUIDs of the visualizations in the Liveboard.<br><br>The vizId field will not be considered when transientContent input is provided. |
