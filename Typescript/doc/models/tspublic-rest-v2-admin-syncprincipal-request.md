...
| `updateModified` | [`SyncPrincipalUpdateModifiedEnum \| undefined`](../../doc/models/sync-principal-update-modified-enum.md) | Optional | Specifies whether to apply the changes to users and groups already in the cluster based on the principal object list input.<br>**Default**: `SyncPrincipalUpdateModifiedEnum.False` |
| `deleteRemoved` | [`SyncPrincipalDeleteRemovedEnum \| undefined`](../../doc/models/sync-principal-delete-removed-enum.md) | Optional | Specifies whether to delete the users and groups already in the cluster if not present in the principal object list input.<br>**Default**: `SyncPrincipalDeleteRemovedEnum.False` |
