...
import { Type4Enum, type4EnumSchema } from '../models/type4Enum';
import { Type5Enum, type5EnumSchema } from '../models/type5Enum';
...
export class MetadataController extends BaseController {
   ...
   *
   * @param userName Name of the tag
   * @param userId   The GUID of the tag
   * @return Response from the API call
   */
   ...
   * of C2 will be prevented by the relationship between W1's column C1 and C2. Similarly C1 is said to
