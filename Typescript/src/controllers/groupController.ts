...
export class GroupController extends BaseController {
   ...
   *
   * For ease of user management and access control, ThoughtSpot administrations can create groups and
   ...
   *
   * ThoughtSpot also has a default group called ALL. When you create new group in ThoughtSpot, they are
   * automatically added to ALL user group. You cannot delete the ALL user group or remove members from
   * it.
   *
   * Permission: Requires administration privilege
   *
