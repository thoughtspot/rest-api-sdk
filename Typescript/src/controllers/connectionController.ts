...
export class ConnectionController extends BaseController {
   ...
   * At least one of Connection Id or connectionname is mandatory. When both are given, then connection
   * id will be considered and connectionname will be updated
   *
   * @param body
   * @return Response from the API call
   */
   ...
   * When you assign groups to a connection, the connection inherits the privileges assigned to those
   * groups.
   * At least one of Connection Id or connectionname is mandatory. When both are given, then connection
   ...
   * The API removes only the connection association. It does not delete the connection or group from the
   * Thoughtspot system.
   * At least one of id or name of connection is required. When both are given connection id will be
   * considered.
   *
   * @param body
   * @return Response from the API call
