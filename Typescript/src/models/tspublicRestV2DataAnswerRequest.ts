...
import {
  ...
  answerDataFormatTypeEnumSchema,
} from './answerDataFormatTypeEnum';
...
export interface TspublicRestV2DataAnswerRequest {
   ...
   */
  formatType?: AnswerDataFormatTypeEnum;
}
...
export const tspublicRestV2DataAnswerRequestSchema: Schema<TspublicRestV2DataAnswerRequest> = object(
  {
    ...
    id: ['id', string()],
    formatType: ['formatType', optional(answerDataFormatTypeEnumSchema)],
  }
);
