...
/**
 * Enum for GetObjectHeaderTypeEnum
 */
export enum GetObjectHeaderTypeEnum {
  ANSWER = 'ANSWER',
  LIVEBOARD = 'LIVEBOARD',
...
/**
 * Schema for GetObjectHeaderTypeEnum
 */
export const getObjectHeaderTypeEnumSchema: Schema<GetObjectHeaderTypeEnum> = stringEnum(GetObjectHeaderTypeEnum);
