...
export interface TspublicRestV2MetadataTagUnassignRequest {
  /** Name of the tag */
  name?: string;
  /** The GUID of the tag */
  id?: string;
...
export const tspublicRestV2MetadataTagUnassignRequestSchema: Schema<TspublicRestV2MetadataTagUnassignRequest> = object(
  {
