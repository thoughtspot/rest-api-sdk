...
export interface ApiRestV2AdminChangeownerRequest {
  /**
...
export const apiRestV2AdminChangeownerRequestSchema: Schema<ApiRestV2AdminChangeownerRequest> = object(
  {
    metaObjectId: ['metaObjectId', array(string())],
