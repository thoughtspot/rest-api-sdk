...
/**
 * Enum for SearchObjectHeaderTypeEnum
 */
export enum SearchObjectHeaderTypeEnum {
  ANSWER = 'ANSWER',
  LIVEBOARD = 'LIVEBOARD',
...
/**
 * Schema for SearchObjectHeaderTypeEnum
 */
export const searchObjectHeaderTypeEnumSchema: Schema<SearchObjectHeaderTypeEnum> = stringEnum(SearchObjectHeaderTypeEnum);
