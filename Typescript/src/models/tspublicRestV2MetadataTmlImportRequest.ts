...
import {
  ...
  importObjectTMLForceCreateEnumSchema,
} from './importObjectTMLForceCreateEnum';
import {
  ImportObjectTMLImportPolicyEnum,
  importObjectTMLImportPolicyEnumSchema,
} from './importObjectTMLImportPolicyEnum';
...
export interface TspublicRestV2MetadataTmlImportRequest {
   ...
   */
  importPolicy?: ImportObjectTMLImportPolicyEnum;
  /**
   ...
   */
  forceCreate?: ImportObjectTMLForceCreateEnum;
}
...
export const tspublicRestV2MetadataTmlImportRequestSchema: Schema<TspublicRestV2MetadataTmlImportRequest> = object(
  {
    ...
    importPolicy: [
      'importPolicy',
      optional(importObjectTMLImportPolicyEnumSchema),
    ],
    forceCreate: [
      'forceCreate',
      optional(importObjectTMLForceCreateEnumSchema),
    ],
  }
);
