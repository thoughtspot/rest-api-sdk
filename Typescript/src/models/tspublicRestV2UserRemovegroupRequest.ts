...
export interface TspublicRestV2UserRemovegroupRequest {
...
export const tspublicRestV2UserRemovegroupRequestSchema: Schema<TspublicRestV2UserRemovegroupRequest> = object(
  {
