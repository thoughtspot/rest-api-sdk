...
export interface ApiRestV2AdminSyncprincipalRequest {
  /**
...
export const apiRestV2AdminSyncprincipalRequestSchema: Schema<ApiRestV2AdminSyncprincipalRequest> = object(
  {
    principalObject: ['principalObject', array(string())],
