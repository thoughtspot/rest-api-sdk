...
export interface TspublicRestV2AdminChangeauthorRequest {
  /**
...
export const tspublicRestV2AdminChangeauthorRequestSchema: Schema<TspublicRestV2AdminChangeauthorRequest> = object(
  {
