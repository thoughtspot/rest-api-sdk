...
export interface ApiRestV2MetadataTagAssignRequest {
  /** Name of the tag */
  name?: string;
  /** The GUID of the tag */
  id?: string;
...
export const apiRestV2MetadataTagAssignRequestSchema: Schema<ApiRestV2MetadataTagAssignRequest> = object(
  {
