...
import {
  DeleteRemovedEnum,
  deleteRemovedEnumSchema,
} from './deleteRemovedEnum';
import {
  UpdateModifiedEnum,
  updateModifiedEnumSchema,
} from './updateModifiedEnum';
...
export interface TspublicRestV2AdminSyncprincipalRequest {
  ...
  updateModified?: UpdateModifiedEnum;
  ...
  deleteRemoved?: DeleteRemovedEnum;
  /**
...
export const tspublicRestV2AdminSyncprincipalRequestSchema: Schema<TspublicRestV2AdminSyncprincipalRequest> = object(
  {
    ...
    updateModified: ['updateModified', optional(updateModifiedEnumSchema)],
    deleteRemoved: ['deleteRemoved', optional(deleteRemovedEnumSchema)],
