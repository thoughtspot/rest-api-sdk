...
import {
  ...
  syncPrincipalDeleteRemovedEnumSchema,
} from './syncPrincipalDeleteRemovedEnum';
import {
  SyncPrincipalUpdateModifiedEnum,
  syncPrincipalUpdateModifiedEnumSchema,
} from './syncPrincipalUpdateModifiedEnum';
...
export interface TspublicRestV2AdminSyncprincipalRequest {
  ...
  updateModified?: SyncPrincipalUpdateModifiedEnum;
  ...
  deleteRemoved?: SyncPrincipalDeleteRemovedEnum;
  /**
...
export const tspublicRestV2AdminSyncprincipalRequestSchema: Schema<TspublicRestV2AdminSyncprincipalRequest> = object(
  {
    ...
    updateModified: [
      'updateModified',
      optional(syncPrincipalUpdateModifiedEnumSchema),
    ],
    deleteRemoved: [
      'deleteRemoved',
      optional(syncPrincipalDeleteRemovedEnumSchema),
    ],
