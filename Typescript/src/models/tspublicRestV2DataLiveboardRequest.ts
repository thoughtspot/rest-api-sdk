...
import {
  ...
  liveboardDataFormatTypeEnumSchema,
} from './liveboardDataFormatTypeEnum';
...
export interface TspublicRestV2DataLiveboardRequest {
   ...
   */
  formatType?: LiveboardDataFormatTypeEnum;
}
...
export const tspublicRestV2DataLiveboardRequestSchema: Schema<TspublicRestV2DataLiveboardRequest> = object(
  {
    ...
    formatType: ['formatType', optional(liveboardDataFormatTypeEnumSchema)],
  }
);
