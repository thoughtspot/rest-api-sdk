...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class CreateUserRequest : IValidatableObject
    {
        ...
        public CreateUserRequest(string name = default(string), string displayName = default(string), string password = default(string), string email = default(string), AccountTypeEnum? accountType = AccountTypeEnum.LOCALUSER, AccountStatusEnum? accountStatus = AccountStatusEnum.ACTIVE, List<string> orgIdentifiers = default(List<string>), List<string> groupIdentifiers = default(List<string>), VisibilityEnum? visibility = VisibilityEnum.SHARABLE, bool? notifyOnShare = true, bool? showOnboardingExperience = true, bool? onboardingExperienceCompleted = false, string homeLiveboardIdentifier = default(string), List<FavoriteMetadataInput> favoriteMetadata = default(List<FavoriteMetadataInput>), PreferredLocaleEnum? preferredLocale = default(PreferredLocaleEnum?), bool? useBrowserLanguage = default(bool?), Object extendedProperties = default(Object), Object extendedPreferences = default(Object), bool? triggerWelcomeEmail = default(bool?), bool? triggerActivationEmail = default(bool?))
        {
