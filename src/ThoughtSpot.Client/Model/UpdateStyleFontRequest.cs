...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class UpdateStyleFontRequest : IValidatableObject
    {
        ...
        public UpdateStyleFontRequest(ScopeEnum? scope = ScopeEnum.ORG, string name = default(string), WeightEnum? weight = default(WeightEnum?), StyleEnum? style = default(StyleEnum?), string color = default(string))
        {
            this.Scope = scope;
            this.Name = name;
            this.Weight = weight;
