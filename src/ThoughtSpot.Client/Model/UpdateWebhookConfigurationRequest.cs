...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class UpdateWebhookConfigurationRequest : IValidatableObject
    {
        ...
        public UpdateWebhookConfigurationRequest(string name = default(string), string description = default(string), string url = default(string), Object urlParams = default(Object), List<EventsEnum> events = default(List<EventsEnum>), WebhookAuthenticationInput authentication = default(WebhookAuthenticationInput), WebhookSignatureVerificationInput signatureVerification = default(WebhookSignatureVerificationInput), StorageDestinationInput storageDestination = default(StorageDestinationInput), List<WebhookKeyValuePairInput> additionalHeaders = default(List<WebhookKeyValuePairInput>), StatusEnum? status = default(StatusEnum?), List<ResetOptionsEnum> resetOptions = default(List<ResetOptionsEnum>))
        {
            this.Name = name;
