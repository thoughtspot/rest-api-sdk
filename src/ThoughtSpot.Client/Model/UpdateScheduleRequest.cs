...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class UpdateScheduleRequest : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="name">Name of the scheduled job..</param>
        /// <param name="description">Description of the scheduled job..</param>
        /// <param name="metadataType">Type of metadata object..</param>
        /// <param name="metadataIdentifier">Unique ID or name of the metadata object..</param>
        /// <param name="fileFormat">Export file format..</param>
        /// <param name="liveboardOptions">Options to specify the details of a Liveboard..</param>
        /// <param name="pdfOptions">Options for PDF export..</param>
        /// <param name="varTimeZone">Time zone.</param>
        /// <param name="frequency">Frequency of the scheduled job run..</param>
        /// <param name="recipientDetails">Recipients of the scheduled job notifications. You can add the ID or name of the ThoughtSpot users or groups as recipients in the &#x60;principals&#x60; array. If a recipient is not a ThoughtSpot user, specify email address..</param>
        ...
        public UpdateScheduleRequest(string name = default(string), string description = default(string), MetadataTypeEnum? metadataType = default(MetadataTypeEnum?), string metadataIdentifier = default(string), FileFormatEnum? fileFormat = default(FileFormatEnum?), LiveboardOptionsInput liveboardOptions = default(LiveboardOptionsInput), SchedulesPdfOptionsInput pdfOptions = default(SchedulesPdfOptionsInput), VarTimeZoneEnum? varTimeZone = default(VarTimeZoneEnum?), FrequencyInput frequency = default(FrequencyInput), RecipientDetailsInput recipientDetails = default(RecipientDetailsInput), StatusEnum? status = default(StatusEnum?), string personalisedViewId = default(string))
        {
            this.Name = name;
        ...
        /// </summary>
        /// <value>Description of the scheduled job.</value>
        ...
        /// </summary>
        /// <value>Options to specify the details of a Liveboard.</value>
        ...
        /// </summary>
        /// <value>Frequency of the scheduled job run.</value>
        ...
        /// </summary>
        /// <value>Recipients of the scheduled job notifications. You can add the ID or name of the ThoughtSpot users or groups as recipients in the &#x60;principals&#x60; array. If a recipient is not a ThoughtSpot user, specify email address.</value>
        [DataMember(Name = "recipient_details", EmitDefaultValue = false)]
