...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class ExportAnswerReportRequest : IValidatableObject
    {
        ...
        public ExportAnswerReportRequest(string metadataIdentifier = default(string), string sessionIdentifier = default(string), int generationNumber = default(int), FileFormatEnum? fileFormat = FileFormatEnum.CSV, Object runtimeFilter = default(Object), Object runtimeSort = default(Object), Object runtimeParamOverride = default(Object), RegionalSettingsInput regionalSettings = default(RegionalSettingsInput), AnswerPngOptionsInput pngOptions = default(AnswerPngOptionsInput), string personalisedViewIdentifier = default(string), TypeEnum? type = TypeEnum.SAVED)
        {
