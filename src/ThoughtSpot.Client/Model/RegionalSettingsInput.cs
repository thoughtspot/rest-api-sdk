...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class RegionalSettingsInput : IValidatableObject
    {
        ...
        public RegionalSettingsInput(CurrencyFormatEnum? currencyFormat = default(CurrencyFormatEnum?), UserLocaleEnum? userLocale = default(UserLocaleEnum?), NumberFormatLocaleEnum? numberFormatLocale = default(NumberFormatLocaleEnum?), DateFormatLocaleEnum? dateFormatLocale = default(DateFormatLocaleEnum?))
        {
