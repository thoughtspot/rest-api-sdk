...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class CreateAgentConversationRequest : IValidatableObject
    {
        ...
        public CreateAgentConversationRequest(ContextPayloadV2Input metadataContext = default(ContextPayloadV2Input), ConversationSettingsInput conversationSettings = default(ConversationSettingsInput))
        {
