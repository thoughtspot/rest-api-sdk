...
namespace ThoughtSpot.Client.Model
{
    ...
    public partial class CreateScheduleRequest : IValidatableObject
    {
        ...
        public CreateScheduleRequest(string name = default(string), string description = default(string), MetadataTypeEnum metadataType = default(MetadataTypeEnum), string metadataIdentifier = default(string), FileFormatEnum? fileFormat = FileFormatEnum.PDF, LiveboardOptionsInput liveboardOptions = default(LiveboardOptionsInput), SchedulesPdfOptionsInput pdfOptions = default(SchedulesPdfOptionsInput), VarTimeZoneEnum varTimeZone = VarTimeZoneEnum.AmericaLosAngeles, FrequencyInput frequency = default(FrequencyInput), RecipientDetailsInput recipientDetails = default(RecipientDetailsInput), string personalisedViewId = default(string))
        {
