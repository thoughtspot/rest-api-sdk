...
| `FormatType` | [`AnswerDataFormatTypeEnum`](../../doc/models/answer-data-format-type-enum.md) | Optional | The format of the data in the response.<br><br>FULL: The response comes in "column":"value" format.<br><br>COMPACT: The response includes only the value of the columns.<br>**Default**: `AnswerDataFormatTypeEnum.COMPACT` | AnswerDataFormatTypeEnum getFormatType() | setFormatType(AnswerDataFormatTypeEnum formatType) |
