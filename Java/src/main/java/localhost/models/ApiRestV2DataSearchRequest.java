...
/**
 * This is a model class for ApiRestV2DataSearchRequest type.
 */
public class ApiRestV2DataSearchRequest {
    ...
    /**
     * Converts this ApiRestV2DataSearchRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ApiRestV2DataSearchRequest [" + "queryString=" + queryString + ", dataObjectId="
                + dataObjectId + ", offset=" + offset + ", batchNumber=" + batchNumber
                + ", batchSize=" + batchSize + ", formatType=" + formatType + "]";
    }

    /**
     * Builds a new {@link ApiRestV2DataSearchRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ApiRestV2DataSearchRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ApiRestV2DataSearchRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ApiRestV2DataSearchRequest} object using the set fields.
         * @return {@link ApiRestV2DataSearchRequest}
         */
        public ApiRestV2DataSearchRequest build() {
            return new ApiRestV2DataSearchRequest(queryString, dataObjectId, offset, batchNumber,
                    batchSize, formatType);
        }
    }
}
