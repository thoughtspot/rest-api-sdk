...
/**
 * SearchUsersPrivilegesEnum to be used.
 */
public enum SearchUsersPrivilegesEnum {
    ...
    private static TreeMap<String, SearchUsersPrivilegesEnum> valueMap = new TreeMap<>();
    ...
    public static SearchUsersPrivilegesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of SearchUsersPrivilegesEnum values to list of string values.
     * @param toConvert The list of SearchUsersPrivilegesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SearchUsersPrivilegesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SearchUsersPrivilegesEnum enumValue : toConvert) {
