...
/**
 * UpdateGroupPrivilegesEnum to be used.
 */
public enum UpdateGroupPrivilegesEnum {
    ...
    private static TreeMap<String, UpdateGroupPrivilegesEnum> valueMap = new TreeMap<>();
    ...
    public static UpdateGroupPrivilegesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of UpdateGroupPrivilegesEnum values to list of string values.
     * @param toConvert The list of UpdateGroupPrivilegesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<UpdateGroupPrivilegesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (UpdateGroupPrivilegesEnum enumValue : toConvert) {
