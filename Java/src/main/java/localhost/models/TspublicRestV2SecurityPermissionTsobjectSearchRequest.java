...
public class TspublicRestV2SecurityPermissionTsobjectSearchRequest {
    ...
    private IncludeDependentEnum includeDependent;

    /**
     * Default constructor.
     */
    public TspublicRestV2SecurityPermissionTsobjectSearchRequest() {
        includeDependent = IncludeDependentEnum.ENUM_FALSE;
    }
     ...
     * @param  includeDependent  IncludeDependentEnum value for includeDependent.
     */
    public TspublicRestV2SecurityPermissionTsobjectSearchRequest(
            List<TsObjectSearchInput> tsObject,
            List<UserNameAndIDInput> principal,
            IncludeDependentEnum includeDependent) {
     ...
     * dependent objects
     * @return Returns the IncludeDependentEnum
     */
    @JsonGetter("includeDependent")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public IncludeDependentEnum getIncludeDependent() {
     ...
     * When this field is set to true, the API response includes the permission details for the
     * dependent objects
     * @param includeDependent Value for IncludeDependentEnum
     */
    @JsonSetter("includeDependent")
    public void setIncludeDependent(IncludeDependentEnum includeDependent) {
        this.includeDependent = includeDependent;
    }
    ...
    public static class Builder {
        private List<TsObjectSearchInput> tsObject;
        private List<UserNameAndIDInput> principal;
        private IncludeDependentEnum includeDependent = IncludeDependentEnum.ENUM_FALSE;
         ...
         * @return Builder
         */
        public Builder includeDependent(IncludeDependentEnum includeDependent) {
            this.includeDependent = includeDependent;
            return this;
        }
