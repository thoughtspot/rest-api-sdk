...
public class TspublicRestV2AdminSyncprincipalRequest {
    ...
    public TspublicRestV2AdminSyncprincipalRequest() {
        updateModified = SyncPrincipalUpdateModifiedEnum.ENUM_FALSE;
        deleteRemoved = SyncPrincipalDeleteRemovedEnum.ENUM_FALSE;
    }

    /**
     * Initialization constructor.
     * @param  principalObject  List of Object value for principalObject.
     * @param  updateModified  SyncPrincipalUpdateModifiedEnum value for updateModified.
     * @param  deleteRemoved  SyncPrincipalDeleteRemovedEnum value for deleteRemoved.
    ...
    public TspublicRestV2AdminSyncprincipalRequest(
            ...
            SyncPrincipalDeleteRemovedEnum deleteRemoved,
     ...
     * @return Returns the SyncPrincipalUpdateModifiedEnum
     */
     ...
     * Specifies whether to apply the changes to users and groups already in the cluster based on
     * the principal object list input.
     * @param updateModified Value for SyncPrincipalUpdateModifiedEnum
     */
    @JsonSetter("updateModified")
    public void setUpdateModified(SyncPrincipalUpdateModifiedEnum updateModified) {
        this.updateModified = updateModified;
    }
     ...
     * @return Returns the SyncPrincipalDeleteRemovedEnum
     */
     ...
     * Specifies whether to delete the users and groups already in the cluster if not present in the
     * principal object list input.
     * @param deleteRemoved Value for SyncPrincipalDeleteRemovedEnum
     */
    @JsonSetter("deleteRemoved")
    public void setDeleteRemoved(SyncPrincipalDeleteRemovedEnum deleteRemoved) {
        this.deleteRemoved = deleteRemoved;
    }
    ...
    public static class Builder {
        private List<Object> principalObject;
        private SyncPrincipalUpdateModifiedEnum updateModified =
                SyncPrincipalUpdateModifiedEnum.ENUM_FALSE;
        private SyncPrincipalDeleteRemovedEnum deleteRemoved =
                SyncPrincipalDeleteRemovedEnum.ENUM_FALSE;
        private String newUserPassword;
         ...
         * @return Builder
         */
        public Builder updateModified(SyncPrincipalUpdateModifiedEnum updateModified) {
            this.updateModified = updateModified;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder deleteRemoved(SyncPrincipalDeleteRemovedEnum deleteRemoved) {
            this.deleteRemoved = deleteRemoved;
            return this;
        }
