...
public class TspublicRestV2MetadataDependencyRequest {
    private GetObjectDependencyTypeEnum type;
     ...
     * @param  type  GetObjectDependencyTypeEnum value for type.
     * @param  id  List of String value for id.
     * @param  batchSize  Integer value for batchSize.
     */
    public TspublicRestV2MetadataDependencyRequest(
            GetObjectDependencyTypeEnum type,
            List<String> id,
            Integer batchSize) {
        this.type = type;
        this.id = id;
     ...
     * @return Returns the GetObjectDependencyTypeEnum
     */
    @JsonGetter("type")
    public GetObjectDependencyTypeEnum getType() {
        return type;
    }
     ...
     * Setter for Type.
     * Type of the data object
     * @param type Value for GetObjectDependencyTypeEnum
     */
    @JsonSetter("type")
    public void setType(GetObjectDependencyTypeEnum type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @param  id  List of String value for id.
         */
        public Builder(GetObjectDependencyTypeEnum type, List<String> id) {
            this.type = type;
            this.id = id;
        }
         ...
         * @return Builder
         */
        public Builder type(GetObjectDependencyTypeEnum type) {
            this.type = type;
            return this;
        }
