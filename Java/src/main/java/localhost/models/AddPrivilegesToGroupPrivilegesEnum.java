...
/**
 * AddPrivilegesToGroupPrivilegesEnum to be used.
 */
public enum AddPrivilegesToGroupPrivilegesEnum {
    ...
    private static TreeMap<String, AddPrivilegesToGroupPrivilegesEnum> valueMap = new TreeMap<>();
    ...
    public static AddPrivilegesToGroupPrivilegesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of AddPrivilegesToGroupPrivilegesEnum values to list of string values.
     * @param toConvert The list of AddPrivilegesToGroupPrivilegesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<AddPrivilegesToGroupPrivilegesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (AddPrivilegesToGroupPrivilegesEnum enumValue : toConvert) {
