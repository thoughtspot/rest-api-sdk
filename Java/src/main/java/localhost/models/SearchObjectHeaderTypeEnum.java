...
/**
 * SearchObjectHeaderTypeEnum to be used.
 */
public enum SearchObjectHeaderTypeEnum {
    ...
    private static TreeMap<String, SearchObjectHeaderTypeEnum> valueMap = new TreeMap<>();
    ...
    public static SearchObjectHeaderTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of SearchObjectHeaderTypeEnum values to list of string values.
     * @param toConvert The list of SearchObjectHeaderTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SearchObjectHeaderTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SearchObjectHeaderTypeEnum enumValue : toConvert) {
