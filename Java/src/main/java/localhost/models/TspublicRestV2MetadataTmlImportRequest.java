...
public class TspublicRestV2MetadataTmlImportRequest {
     ...
     * then use escape characters for quotes and new line characters. Example TML: guid:
     * 6d2c1c9b-a407-409c-8c0c-819aeb51350f\ntable:\n name: TESTINT\n db: SUPPLYCHAIN_MAIN\n schema:
     * PUBLIC\n db_table: TESTINT\n connection:\n name: SnowflakeConnection\n columns:\n - name:
     * C1\n db_column_name: C1\n properties:\n column_type: MEASURE\n aggregation: SUM\n index_type:
     * DONT_INDEX\n db_column_properties:\n data_type: INT64\n If TML is in JSON format, then use
     * escape characters for quotes. Example TML: {\\"guid\\":
     * \\"6d2c1c9b-a407-409c-8c0c-819aeb51350f\\", \\"table\\": { \\"name\\": \\"TESTINT\\",
     * \\"db\\": \\"SUPPLYCHAIN_MAIN\\", \\"schema\\": \\"PUBLIC\\", \\"db_table\\": \\"TESTINT\\",
     * \\"connection\\": { \\"name\\": \\"SnowflakeConnection\\" }, \\"columns\\": [ { \\"name\\":
     * \\"C1\\", \\"db_column_name\\": \\"C1\\", \\"properties\\": { \\"column_type\\":
     * \\"MEASURE\\", \\"aggregation\\": \\"SUM\\", \\"index_type\\": \\"DONT_INDEX\\" },
