...
public class TspublicRestV2MetadataTmlImportRequest {
    ...
    private ImportObjectTMLImportPolicyEnum importPolicy;
    private ImportObjectTMLForceCreateEnum forceCreate;
    ...
    public TspublicRestV2MetadataTmlImportRequest() {
        ...
        forceCreate = ImportObjectTMLForceCreateEnum.ENUM_FALSE;
    }

    /**
     * Initialization constructor.
     * @param  objectTML  List of String value for objectTML.
     * @param  importPolicy  ImportObjectTMLImportPolicyEnum value for importPolicy.
     * @param  forceCreate  ImportObjectTMLForceCreateEnum value for forceCreate.
     */
    public TspublicRestV2MetadataTmlImportRequest(
            List<String> objectTML,
            ImportObjectTMLImportPolicyEnum importPolicy,
            ImportObjectTMLForceCreateEnum forceCreate) {
     ...
     * @return Returns the ImportObjectTMLImportPolicyEnum
     */
    @JsonGetter("importPolicy")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ImportObjectTMLImportPolicyEnum getImportPolicy() {
        return importPolicy;
    }
     ...
     * ignores objects that do not validate successfully. ALL_OR_NONE Imports the objects that
     * validate successfully. VALIDATE_ONLY Validates the objects but does not import them.
     * @param importPolicy Value for ImportObjectTMLImportPolicyEnum
     */
    @JsonSetter("importPolicy")
    public void setImportPolicy(ImportObjectTMLImportPolicyEnum importPolicy) {
        this.importPolicy = importPolicy;
    }
     ...
     * forceCreate=true.
     * @return Returns the ImportObjectTMLForceCreateEnum
     */
    @JsonGetter("forceCreate")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ImportObjectTMLForceCreateEnum getForceCreate() {
        return forceCreate;
    }
     ...
     * value. Thus, there is no need to include the guid in the TML file if you are using
     * forceCreate=true.
     * @param forceCreate Value for ImportObjectTMLForceCreateEnum
     */
    @JsonSetter("forceCreate")
    public void setForceCreate(ImportObjectTMLForceCreateEnum forceCreate) {
        this.forceCreate = forceCreate;
    }
    ...
    public static class Builder {
        ...
        private ImportObjectTMLForceCreateEnum forceCreate =
                ImportObjectTMLForceCreateEnum.ENUM_FALSE;
         ...
         * @return Builder
         */
        public Builder importPolicy(ImportObjectTMLImportPolicyEnum importPolicy) {
            this.importPolicy = importPolicy;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder forceCreate(ImportObjectTMLForceCreateEnum forceCreate) {
            this.forceCreate = forceCreate;
            return this;
        }
