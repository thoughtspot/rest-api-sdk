...
public class TspublicRestV2ConnectionTableRequest {
     ...
     * @param  includeColumn  Boolean value for includeColumn.
     */
    public TspublicRestV2ConnectionTableRequest(
            String id,
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public Boolean getIncludeColumn() {
     ...
     * When set to true, the response will include column level details as well
     * @param includeColumn Value for Boolean
     */
    @JsonSetter("includeColumn")
    public void setIncludeColumn(Boolean includeColumn) {
        this.includeColumn = includeColumn;
    }
    ...
    public static class Builder {
        private String id;
        private String configuration;
        private Boolean includeColumn = true;
         ...
         * @return Builder
         */
        public Builder includeColumn(Boolean includeColumn) {
            this.includeColumn = includeColumn;
            return this;
        }
