...
public class TspublicRestV2SessionLoginRequest {
     ...
     * @param  rememberMe  LoginRememberMeEnum value for rememberMe.
     */
    public TspublicRestV2SessionLoginRequest(
            String userName,
            String password,
            LoginRememberMeEnum rememberMe) {
     ...
     * @return Returns the LoginRememberMeEnum
     */
     ...
     * A flag to remember the user session. When set to true, sets a session cookie that persists in
     * subsequent API calls.
     * @param rememberMe Value for LoginRememberMeEnum
     */
    @JsonSetter("rememberMe")
    public void setRememberMe(LoginRememberMeEnum rememberMe) {
        this.rememberMe = rememberMe;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder rememberMe(LoginRememberMeEnum rememberMe) {
            this.rememberMe = rememberMe;
            return this;
        }
