...
/**
 * SearchConnectionTypeEnum to be used.
 */
public enum SearchConnectionTypeEnum {
    ...
    public static SearchConnectionTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of SearchConnectionTypeEnum values to list of string values.
     * @param toConvert The list of SearchConnectionTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SearchConnectionTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SearchConnectionTypeEnum enumValue : toConvert) {
