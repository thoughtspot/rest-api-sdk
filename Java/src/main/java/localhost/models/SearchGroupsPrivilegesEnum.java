...
/**
 * SearchGroupsPrivilegesEnum to be used.
 */
public enum SearchGroupsPrivilegesEnum {
    ...
    public static SearchGroupsPrivilegesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of SearchGroupsPrivilegesEnum values to list of string values.
     * @param toConvert The list of SearchGroupsPrivilegesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SearchGroupsPrivilegesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SearchGroupsPrivilegesEnum enumValue : toConvert) {
