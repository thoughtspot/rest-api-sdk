...
public enum UpdateUserTypeEnum {
    ...
    private static TreeMap<String, UpdateUserTypeEnum> valueMap = new TreeMap<>();
    ...
    public static UpdateUserTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of UpdateUserTypeEnum values to list of string values.
     * @param toConvert The list of UpdateUserTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<UpdateUserTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (UpdateUserTypeEnum enumValue : toConvert) {
