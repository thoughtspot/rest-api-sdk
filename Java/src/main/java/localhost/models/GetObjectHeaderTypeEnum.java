...
/**
 * GetObjectHeaderTypeEnum to be used.
 */
public enum GetObjectHeaderTypeEnum {
    ...
    private static TreeMap<String, GetObjectHeaderTypeEnum> valueMap = new TreeMap<>();
    ...
    public static GetObjectHeaderTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of GetObjectHeaderTypeEnum values to list of string values.
     * @param toConvert The list of GetObjectHeaderTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<GetObjectHeaderTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (GetObjectHeaderTypeEnum enumValue : toConvert) {
