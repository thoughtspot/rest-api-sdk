...
public class TspublicRestV2ReportLiveboardRequest {
    ...
    private LiveboardReportTypeEnum type;
     ...
     * @param  type  LiveboardReportTypeEnum value for type.
     ...
     * @return Returns the LiveboardReportTypeEnum
     */
    @JsonGetter("type")
    public LiveboardReportTypeEnum getType() {
        return type;
    }
     ...
     * Setter for Type.
     * Type of file to be generated.
     * @param type Value for LiveboardReportTypeEnum
     */
    @JsonSetter("type")
    public void setType(LiveboardReportTypeEnum type) {
        this.type = type;
    }
    ...
    public static class Builder {
        private LiveboardReportTypeEnum type = LiveboardReportTypeEnum.PDF;
        private String id;
        private List<String> vizId;
        private String transientContent;
        private String runtimeFilter;
         ...
         * @param  type  LiveboardReportTypeEnum value for type.
         */
        public Builder(LiveboardReportTypeEnum type) {
            this.type = type;
        }
         ...
         * @return Builder
         */
        public Builder type(LiveboardReportTypeEnum type) {
            this.type = type;
            return this;
        }
