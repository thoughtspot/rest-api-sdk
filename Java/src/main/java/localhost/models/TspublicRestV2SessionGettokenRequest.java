...
public class TspublicRestV2SessionGettokenRequest {
     ...
     * @return Returns the GetTokenAccessLevelEnum
     */
     ...
     * User access privilege. FULL - Creates a session with full access. REPORT_BOOK_VIEW - Allow
     * view access to the specified visualizations.
     * @param accessLevel Value for GetTokenAccessLevelEnum
     */
    @JsonSetter("accessLevel")
    public void setAccessLevel(GetTokenAccessLevelEnum accessLevel) {
        this.accessLevel = accessLevel;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder accessLevel(GetTokenAccessLevelEnum accessLevel) {
            this.accessLevel = accessLevel;
            return this;
        }
