...
public class TspublicRestV2DatabaseTableCreateRequest {
    private CreateTableCreateDatabaseEnum createDatabase;
    ...
    public TspublicRestV2DatabaseTableCreateRequest() {
        createDatabase = CreateTableCreateDatabaseEnum.ENUM_TRUE;
    }

    /**
     * Initialization constructor.
     * @param  createDatabase  CreateTableCreateDatabaseEnum value for createDatabase.
     * @param  schema  String value for schema.
     */
    public TspublicRestV2DatabaseTableCreateRequest(
            CreateTableCreateDatabaseEnum createDatabase,
            String schema) {
     ...
     * @return Returns the CreateTableCreateDatabaseEnum
     */
    @JsonGetter("createDatabase")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CreateTableCreateDatabaseEnum getCreateDatabase() {
     ...
     * Flag to indicate if the database and schema should be created if they do not exist in Falcon.
     * (Valid values: True/False)
     * @param createDatabase Value for CreateTableCreateDatabaseEnum
     */
    @JsonSetter("createDatabase")
    public void setCreateDatabase(CreateTableCreateDatabaseEnum createDatabase) {
        this.createDatabase = createDatabase;
    }
    ...
    /**
     * Builds a new {@link TspublicRestV2DatabaseTableCreateRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TspublicRestV2DatabaseTableCreateRequest.Builder} object
     */
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder createDatabase(CreateTableCreateDatabaseEnum createDatabase) {
            this.createDatabase = createDatabase;
            return this;
        }
