...
public class TspublicRestV2SecurityShareVisualizationRequest {
    ...
    private ShareVisualizationNotifyEnum notify;
    private String message;
    private ShareVisualizationIncludeCustomEmbedUrlEnum includeCustomEmbedUrl;

    /**
     * Default constructor.
     */
    public TspublicRestV2SecurityShareVisualizationRequest() {
        notify = ShareVisualizationNotifyEnum.ENUM_TRUE;
        includeCustomEmbedUrl = ShareVisualizationIncludeCustomEmbedUrlEnum.ENUM_FALSE;
    }
     ...
     * @param  notify  ShareVisualizationNotifyEnum value for notify.
     * @param  message  String value for message.
     * @param  includeCustomEmbedUrl  ShareVisualizationIncludeCustomEmbedUrlEnum value for
    ...
    public TspublicRestV2SecurityShareVisualizationRequest(
            ...
            List<String> emailId,
            ShareVisualizationNotifyEnum notify,
            String message,
     ...
     * @return Returns the ShareVisualizationNotifyEnum
     */
    @JsonGetter("notify")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ShareVisualizationNotifyEnum getNotify() {
        return notify;
    }
     ...
     * Setter for Notify.
     * When set to true, a notification is sent to the users after an object is shared.
     * @param notify Value for ShareVisualizationNotifyEnum
     */
    @JsonSetter("notify")
    public void setNotify(ShareVisualizationNotifyEnum notify) {
        this.notify = notify;
    }
     ...
     * @return Returns the ShareVisualizationIncludeCustomEmbedUrlEnum
     */
    @JsonGetter("includeCustomEmbedUrl")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ShareVisualizationIncludeCustomEmbedUrlEnum getIncludeCustomEmbedUrl() {
     ...
     * When set to true, ThoughtSpot sends a link with the host application context to allow users
     * to access the shared object from their ThoughtSpot embedded instance.
     * @param includeCustomEmbedUrl Value for ShareVisualizationIncludeCustomEmbedUrlEnum
     */
    @JsonSetter("includeCustomEmbedUrl")
    public void setIncludeCustomEmbedUrl(ShareVisualizationIncludeCustomEmbedUrlEnum includeCustomEmbedUrl) {
        this.includeCustomEmbedUrl = includeCustomEmbedUrl;
    }
    ...
    public static class Builder {
        ...
        private List<String> principalId;
        private List<String> emailId;
        private ShareVisualizationNotifyEnum notify = ShareVisualizationNotifyEnum.ENUM_TRUE;
        private String message;
        private ShareVisualizationIncludeCustomEmbedUrlEnum includeCustomEmbedUrl =
                ShareVisualizationIncludeCustomEmbedUrlEnum.ENUM_FALSE;
         ...
         * @return Builder
         */
        public Builder notify(ShareVisualizationNotifyEnum notify) {
            this.notify = notify;
            return this;
        }
