...
public class TspublicRestV2GroupSearchRequest {
    ...
    private SearchGroupsVisibilityEnum visibility;
    private String description;
    private List<SearchGroupsPrivilegesEnum> privileges;
    private List<GroupNameAndIDInput> groups;
    private List<UserNameAndIDInput> users;
    private SearchGroupsTypeEnum type;
     ...
     * @param  visibility  SearchGroupsVisibilityEnum value for visibility.
     * @param  description  String value for description.
     * @param  privileges  List of SearchGroupsPrivilegesEnum value for privileges.
     * @param  groups  List of GroupNameAndIDInput value for groups.
     * @param  users  List of UserNameAndIDInput value for users.
     * @param  type  SearchGroupsTypeEnum value for type.
     */
    public TspublicRestV2GroupSearchRequest(
            ...
            String id,
            String displayName,
            SearchGroupsVisibilityEnum visibility,
            String description,
            List<SearchGroupsPrivilegesEnum> privileges,
            List<GroupNameAndIDInput> groups,
            List<UserNameAndIDInput> users,
            SearchGroupsTypeEnum type) {
     ...
     * objects.
     * @return Returns the SearchGroupsVisibilityEnum
     */
    @JsonGetter("visibility")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SearchGroupsVisibilityEnum getVisibility() {
        return visibility;
    }
     ...
     * attribute makes the user group visible for other user groups and allows them to share
     * objects.
     * @param visibility Value for SearchGroupsVisibilityEnum
     */
    @JsonSetter("visibility")
    public void setVisibility(SearchGroupsVisibilityEnum visibility) {
        this.visibility = visibility;
    }
     ...
     * @return Returns the List of SearchGroupsPrivilegesEnum
     */
    @JsonGetter("privileges")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<SearchGroupsPrivilegesEnum> getPrivileges() {
        return privileges;
    }
     ...
     * A JSON array of privileges assigned to the group
     * @param privileges Value for List of SearchGroupsPrivilegesEnum
     */
    @JsonSetter("privileges")
    public void setPrivileges(List<SearchGroupsPrivilegesEnum> privileges) {
        this.privileges = privileges;
    }
     ...
     * system.
     * @return Returns the SearchGroupsTypeEnum
     */
    @JsonGetter("type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SearchGroupsTypeEnum getType() {
        return type;
    }
     ...
     * Type of user group. LOCAL_GROUP indicates that the user is created locally in the ThoughtSpot
     * system.
     * @param type Value for SearchGroupsTypeEnum
     */
    @JsonSetter("type")
    public void setType(SearchGroupsTypeEnum type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder visibility(SearchGroupsVisibilityEnum visibility) {
            this.visibility = visibility;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder privileges(List<SearchGroupsPrivilegesEnum> privileges) {
            this.privileges = privileges;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder type(SearchGroupsTypeEnum type) {
            this.type = type;
            return this;
        }
