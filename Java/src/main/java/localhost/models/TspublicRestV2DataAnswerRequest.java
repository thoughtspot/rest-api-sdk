...
public class TspublicRestV2DataAnswerRequest {
    ...
    private String id;
    private AnswerDataFormatTypeEnum formatType;
    ...
    public TspublicRestV2DataAnswerRequest() {
        offset = 0;
        formatType = AnswerDataFormatTypeEnum.COMPACT;
    }
     ...
     * @param  formatType  AnswerDataFormatTypeEnum value for formatType.
     */
    public TspublicRestV2DataAnswerRequest(
            String id,
            Integer offset,
            Integer batchNumber,
            Integer batchSize,
            AnswerDataFormatTypeEnum formatType) {
        this.offset = offset;
     ...
     * @return Returns the AnswerDataFormatTypeEnum
     */
    @JsonGetter("formatType")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public AnswerDataFormatTypeEnum getFormatType() {
        return formatType;
    }
     ...
     * The format of the data in the response. FULL: The response comes in "column":"value" format.
     * COMPACT: The response includes only the value of the columns.
     * @param formatType Value for AnswerDataFormatTypeEnum
     */
    @JsonSetter("formatType")
    public void setFormatType(AnswerDataFormatTypeEnum formatType) {
        this.formatType = formatType;
    }
    ...
    public static class Builder {
        ...
        private Integer batchNumber;
        private Integer batchSize;
        private AnswerDataFormatTypeEnum formatType = AnswerDataFormatTypeEnum.COMPACT;
         ...
         * @return Builder
         */
        public Builder formatType(AnswerDataFormatTypeEnum formatType) {
            this.formatType = formatType;
            return this;
        }
