...
public class TspublicRestV2DataSearchRequest {
    ...
    public TspublicRestV2DataSearchRequest() {
        offset = 0;
        formatType = SearchQueryDataFormatTypeEnum.COMPACT;
    }
     ...
     * @param  formatType  SearchQueryDataFormatTypeEnum value for formatType.
     */
    public TspublicRestV2DataSearchRequest(
            String queryString,
            String dataObjectId,
            ...
            Integer batchNumber,
            Integer batchSize,
            SearchQueryDataFormatTypeEnum formatType) {
        this.offset = offset;
     ...
     * @return Returns the SearchQueryDataFormatTypeEnum
     */
     ...
     * The format of the data in the response. FULL: The response comes in "column":"value" format.
     * COMPACT: The response includes only the value of the columns.
     * @param formatType Value for SearchQueryDataFormatTypeEnum
     */
    @JsonSetter("formatType")
    public void setFormatType(SearchQueryDataFormatTypeEnum formatType) {
        this.formatType = formatType;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder formatType(SearchQueryDataFormatTypeEnum formatType) {
            this.formatType = formatType;
            return this;
        }
