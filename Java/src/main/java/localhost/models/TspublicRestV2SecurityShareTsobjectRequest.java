...
public class TspublicRestV2SecurityShareTsobjectRequest {
    ...
    public TspublicRestV2SecurityShareTsobjectRequest() {
        notify = NotifyEnum.ENUM_TRUE;
        includeCustomEmbedUrl = IncludeCustomEmbedUrlEnum.ENUM_FALSE;
    }

    /**
     * Initialization constructor.
     * @param  type  Type19Enum value for type.
     ...
     * @param  notify  NotifyEnum value for notify.
     * @param  message  String value for message.
     * @param  includeCustomEmbedUrl  IncludeCustomEmbedUrlEnum value for includeCustomEmbedUrl.
     */
    public TspublicRestV2SecurityShareTsobjectRequest(
            Type19Enum type,
            List<String> id,
     ...
     * @return Returns the Type19Enum
     */
    @JsonGetter("type")
    public Type19Enum getType() {
        return type;
    }
     ...
     * Setter for Type.
     * Type of metadata object
     * @param type Value for Type19Enum
     */
    @JsonSetter("type")
    public void setType(Type19Enum type) {
        this.type = type;
    }
     ...
     * Setter for Notify.
     * When set to true, a notification is sent to the users after an object is shared.
     * @param notify Value for NotifyEnum
     */
    @JsonSetter("notify")
     ...
     * @return Returns the IncludeCustomEmbedUrlEnum
     */
     ...
     * When set to true, ThoughtSpot sends a link with the host application context to allow users
     * to access the shared object from their ThoughtSpot embedded instance.
     * @param includeCustomEmbedUrl Value for IncludeCustomEmbedUrlEnum
     */
    @JsonSetter("includeCustomEmbedUrl")
    public void setIncludeCustomEmbedUrl(IncludeCustomEmbedUrlEnum includeCustomEmbedUrl) {
        this.includeCustomEmbedUrl = includeCustomEmbedUrl;
    }
    ...
    public static class Builder {
         ...
         * @param  permission  String value for permission.
         */
        public Builder(Type19Enum type, List<String> id, String permission) {
            this.type = type;
            this.id = id;
            this.permission = permission;
        }
         ...
         * @return Builder
         */
        public Builder type(Type19Enum type) {
            this.type = type;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder notify(NotifyEnum notify) {
            this.notify = notify;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder includeCustomEmbedUrl(IncludeCustomEmbedUrlEnum includeCustomEmbedUrl) {
            this.includeCustomEmbedUrl = includeCustomEmbedUrl;
            return this;
        }
