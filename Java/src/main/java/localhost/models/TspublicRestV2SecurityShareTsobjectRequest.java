...
public class TspublicRestV2SecurityShareTsobjectRequest {
     ...
     * @param  type  Type18Enum value for type.
     ...
     * Setter for Type.
     * Type of metadata object. Valid values: Liveboard|Answer|DataObject|Column
     * @param type Value for Type18Enum
     */
    @JsonSetter("type")
    public void setType(Type18Enum type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @param  permission  String value for permission.
         */
        public Builder(Type18Enum type, List<String> id, String permission) {
            this.type = type;
            this.id = id;
            this.permission = permission;
        }
         ...
         * @return Builder
         */
        public Builder type(Type18Enum type) {
            this.type = type;
            return this;
        }
