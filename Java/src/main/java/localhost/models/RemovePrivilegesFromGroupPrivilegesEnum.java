...
/**
 * RemovePrivilegesFromGroupPrivilegesEnum to be used.
 */
public enum RemovePrivilegesFromGroupPrivilegesEnum {
    ...
    private static TreeMap<String, RemovePrivilegesFromGroupPrivilegesEnum> valueMap = new TreeMap<>();
    ...
    public static RemovePrivilegesFromGroupPrivilegesEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of RemovePrivilegesFromGroupPrivilegesEnum values to list of string values.
     * @param toConvert The list of RemovePrivilegesFromGroupPrivilegesEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<RemovePrivilegesFromGroupPrivilegesEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (RemovePrivilegesFromGroupPrivilegesEnum enumValue : toConvert) {
