...
public final class MetadataController extends BaseController {
    ...
    /**
     * To programmatically create tags, use this endpoint Permission: Requires administration
     * privilege.
     ...
     * When both are given, then id will be considered. Permission: Requires at least view access to
     * the object.
     * @param  body  Required parameter: Example:
     * @return    Returns the Boolean response from the API call
     * @throws    ApiException    Represents error response from the server.
     ...
     * considered. Permission: Requires at least view access to the object.
     * @param  body  Required parameter: Example:
     * @return    Returns the Boolean response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     ...
     * be considered. Screen reader support enabled. Permission: Requires at least view access to
     * the object.
     * @param  body  Required parameter: Example:
     * @return    Returns the Boolean response from the API call
     * @throws    ApiException    Represents error response from the server.
     ...
     * username is required. When both are given, then id will be considered. Permission: Requires
     * at least view access to the object.
     * @param  body  Required parameter: Example:
     * @return    Returns the Boolean response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     ...
     * selective fields to get the data for. Permission: Requires administration privilege for USER
     * and USER_GROUP type. Requires datamanagement privilege for CONNECTION type. Requires at least
     * view access for other object types.
    ...
    /**
     * Use this endpoint to get full details of metadata objects. Permission: Requires
     * administration privilege for USER and USER_GROUP type. Requires datamanagement privilege for
     * CONNECTION type. Requires at least view access to other object types.
     ...
     * then id will be considered. Permission: Requires at least view access to the object.
     ...
     * Use this endpoint to get full details of metadata objects. Permission: Requires
     * administration privilege for USER and USER_GROUP type. Requires datamanagement privilege for
     * CONNECTION type. Requires at least view access for other object types.
     * @param  body  Required parameter: Example:
     * @return    Returns the Object response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
    ...
    /**
     * Use this endpoint to delete the metadata objects. Permission: Requires modify access to the
     * object.
     * @param  type  Required parameter: Type of the metadata object being searched.
     * @param  id  Required parameter: A JSON array of GUIDs of the objects.
     * @return    Returns the Boolean response from the API call
     ...
     * first deleting C1 Permission: Requires at least view access to the object.
     * @param  body  Required parameter: Example:
     * @return    Returns the Object response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     ...
     * endpoint. Permission: Requires at least view access to the object.
     * @param  body  Required parameter: Example:
     * @return    Returns the Object response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     ...
     * endpoint. Permission: Requires datamanagement privilge.
     * @param  body  Required parameter: Example:
     * @return    Returns the Object response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
