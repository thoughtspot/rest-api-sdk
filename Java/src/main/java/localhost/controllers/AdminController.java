...
public final class AdminController extends BaseController {
     ...
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public Boolean forceLogoutUsers(
            final TspublicRestV2AdminForcelogoutRequest body) throws ApiException, IOException {
        HttpRequest request = buildForceLogoutUsersRequest(body);
        authManagers.get("global").apply(request);

        HttpResponse response = getClientInstance().execute(request, false);
        HttpContext context = new HttpContext(request, response);

        return handleForceLogoutUsersResponse(context);
    }
     ...
     * @return    Returns the Boolean response from the API call
     */
    public CompletableFuture<Boolean> forceLogoutUsersAsync(
            final TspublicRestV2AdminForcelogoutRequest body) {
        return makeHttpCallAsync(() -> buildForceLogoutUsersRequest(body),
            req -> authManagers.get("global").applyAsync(req)
                .thenCompose(request -> getClientInstance()
                        .executeAsync(request, false)),
            context -> handleForceLogoutUsersResponse(context));
    }

    /**
     * Builds the HttpRequest object for forceLogoutUsers.
     */
    private HttpRequest buildForceLogoutUsersRequest(
            final TspublicRestV2AdminForcelogoutRequest body) throws JsonProcessingException {
        //validating required parameters
        if (null == body) {
            throw new NullPointerException("The parameter \"body\" is a required parameter and cannot be null.");
        }
    ...
    /**
     * Processes the response for forceLogoutUsers.
     * @return An object of type boolean
     */
    private Boolean handleForceLogoutUsersResponse(
            HttpContext context) throws ApiException, IOException {
        HttpResponse response = context.getResponse();
